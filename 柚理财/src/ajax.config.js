//京圆柚
export const MobileServer = 'http://120.26.7.114:8087'; // 京圆柚测试服务器的域名
export const StaticsServer = 'http://120.26.7.114:8083/'; // 京圆柚静态服务器地址
...
export const smsCodeApply = MobileServer + '/app/member/security/smsCodeApply.html'; //托管账户短信
...
export const unBind = MobileServer + '/app/member/bankCard/unbindCard.html'; //银行卡解绑
export const bindCard = MobileServer + '/app/member/bankCard/bindCard.html'; //银行卡绑定
export const authSign = MobileServer + '/app/member/security/authSign.html'; //业务授权
export const authSignCancel = MobileServer + '/app/member/security/authSignCancel.html'; //撤销业务授权
...
/* S--抽奖-- */
export const lotteryListAjax = MobileServer + '/app/open/lottery/list.html'; // 抽奖记录，默认30条
export const scoreLotteryInfoAjax = MobileServer + '/app/member/lottery/scoreLotteryInfo.html'; // 我的积分及可抽奖次数
export const doLotteryAjax = MobileServer + '/app/member/lottery/doLottery.html'; // 积分抽奖
export const getScoreLotteryAjax = MobileServer + '/app/member/score/getScoreLottery.html'; // 中奖记录
/* --抽奖--E */

/* S--任务和签到-- */
export const taskStatusAjax = MobileServer + '/app/member/taskCenter/taskStatus.html'; // 任务状态
export const signInAjax = MobileServer + '/app/member/taskCenter/signIn.html'; // 签到
/* S--任务和签到-- */