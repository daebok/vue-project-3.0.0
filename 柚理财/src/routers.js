...
// 防止刷新时候判断登录是否过期使用组件路由钩子---app商城免登陆
function requireAuth(to, from, next) {
...
const router = new Router({
  routes: [
    ...
    { // 立即还款
      path: '/account/refund/:projectId/:uuid/:period',
      name: 'refund',
    ...
    { // 业务授权
      path: '/mine/safe/authSign',
      name: 'authSign',
      component: resolve => { require(['./views/mine/safe/authSign.vue'], resolve) },
      beforeEnter: requireAuth,
      meta: { requiresAuth: true }
    },
    { // 托管账户、实名认证
    ...
    { // 大转盘活动抽奖
      path: '/shop/lottery',
      name: 'lottery',
      component: resolve => { require(['./views/shop/lottery.vue'], resolve) },
      meta: { title: '积分抽奖' }
    },
    { // 任务中心
      path: '/account/task',
      name: 'task',
      component: resolve => { require(['./views/account/task.vue'], resolve) },
      meta: { title: '任务中心' }
    },
    { // 中奖记录
      path: '/shop/lottery/record',
      name: 'lotteryRecord',
      beforeEnter: requireAuth,
      component: resolve => { require(['./views/shop/lotteryRecord.vue'], resolve) },
      meta: { requiresAuth: true, title: '中奖记录' }
    },
    // 给APP用的链接URL
    {
      path: '/appH5/aboutUs',
    ...
    { // 平台公告详情
      path: '/appH5/siteIntro/detail/:uuid',
      name: 'AppSiteIntroDetail',
      component: resolve => { require(['./views/mine/siteIntroDetail.vue'], resolve) },
      meta: { title: '平台公告详情' }
    },
    { // app商城
      path: '/appH5/shop/index',
      name: 'AppShopIndex',
      component: resolve => { require(['./views/shop/index.vue'], resolve) },
      meta: { title: '商城' }
    }
