<template>
  <div class="page" id="result">
    ...
    <!-- 柚理财回调 -->
    <!--设置密码处理完成-->
    <!-- set_success：设置交易密码处理完成
    reset_success：重置交易密码处理完成
    autoBidAuth_success：自动投标签约处理完成
    autoCreditAuth_success：自动债权签约处理完成 -->
    <div v-if="$route.query.code=='set_success' || $route.query.code=='reset_success' || $route.query.code=='autoBidAuth_success' || $route.query.code=='autoCreditAuth_success'" class="box-msg">
      <div class="result-img">
        <img src="../assets/images/me/tips_escrow_account.png" />
      </div>
      <div class="msg-text text-center color-666">
