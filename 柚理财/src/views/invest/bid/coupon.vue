<template>
  <div class="page redPacket-page" id="redPacket">
    <mt-header class="bar-nav" title="选择加息券" >
      ...
      <ul class="coupon-list">
        <li v-for="item in list">
          <div class="coupon-list-1">
            ...
            <label class="label-check" @click.prevent="cancelChoose">
              <input class="checkbox hide" :data-up-apr="item.upApr" :ref="item.uuid" type="radio" :value="item.uuid" v-model="selected_coupon">
    ...
    <div class="redPacket-bottom">
      ...
      <p class="redPacket-tips">每次投资只可使用一张加息券</p>
