<template>
  <div class="page">
    ...
    <ul class="select-area aui-border-b">
      <li @click="showLayer('order', $event)" id="orderLi" class="aui-border-r">兑换状态 <img src="../../assets/images/shop/arrow_down.png"></li>
      <li @click="showLayer('score', $event)" id="scoreLi">日期范围 <img src="../../assets/images/shop/arrow_down.png"></li>
    </ul>
