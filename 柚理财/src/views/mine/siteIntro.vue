...
<template>
  <div class="page" id="siteIntro">
    ...
    <div class="page-loadmore-wrapper" ref="wrapper" :style="{height: wrapperHeight + 'px'}">
      ...
      <!-- {{ item.lowestAmount | moneyFormat('')}} -->
        <mt-cell v-for="item in list" :key="item.id" :title="item.title | hideBorrowName(18)" :label="item.remark | hideBorrowName(20)" :to="'/mine/siteIntro/detail/'+item.uuid" is-link></mt-cell>
      </mt-loadmore>
...
<style type="text/css">
  .mint-cell{min-height: .55rem;}
  .mint-cell-text{font-size: .14rem;}
  .mint-cell-label{font-size: .12rem;}
</style>