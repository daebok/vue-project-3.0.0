    ...
    <div class="content">
      ...
      <div class="top text-center">
        ...
        <router-link to="/mine/invite/award_rule">
          <span class="rule color-999">查看奖励规则</span>
        </router-link>
      </div>
      <div class="icon-area clearfix text-center">
        ...
        <div class="aui-flex-item-4" @click="popupVisible = !popupVisible">
  ...
  export default {
    ...
    mounted() {
      this.$http.get(ajaxUrl.wxInvite, { params: this.getParams }).then((res) => {
        ...
        weixin.config({
          debug: false,
          appId: 'wx43852f8f0e199224', // 微信公众平台appid，视不同项目平台而定
        ...
        var obj = {
          ...
          link: data.url, // 分享链接
          imgUrl: '../../assets/images/public/default/nodata_trilateral.png', // 分享图标
          success: function() {
            // 用户确认分享后执行的回调函数
        ...
        var qrcode = new QRCode(this.$refs.qrcode, {
          text: ajaxUrl.MobileServer + '/register?ui='+this.$store.state.user.userName,
          width: 120,
          height: 120,
          colorDark: '#000'
        })
...
<style type="text/css" scoped>
  ...
  .icon-area .aui-flex-item-4 { margin: .15rem 0;}
  ...
  .qrcode { display: inline-block; margin-top: .15rem; }
