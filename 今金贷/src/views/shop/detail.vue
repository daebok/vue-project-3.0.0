  ...
  <div class="page">
    <div class="content" :class="{'margin-85': limited}" >
      ...
      <div class="flex box aui-border-b">
        <div class="cell left">
          <img v-if="resdata.goodsCategoryName == '家居百货'" src="../../assets/images/shop/home_goods.png" >
          <img v-if="resdata.goodsCategoryName == '家用电器'" src="../../assets/images/shop/home_electrical.png" >
          <img v-if="resdata.goodsCategoryName == '数码娱乐'" src="../../assets/images/shop/digital_entertainment.png" >
          <img v-if="resdata.goodsCategoryName == '红包票券'" src="../../assets/images/shop/coupon.png" >
        </div>
