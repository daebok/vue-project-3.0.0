...
public class UserCertificationController extends WebController{
	 ...
	 * @return
	 */
	@RequestMapping(value = "/member/usercertification/getCertificateInfoByUserId")
	@ResponseBody
	public Object getCertificateInfoByUserId(final String qualificationType,final String userId){
		final Map<String, Object> data = Maps.newHashMap();
