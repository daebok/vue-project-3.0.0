 ...
 * @date 2017年8月18日
 */
public class JxBatchRepayModel extends JxBaseModel {
	...
	public JxBatchRepayModel() {
		super();
		super.setTxCode(JxConfig.BATCH_REPAY);
		setNotifyURL(ConfigUtils.getValue("notify_url")+ "/jxbank/batchRepay/notify.html");
		setRetNotifyURL(ConfigUtils.getValue("notify_url")+ "/jxbank/batchRepay/retNotify.html");
	}
