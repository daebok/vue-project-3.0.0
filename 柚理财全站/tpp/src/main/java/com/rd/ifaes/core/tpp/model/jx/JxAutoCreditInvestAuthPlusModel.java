...
public class JxAutoCreditInvestAuthPlusModel extends JxBaseModel {
     ...
     * 请求参数
     */
    private String[] directRequestParamNames = new String[]{"accountId", "orderId",
    ...
    public JxAutoCreditInvestAuthPlusModel() {
        super();
        super.setTxCode(JxConfig.AUTO_CREDIT_INVEST_AUTH_PLUS);
        setSummitUrl(getBaseUrl() + "/p2p/page/mobile/plus");
        setRetUrl(ConfigUtils.getValue("notify_url") + "/jxbank/autoCreditInvestAuthPlus/return.html");
        setForgotPwdUrl(ConfigUtils.getValue("notify_url") + "/member/security/modifyTransactionPwd.html");
        setNotifyUrl(ConfigUtils.getValue("notify_url") + "/jxbank/autoCreditInvestAuthPlus/notify.html");
    }
