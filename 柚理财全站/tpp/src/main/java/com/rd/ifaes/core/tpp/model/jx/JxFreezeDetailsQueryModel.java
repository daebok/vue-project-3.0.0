...
public class JxFreezeDetailsQueryModel extends JxBaseModel {
     ...
     * 请求参数
     */
    private String[] directRequestParamNames = new String[]{"accountId", "state", "startDate", 
    		"endDate", "pageNum", "pageSize"};
    
    /**
     * 响应参数
     */
    private String[] directResponseParamNames = new String[]{"accountId", "state", "startDate", 
    		"endDate", "name", "pageNum", "pageSize", "totalItems", "subPacks"};
    
    public JxFreezeDetailsQueryModel() {
		super();
		super.setTxCode(JxConfig.FREEZE_DETAILS_QUERY);
	}
