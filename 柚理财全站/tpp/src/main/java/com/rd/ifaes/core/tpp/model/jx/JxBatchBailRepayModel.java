 ...
 * @date 2017年8月18日
 */
public class JxBatchBailRepayModel extends JxBaseModel {
    private String batchNo; //批次号	N	6	M	当日相同的批次号交易后台在一个批量中处理 批次号当日必须唯一
    private String accountId; //电子账号	A	19	M	担保电子账户
    private String productId; //标的号	A	6	M	投标的原标的号
     ...
     * 请求参数
     */
    private String[] directRequestParamNames = new String[]{"batchNo", "accountId", "productId", "txAmount", "txCounts", "notifyURL",
            "retNotifyURL", "subPacks"};

    /**
     * 响应参数
     */
    private String[] directResponseParamNames = new String[]{"batchNo", "accountId", "productId", "sucAmount",
            "sucCounts", "failAmount", "failCounts", "subPacks"};
    ...
    public JxBatchBailRepayModel() {
        super();
        super.setTxCode(JxConfig.BATCH_BAIL_REPAY);
        setNotifyURL(ConfigUtils.getValue("notify_url") + "/jxbank/batchBailRepay/notify.html");
        setRetNotifyURL(ConfigUtils.getValue("notify_url") + "/jxbank/batchBailRepay/retNotify.html");
    }
