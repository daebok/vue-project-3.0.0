...
public class CbhbNetLoanRechargeModel extends CbhbAppBaseModel{
	/**
	 * 日志记录器
	 */
	private static final Logger LOGGER = LoggerFactory.getLogger(CbhbNetLoanRechargeModel.class);	
	/**
	 * 构造器
	 */
	public CbhbNetLoanRechargeModel() {
		super();
		this.setTransid("CBHBNetLoanRecharge");
		this.setBackUrl("http://localhost:8080"+"/cbhbApp/appRecharge/notify.html");
		this.setFrontUrl("http://localhost:8080"+"/cbhbApp/appRecharge/return.html");
	}
	...
	private String[] requestParamNames = new String[] {"PartnerId","MerBillNo","PlaCustId","FeeType","MerFeeAmt"
			,"MarketAmt","BackUrl","FrontUrl","TransAmt","MerPriv"};
