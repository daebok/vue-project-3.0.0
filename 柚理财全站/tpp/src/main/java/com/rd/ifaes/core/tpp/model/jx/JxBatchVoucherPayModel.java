...
public class JxBatchVoucherPayModel extends JxBaseModel {
    ...
    public JxBatchVoucherPayModel() {
        super();
        super.setTxCode(JxConfig.BATCH_VOUCHER_PAY);
        setNotifyURL(ConfigUtils.getValue("notify_url") + "/jxbank/batchVoucherPay/notify.html");
        setRetNotifyURL(ConfigUtils.getValue("notify_url") + "/jxbank/batchVoucherPay/retNotify.html");
    }
