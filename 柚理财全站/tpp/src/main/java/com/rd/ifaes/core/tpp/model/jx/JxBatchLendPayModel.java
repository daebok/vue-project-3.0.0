 ...
 * @date 2017年8月18日
 */
public class JxBatchLendPayModel extends JxBaseModel {
	...
	public JxBatchLendPayModel() {
		super();
		super.setTxCode(JxConfig.BATCH_LEND_PAY);
		setNotifyURL(ConfigUtils.getValue("notify_url")+ "/jxbank/batchLendPay/notify.html");
		setRetNotifyURL(ConfigUtils.getValue("notify_url")+ "/jxbank/batchLendPay/retNotify.html");
	}
