 ...
 * @date 2017年8月18日
 */
public class JxBatchCreditEndModel extends JxBaseModel {
	...
	private String sucAmount; //成功交易金额	N	6	C	成功金额
     ...
     * 请求参数
     */
    private String[] directRequestParamNames = new String[]{"batchNo", "txCounts", "notifyURL", "retNotifyURL", "subPacks"};

    /**
     * 响应参数
     */
    private String[] directResponseParamNames = new String[]{"batchNo", "failCounts", "sucCounts", "failAmount", "sucAmount"};

    /**
     * 响应参数
     */
    private String[] directResponseValidParamNames = new String[]{"batchNo", "txCounts"};

	public JxBatchCreditEndModel() {
		super();
		super.setTxCode(JxConfig.BATCH_CREDIT_END);
		setNotifyURL(ConfigUtils.getValue("notify_url")+ "/jxbank/batchCreditEnd/notify.html");
		setRetNotifyURL(ConfigUtils.getValue("notify_url")+ "/jxbank/batchCreditEnd/retNotify.html");
	}
