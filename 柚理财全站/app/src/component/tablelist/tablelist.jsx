...
export default class Tablelist extends React.Component{
  ...
  getlist(urls,stime,etime,selectvalue,page){
    ...
    let datas = {dateType:that.datatype,startTime:stime,endTime:etime,"page.page":pages,"page.pageSize":"10"};
  ...
  render() {
    ...
    if(this.props.singleArr){
      let liList = this.props.singleArr.map(function(el, index) {
            ...
            <div className={filterclassname} id={filterid}>
              ...
              <div className={filterSectiontime}>
                <dl className="dataselect clearfix">
                  <dd><Datepicker ref="clean" callback={this.initialize} selectvalue = {this.state.selectvalue} columns={this.props.columns} tableid={this.props.tableid} url={this.props.url} selectname={this.props.selectname} /></dd>
                </dl>
              </div>
