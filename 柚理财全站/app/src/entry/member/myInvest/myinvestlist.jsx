...
const columns_first = [{
            ...
            title: '操作',
            render: (text, record) => {
                    const href = "/member/myInvest/projectCollection.html?investId=" + record.id;
...
const columns_fourth = [{
            ...
            render: (text, record) => {
                      const href = "/member/myInvest/projectCollection.html?investId="+record.id;                           
             return  record.liquid == "0" ? <span className="tablelink"><a href={href}>回款详情</a></span> : "-";               
              },
          }];
        ...
        <div>
          <Tabs defaultActiveKey={this.props.urlTab}>
            ...
            <TabPane tab="投资申请" key="2">
                <Tablelist config={config_second} url='/member/myInvest/getInvestApply.html' tableid="tablelist-second" select={select_second} columns={columns_second}/>
            </TabPane>
