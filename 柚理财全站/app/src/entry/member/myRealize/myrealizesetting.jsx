...
let MyrealizeSetting = React.createClass({
  ...
  render(){
            ...
            const label = !this.state.checked ? '请阅读并同意《变现协议》' : '';
            ...
            return (
                    <Form horizontal className="form-themes" form={this.props.form} onSubmit={this.handleSubmit}>
                        <div className="row mb24" style={{width:800}}>
                          ...
                          <span className="form-text"><span className="form-textsm">{this.props.assets}</span>元<span className="form-supplement">(含预期收益{this.props.waitInterest}元)</span></span>
                          </div>
                        </div>                                                                                      
                        ...
                        <div className="row" style={{width:800}}>
                          ...
                          <FormItem hasFeedback extra={this.state.propmtNumber}>
                            <Input {...accountProps}  placeholder="请输入变现金额" maxLength="10" onInput = {this.filterInt} /></FormItem>
                        ...
                        <div className="row" style={{width:800}}>
                          ...
                          <div className="col-18 pl20">
                            <FormItem validateStatus="error" {...agreeProps} help = {label}><Checkbox checked={this.state.checked} onChange={this.onChange} ></Checkbox>我已阅读并同意<a href="javascript:;" onClick={this.getInfo}>《变现协议》</a></FormItem>
                              <Modal
