...
export default class Favorable extends React.Component{
    constructor(props){
        ...
        this._selectAddInterestHander = this.selectAddInterestHander.bind(this);//选择加息劵
        ...
        this.state = {        
            ...
            selectAddInteres: 0,//加息劵
            selectAddInteresId: "",//选中的加息劵
            selectStatus: false,
        };
    }
    ...
    render(){
        //选择优惠弹窗标题
        let favorableModalTitle = <div className="favorable-modal-title" id="favorableTab"><a href="javascript:;" className="active">红包</a><a href="javascript:;">加息劵</a></div>;
        //红包组件
        ...
        //判断是否使用红包
        if($("#redEnvelopeUseful").val() != '1' && $("#additionalRateUseful").val() == "1"){//无红包 有加息劵
            favorableModalTitle = <div className="favorable-modal-title" id="favorableTab"><a href="javascript:;">加息劵</a></div>;
            redPacketHtml = "";
            redPacketFooterHtml = "";
            this.state.favorableStatus = 1;//显示加息劵内容
        }
        //判断是否已使用加息劵                     
        if($("#redEnvelopeUseful").val() == "1" && parseFloat(this.useMoney) > 0 && $("#additionalRateUseful").val() != "1"){//有红包 无加息劵
        ...
        if((this.state.selectRedPacketRental > 0)&&(this.state.selectAddInteres==0)){//已选择红包与加息劵的状态
