...
//                var $img = $("<img src='" + editor.options.imagePath + url + "' class='edui-image-pic' />"),
                var $img = $("<img src='" + image_server_url + url + "' class='edui-image-pic' />"),
    ...
    var Upload = {
        ...
        uploadTpl: '<div class="edui-image-upload%%">' +
            ...
            '<input style=\"filter: alpha(opacity=0);\" class="edui-image-file" type="file" hidefocus name="upload" accept="image/gif,image/jpeg,image/png,image/jpg,image/bmp"/>' +
            '</form>' +
                ...
                me.dialog.find('.edui-image-content').on('drop',function (e) {
                    ...
                    $.each(fileList, function (i, f) {
                        if (/^image/.test(f.type)) {
                            ...
                            xhr.open("post", me.editor.getOpt('imageUrl') + "?type=ajax&editorid="+me.editor.id, true);
    ...
    UM.registerWidget('image', {
        tpl: "<link rel=\"stylesheet\" type=\"text/css\" href=\"<%=image_url%>image.css\">" +
            ...
            "<li  class=\"edui-tab-item\"><a data-context=\".edui-image-JimgSearch\" class=\"edui-tab-text\" style=\"display:none;\"><%=lang_tab_imgSearch%></a></li>" +
            "</ul>" +
