...
<mapper namespace="${package_path}.mapper.${class_name}Mapper">
	<resultMap type="${package_path}.domain.${class_name}" id="${class_name?uncap_first}ResultMap">
	...
	<insert id="insert" parameterType="${package_path}.domain.${class_name}">
	...
	<update id="update" parameterType="${package_path}.domain.${class_name}">
		update ${table_name} 
