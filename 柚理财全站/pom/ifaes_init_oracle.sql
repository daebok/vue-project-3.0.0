...
account_code NVARCHAR2(20) NOT NULL ,
account_type NVARCHAR2(2) NULL ,
parent_code NVARCHAR2(20) NULL ,
total NUMBER(20, 4) NULL ,
use_money NUMBER(20, 4) NULL ,
no_use_money NUMBER(20, 4) NULL ,
status CHAR(1) NULL ,
...
COMMENT ON COLUMN account.uuid IS '主键';
COMMENT ON COLUMN account.user_id IS '用户ID';
COMMENT ON COLUMN account.account_code IS '账户编号';
COMMENT ON COLUMN account.account_type IS '账户类别';
COMMENT ON COLUMN account.parent_code IS '上级账户编号';
COMMENT ON COLUMN account.total IS '账户总额';
COMMENT ON COLUMN account.use_money IS '可用余额';
COMMENT ON COLUMN account.no_use_money IS '冻结金额';
COMMENT ON COLUMN account.status IS '账户状态 0 未启用；1 启用';
COMMENT ON COLUMN account.create_time IS '添加时间';

-- ----------------------------
-- Records of account
-- ----------------------------
INSERT INTO account VALUES ('8185665ea4d311e6b8d6408d5c2885aa', 'd315ad95a4d211e6b8d6408d5c2885aa', '01', '01', null, '0', '0', '0', '1', TO_DATE('2016-11-07 18:19:55', 'YYYY-MM-DD HH24:MI:SS'));

-- ----------------------------
-- Table structure for account_bank_card
-- ----------------------------
DROP TABLE account_bank_card;
CREATE TABLE account_bank_card (
uuid NVARCHAR2(32) NOT NULL ,
user_id NVARCHAR2(32) NOT NULL ,
bank_code NVARCHAR2(64) NULL ,
bank_name NVARCHAR2(64) NULL ,
bank_account NVARCHAR2(64) NULL ,
create_time DATE NULL ,
update_time DATE NULL ,
create_ip NVARCHAR2(32) NULL ,
update_ip NVARCHAR2(32) NULL ,
...
;
COMMENT ON TABLE account_bank_card IS '银行卡表';
COMMENT ON COLUMN account_bank_card.uuid IS '主键';
COMMENT ON COLUMN account_bank_card.user_id IS '用户ID';
COMMENT ON COLUMN account_bank_card.bank_code IS '银行代码';
COMMENT ON COLUMN account_bank_card.bank_name IS '银行名称';
COMMENT ON COLUMN account_bank_card.bank_account IS '银行账号';
COMMENT ON COLUMN account_bank_card.create_time IS '创建时间';
COMMENT ON COLUMN account_bank_card.update_time IS '修改时间';
COMMENT ON COLUMN account_bank_card.create_ip IS '添加时候的IP';
COMMENT ON COLUMN account_bank_card.update_ip IS '修改时候的ip';
COMMENT ON COLUMN account_bank_card.status IS '银行卡状态，0:未启用，1：启用';

-- ----------------------------
-- Records of account_bank_card
-- ----------------------------

-- ----------------------------
-- Table structure for account_check
-- ----------------------------
DROP TABLE account_check;
CREATE TABLE account_check (
uuid NVARCHAR2(32) NOT NULL ,
user_id NVARCHAR2(32) NULL ,
tpp_user_cust_id NVARCHAR2(50) NULL ,
tpp_use_money NUMBER(20, 4) NULL ,
tpp_no_use_money NUMBER(20, 4) NULL ,
use_money NUMBER(20, 4) NULL ,
no_use_money NUMBER(20, 4) NULL ,
use_money_diff NUMBER(20, 4) NULL ,
no_use_money_diff NUMBER(20, 4) NULL 
)
LOGGING
NOCOMPRESS
NOCACHE
...
;
COMMENT ON TABLE account_check IS '账户资金对账';
COMMENT ON COLUMN account_check.uuid IS '主键';
COMMENT ON COLUMN account_check.user_id IS '用户id';
COMMENT ON COLUMN account_check.tpp_user_cust_id IS '用户第三方id';
COMMENT ON COLUMN account_check.tpp_use_money IS '第三方可用';
COMMENT ON COLUMN account_check.tpp_no_use_money IS '第三方冻结';
COMMENT ON COLUMN account_check.use_money IS '可用';
COMMENT ON COLUMN account_check.no_use_money IS '冻结';
COMMENT ON COLUMN account_check.use_money_diff IS '可用差额';
COMMENT ON COLUMN account_check.no_use_money_diff IS '冻结差额';
...
payments_type NVARCHAR2(2) NULL ,
money NUMBER(20, 4) NULL ,
account_type NVARCHAR2(32) NULL ,
create_time DATE NULL ,
trade_no NVARCHAR2(64) NULL ,
remark NCLOB NULL ,
order_no NVARCHAR2(64) NULL ,
use_money NUMBER(20, 4) NULL ,
no_use_money NUMBER(20, 4) NULL ,
create_timestamp NUMBER(20) NULL ,
earn NUMBER(20, 4) NULL 
)
LOGGING
NOCOMPRESS
NOCACHE
...
;
COMMENT ON TABLE account_log IS '账户日志表';
COMMENT ON COLUMN account_log.uuid IS '主键';
COMMENT ON COLUMN account_log.user_id IS '用户ID';
COMMENT ON COLUMN account_log.account_code IS '账户编号';
COMMENT ON COLUMN account_log.to_user IS '交易对方的用户ID';
COMMENT ON COLUMN account_log.payments_type IS '收支类型:0不变  1收入  2支出';
COMMENT ON COLUMN account_log.money IS '交易金额';
COMMENT ON COLUMN account_log.account_type IS '资金操作类型（操作类型：充值recharge、投资tender）';
COMMENT ON COLUMN account_log.create_time IS '添加时间';
COMMENT ON COLUMN account_log.trade_no IS '交易流水号';
COMMENT ON COLUMN account_log.remark IS '备注';
COMMENT ON COLUMN account_log.order_no IS '订单号';
COMMENT ON COLUMN account_log.use_money IS '可用余额';
COMMENT ON COLUMN account_log.no_use_money IS '冻结余额';
COMMENT ON COLUMN account_log.create_timestamp IS '新增时间戳（毫秒）';
COMMENT ON COLUMN account_log.earn IS '收益';
...
uuid NVARCHAR2(32) NOT NULL ,
activity_name NVARCHAR2(20) NULL ,
activity_code NVARCHAR2(30) NULL ,
sort NUMBER(11) NULL ,
status CHAR(1) NULL ,
create_time DATE NULL 
)
...
;
COMMENT ON TABLE activity_plan IS '活动方案表';
COMMENT ON COLUMN activity_plan.uuid IS '主键';
COMMENT ON COLUMN activity_plan.activity_name IS '活动方案名称';
COMMENT ON COLUMN activity_plan.activity_code IS '活动方案唯一标识';
COMMENT ON COLUMN activity_plan.sort IS '排序字段';
COMMENT ON COLUMN activity_plan.status IS '状态 ：0禁用  1启用';
COMMENT ON COLUMN activity_plan.create_time IS '创建日期';

-- ----------------------------
-- Records of activity_plan
-- ----------------------------
INSERT INTO activity_plan VALUES ('1764f3e6d315454ab070568f55c982f1', '一级好友邀请投资奖励', 'first_invite_tender_suc', '7', '1', TO_DATE('2016-08-15 14:29:48', 'YYYY-MM-DD HH24:MI:SS'));
INSERT INTO activity_plan VALUES ('1764f3e6d315454ab070568f55c982f2', '二级好友邀请投资奖励', 'second_invite_tender_suc', '8', '1', TO_DATE('2016-08-15 14:30:23', 'YYYY-MM-DD HH24:MI:SS'));
INSERT INTO activity_plan VALUES ('1764f3e6d315454ab070568f55c992f1', '注册送好礼', 'register', '1', '1', TO_DATE('2016-07-22 17:17:47', 'YYYY-MM-DD HH24:MI:SS'));
INSERT INTO activity_plan VALUES ('1764f3e6d315454ab070568f55c992f2', '首次投资奖励', 'first_tender', '2', '1', TO_DATE('2016-07-22 17:18:27', 'YYYY-MM-DD HH24:MI:SS'));
INSERT INTO activity_plan VALUES ('1764f3e6d315454ab070568f55c992f3', '投资奖励', 'tender_suc', '3', '1', TO_DATE('2016-07-22 17:19:03', 'YYYY-MM-DD HH24:MI:SS'));
INSERT INTO activity_plan VALUES ('1764f3e6d315454ab070568f55c992f4', '好友注册奖励', 'invite_register', '4', '1', TO_DATE('2016-07-22 17:19:59', 'YYYY-MM-DD HH24:MI:SS'));
INSERT INTO activity_plan VALUES ('1764f3e6d315454ab070568f55c992f5', '一级好友邀请首投奖励', 'first_invite_first_tender', '5', '1', TO_DATE('2016-07-22 17:21:10', 'YYYY-MM-DD HH24:MI:SS'));
INSERT INTO activity_plan VALUES ('1764f3e6d315454ab070568f55c992f6', '二级好友邀请首投奖励', 'second_invite_first_tender', '6', '1', TO_DATE('2016-07-22 17:21:57', 'YYYY-MM-DD HH24:MI:SS'));
INSERT INTO activity_plan VALUES ('1764f3e6d315454ab070568f55c992f7', '自定义', 'custom', '11', '1', TO_DATE('2016-07-22 17:22:33', 'YYYY-MM-DD HH24:MI:SS'));
INSERT INTO activity_plan VALUES ('1764f3e6d315454ab070568f55c992f8', 'vip等级特权', 'vip_level', '9', '1', TO_DATE('2016-07-22 17:23:29', 'YYYY-MM-DD HH24:MI:SS'));
INSERT INTO activity_plan VALUES ('1764f3e6d315454ab070568f55c992f9', '手动定向发放', 'select_users', '10', '1', TO_DATE('2016-08-28 11:14:54', 'YYYY-MM-DD HH24:MI:SS'));
...
uuid NVARCHAR2(32) NOT NULL ,
section_code NVARCHAR2(32) NOT NULL ,
...
clicks NUMBER(11) NULL ,
create_time DATE NULL ,
pic_path NVARCHAR2(512) NULL ,
...
COMMENT ON COLUMN article.uuid IS '主键';
COMMENT ON COLUMN article.section_code IS '栏目标识';
COMMENT ON COLUMN article.title IS '标题';
COMMENT ON COLUMN article.sort IS '排序';
COMMENT ON COLUMN article.is_recommend IS '是否推荐，0：否，1：是';
...
COMMENT ON COLUMN article.clicks IS '点击量';
COMMENT ON COLUMN article.create_time IS '添加时间';
COMMENT ON COLUMN article.pic_path IS '图片路径';
COMMENT ON COLUMN article.url IS '链接';
COMMENT ON COLUMN article.delete_flag IS '状态，0：显示，1：删除';
...
-- ----------------------------
DROP TABLE auto_invest_rule_log;
CREATE TABLE auto_invest_rule_log (
uuid NVARCHAR2(32) NOT NULL ,
amount_day_max NUMBER(20, 4)  NULL ,
repay_styles NVARCHAR2(20) NULL ,
month_type CHAR(1) NULL ,
month_limit_min NUMBER(11) NULL ,
month_limit_max NUMBER(11) NULL ,
day_type CHAR(1) NULL ,
day_limit_min NUMBER(11) NULL ,
day_limit_max NUMBER(11) NULL ,
apr_min NUMBER(4, 2) NULL ,
realize_useful CHAR(1) NULL ,
bond_useful CHAR(1) NULL ,
status CHAR(1) NULL ,
create_time DATE NULL 
)
LOGGING
...
;
COMMENT ON TABLE auto_invest_rule_log IS '自动投资设置记录表';
COMMENT ON COLUMN auto_invest_rule_log.uuid IS '主键';
COMMENT ON COLUMN auto_invest_rule_log.amount_day_max IS '每日最大投资金额';
COMMENT ON COLUMN auto_invest_rule_log.repay_styles IS '还款方式';
COMMENT ON COLUMN auto_invest_rule_log.month_type IS '是否可投月期限';
COMMENT ON COLUMN auto_invest_rule_log.month_limit_min IS '月期限最小值';
COMMENT ON COLUMN auto_invest_rule_log.month_limit_max IS '月截至期限';
COMMENT ON COLUMN auto_invest_rule_log.day_type IS '是否可投天期限';
COMMENT ON COLUMN auto_invest_rule_log.day_limit_min IS '天期限最小值';
COMMENT ON COLUMN auto_invest_rule_log.day_limit_max IS '天期限最大值';
COMMENT ON COLUMN auto_invest_rule_log.apr_min IS '投资收益最小值';
COMMENT ON COLUMN auto_invest_rule_log.realize_useful IS ' 是否可投变现产品 0 不可投1可投，默认0';
COMMENT ON COLUMN auto_invest_rule_log.bond_useful IS ' 是否可投债权转让0 不可投1可投，默认0';
COMMENT ON COLUMN auto_invest_rule_log.status IS '状态 0.关闭 1开启';
COMMENT ON COLUMN auto_invest_rule_log.create_time IS '添加时间';
...
CREATE TABLE bond (
uuid NVARCHAR2(32) NOT NULL ,
bond_name NVARCHAR2(30) NULL ,
project_id NVARCHAR2(32) NULL ,
invest_id NVARCHAR2(32) NULL ,
user_id NVARCHAR2(32) NULL ,
bond_apr NUMBER(10, 4) NULL ,
sold_interest NUMBER(20, 4) NULL ,
bond_fee NUMBER(10, 4) NULL ,
bond_money NUMBER(20, 4) NULL ,
sold_capital NUMBER(20, 4) NULL ,
status CHAR(1) NULL ,
limit_hours NUMBER(11) NULL ,
bond_end_time DATE NULL ,
bond_no NVARCHAR2(20) NULL ,
start_period NUMBER(11) NULL ,
create_time DATE NULL ,
rule_id NVARCHAR2(32) NULL ,
bond_lowest_money NUMBER(20, 4) NULL ,
bond_most_money NUMBER(20, 4) NULL ,
remain_days NUMBER(11) NULL ,
success_time DATE NULL ,
sell_style NVARCHAR2(1) NULL ,
stage NUMBER(11) NULL ,
protocol_id NVARCHAR2(32) NULL 
)
LOGGING
NOCOMPRESS
NOCACHE
...
;
COMMENT ON TABLE bond IS '债权转让表';
COMMENT ON COLUMN bond.uuid IS '主键';
COMMENT ON COLUMN bond.bond_name IS '债权名称';
COMMENT ON COLUMN bond.project_id IS '项目ID';
COMMENT ON COLUMN bond.invest_id IS '投资记录ID';
COMMENT ON COLUMN bond.user_id IS '债权人';
COMMENT ON COLUMN bond.bond_apr IS '折溢价率';
COMMENT ON COLUMN bond.sold_interest IS '已售债权利息';
COMMENT ON COLUMN bond.bond_fee IS '已支付手续费';
COMMENT ON COLUMN bond.bond_money IS '债权金额';
COMMENT ON COLUMN bond.sold_capital IS '已售债权本金';
COMMENT ON COLUMN bond.status IS '债权状态:发布0， 转让完成3，自动撤回4，后台撤回5 ';
COMMENT ON COLUMN bond.limit_hours IS '债权有效时长（小时）';
COMMENT ON COLUMN bond.bond_end_time IS '债权截止日期';
COMMENT ON COLUMN bond.bond_no IS '债权转让编号';
COMMENT ON COLUMN bond.start_period IS '开始期数';
COMMENT ON COLUMN bond.create_time IS '添加时间';
COMMENT ON COLUMN bond.rule_id IS '债权转让规则ID';
COMMENT ON COLUMN bond.bond_lowest_money IS '债权起投金额';
COMMENT ON COLUMN bond.bond_most_money IS '债权最高投资金额';
COMMENT ON COLUMN bond.remain_days IS '剩余期限（天）';
COMMENT ON COLUMN bond.success_time IS '转让成功时间';
COMMENT ON COLUMN bond.sell_style IS '实际转让的方式 0 部分转让 1 全部转让';
COMMENT ON COLUMN bond.stage IS '债权投资阶段：1 在投;2、满标(或无剩余可投)';
COMMENT ON COLUMN bond.protocol_id IS '债权协议ID';
...
-- ----------------------------
DROP TABLE bond_collection;
CREATE TABLE bond_collection (
uuid NVARCHAR2(32) NOT NULL ,
project_id NVARCHAR2(32) NULL ,
invest_id NVARCHAR2(32) NULL ,
user_id NVARCHAR2(32) NULL ,
bond_id NVARCHAR2(32) NULL ,
bond_invest_id NVARCHAR2(32) NULL ,
repayment_id NVARCHAR2(32) NULL ,
bond_capital NUMBER(20, 4) NULL ,
bond_interest NUMBER(20, 4) NULL ,
capital NUMBER(20, 4) NULL ,
collection_amount NUMBER(20, 4) NULL ,
collection_time DATE NULL ,
received_amount NUMBER(20, 4) NULL ,
received_time DATE NULL ,
interest NUMBER(20, 4) NULL ,
late_days NUMBER(11) NULL ,
late_interest NUMBER(20, 4) NULL ,
period NUMBER(4) NULL ,
status CHAR(1) NULL ,
create_time DATE NULL 
)
LOGGING
...
;
COMMENT ON TABLE bond_collection IS '债权待收表';
COMMENT ON COLUMN bond_collection.uuid IS '主键';
COMMENT ON COLUMN bond_collection.project_id IS '项目ID';
COMMENT ON COLUMN bond_collection.invest_id IS '投资记录ID';
COMMENT ON COLUMN bond_collection.user_id IS '投资人';
COMMENT ON COLUMN bond_collection.bond_id IS '债权ID';
COMMENT ON COLUMN bond_collection.bond_invest_id IS '债权投资ID';
COMMENT ON COLUMN bond_collection.repayment_id IS '还款ID';
COMMENT ON COLUMN bond_collection.bond_capital IS '已成功转出本金';
COMMENT ON COLUMN bond_collection.bond_interest IS '已成功转出利息';
COMMENT ON COLUMN bond_collection.capital IS '待收本金';
COMMENT ON COLUMN bond_collection.collection_amount IS '预计收款金额';
COMMENT ON COLUMN bond_collection.collection_time IS '预计收款时间';
COMMENT ON COLUMN bond_collection.received_amount IS '实际收款金额';
COMMENT ON COLUMN bond_collection.received_time IS '实际收款时间';
COMMENT ON COLUMN bond_collection.interest IS '待收利息';
COMMENT ON COLUMN bond_collection.late_days IS '预计天数';
COMMENT ON COLUMN bond_collection.late_interest IS '逾期利息';
COMMENT ON COLUMN bond_collection.period IS '待收期数';
COMMENT ON COLUMN bond_collection.status IS '状态：0未还，1已还';
COMMENT ON COLUMN bond_collection.create_time IS '添加时间';
...
-- ----------------------------
DROP TABLE bond_invest;
CREATE TABLE bond_invest (
uuid NVARCHAR2(32) NOT NULL ,
bond_id NVARCHAR2(32) NULL ,
project_id NVARCHAR2(32) NULL ,
invest_id NVARCHAR2(32) NULL ,
invest_no NVARCHAR2(30) NULL ,
invest_date NVARCHAR2(8) NULL ,
user_id NVARCHAR2(32) NULL ,
amount NUMBER(20, 4) NULL ,
bond_fee NUMBER(10, 2) NULL ,
payed_interest NUMBER(10, 2) NULL ,
received_account NUMBER(10, 2) NULL ,
status CHAR(1) NULL ,
create_time DATE NULL ,
add_ip NVARCHAR2(32) NULL ,
invest_order_no NVARCHAR2(32) NULL ,
project_invest_id NVARCHAR2(32) NULL ,
invest_channel CHAR(1) NULL 
)
LOGGING
NOCOMPRESS
NOCACHE
...
;
COMMENT ON TABLE bond_invest IS '债权投资表';
COMMENT ON COLUMN bond_invest.uuid IS '主键';
COMMENT ON COLUMN bond_invest.bond_id IS '债权ID';
COMMENT ON COLUMN bond_invest.project_id IS '项目ID';
COMMENT ON COLUMN bond_invest.invest_id IS '投资记录ID';
COMMENT ON COLUMN bond_invest.invest_no IS '投资流水号';
COMMENT ON COLUMN bond_invest.invest_date IS '投资日期';
COMMENT ON COLUMN bond_invest.user_id IS '受让人';
COMMENT ON COLUMN bond_invest.amount IS '投资金额';
COMMENT ON COLUMN bond_invest.bond_fee IS '债权人支付手续费';
COMMENT ON COLUMN bond_invest.payed_interest IS '提前付息';
COMMENT ON COLUMN bond_invest.received_account IS '已收金额';
COMMENT ON COLUMN bond_invest.status IS '状态';
COMMENT ON COLUMN bond_invest.create_time IS '添加时间';
COMMENT ON COLUMN bond_invest.add_ip IS '添加IP';
COMMENT ON COLUMN bond_invest.invest_order_no IS '债权投资订单号';
COMMENT ON COLUMN bond_invest.project_invest_id IS '债权投资对应原始投资记录ID';
COMMENT ON COLUMN bond_invest.invest_channel IS '投资渠道 1 PC  2 APP 3 微信 ';
...
-- ----------------------------
DROP TABLE bond_rule;
CREATE TABLE bond_rule (
uuid NVARCHAR2(32) NOT NULL ,
create_time DATE NULL ,
rule_status CHAR(1) NULL ,
hold_days NUMBER(11) NULL ,
remain_days NUMBER(11) NULL ,
period_remain_days NUMBER(11) NULL ,
deadline NUMBER(11) NULL ,
sell_multiple NUMBER(11) NULL ,
sell_style CHAR(1) NULL ,
buy_style CHAR(1) NULL ,
buy_amount_min NUMBER(20, 4) NULL ,
buy_amount_max NUMBER(20, 4) NULL ,
discount_rate_min NUMBER(6, 4) NULL ,
discount_rate_max NUMBER(6, 4) NULL ,
fee_style CHAR(1) NULL ,
fee_initiate_amount NUMBER(20, 4) NULL ,
fee_fixed NUMBER(20, 4) NULL ,
fee_rate NUMBER(6, 4) NULL ,
fee_single_max NUMBER(20, 4) NULL 
)
LOGGING
NOCOMPRESS
NOCACHE
...
;
COMMENT ON TABLE bond_rule IS '债权转让规则配置';
COMMENT ON COLUMN bond_rule.uuid IS '主键';
COMMENT ON COLUMN bond_rule.create_time IS '添加时间';
COMMENT ON COLUMN bond_rule.rule_status IS '1 开启 0未开启  默认1,未开启不允许发布债权';
COMMENT ON COLUMN bond_rule.hold_days IS '起息持有天数  默认 0 不开启此规则';
COMMENT ON COLUMN bond_rule.remain_days IS '还款到期剩余天数,默认0 不开启此规则';
COMMENT ON COLUMN bond_rule.period_remain_days IS '本期还款剩余天数 0 不开启此规则';
COMMENT ON COLUMN bond_rule.deadline IS '转让时效（单位：小时，到时间自动撤回）';
COMMENT ON COLUMN bond_rule.sell_multiple IS '转让起投金额倍数';
COMMENT ON COLUMN bond_rule.sell_style IS '转让金额方式:0 部分转让;1全额转让,默认0';
COMMENT ON COLUMN bond_rule.buy_style IS '受让金额方式:0 部分受让;1全额受让,默认0';
COMMENT ON COLUMN bond_rule.buy_amount_min IS '单笔受让最小金额';
COMMENT ON COLUMN bond_rule.buy_amount_max IS '单笔受让最大金额';
COMMENT ON COLUMN bond_rule.discount_rate_min IS '折溢价率下限值';
COMMENT ON COLUMN bond_rule.discount_rate_max IS '折溢价率上限值';
COMMENT ON COLUMN bond_rule.fee_style IS '收费方式 0不收费 1固定金额 2 固定比例; 默认1';
COMMENT ON COLUMN bond_rule.fee_initiate_amount IS '收费起步金额';
COMMENT ON COLUMN bond_rule.fee_fixed IS '固定金额手续费';
COMMENT ON COLUMN bond_rule.fee_rate IS '转让金额百分比收取手续费（默认为0，单位是%）';
COMMENT ON COLUMN bond_rule.fee_single_max IS '单笔手续费上限值（单位:元）';
...
content NCLOB NULL ,
borrow_use NVARCHAR2(50) NULL ,
period NUMBER(11) NULL ,
repayment_account NUMBER(20, 4) NULL ,
repayment_yes_account NUMBER(20, 4) NULL ,
repayment_yes_interest NUMBER(20, 4) NULL ,
bond_useful CHAR(1) NULL ,
bond_max_turn NUMBER(11) NULL ,
borrow_nature CHAR(1) NULL ,
has_pawn CHAR(1) NULL 
)
LOGGING
NOCOMPRESS
NOCACHE
...
;
COMMENT ON TABLE borrow IS '借款项目';
COMMENT ON COLUMN borrow.project_id IS '借款基本信息ID';
COMMENT ON COLUMN borrow.content IS '借款详情';
COMMENT ON COLUMN borrow.borrow_use IS '借款用途';
COMMENT ON COLUMN borrow.period IS '期数';
COMMENT ON COLUMN borrow.repayment_account IS '应还本金';
COMMENT ON COLUMN borrow.repayment_yes_account IS '实还本金';
COMMENT ON COLUMN borrow.repayment_yes_interest IS '实还利息';
COMMENT ON COLUMN borrow.bond_useful IS '是否可以债权转让 1 可以，0不可以';
COMMENT ON COLUMN borrow.bond_max_turn IS '债权转让最大次数,默认为1,单次转让，0为无限次转让';
COMMENT ON COLUMN borrow.borrow_nature IS '借款性质: 1  个人借款 2 企业借款';
COMMENT ON COLUMN borrow.has_pawn IS '是否有抵押物；1有抵押物，0无，默认0';
...
-- ----------------------------
DROP TABLE borrow_bespeak;
CREATE TABLE borrow_bespeak (
uuid NVARCHAR2(32) NOT NULL ,
contact_name NVARCHAR2(50) NULL ,
mobile NVARCHAR2(12) NULL ,
sex CHAR(1) NULL ,
province NVARCHAR2(20) NULL ,
city NVARCHAR2(20) NULL ,
money NUMBER(20, 4) NULL ,
limit_time NUMBER(11) NULL ,
status CHAR(1) NULL ,
create_time DATE NULL ,
add_ip NVARCHAR2(32) NULL ,
handle_time DATE NULL ,
remark NVARCHAR2(512) NULL ,
area NVARCHAR2(20) NULL 
)
LOGGING
NOCOMPRESS
NOCACHE
...
;
COMMENT ON TABLE borrow_bespeak IS '借款预约表';
COMMENT ON COLUMN borrow_bespeak.uuid IS '主键';
COMMENT ON COLUMN borrow_bespeak.contact_name IS '联系人';
COMMENT ON COLUMN borrow_bespeak.mobile IS '联系电话';
COMMENT ON COLUMN borrow_bespeak.sex IS '性别:M 男性，F女性';
COMMENT ON COLUMN borrow_bespeak.province IS '省';
COMMENT ON COLUMN borrow_bespeak.city IS '市';
COMMENT ON COLUMN borrow_bespeak.money IS '借款金额';
COMMENT ON COLUMN borrow_bespeak.limit_time IS '借款期限(天)';
COMMENT ON COLUMN borrow_bespeak.status IS '状态 0未处理 1 已回访 2不回访';
COMMENT ON COLUMN borrow_bespeak.create_time IS '添加时间';
COMMENT ON COLUMN borrow_bespeak.add_ip IS '添加IP';
COMMENT ON COLUMN borrow_bespeak.handle_time IS '处理时间';
COMMENT ON COLUMN borrow_bespeak.remark IS '备注';
COMMENT ON COLUMN borrow_bespeak.area IS '区';
...
-- ----------------------------
DROP TABLE borrow_follow;
CREATE TABLE borrow_follow (
uuid NVARCHAR2(32) NOT NULL ,
project_id NVARCHAR2(32) NULL ,
funds_condition NVARCHAR2(512) NULL ,
operate_condition NVARCHAR2(512) NULL ,
finance_condition NVARCHAR2(512) NULL ,
repayment_ability NVARCHAR2(512) NULL 
)
LOGGING
NOCOMPRESS
NOCACHE
...
;
COMMENT ON TABLE borrow_follow IS '贷后跟踪';
COMMENT ON COLUMN borrow_follow.uuid IS '主键';
COMMENT ON COLUMN borrow_follow.project_id IS '项目id';
COMMENT ON COLUMN borrow_follow.funds_condition IS '资金使用情况';
COMMENT ON COLUMN borrow_follow.operate_condition IS '借款人经营情况';
COMMENT ON COLUMN borrow_follow.finance_condition IS '借款人财务情况';
COMMENT ON COLUMN borrow_follow.repayment_ability IS '借款还款能力';
...
-- ----------------------------
DROP TABLE borrow_upload;
CREATE TABLE borrow_upload (
uuid NVARCHAR2(32) NOT NULL ,
project_id NVARCHAR2(32) NULL ,
file_type NVARCHAR2(2) NULL ,
file_path NVARCHAR2(512) NULL ,
add_time DATE NULL ,
sort NUMBER(11) NULL 
)
LOGGING
...
;
COMMENT ON TABLE borrow_upload IS '借款资料关联表';
COMMENT ON COLUMN borrow_upload.uuid IS '主键';
COMMENT ON COLUMN borrow_upload.project_id IS '项目ID';
COMMENT ON COLUMN borrow_upload.file_type IS '上传文件类型: 1借款资料 2抵押物资料 3其他';
COMMENT ON COLUMN borrow_upload.file_path IS '上传文件路径';
COMMENT ON COLUMN borrow_upload.add_time IS '上传时间';
COMMENT ON COLUMN borrow_upload.sort IS '显示顺序';
...
;
COMMENT ON TABLE buyback IS '赎回记录表';
COMMENT ON COLUMN buyback.uuid IS '主键';
COMMENT ON COLUMN buyback.project_id IS '项目ID';
COMMENT ON COLUMN buyback.invest_id IS '投资记录ID';
COMMENT ON COLUMN buyback.user_id IS '申请人ID';
COMMENT ON COLUMN buyback.money IS '赎回金额';
COMMENT ON COLUMN buyback.apply_time IS '申请时间';
COMMENT ON COLUMN buyback.status IS '状态：0 新建  1 申请已提交   2 审批通过 3 审批不通过  4 成功 5 失败';
...
cash_no NVARCHAR2(64) NULL ,
amount NUMBER(20, 4) NULL ,
real_amount NUMBER(20, 4) NULL ,
cash_fee NUMBER(20, 4) NULL ,
serv_fee NUMBER(20, 4) NULL ,
status CHAR(1) NULL ,
card_id NVARCHAR2(50) NULL ,
bank_code NVARCHAR2(12) NULL ,
need_audit CHAR(1) NULL ,
is_advance CHAR(1) NULL ,
add_time DATE NULL ,
add_ip NVARCHAR2(32) NULL ,
verify_time DATE NULL ,
verify_user_name NVARCHAR2(30) NULL ,
verify_remark NVARCHAR2(30) NULL ,
money NUMBER(20, 4) NULL ,
remark NVARCHAR2(255) NULL ,
man_handle CHAR(1) NULL ,
handle_reason NVARCHAR2(255) NULL ,
handle_time DATE NULL ,
handle_user NVARCHAR2(32) NULL ,
channel CHAR(1) NULL 
)
LOGGING
NOCOMPRESS
...
;
COMMENT ON TABLE cash IS '取现记录表';
COMMENT ON COLUMN cash.uuid IS '主键';
COMMENT ON COLUMN cash.user_id IS '用户ID';
COMMENT ON COLUMN cash.order_no IS '订单号（平台本地生成订单号）';
COMMENT ON COLUMN cash.cash_no IS '取现订单号（UFX流水号）';
COMMENT ON COLUMN cash.amount IS '取现金额';
COMMENT ON COLUMN cash.real_amount IS '实际到账金额';
COMMENT ON COLUMN cash.cash_fee IS '取现手续费';
COMMENT ON COLUMN cash.serv_fee IS '手续费';
COMMENT ON COLUMN cash.status IS '0：提现申请  1：提现处理中 2：提现待审核  3：提现成功  4：提现失败';
COMMENT ON COLUMN cash.card_id IS '取现银行卡号';
COMMENT ON COLUMN cash.bank_code IS '所属银行';
COMMENT ON COLUMN cash.need_audit IS '是否需要审核（1：需要 0：不需要）';
COMMENT ON COLUMN cash.is_advance IS '是否垫付手续费（1：需要 0：不需要）';
COMMENT ON COLUMN cash.add_time IS '添加时间';
COMMENT ON COLUMN cash.add_ip IS '添加IP';
COMMENT ON COLUMN cash.verify_time IS '审核时间';
COMMENT ON COLUMN cash.verify_user_name IS '审核人';
COMMENT ON COLUMN cash.verify_remark IS '审核备注';
COMMENT ON COLUMN cash.money IS '实际操作金额';
COMMENT ON COLUMN cash.remark IS '备注';
COMMENT ON COLUMN cash.man_handle IS '人工核查状态 0 不需处理 1待处理  2已处理，默认0';
COMMENT ON COLUMN cash.handle_reason IS '核查原因';
COMMENT ON COLUMN cash.handle_time IS '核查时间';
COMMENT ON COLUMN cash.handle_user IS '核查人';
COMMENT ON COLUMN cash.channel IS '渠道(1-PC,2-APP,3-微信,默认PC)';
...
-- ----------------------------
DROP TABLE freeze_trade_log;
CREATE TABLE freeze_trade_log (
uuid NVARCHAR2(32) NOT NULL ,
freeze_type NVARCHAR2(2) NULL ,
order_no NVARCHAR2(30) NULL ,
user_id NVARCHAR2(32) NULL ,
amount NUMBER(20, 4) NULL ,
project_no NVARCHAR2(32) NULL ,
freeze_no NVARCHAR2(30) NULL ,
create_time DATE NULL ,
...
;
COMMENT ON TABLE freeze_trade_log IS '资金冻结记录';
COMMENT ON COLUMN freeze_trade_log.freeze_type IS '冻结类型（00 冻结, 01 取现冻结;02 还款冻结 ,默认00  ）';
COMMENT ON COLUMN freeze_trade_log.order_no IS '订单号（平台本地生成订单号）';
COMMENT ON COLUMN freeze_trade_log.user_id IS '用户号';
COMMENT ON COLUMN freeze_trade_log.amount IS '交易金额';
COMMENT ON COLUMN freeze_trade_log.project_no IS '项目编号(还款冻结)';
COMMENT ON COLUMN freeze_trade_log.freeze_no IS '冻结流水号';
COMMENT ON COLUMN freeze_trade_log.create_time IS '添加时间';
COMMENT ON COLUMN freeze_trade_log.remark IS '备注';
COMMENT ON COLUMN freeze_trade_log.invest_id IS '投资记录ID';
COMMENT ON COLUMN freeze_trade_log.status IS '状态';
...
project_id NVARCHAR2(32) NOT NULL ,
content NCLOB NULL ,
lock_time_limit NUMBER(11) NULL ,
sale_time_limit NUMBER(11) NULL ,
realize_useful CHAR(1) NULL ,
buyback_verify CHAR(1) NULL ,
realize_lowest_money NUMBER(20, 4) NULL ,
overdue_rate NUMBER(10, 4) NULL ,
auto_repay CHAR(1) NULL 
)
LOGGING
NOCOMPRESS
NOCACHE
...
;
COMMENT ON TABLE product IS '理财产品表';
COMMENT ON COLUMN product.project_id IS '项目ID';
COMMENT ON COLUMN product.content IS '借款项目信息内容';
COMMENT ON COLUMN product.lock_time_limit IS '锁定期';
COMMENT ON COLUMN product.sale_time_limit IS '开放期';
COMMENT ON COLUMN product.realize_useful IS '是否可变现: 1 可变现 0 不可变现，默认 0';
COMMENT ON COLUMN product.buyback_verify IS '赎回是否需要审核( 1 需要， 0 不需要,默认1 )';
COMMENT ON COLUMN product.realize_lowest_money IS '最低变现金额';
COMMENT ON COLUMN product.overdue_rate IS '变现逾期罚息率';
COMMENT ON COLUMN product.auto_repay IS '是否可自动还款: 1 自动还款 0 自动还款，默认 0';
...
uuid NVARCHAR2(32) NOT NULL ,
user_id NVARCHAR2(32) NULL ,
project_no NVARCHAR2(18) NULL ,
project_name NVARCHAR2(100) NULL ,
raise_account NUMBER(20, 4) NULL ,
account NUMBER(20, 4) NULL ,
account_yes NUMBER(20, 4) NULL ,
apr NUMBER(8, 4) NULL ,
add_apr NUMBER(8, 4) NULL ,
interest_style CHAR(1) NULL ,
interest_start_days NUMBER(11) NULL ,
repay_style CHAR(1) NULL ,
fixed_repay_day NUMBER(11) NULL ,
time_type CHAR(1) NULL ,
time_limit NUMBER(11) NULL ,
create_time DATE NULL ,
publish_verify_time DATE NULL ,
update_time DATE NULL ,
show_time DATE NULL ,
stop_time DATE NULL ,
sale_time DATE NULL ,
raise_time_limit NUMBER(11) NULL ,
raise_end_time DATE NULL ,
review_time DATE NULL ,
borrow_manage_rate NUMBER(8, 4) NULL ,
interest_manage_rate NUMBER(8, 4) NULL ,
overdue_fee_rate NUMBER(8, 4) NULL ,
guarantee_rate NUMBER(8, 4) NULL ,
novice CHAR(1) NULL ,
choice CHAR(1) NULL ,
sale_style CHAR(1) NULL ,
lowest_account NUMBER(20, 4) NULL ,
step_account NUMBER(20, 4) NULL ,
most_account NUMBER(20, 4) NULL ,
total_copies NUMBER(11) NULL ,
copy_account NUMBER(20, 4) NULL ,
lowest_copies NUMBER(11) NULL ,
most_copies NUMBER(11) NULL ,
risk_level NVARCHAR2(2) NULL ,
red_envelope_rate NUMBER(20, 4) NULL ,
red_envelope_useful CHAR(1) NULL ,
additional_rate_useful CHAR(1) NULL ,
project_type_id NVARCHAR2(32) NULL ,
protocol_id NVARCHAR2(32) NULL ,
status NVARCHAR2(2) NULL ,
is_vouch CHAR(1) NULL ,
vouch_id NVARCHAR2(32) NULL ,
borrow_flag CHAR(1) NULL ,
realize_flag CHAR(1) NULL ,
sale_channel NVARCHAR2(10) NULL ,
specific_sale NVARCHAR2(2) NULL ,
specific_sale_rule NVARCHAR2(64) NULL ,
repay_amount NUMBER(20, 4) NULL ,
repay_yes_account NUMBER(20, 4) NULL ,
repay_yes_interest NUMBER(20, 4) NULL ,
vouch_status CHAR(1) NULL ,
interest_time NVARCHAR2(8) NULL ,
vouch_verify_time DATE NULL ,
total_period NUMBER(11) NULL ,
repayed_period NUMBER(11) NULL ,
next_repay_time DATE NULL ,
last_repay_time DATE NULL ,
real_last_repay_time DATE NULL ,
redenvelope_rule_id NVARCHAR2(32) NULL ,
rate_coupon_rule_id NVARCHAR2(32) NULL ,
stage NUMBER(11) NULL 
)
LOGGING
NOCOMPRESS
...
;
COMMENT ON TABLE project IS '项目(理财产品、借款项目表公用信息)';
COMMENT ON COLUMN project.uuid IS '主键';
COMMENT ON COLUMN project.user_id IS '用户ID';
COMMENT ON COLUMN project.project_no IS '项目编号(YYYYMMDD+5位自增长数字)';
COMMENT ON COLUMN project.project_name IS '项目名称';
COMMENT ON COLUMN project.raise_account IS '筹集目标金额，大于截标后金额';
COMMENT ON COLUMN project.account IS '项目总额（成立后为实际募集金额）';
COMMENT ON COLUMN project.account_yes IS '已投金额';
COMMENT ON COLUMN project.apr IS '年利率';
COMMENT ON COLUMN project.add_apr IS '加息';
COMMENT ON COLUMN project.interest_style IS '计息方式: 1、成立计息   2、 T+N计息 ';
COMMENT ON COLUMN project.interest_start_days IS '起始计息天数(T+N计息方式 )';
COMMENT ON COLUMN project.repay_style IS '还款方式: 1月等额本息  2一次性还款 3 每月还息到期还本 4 等额本金';
COMMENT ON COLUMN project.fixed_repay_day IS '固定还款日(1-31)';
COMMENT ON COLUMN project.time_type IS '借款期限类型： 0月标 1天标';
COMMENT ON COLUMN project.time_limit IS '借款期限';
COMMENT ON COLUMN project.create_time IS '添加时间';
COMMENT ON COLUMN project.publish_verify_time IS '发布审核时间(或借款审核时间)';
COMMENT ON COLUMN project.update_time IS '更新时间';
COMMENT ON COLUMN project.show_time IS '上架时间';
COMMENT ON COLUMN project.stop_time IS '下架时间';
COMMENT ON COLUMN project.sale_time IS '开售时间';
COMMENT ON COLUMN project.raise_time_limit IS '募集期:募集期时长，单位：天（不填，默认为0，不限制）';
COMMENT ON COLUMN project.raise_end_time IS '募集结束时间';
COMMENT ON COLUMN project.review_time IS '成立审核时间';
COMMENT ON COLUMN project.borrow_manage_rate IS '借款手续费率';
COMMENT ON COLUMN project.interest_manage_rate IS '利息管理费率';
COMMENT ON COLUMN project.overdue_fee_rate IS '逾期罚息利率';
COMMENT ON COLUMN project.guarantee_rate IS '担保费率';
COMMENT ON COLUMN project.novice IS '新手专享标识： 1新手专享 0 普通 ，默认：0';
COMMENT ON COLUMN project.choice IS '是否精选 0：不是精选，1：精选;默认0';
COMMENT ON COLUMN project.sale_style IS '销售规则 ：1 按金额  2 按份数，默认1';
COMMENT ON COLUMN project.lowest_account IS '最低起投金额';
COMMENT ON COLUMN project.step_account IS '递增金额';
COMMENT ON COLUMN project.most_account IS '最高投资总额';
COMMENT ON COLUMN project.total_copies IS '总份数';
COMMENT ON COLUMN project.copy_account IS '每份金额';
COMMENT ON COLUMN project.lowest_copies IS '最低起投份数';
COMMENT ON COLUMN project.most_copies IS '最高投资份数';
COMMENT ON COLUMN project.risk_level IS '产品风险等级（默认为1，极低风险）';
COMMENT ON COLUMN project.red_envelope_rate IS ' 红包可用最大比例';
COMMENT ON COLUMN project.red_envelope_useful IS '红包可用标识: 1 红包可用  0 红包不可用';
COMMENT ON COLUMN project.additional_rate_useful IS '加息劵可用标识:1可用 0不可用';
COMMENT ON COLUMN project.project_type_id IS '理财分类:对应前台的理财产品分类，上架时候选择';
COMMENT ON COLUMN project.protocol_id IS '产品协议ID';
COMMENT ON COLUMN project.status IS '状态: 0 新增 1发布待审 2发布审核成功(待售) 3发布审核失败 4 募集中 5 满额待审 6 复审成功 7 复审失败 8 待还   9还款成功（已完成）';
COMMENT ON COLUMN project.is_vouch IS '是否担保( 1 担保，0 不担保;默认0）';
COMMENT ON COLUMN project.vouch_id IS '担保公司ID';
COMMENT ON COLUMN project.borrow_flag IS '借款项目标识(1是，借款项目， 0否，即是理财产品）  ';
COMMENT ON COLUMN project.realize_flag IS '变现借款项目识( 1是产品变现后发布借款，0 普通借款，默认0)';
COMMENT ON COLUMN project.sale_channel IS '上架渠道( 1 PC  2 APP 3 微信 ；多选使用拼接,默认全选：1,2,3)';
COMMENT ON COLUMN project.specific_sale IS '定向销售方式(0 不定向 1 定向密码 2 定向等级 3 定向邮箱域名，默认0)';
COMMENT ON COLUMN project.specific_sale_rule IS '定向销售规则（对应规则内容,如：具体定向密码、定向邮箱域名）';
COMMENT ON COLUMN project.repay_amount IS '预还本息';
COMMENT ON COLUMN project.repay_yes_account IS '实还本金';
COMMENT ON COLUMN project.repay_yes_interest IS '实还利息';
COMMENT ON COLUMN project.vouch_status IS '担保审核状态(0 待审核 1 审核成功 2 审核失败)';
COMMENT ON COLUMN project.interest_time IS '交易登记日时间分界点(T+N计息，最长格式HH:MM:SS，暂到小时HH)';
COMMENT ON COLUMN project.vouch_verify_time IS '担保审核时间';
COMMENT ON COLUMN project.total_period IS '项目总期数';
COMMENT ON COLUMN project.repayed_period IS '项目已还期数';
COMMENT ON COLUMN project.next_repay_time IS '本期回款时间';
COMMENT ON COLUMN project.last_repay_time IS '最后一期回款时间';
COMMENT ON COLUMN project.real_last_repay_time IS '最后一期实际回款时间';
COMMENT ON COLUMN project.redenvelope_rule_id IS '红包规则ID';
COMMENT ON COLUMN project.rate_coupon_rule_id IS '加息券规则ID';
COMMENT ON COLUMN project.stage IS '项目投资阶段：1 在投；2 待售；3 满标(或无剩余可投) ;4 还款中或已还款';
...
last_repay_time DATE NULL ,
status CHAR(1) NULL ,
payment NUMBER(20, 4) NULL ,
repayed_amount NUMBER(20, 4) NULL ,
capital NUMBER(20, 4) NULL ,
interest NUMBER(20, 4) NULL ,
raise_interest NUMBER(20, 4) NULL ,
late_days NUMBER(11) NULL ,
late_interest NUMBER(20, 4) NULL ,
merchant_late_interest NUMBER(20, 4) NULL ,
manage_fee NUMBER(20, 4) NULL ,
collection_type CHAR(1) NULL ,
period NUMBER(11) NULL ,
bond_capital NUMBER(20, 4) NULL ,
bond_interest NUMBER(20, 4) NULL ,
add_ip NVARCHAR2(32) NULL ,
...
freeze_interest NUMBER(20, 4) NULL ,
freeze_capital NUMBER(20, 4) NULL ,
periods NUMBER(11) NULL 
)
LOGGING
NOCOMPRESS
NOCACHE
...
;
COMMENT ON TABLE project_collection IS '借款待收表';
COMMENT ON COLUMN project_collection.uuid IS '主键';
COMMENT ON COLUMN project_collection.user_id IS '用户ID';
COMMENT ON COLUMN project_collection.project_id IS '项目ID';
COMMENT ON COLUMN project_collection.invest_id IS '投资记录ID';
COMMENT ON COLUMN project_collection.repay_time IS '预计还款时间';
COMMENT ON COLUMN project_collection.last_repay_time IS '已经还款时间';
COMMENT ON COLUMN project_collection.status IS '还款状态  0未还款 1已还款';
COMMENT ON COLUMN project_collection.payment IS '预还金额';
COMMENT ON COLUMN project_collection.repayed_amount IS '已还金额';
COMMENT ON COLUMN project_collection.capital IS '本金';
COMMENT ON COLUMN project_collection.interest IS '利息';
COMMENT ON COLUMN project_collection.raise_interest IS '加息利息';
COMMENT ON COLUMN project_collection.late_days IS '逾期天数';
COMMENT ON COLUMN project_collection.late_interest IS '逾期利息';
COMMENT ON COLUMN project_collection.merchant_late_interest IS '给平台总逾期利息';
COMMENT ON COLUMN project_collection.manage_fee IS '利息管理费';
COMMENT ON COLUMN project_collection.collection_type IS '待收类型  0普通待收;1转让人待收 2 受让人待收 3 已作废 ';
COMMENT ON COLUMN project_collection.period IS '期数';
COMMENT ON COLUMN project_collection.bond_capital IS '已成功转出本金';
COMMENT ON COLUMN project_collection.bond_interest IS '已成功转出利息';
COMMENT ON COLUMN project_collection.add_ip IS '添加ip';
COMMENT ON COLUMN project_collection.create_time IS '添加时间';
COMMENT ON COLUMN project_collection.parent_id IS '待收记录父ID';
COMMENT ON COLUMN project_collection.freeze_interest IS '冻结变现利息';
COMMENT ON COLUMN project_collection.freeze_capital IS '冻结变现本金';
COMMENT ON COLUMN project_collection.periods IS '总期数';
...
interest NUMBER(20, 4) NULL ,
repayed_amount NUMBER(20, 4) NULL ,
repayed_interest NUMBER(20, 4) NULL ,
wait_amount NUMBER(20, 4) NULL ,
wait_interest NUMBER(20, 4) NULL ,
invest_channel CHAR(1) NULL ,
invest_type CHAR(1) NULL ,
invest_order_no NVARCHAR2(32) NULL ,
freeze_no NVARCHAR2(32) NULL ,
user_first_invest CHAR(1) NULL ,
realize_flag CHAR(1) NULL ,
create_time DATE NULL ,
add_ip NVARCHAR2(32) NULL ,
invest_no NVARCHAR2(32) NULL ,
invest_date NVARCHAR2(8) NULL ,
origin_invest_id NVARCHAR2(32) NULL ,
bond_flag CHAR(1) NULL ,
invest_style CHAR(1) NULL ,
realize_amount NUMBER(20, 4) NULL ,
wait_raise_interest NUMBER(20, 4) NULL ,
realize_interest NUMBER(20, 4) NULL ,
freeze_interest NUMBER(20, 4) NULL ,
freeze_capital NUMBER(20, 4) NULL ,
interest_date DATE NULL ,
end_date DATE NULL ,
raise_interest NUMBER(20, 4) NULL ,
realize_id NVARCHAR2(32) NULL 
)
LOGGING
NOCOMPRESS
NOCACHE
...
;
COMMENT ON TABLE project_invest IS '投资记录';
COMMENT ON COLUMN project_invest.uuid IS '主键';
COMMENT ON COLUMN project_invest.user_id IS '用户ID';
COMMENT ON COLUMN project_invest.project_id IS '项目ID';
COMMENT ON COLUMN project_invest.status IS '投资状态 0投资待处理，1成功，2失败';
COMMENT ON COLUMN project_invest.money IS '投资金额';
COMMENT ON COLUMN project_invest.amount IS '有效投资金额';
COMMENT ON COLUMN project_invest.real_amount IS '用户真实资金';
COMMENT ON COLUMN project_invest.payment IS '预收本息';
COMMENT ON COLUMN project_invest.interest IS '预期利息';
COMMENT ON COLUMN project_invest.repayed_amount IS '已还金额';
COMMENT ON COLUMN project_invest.repayed_interest IS '已还利息';
COMMENT ON COLUMN project_invest.wait_amount IS '待还总额';
COMMENT ON COLUMN project_invest.wait_interest IS '待还利息';
COMMENT ON COLUMN project_invest.invest_channel IS '投资渠道 1 PC  2 APP 3 微信 ';
COMMENT ON COLUMN project_invest.invest_type IS '投资方式  0手动投资;1自动投资';
COMMENT ON COLUMN project_invest.invest_order_no IS '投资时订单号';
COMMENT ON COLUMN project_invest.freeze_no IS '投资冻结流水号';
COMMENT ON COLUMN project_invest.user_first_invest IS '用户首次投资，0：非首投，1：首投';
COMMENT ON COLUMN project_invest.realize_flag IS '变现标识';
COMMENT ON COLUMN project_invest.create_time IS '添加时间';
COMMENT ON COLUMN project_invest.add_ip IS 'ip地址';
COMMENT ON COLUMN project_invest.invest_no IS '投资流水号';
COMMENT ON COLUMN project_invest.invest_date IS '投资日期(UFX)';
COMMENT ON COLUMN project_invest.origin_invest_id IS '原始投资ID';
COMMENT ON COLUMN project_invest.bond_flag IS '债权发布标识0否1是，默认0';
COMMENT ON COLUMN project_invest.invest_style IS '投资方式 0通投资,1转让投资,2受让投资，默认0';
COMMENT ON COLUMN project_invest.realize_amount IS '已变现本息';
COMMENT ON COLUMN project_invest.wait_raise_interest IS '待还加息';
COMMENT ON COLUMN project_invest.realize_interest IS '已变现利息';
COMMENT ON COLUMN project_invest.freeze_interest IS '已冻结变现利息';
COMMENT ON COLUMN project_invest.freeze_capital IS '已冻结变现本金';
COMMENT ON COLUMN project_invest.interest_date IS '起息日';
COMMENT ON COLUMN project_invest.end_date IS '结束日';
COMMENT ON COLUMN project_invest.raise_interest IS '加息利息（元）';
COMMENT ON COLUMN project_invest.realize_id IS '首次变现ID';
...
-- ----------------------------
DROP TABLE project_invest_bespeak;
CREATE TABLE project_invest_bespeak (
uuid NVARCHAR2(32) NOT NULL ,
user_id NVARCHAR2(32) NOT NULL ,
project_id NVARCHAR2(32) NOT NULL ,
sale_time DATE NOT NULL ,
remind_status CHAR(1) NULL ,
...
;
COMMENT ON TABLE project_invest_bespeak IS '投资预约表';
COMMENT ON COLUMN project_invest_bespeak.uuid IS '主键';
COMMENT ON COLUMN project_invest_bespeak.user_id IS '投资预约人id';
COMMENT ON COLUMN project_invest_bespeak.project_id IS '项目id';
COMMENT ON COLUMN project_invest_bespeak.sale_time IS '项目开售时间';
COMMENT ON COLUMN project_invest_bespeak.remind_status IS '提醒状态 0未提醒 1已经提醒';
COMMENT ON COLUMN project_invest_bespeak.remind_time IS '提醒时间';
COMMENT ON COLUMN project_invest_bespeak.create_time IS '预约时间';
...
invest_id NVARCHAR2(32) NULL ,
repay_time DATE NULL ,
real_repay_time DATE NULL ,
payment NUMBER(20, 4) NULL ,
payed_amount NUMBER(20, 4) NULL ,
capital NUMBER(20, 4) NULL ,
interest NUMBER(20, 4) NULL ,
status CHAR(1) NULL ,
repay_type CHAR(1) NULL ,
period NUMBER(11) NULL ,
late_days NUMBER(11) NULL ,
late_interest NUMBER(20, 4) NULL ,
merchant_late_interest NUMBER(20, 4) NULL ,
repay_user_id NVARCHAR2(32) NULL ,
repay_trade_no NVARCHAR2(32) NULL ,
create_time DATE NULL ,
periods NUMBER(11) NULL 
)
LOGGING
...
;
COMMENT ON TABLE project_repayment IS '借款还款记录表';
COMMENT ON COLUMN project_repayment.uuid IS '主键';
COMMENT ON COLUMN project_repayment.user_id IS '用户ID';
COMMENT ON COLUMN project_repayment.project_id IS '项目ID';
COMMENT ON COLUMN project_repayment.invest_id IS '投资记录ID';
COMMENT ON COLUMN project_repayment.repay_time IS '预计还款时间';
COMMENT ON COLUMN project_repayment.real_repay_time IS '实际还款时间';
COMMENT ON COLUMN project_repayment.payment IS '预还金额';
COMMENT ON COLUMN project_repayment.payed_amount IS '已还金额';
COMMENT ON COLUMN project_repayment.capital IS '本金';
COMMENT ON COLUMN project_repayment.interest IS '利息';
COMMENT ON COLUMN project_repayment.status IS '还款状态  0未还；1已还 ';
COMMENT ON COLUMN project_repayment.repay_type IS '还款类型（1正常还款 2 垫付  3 已还垫付4 逾期还款）';
COMMENT ON COLUMN project_repayment.period IS '期数';
COMMENT ON COLUMN project_repayment.late_days IS '逾期天数';
COMMENT ON COLUMN project_repayment.late_interest IS '逾期利息';
COMMENT ON COLUMN project_repayment.merchant_late_interest IS '给平台逾期利息';
COMMENT ON COLUMN project_repayment.repay_user_id IS '实际还款者';
COMMENT ON COLUMN project_repayment.repay_trade_no IS '第三方还款流水号';
COMMENT ON COLUMN project_repayment.create_time IS '添加时间';
COMMENT ON COLUMN project_repayment.periods IS '总期数';
...
uuid NVARCHAR2(32) NOT NULL ,
nid NVARCHAR2(32) NULL ,
type_name NVARCHAR2(40) NULL ,
parent_id NVARCHAR2(32) NULL ,
sort NUMBER(11) NULL ,
protocol_id NVARCHAR2(32) NULL ,
features NVARCHAR2(15) NULL ,
delete_flag CHAR(1) NOT NULL ,
type_level NUMBER(11) NULL ,
liquid CHAR(1) NULL ,
has_child CHAR(1) NULL 
)
LOGGING
NOCOMPRESS
NOCACHE
...
;
COMMENT ON TABLE project_type IS '产品分类';
COMMENT ON COLUMN project_type.uuid IS '主键';
COMMENT ON COLUMN project_type.nid IS '类型标识';
COMMENT ON COLUMN project_type.type_name IS '分类名称';
COMMENT ON COLUMN project_type.parent_id IS '父类ID';
COMMENT ON COLUMN project_type.sort IS '排序';
COMMENT ON COLUMN project_type.protocol_id IS '协议模板标识';
COMMENT ON COLUMN project_type.features IS '特点';
COMMENT ON COLUMN project_type.delete_flag IS '0 未删除，1 已删除';
COMMENT ON COLUMN project_type.type_level IS '层级(根目录为0层，最大2）';
COMMENT ON COLUMN project_type.liquid IS '是否活期，0否1是，默认0';
COMMENT ON COLUMN project_type.has_child IS '有无子分类(1有，0无，默认0）';
...
-- ----------------------------
DROP TABLE project_verify_log;
CREATE TABLE project_verify_log (
uuid NVARCHAR2(32) NOT NULL ,
project_id NVARCHAR2(32) NOT NULL ,
verify_name NVARCHAR2(32) NOT NULL ,
process_node NVARCHAR2(32) NULL ,
process_result NVARCHAR2(64) NULL ,
create_time DATE NULL ,
remark NVARCHAR2(128) NULL 
)
LOGGING
NOCOMPRESS
NOCACHE
...
;
COMMENT ON TABLE project_verify_log IS '项目审核记录表';
COMMENT ON COLUMN project_verify_log.uuid IS '主键';
COMMENT ON COLUMN project_verify_log.project_id IS '项目ID';
COMMENT ON COLUMN project_verify_log.verify_name IS '处理人';
COMMENT ON COLUMN project_verify_log.process_node IS '处理环节';
COMMENT ON COLUMN project_verify_log.process_result IS '处理结果';
COMMENT ON COLUMN project_verify_log.create_time IS '处理时间';
COMMENT ON COLUMN project_verify_log.remark IS '备注';
...
uuid NVARCHAR2(32) NOT NULL ,
protocol_type NVARCHAR2(128) NULL ,
...
;
COMMENT ON TABLE protocol IS '协议模板';
COMMENT ON COLUMN protocol.uuid IS '主键';
COMMENT ON COLUMN protocol.protocol_type IS '模板类型（注册用户协议、借款协议、转让协议等）';
COMMENT ON COLUMN protocol.name IS '名称';
COMMENT ON COLUMN protocol.content IS '协议内容';
COMMENT ON COLUMN protocol.create_time IS '添加时间';
COMMENT ON COLUMN protocol.status IS '1有效,0失效';

-- ----------------------------
-- Records of protocol
-- ----------------------------
INSERT INTO protocol VALUES ('13c0fd39aa4d4de99936a1ceea6fdb38', 'bond_invest_protocol', '债权转让协议', empty_clob(), TO_DATE('2016-11-03 09:42:23', 'YYYY-MM-DD HH24:MI:SS'), '1');
INSERT INTO protocol VALUES ('1707304646c6453b874aabbb581c99ea', 'invest_protocol', '产品投资协议', empty_clob(), TO_DATE('2016-11-05 14:16:36', 'YYYY-MM-DD HH24:MI:SS'), '1');
INSERT INTO protocol VALUES ('25694e70172b4b2a802e96c4b549e271', 'register_protocol', '用户平台注册协议', empty_clob(), TO_DATE('2016-08-15 15:04:34', 'YYYY-MM-DD HH24:MI:SS'), '1');

-- ----------------------------
-- Table structure for protocol_log
-- ----------------------------
DROP TABLE protocol_log;
CREATE TABLE protocol_log (
uuid NVARCHAR2(32) NOT NULL ,
protocol_id NVARCHAR2(32) NOT NULL ,
protocol_type NVARCHAR2(128) NOT NULL ,
protocol_name NVARCHAR2(128) NOT NULL ,
business_id NVARCHAR2(32) NULL ,
file_path NVARCHAR2(128) NULL ,
create_time DATE NULL ,
remark NVARCHAR2(128) NULL 
)
LOGGING
...
;
COMMENT ON TABLE protocol_log IS '协议记录表';
COMMENT ON COLUMN protocol_log.uuid IS '主键';
COMMENT ON COLUMN protocol_log.protocol_id IS '协议模板id';
COMMENT ON COLUMN protocol_log.protocol_type IS '模板类型（注册用户协议、借款协议、转让协议等）';
COMMENT ON COLUMN protocol_log.protocol_name IS '协议名称';
COMMENT ON COLUMN protocol_log.business_id IS '业务id，如投资，债权投资等id';
COMMENT ON COLUMN protocol_log.file_path IS '生成的合同地址';
COMMENT ON COLUMN protocol_log.create_time IS '添加时间';
COMMENT ON COLUMN protocol_log.remark IS '备注';
...
-- ----------------------------
DROP TABLE rate_coupon_rule;
CREATE TABLE rate_coupon_rule (
uuid NVARCHAR2(32) NOT NULL ,
activity_code NVARCHAR2(30) NULL ,
rule_name NVARCHAR2(20) NULL ,
status CHAR(1) NULL ,
total_num NUMBER(11) NULL ,
lssue_num NUMBER(11) NULL ,
create_time DATE NULL ,
update_time DATE NULL ,
delete_flag CHAR(1) NULL ,
grant_type CHAR(1) NULL ,
grant_url NVARCHAR2(512) NULL ,
grant_start_time DATE NULL ,
grant_end_time DATE NULL ,
use_project_type NCLOB NULL ,
use_valid_day NVARCHAR2(11) NULL ,
use_expire_time DATE NULL ,
grant_project_type NCLOB NULL 
)
LOGGING
NOCOMPRESS
NOCACHE
...
;
COMMENT ON TABLE rate_coupon_rule IS '加息券规则设置表';
COMMENT ON COLUMN rate_coupon_rule.uuid IS '主键';
COMMENT ON COLUMN rate_coupon_rule.activity_code IS '活动方案唯一标识';
COMMENT ON COLUMN rate_coupon_rule.rule_name IS '加息券规则名称';
COMMENT ON COLUMN rate_coupon_rule.status IS '状态： 0禁用  1启用';
COMMENT ON COLUMN rate_coupon_rule.total_num IS '发放加息券的总数，当发放方式为固定值时,值为规则明细之和的倍数';
COMMENT ON COLUMN rate_coupon_rule.lssue_num IS '已经发放数量';
COMMENT ON COLUMN rate_coupon_rule.create_time IS '创建日期';
COMMENT ON COLUMN rate_coupon_rule.update_time IS '最后修改日期';
COMMENT ON COLUMN rate_coupon_rule.delete_flag IS '逻辑删除标识 0正常  1删除';
COMMENT ON COLUMN rate_coupon_rule.grant_type IS '加息券发放方式：1 固定金额、2金额满返';
COMMENT ON COLUMN rate_coupon_rule.grant_url IS '发放的url';
COMMENT ON COLUMN rate_coupon_rule.grant_start_time IS '发放开始时间';
COMMENT ON COLUMN rate_coupon_rule.grant_end_time IS '发放结束时间';
COMMENT ON COLUMN rate_coupon_rule.use_project_type IS '项目分类id值，多个项目分类以英文,分割 ';
COMMENT ON COLUMN rate_coupon_rule.use_valid_day IS '有效天数';
COMMENT ON COLUMN rate_coupon_rule.use_expire_time IS '到期时间';
COMMENT ON COLUMN rate_coupon_rule.grant_project_type IS '发放项目类别id，多个用逗号分隔';
...
-- ----------------------------
DROP TABLE rate_coupon_rule_detail;
CREATE TABLE rate_coupon_rule_detail (
uuid NVARCHAR2(32) NOT NULL ,
rule_id NVARCHAR2(32) NOT NULL ,
up_apr NUMBER(20, 4) NULL ,
use_tender_money NUMBER(20, 4) NULL ,
tender_min NUMBER(20, 4) NULL ,
tender_max NUMBER(20, 4) NULL ,
create_time DATE NULL 
)
LOGGING
NOCOMPRESS
...
;
COMMENT ON TABLE rate_coupon_rule_detail IS '加息券规则明细表';
COMMENT ON COLUMN rate_coupon_rule_detail.uuid IS '主键';
COMMENT ON COLUMN rate_coupon_rule_detail.rule_id IS '加息券规则id值';
COMMENT ON COLUMN rate_coupon_rule_detail.up_apr IS '发放加息券的固定值';
COMMENT ON COLUMN rate_coupon_rule_detail.use_tender_money IS '最低投资金额限制';
COMMENT ON COLUMN rate_coupon_rule_detail.tender_min IS '投资金额开始区间值';
COMMENT ON COLUMN rate_coupon_rule_detail.tender_max IS '投资金额结束区间值';
COMMENT ON COLUMN rate_coupon_rule_detail.create_time IS '创建日期';
...
project_id NVARCHAR2(32) NOT NULL ,
invest_id NVARCHAR2(32) NULL ,
old_project_id NVARCHAR2(32) NULL ,
original_project_id NVARCHAR2(32) NULL ,
deadline NUMBER(11) NULL ,
rule_id NVARCHAR2(32) NULL ,
realize_amount NUMBER(20, 4) NULL ,
realize_interest NUMBER(20, 4) NULL 
...
;
COMMENT ON TABLE realize IS '变现记录表';
COMMENT ON COLUMN realize.project_id IS '项目ID';
COMMENT ON COLUMN realize.invest_id IS '投资记录ID';
COMMENT ON COLUMN realize.old_project_id IS '变现项目ID';
COMMENT ON COLUMN realize.original_project_id IS '变现项目ID';
COMMENT ON COLUMN realize.deadline IS '变现期限(单位，小时)';
COMMENT ON COLUMN realize.rule_id IS '变现规则ID';
COMMENT ON COLUMN realize.realize_amount IS '对应原产品本息';
COMMENT ON COLUMN realize.realize_interest IS '对应原产品利息';
...
-- ----------------------------
DROP TABLE realize_freeze;
CREATE TABLE realize_freeze (
uuid NVARCHAR2(32) NOT NULL ,
user_id NVARCHAR2(32) NOT NULL ,
realize_id NVARCHAR2(32) NOT NULL ,
collection_id NVARCHAR2(32) NOT NULL ,
money NUMBER(20, 4) NOT NULL ,
freeze_type NVARCHAR2(32) NOT NULL ,
status NVARCHAR2(2) NULL ,
order_no NVARCHAR2(32) NULL ,
freeze_no NVARCHAR2(32) NULL ,
create_time DATE NULL 
...
;
COMMENT ON TABLE realize_freeze IS '变现冻结信息表';
COMMENT ON COLUMN realize_freeze.uuid IS '主键';
COMMENT ON COLUMN realize_freeze.user_id IS '用户ID';
COMMENT ON COLUMN realize_freeze.realize_id IS '变现产品ID';
COMMENT ON COLUMN realize_freeze.collection_id IS '被变现待收ID';
COMMENT ON COLUMN realize_freeze.money IS '冻结金额';
COMMENT ON COLUMN realize_freeze.freeze_type IS '冻结类型';
COMMENT ON COLUMN realize_freeze.status IS '状态 0未冻结1已冻结2已解冻3已撤销';
COMMENT ON COLUMN realize_freeze.order_no IS '订单号';
COMMENT ON COLUMN realize_freeze.freeze_no IS '冻结流水号';
COMMENT ON COLUMN realize_freeze.create_time IS '添加时间';
...
-- ----------------------------
DROP TABLE realize_rule;
CREATE TABLE realize_rule (
uuid NVARCHAR2(32) NOT NULL ,
rule_name NVARCHAR2(32) NULL ,
create_time DATE NULL ,
rule_status CHAR(1) NULL ,
hold_days NUMBER(11) NULL ,
remain_days NUMBER(11) NULL ,
period_remain_days NUMBER(11) NULL ,
sell_style CHAR(1) NULL ,
sell_amount_min NUMBER(20, 4) NULL ,
buy_style CHAR(1) NULL ,
buy_amount_min NUMBER(20, 4) NULL ,
buy_amount_max NUMBER(20, 4) NULL ,
realize_rate_min NUMBER(6, 4) NULL ,
realize_rate_max NUMBER(6, 4) NULL ,
overdue_fee_rate NUMBER(6, 4) NULL ,
fee_rate NUMBER(6, 4) NULL ,
fee_single_max NUMBER(20, 4) NULL ,
issue_time NVARCHAR2(8) NULL ,
raise_end_time NVARCHAR2(8) NULL ,
interest_manage_rate NUMBER(8, 4) NULL 
)
LOGGING
NOCOMPRESS
...
;
COMMENT ON TABLE realize_rule IS '变现规则配置';
COMMENT ON COLUMN realize_rule.uuid IS '主键';
COMMENT ON COLUMN realize_rule.rule_name IS '规则名称';
COMMENT ON COLUMN realize_rule.create_time IS '添加时间';
COMMENT ON COLUMN realize_rule.rule_status IS '1 开启 0未开启  默认1,未开启不允许发布变现';
COMMENT ON COLUMN realize_rule.hold_days IS '起息持有天数  默认 0 不开启此规则';
COMMENT ON COLUMN realize_rule.remain_days IS '还款到期剩余天数,默认0 不开启此规则';
COMMENT ON COLUMN realize_rule.period_remain_days IS '本期还款剩余天数 0 不开启此规则';
COMMENT ON COLUMN realize_rule.sell_style IS '变现金额方式:0 部分变现;1全额变现,默认0';
COMMENT ON COLUMN realize_rule.sell_amount_min IS '变现最小金额';
COMMENT ON COLUMN realize_rule.buy_style IS '投资金额方式:0 部分投资;1全额投资,默认0';
COMMENT ON COLUMN realize_rule.buy_amount_min IS '单笔投资最小金额';
COMMENT ON COLUMN realize_rule.buy_amount_max IS '单笔投资最大金额';
COMMENT ON COLUMN realize_rule.realize_rate_min IS '变现利率下限值';
COMMENT ON COLUMN realize_rule.realize_rate_max IS '变现利率上限值';
COMMENT ON COLUMN realize_rule.overdue_fee_rate IS '逾期罚息率';
COMMENT ON COLUMN realize_rule.fee_rate IS '转让金额百分比收取手续费（默认为0，单位是%）';
COMMENT ON COLUMN realize_rule.fee_single_max IS '单笔手续费上限值（单位:元）';
COMMENT ON COLUMN realize_rule.issue_time IS '发布时间';
COMMENT ON COLUMN realize_rule.raise_end_time IS '募集结束时间';
COMMENT ON COLUMN realize_rule.interest_manage_rate IS '利息管理费';
...
-- ----------------------------
DROP TABLE receiving_info;
CREATE TABLE receiving_info (
uuid NVARCHAR2(32) NOT NULL ,
user_id NVARCHAR2(32) NULL ,
address NVARCHAR2(255) NULL ,
province NVARCHAR2(32) NULL ,
city NVARCHAR2(32) NULL ,
area NVARCHAR2(32) NULL ,
is_defult CHAR(1) NULL ,
mobile NVARCHAR2(16) NULL ,
name NVARCHAR2(32) NULL ,
postal_code NVARCHAR2(16) NULL ,
create_time DATE NULL 
)
LOGGING
NOCOMPRESS
...
;
COMMENT ON TABLE receiving_info IS '收货地址记录表';
COMMENT ON COLUMN receiving_info.uuid IS '主键';
COMMENT ON COLUMN receiving_info.user_id IS '用户ID';
COMMENT ON COLUMN receiving_info.address IS '详细地址';
COMMENT ON COLUMN receiving_info.province IS '省';
COMMENT ON COLUMN receiving_info.city IS '市';
COMMENT ON COLUMN receiving_info.area IS '区';
COMMENT ON COLUMN receiving_info.is_defult IS '是否默认收货信息';
COMMENT ON COLUMN receiving_info.mobile IS '收件人手机';
COMMENT ON COLUMN receiving_info.name IS '收件人姓名';
COMMENT ON COLUMN receiving_info.postal_code IS '邮政编码';
COMMENT ON COLUMN receiving_info.create_time IS '添加时间';
...
uuid NVARCHAR2(32) NOT NULL ,
order_no NVARCHAR2(32) NULL ,
trade_no NVARCHAR2(32) NULL ,
user_id NVARCHAR2(32) NULL ,
status CHAR(1) NULL ,
card_id NVARCHAR2(32) NULL ,
amount NUMBER(20, 4) NULL ,
pay_way CHAR(1) NULL ,
fee NUMBER(20, 4) NULL ,
fee_type NVARCHAR2(2) NOT NULL ,
recharge_fee NUMBER(20, 4) NULL ,
create_time DATE NULL ,
add_ip NVARCHAR2(32) NULL ,
remark NVARCHAR2(255) NULL ,
channel CHAR(1) NULL 
...
;
COMMENT ON TABLE recharge IS '充值记录表';
COMMENT ON COLUMN recharge.uuid IS '主键';
COMMENT ON COLUMN recharge.order_no IS '订单号';
COMMENT ON COLUMN recharge.trade_no IS 'UFX处理流水号';
COMMENT ON COLUMN recharge.user_id IS '用户ID';
COMMENT ON COLUMN recharge.status IS '状态 0 充值申请中 1充值成功 2充值失败';
COMMENT ON COLUMN recharge.card_id IS '充值银行卡';
COMMENT ON COLUMN recharge.amount IS '金额';
COMMENT ON COLUMN recharge.pay_way IS '支付方式(0：网银充值 1：代扣充值 2：快捷支付 3：汇款充值 4：企业网银充值 )';
COMMENT ON COLUMN recharge.fee IS '手续费';
COMMENT ON COLUMN recharge.fee_type IS '手续费类型(01 用户，02商户)';
COMMENT ON COLUMN recharge.recharge_fee IS '用户承担手续费';
COMMENT ON COLUMN recharge.create_time IS '添加时间';
COMMENT ON COLUMN recharge.add_ip IS '添加IP';
COMMENT ON COLUMN recharge.remark IS '备注';
COMMENT ON COLUMN recharge.channel IS '渠道(1-PC,2-APP,3-微信,默认PC)';
...
grant_start_time DATE NULL ,
grant_end_time DATE NULL ,
grant_max NUMBER(20, 4) NULL ,
grant_min NUMBER(20, 4) NULL ,
grant_rate NUMBER(20, 4) NULL ,
use_project_type NCLOB NULL ,
use_valid_day NVARCHAR2(11) NULL ,
use_expire_time DATE NULL ,
grant_project_type NCLOB NULL 
...
;
COMMENT ON TABLE redenvelope_rule IS '红包规则配置表';
COMMENT ON COLUMN redenvelope_rule.uuid IS '主键';
COMMENT ON COLUMN redenvelope_rule.activity_code IS '活动方案唯一标识';
COMMENT ON COLUMN redenvelope_rule.rule_name IS '红包规则名称';
COMMENT ON COLUMN redenvelope_rule.status IS '状态： 0禁用  1启用';
COMMENT ON COLUMN redenvelope_rule.total_num IS '发放红包的总数，当发放方式为固定金额时,值为规则明细之和的倍数';
COMMENT ON COLUMN redenvelope_rule.lssue_num IS '已经发放数量';
COMMENT ON COLUMN redenvelope_rule.create_time IS '创建日期';
COMMENT ON COLUMN redenvelope_rule.update_time IS '最后修改日期';
COMMENT ON COLUMN redenvelope_rule.delete_flag IS '逻辑删除标识 0正常  1删除';
COMMENT ON COLUMN redenvelope_rule.grant_type IS '红包发放方式：1 固定金额、2固定比例、3金额满返、4比例满返';
COMMENT ON COLUMN redenvelope_rule.grant_url IS '发放的url';
COMMENT ON COLUMN redenvelope_rule.grant_start_time IS '发放开始时间';
COMMENT ON COLUMN redenvelope_rule.grant_end_time IS '发放结束时间';
COMMENT ON COLUMN redenvelope_rule.grant_max IS '发放最大金额（发放类型为固定比例、比例满返的时候，设置发放红包最大值）';
COMMENT ON COLUMN redenvelope_rule.grant_min IS '发放最小金额（发放类型为固定比例、比例满返的时候，设置发放红包最小值）';
COMMENT ON COLUMN redenvelope_rule.grant_rate IS '固定比例（固定比例，红包发放方式为固定比率时设定）';
COMMENT ON COLUMN redenvelope_rule.use_project_type IS '项目分类id值，多个项目分类以英文,分割 ';
COMMENT ON COLUMN redenvelope_rule.use_valid_day IS '有效天数';
COMMENT ON COLUMN redenvelope_rule.use_expire_time IS '到期时间';
COMMENT ON COLUMN redenvelope_rule.grant_project_type IS '发放项目类别id，多个用逗号分隔';
...
-- ----------------------------
DROP TABLE redenvelope_rule_detail;
...
;
COMMENT ON TABLE redenvelope_rule_detail IS '红包规则配置明细表';
COMMENT ON COLUMN redenvelope_rule_detail.uuid IS '主键';
COMMENT ON COLUMN redenvelope_rule_detail.rule_id IS '红包规则id值';
COMMENT ON COLUMN redenvelope_rule_detail.amount IS '发放固定红包金额值';
COMMENT ON COLUMN redenvelope_rule_detail.use_tender_money IS '固定金额方式，最低投资金额限制';
COMMENT ON COLUMN redenvelope_rule_detail.tender_min IS '投资金额开始区间值';
COMMENT ON COLUMN redenvelope_rule_detail.tender_max IS '投资金额结束区间值';
COMMENT ON COLUMN redenvelope_rule_detail.grant_rate IS '比例发放的值（固定比例，比例满返）';
COMMENT ON COLUMN redenvelope_rule_detail.create_time IS '创建日期';
...
uuid NVARCHAR2(32) NOT NULL ,
question_id NVARCHAR2(32) NULL ,
answer_no NVARCHAR2(20) NULL ,
content NCLOB NULL ,
score NUMBER(11) NULL ,
sort NVARCHAR2(10) NULL ,
create_time DATE NULL ,
delete_flag NUMBER(11) NULL 
)
LOGGING
NOCOMPRESS
NOCACHE
...
;
COMMENT ON TABLE risk_answer IS '风险评估问卷答案';
COMMENT ON COLUMN risk_answer.uuid IS '主键';
COMMENT ON COLUMN risk_answer.question_id IS '关联问题表ID';
COMMENT ON COLUMN risk_answer.answer_no IS '答案编号';
COMMENT ON COLUMN risk_answer.content IS '答案内容';
COMMENT ON COLUMN risk_answer.score IS '答案分值';
COMMENT ON COLUMN risk_answer.sort IS '排序';
COMMENT ON COLUMN risk_answer.create_time IS '创建时间';
COMMENT ON COLUMN risk_answer.delete_flag IS '逻辑删除';
...
-- ----------------------------
DROP TABLE risk_level_config;
CREATE TABLE risk_level_config (
uuid NVARCHAR2(32) NOT NULL ,
risk_level_no NVARCHAR2(20) NULL ,
risk_level_name NVARCHAR2(32) NULL ,
risk_level_val NUMBER(11) NULL ,
risk_level_desc NVARCHAR2(512) NULL ,
user_risk_level_name NVARCHAR2(32) NULL ,
user_risk_level_val NUMBER(11) NULL ,
user_risk_level_desc NVARCHAR2(512) NULL ,
sort NUMBER(11) NULL ,
delete_flag NUMBER(11) NULL ,
create_time DATE NULL 
)
...
;
COMMENT ON TABLE risk_level_config IS '产品风险等级和用户风险承受能力对应关系';
COMMENT ON COLUMN risk_level_config.uuid IS '主键';
COMMENT ON COLUMN risk_level_config.risk_level_no IS '风险等级编号';
COMMENT ON COLUMN risk_level_config.risk_level_name IS '产品风险等级名称（默认分为：高风险、中高风险、中等风险、较低风险、低风险）';
COMMENT ON COLUMN risk_level_config.risk_level_val IS '产品风险等级数值（高风险：5；中高风险：4；中等风险：3；较低风险：2；低风险：1；）';
COMMENT ON COLUMN risk_level_config.risk_level_desc IS '产品风险等级含义及介绍';
COMMENT ON COLUMN risk_level_config.user_risk_level_name IS '用户风险承受能力评估名称';
COMMENT ON COLUMN risk_level_config.user_risk_level_val IS '用户风险承受能力值(0,1,2,3,4)';
COMMENT ON COLUMN risk_level_config.user_risk_level_desc IS '用户风险承受能力含义';
COMMENT ON COLUMN risk_level_config.sort IS '排序';
COMMENT ON COLUMN risk_level_config.delete_flag IS '逻辑删除标识';
COMMENT ON COLUMN risk_level_config.create_time IS '创建时间';

-- ----------------------------
-- Records of risk_level_config
-- ----------------------------
INSERT INTO risk_level_config VALUES ('0b62b080bdeb4b44b54859d9bb2f77a4', '2016071200005', '高风险', '5', '本金、收益可能有大幅度的波动', '进取型', '4', '可以承受高风险、中高风险、中等风险、较低风险、极低风险的产品', '0', '0', TO_DATE('2016-07-12 14:32:44', 'YYYY-MM-DD HH24:MI:SS'));
INSERT INTO risk_level_config VALUES ('138d7c21fd2c4e72894385dbe791fbaa', '2016071200001', '极低风险', '1', '本金、收益稳定', '保守型', '0', '只能承受极低风险的产品', '0', '0', TO_DATE('2016-07-12 14:26:55', 'YYYY-MM-DD HH24:MI:SS'));
INSERT INTO risk_level_config VALUES ('592490a2e8484b8287ecadb9ac35e643', '2016071200003', '中等风险', '3', '本金、收益可能有一定幅度的波动', '平衡型', '2', '可以承受中等风险、较低风险、极低风险的产品', '0', '0', TO_DATE('2016-07-12 14:30:09', 'YYYY-MM-DD HH24:MI:SS'));
INSERT INTO risk_level_config VALUES ('8a0f572ea5d6477e860866d4ade168d8', '2016071200004', '中高风险', '4', '本金、收益可能有较大幅度的波动', '成长型', '3', '可以承受中高风险、中等风险、较低风险、极低风险的产品', '0', '0', TO_DATE('2016-07-12 14:30:42', 'YYYY-MM-DD HH24:MI:SS'));
INSERT INTO risk_level_config VALUES ('96ac8c459250463ca64178113471d2b1', '2016071200002', '较低风险', '2', '本金相对稳定、收益可能有轻微波动', '稳健型', '1', '可以承受较低风险、极低风险的产品', '0', '0', TO_DATE('2016-07-12 14:28:44', 'YYYY-MM-DD HH24:MI:SS'));

-- ----------------------------
-- Table structure for risk_papers
-- ----------------------------
DROP TABLE risk_papers;
CREATE TABLE risk_papers (
uuid NVARCHAR2(32) NOT NULL ,
papers_no NVARCHAR2(20) NULL ,
papers_name NVARCHAR2(255) NULL ,
papers_type NUMBER(11) NULL ,
question_count NUMBER(11) NULL ,
create_time DATE NULL ,
...
;
COMMENT ON TABLE risk_papers IS '风险评估问卷';
COMMENT ON COLUMN risk_papers.uuid IS '主键';
COMMENT ON COLUMN risk_papers.papers_no IS '问卷编号';
COMMENT ON COLUMN risk_papers.papers_name IS '问卷名称';
COMMENT ON COLUMN risk_papers.papers_type IS '试卷类型（2，答题，1：其他）';
COMMENT ON COLUMN risk_papers.question_count IS '问题数量';
COMMENT ON COLUMN risk_papers.create_time IS '创建时间';
COMMENT ON COLUMN risk_papers.status IS '问卷状态值（1:发布中；2：未发布）';
COMMENT ON COLUMN risk_papers.delete_flag IS '逻辑删除';
...
-- ----------------------------
DROP TABLE risk_papers_score;
CREATE TABLE risk_papers_score (
uuid NVARCHAR2(32) NOT NULL ,
papers_id NVARCHAR2(32) NULL ,
risk_id NVARCHAR2(32) NULL ,
start_score NUMBER(11) NULL ,
end_score NUMBER(11) NULL ,
create_time DATE NULL 
)
LOGGING
NOCOMPRESS
...
;
COMMENT ON TABLE risk_papers_score IS '问卷分数风险等级设置';
COMMENT ON COLUMN risk_papers_score.uuid IS '主键';
COMMENT ON COLUMN risk_papers_score.papers_id IS '关联试卷UUID';
COMMENT ON COLUMN risk_papers_score.risk_id IS '关联风险等级UUID';
COMMENT ON COLUMN risk_papers_score.start_score IS '起始分数0值';
COMMENT ON COLUMN risk_papers_score.end_score IS '截止分数值';
COMMENT ON COLUMN risk_papers_score.create_time IS '创建时间';
...
uuid NVARCHAR2(32) NOT NULL ,
papers_id NVARCHAR2(32) NULL ,
question_no NVARCHAR2(20) NULL ,
question_name NVARCHAR2(128) NULL ,
sort NUMBER(11) NULL ,
score NUMBER(11) NULL ,
is_single NUMBER(11) NULL ,
create_time DATE NULL ,
delete_flag NUMBER(11) NULL 
)
LOGGING
...
;
COMMENT ON TABLE risk_question IS '风险评估问卷问题';
COMMENT ON COLUMN risk_question.uuid IS '主键';
COMMENT ON COLUMN risk_question.papers_id IS '关联问卷表uuid';
COMMENT ON COLUMN risk_question.question_no IS '问卷问题编号';
COMMENT ON COLUMN risk_question.question_name IS '问卷问题内容';
COMMENT ON COLUMN risk_question.sort IS '问题序号';
COMMENT ON COLUMN risk_question.score IS '问题分值';
COMMENT ON COLUMN risk_question.is_single IS '是否单选（1，单选；2，多选，默认单选）';
COMMENT ON COLUMN risk_question.create_time IS '创建时间';
COMMENT ON COLUMN risk_question.delete_flag IS '逻辑删除';
...
-- ----------------------------
DROP TABLE risk_user_log;
CREATE TABLE risk_user_log (
uuid NVARCHAR2(32) NOT NULL ,
user_id NVARCHAR2(32) NULL ,
papers_id NVARCHAR2(32) NULL ,
score NUMBER(11) NULL ,
risk_level NUMBER(11) NULL ,
create_time DATE NULL ,
status NUMBER(11) NULL ,
risk_answers NCLOB NULL 
)
LOGGING
NOCOMPRESS
NOCACHE
...
;
COMMENT ON TABLE risk_user_log IS '用户风险评测记录';
COMMENT ON COLUMN risk_user_log.uuid IS '主键';
COMMENT ON COLUMN risk_user_log.user_id IS '关联用户UUID（风险评估人）';
COMMENT ON COLUMN risk_user_log.papers_id IS '关联问卷UUID（问卷号）';
COMMENT ON COLUMN risk_user_log.score IS '评估所得分数';
COMMENT ON COLUMN risk_user_log.risk_level IS '评估分数对应风险等级';
COMMENT ON COLUMN risk_user_log.create_time IS '创建时间';
COMMENT ON COLUMN risk_user_log.status IS '评估状态值（0:初始状态值；1：有效状态值）';
COMMENT ON COLUMN risk_user_log.risk_answers IS '用户答题的内容（数组题号和用户选择答案）';
...
-- ----------------------------
DROP TABLE score_goods;
CREATE TABLE score_goods (
uuid NVARCHAR2(32) NOT NULL ,
goods_name NVARCHAR2(64) NOT NULL ,
goods_category_id NVARCHAR2(32) NULL ,
exchange_limit NUMBER(11) NULL ,
status CHAR(1) NOT NULL ,
sale_time DATE NULL ,
create_time DATE NULL ,
create_operator_id NVARCHAR2(32) NULL ,
update_time DATE NULL ,
update_operator_id NVARCHAR2(32) NULL ,
cost_price NUMBER(20, 4) NULL ,
market_price NUMBER(20, 4) NULL ,
score NUMBER(11) NULL ,
content NCLOB NULL ,
goods_attribute NCLOB NULL ,
is_virtual CHAR(1) NULL ,
remark NVARCHAR2(255) NULL ,
verify_operator_id NVARCHAR2(32) NULL ,
verify_remark NVARCHAR2(128) NULL ,
verify_time DATE NULL ,
recommend CHAR(1) NULL ,
rule_id NVARCHAR2(32) NULL ,
virtual_type CHAR(1) NULL 
)
LOGGING
NOCOMPRESS
NOCACHE
...
;
COMMENT ON TABLE score_goods IS '积分商品表';
COMMENT ON COLUMN score_goods.uuid IS '主键';
COMMENT ON COLUMN score_goods.goods_name IS '商品名称';
COMMENT ON COLUMN score_goods.goods_category_id IS '商品分类ID';
COMMENT ON COLUMN score_goods.exchange_limit IS '限购数量';
COMMENT ON COLUMN score_goods.status IS '商品状态  0 待审核 1 审核成功   2 审核失败  3 已上架   4 已下架';
COMMENT ON COLUMN score_goods.sale_time IS '上架时间';
COMMENT ON COLUMN score_goods.create_time IS '添加时间';
COMMENT ON COLUMN score_goods.create_operator_id IS '添加者';
COMMENT ON COLUMN score_goods.update_time IS '修改时间';
COMMENT ON COLUMN score_goods.update_operator_id IS '添加者';
COMMENT ON COLUMN score_goods.cost_price IS '采购价格';
COMMENT ON COLUMN score_goods.market_price IS '市场价';
COMMENT ON COLUMN score_goods.score IS '所需积分';
COMMENT ON COLUMN score_goods.content IS '商品详情';
COMMENT ON COLUMN score_goods.goods_attribute IS '商品属性信息';
COMMENT ON COLUMN score_goods.is_virtual IS '是否虚拟商品 1 是 0 否 默认0';
COMMENT ON COLUMN score_goods.remark IS '备注';
COMMENT ON COLUMN score_goods.verify_operator_Id IS '审核人ID';
COMMENT ON COLUMN score_goods.verify_remark IS '审核备注';
COMMENT ON COLUMN score_goods.verify_time IS '审核时间';
COMMENT ON COLUMN score_goods.recommend IS '是否推荐';
COMMENT ON COLUMN score_goods.rule_id IS '虚拟物品所对应的规则Id';
COMMENT ON COLUMN score_goods.virtual_type IS '虚拟类型：0 红包 1加息卷';
...
-- ----------------------------
-- Table structure for score_goods_category
-- ----------------------------
DROP TABLE score_goods_category;
CREATE TABLE score_goods_category (
uuid NVARCHAR2(32) NOT NULL ,
goods_category_name NVARCHAR2(64) NULL ,
intro_pic NVARCHAR2(512) NULL ,
sort NUMBER(4) NULL ,
remark NVARCHAR2(64) NULL ,
create_time DATE NULL ,
operator NVARCHAR2(32) NULL ,
delete_flag CHAR(1) NULL 
)
LOGGING
NOCOMPRESS
...
;
COMMENT ON TABLE score_goods_category IS '积分商品分类表';
COMMENT ON COLUMN score_goods_category.uuid IS '主键';
COMMENT ON COLUMN score_goods_category.goods_category_name IS '商品分类名称';
COMMENT ON COLUMN score_goods_category.intro_pic IS '分类图片路径';
COMMENT ON COLUMN score_goods_category.sort IS '排序';
COMMENT ON COLUMN score_goods_category.remark IS '备注';
COMMENT ON COLUMN score_goods_category.create_time IS '添加时间';
COMMENT ON COLUMN score_goods_category.operator IS '操作员';
COMMENT ON COLUMN score_goods_category.delete_flag IS '是否删除 1 是 0否，默认0';

-- ----------------------------
-- Records of score_goods_category
-- ----------------------------

-- ----------------------------
-- Table structure for score_goods_order
-- ----------------------------
DROP TABLE score_goods_order;
CREATE TABLE score_goods_order (
uuid NVARCHAR2(32) NOT NULL ,
user_id NVARCHAR2(32) NOT NULL ,
user_name NVARCHAR2(32) NULL ,
goods_id NVARCHAR2(32) NOT NULL ,
goods_name NVARCHAR2(64) NULL ,
num NUMBER(11) NOT NULL ,
score NUMBER(11) NULL ,
create_time DATE NULL ,
deliver_time DATE NULL ,
deliver_user NVARCHAR2(32) NULL ,
express_name NVARCHAR2(32) NULL ,
express_no NVARCHAR2(32) NULL ,
money NUMBER(20, 4) NULL ,
receive_address NVARCHAR2(255) NULL ,
receive_phone NVARCHAR2(32) NULL ,
receive_user_name NVARCHAR2(32) NULL ,
receive_remark NVARCHAR2(256) NULL ,
status CHAR(1) NULL ,
verify_time DATE NULL ,
verify_user_id NVARCHAR2(32) NULL ,
verify_user NVARCHAR2(32) NULL ,
verify_remark NVARCHAR2(255) NULL 
)
LOGGING
NOCOMPRESS
NOCACHE
...
;
COMMENT ON TABLE score_goods_order IS '积分商品订单表';
COMMENT ON COLUMN score_goods_order.uuid IS '主键';
COMMENT ON COLUMN score_goods_order.user_id IS '用户id';
COMMENT ON COLUMN score_goods_order.user_name IS '用户名';
COMMENT ON COLUMN score_goods_order.goods_id IS '商品ID';
COMMENT ON COLUMN score_goods_order.goods_name IS '商品名称';
COMMENT ON COLUMN score_goods_order.num IS '兑换数量';
COMMENT ON COLUMN score_goods_order.score IS '使用积分值';
COMMENT ON COLUMN score_goods_order.create_time IS '兑换时间';
COMMENT ON COLUMN score_goods_order.deliver_time IS '发货时间';
COMMENT ON COLUMN score_goods_order.deliver_user IS '发送人';
COMMENT ON COLUMN score_goods_order.express_name IS '物流名称';
COMMENT ON COLUMN score_goods_order.express_no IS '物流单号';
COMMENT ON COLUMN score_goods_order.money IS '费用';
COMMENT ON COLUMN score_goods_order.receive_address IS '收货地址';
COMMENT ON COLUMN score_goods_order.receive_phone IS '收货人电话';
COMMENT ON COLUMN score_goods_order.receive_user_name IS '收货人姓名';
COMMENT ON COLUMN score_goods_order.receive_remark IS '兑换留言';
COMMENT ON COLUMN score_goods_order.status IS '状态 0 新建 1审批通过  2 审核失败 3 已发货 4 已收货 5结束';
COMMENT ON COLUMN score_goods_order.verify_time IS '审批时间';
COMMENT ON COLUMN score_goods_order.verify_user_id IS '审批人ID';
COMMENT ON COLUMN score_goods_order.verify_user IS '审批人用户名';
COMMENT ON COLUMN score_goods_order.verify_remark IS '审批备注';

-- ----------------------------
-- Records of score_goods_order
-- ----------------------------

-- ----------------------------
-- Table structure for score_goods_pic
-- ----------------------------
DROP TABLE score_goods_pic;
CREATE TABLE score_goods_pic (
uuid NVARCHAR2(32) NOT NULL ,
goods_id NVARCHAR2(32) NOT NULL ,
pic_type NVARCHAR2(32) NULL ,
pic_path NVARCHAR2(512) NULL ,
create_time DATE NULL 
)
LOGGING
...
;
COMMENT ON TABLE score_goods_pic IS '积分商品图片表';
COMMENT ON COLUMN score_goods_pic.uuid IS '主键';
COMMENT ON COLUMN score_goods_pic.goods_id IS '商品ID';
COMMENT ON COLUMN score_goods_pic.pic_type IS '图片类型 1 缩略图 2  实体照片';
COMMENT ON COLUMN score_goods_pic.pic_path IS '图片路径';
COMMENT ON COLUMN score_goods_pic.create_time IS '添加时间';

-- ----------------------------
-- Records of score_goods_pic
-- ----------------------------

-- ----------------------------
-- Table structure for score_goods_store
-- ----------------------------
DROP TABLE score_goods_store;
CREATE TABLE score_goods_store (
uuid NVARCHAR2(32) NOT NULL ,
goods_id NVARCHAR2(32) NOT NULL ,
store NUMBER(11) NULL ,
freeze_store NUMBER(11) NULL ,
sold_amount NUMBER(11) NULL 
)
LOGGING
NOCOMPRESS
NOCACHE
...
;
COMMENT ON TABLE score_goods_store IS '积分商品库存表';
COMMENT ON COLUMN score_goods_store.uuid IS '主键';
COMMENT ON COLUMN score_goods_store.goods_id IS '商品ID';
COMMENT ON COLUMN score_goods_store.store IS '商品库存';
COMMENT ON COLUMN score_goods_store.freeze_store IS '冻结库存';
COMMENT ON COLUMN score_goods_store.sold_amount IS '销售数量';

-- ----------------------------
-- Records of score_goods_store
-- ----------------------------
...
uuid NVARCHAR2(32) NOT NULL ,
type_name NVARCHAR2(30) NULL ,
type_code NVARCHAR2(32) NULL ,
grant_type CHAR(1) NULL ,
grant_value NUMBER(11) NULL ,
grant_rate NUMBER(20, 2) NULL ,
grant_min NUMBER(11) NULL ,
grant_max NUMBER(11) NULL ,
grant_up NUMBER(11) NULL ,
...
;
COMMENT ON TABLE score_type IS '积分发放规则表';
COMMENT ON COLUMN score_type.uuid IS '主键';
COMMENT ON COLUMN score_type.type_name IS '积分类型名称';
COMMENT ON COLUMN score_type.grant_type IS '发放类型（1：固定值，2：固定比例，3：金额满返 4：比例满返，5：固定递增）';
COMMENT ON COLUMN score_type.grant_value IS '发放积分（发放类型为1的时候填写）';
COMMENT ON COLUMN score_type.grant_rate IS '发放的比例（发放类型为2,4有效）';
COMMENT ON COLUMN score_type.grant_min IS '发放的最小值';
COMMENT ON COLUMN score_type.grant_max IS '发放的最大值';
COMMENT ON COLUMN score_type.grant_up IS '发放类型为5 固定递增值';
COMMENT ON COLUMN score_type.remark IS '规则备注';
COMMENT ON COLUMN score_type.status IS '状态： 0禁用  1启用';
...
uuid NVARCHAR2(32) NOT NULL ,
section_name NVARCHAR2(50) NULL ,
section_code NVARCHAR2(20) NULL ,
section_type CHAR(1) NULL ,
parent_id NVARCHAR2(32) NULL ,
delete_flag CHAR(1) NULL ,
sort NUMBER(11) NULL ,
remark NVARCHAR2(255) NULL ,
create_time DATE NULL ,
pic_number NUMBER(11) NULL 
)
LOGGING
NOCOMPRESS
NOCACHE
...
;
COMMENT ON TABLE section IS '栏目';
COMMENT ON COLUMN section.uuid IS '主键';
COMMENT ON COLUMN section.section_name IS '栏目名称';
COMMENT ON COLUMN section.section_code IS '栏目标识';
COMMENT ON COLUMN section.section_type IS '栏目类型，1：列表，2：单页';
COMMENT ON COLUMN section.parent_id IS '上一级栏目ID';
COMMENT ON COLUMN section.delete_flag IS '状态 0 未删除，1 已删除';
COMMENT ON COLUMN section.sort IS '排序';
COMMENT ON COLUMN section.remark IS '描述';
COMMENT ON COLUMN section.pic_number IS '图片个数';

-- ----------------------------
-- Records of section
-- ----------------------------
INSERT INTO section VALUES ('1764f3e6d315454ab070568f55c992f2', '合作伙伴', 'partner', '3', 'fc294a1064c647ea820164aa4523d047', '0', '30001', '合作伙伴', TO_DATE('2016-08-04 14:51:36', 'YYYY-MM-DD HH24:MI:SS'), '8');
INSERT INTO section VALUES ('1764f3e6d315454ab070568f55c992f3', '动态资讯', 'news', null, 'fc294a1064c647ea820164aa4523d047', '0', '30009', '动态资讯', TO_DATE('2016-08-04 14:50:35', 'YYYY-MM-DD HH24:MI:SS'), '3');
INSERT INTO section VALUES ('1764f3e6d315454ab070568f55c992f4', '网站公告', 'notice', null, 'fc294a1064c647ea820164aa4523d047', '0', '30002', '网站公告', TO_DATE('2016-07-27 15:29:17', 'YYYY-MM-DD HH24:MI:SS'), '3');
INSERT INTO section VALUES ('1764f3e6d315454ab070568f55c992f5', '滚动图', 'scrollPic', '3', null, '0', '100', '滚动图', TO_DATE('2016-08-04 14:46:57', 'YYYY-MM-DD HH24:MI:SS'), '3');
INSERT INTO section VALUES ('1770737057ec4074abdfecc1405513aa', '帮助中心', 'help', '3', null, '0', '200', '帮助中心', TO_DATE('2016-08-09 18:35:23', 'YYYY-MM-DD HH24:MI:SS'), null);
INSERT INTO section VALUES ('3e6870e33a4e4740a619274520dffa47', '安全保障', 'abc', '1', 'fc294a1064c647ea820164aa4523d047', '0', '30008', null, TO_DATE('2016-11-01 10:43:14', 'YYYY-MM-DD HH24:MI:SS'), null);
INSERT INTO section VALUES ('544b172bf95a4e0b8e1c9ba20aab6952', '充值提现', 'account', '1', '1770737057ec4074abdfecc1405513aa', '0', '20002', '充值提现', TO_DATE('2016-08-09 18:36:36', 'YYYY-MM-DD HH24:MI:SS'), null);
INSERT INTO section VALUES ('5aa5b814214446cbb20814e30cf7f8e7', '注册认证', 'register', '1', '1770737057ec4074abdfecc1405513aa', '0', '20001', '注册认证', TO_DATE('2016-08-09 18:35:59', 'YYYY-MM-DD HH24:MI:SS'), null);
INSERT INTO section VALUES ('73243ceb6ddf4822a7686bae838aa744', '平台简介', 'platformInfo', '1', 'fc294a1064c647ea820164aa4523d047', '0', '30005', '平台简介', TO_DATE('2016-08-10 17:27:14', 'YYYY-MM-DD HH24:MI:SS'), null);
INSERT INTO section VALUES ('b2bd4f7d8be24ff19d668a2ffa3a417a', '资费说明', 'chargeFee', '1', '1770737057ec4074abdfecc1405513aa', '0', '20004', '资费说明', TO_DATE('2016-08-09 18:38:28', 'YYYY-MM-DD HH24:MI:SS'), null);
INSERT INTO section VALUES ('c7a06b999547447c955cb548a1cc385a', '投资收益', 'invest', '1', '1770737057ec4074abdfecc1405513aa', '0', '20003', '投资收益', TO_DATE('2016-08-09 18:37:10', 'YYYY-MM-DD HH24:MI:SS'), null);
INSERT INTO section VALUES ('df693ada499c42b29cc736089f2a3202', '加入我们', 'jionUs', '1', 'fc294a1064c647ea820164aa4523d047', '0', '30007', '加入我们', TO_DATE('2016-08-10 17:28:55', 'YYYY-MM-DD HH24:MI:SS'), null);
INSERT INTO section VALUES ('ecf57b34c1c94f18a4eab002db0d54e4', '联系我们', 'contactUs', '1', 'fc294a1064c647ea820164aa4523d047', '0', '30006', '联系我们', TO_DATE('2016-08-10 17:28:30', 'YYYY-MM-DD HH24:MI:SS'), null);
INSERT INTO section VALUES ('f00a0e1b3b4542329503c4e8cbf7ba98', '法律说明', 'lawInfo', '1', '1770737057ec4074abdfecc1405513aa', '0', '20005', '法律说明', TO_DATE('2016-08-09 18:39:24', 'YYYY-MM-DD HH24:MI:SS'), null);
INSERT INTO section VALUES ('f888af0afbee421db8eeb938591db8fc', '媒体报道', 'media', '1', 'fc294a1064c647ea820164aa4523d047', '0', '30004', '媒体报道', TO_DATE('2016-08-09 10:55:52', 'YYYY-MM-DD HH24:MI:SS'), null);
INSERT INTO section VALUES ('fc294a1064c647ea820164aa4523d047', '关于我们', 'aboutUs', '1', null, '0', '300', '关于我们', TO_DATE('2016-08-09 10:47:15', 'YYYY-MM-DD HH24:MI:SS'), null);

-- ----------------------------
-- Table structure for statistic_account
-- ----------------------------
DROP TABLE statistic_account;
CREATE TABLE statistic_account (
uuid NVARCHAR2(32) NOT NULL ,
stat_date DATE NULL ,
use_money NUMBER(20, 4) NULL ,
relative_ratio NVARCHAR2(10) NULL 
)
LOGGING
NOCOMPRESS
NOCACHE
...
;
COMMENT ON TABLE statistic_account IS '账户统计';
COMMENT ON COLUMN statistic_account.uuid IS '主键';
COMMENT ON COLUMN statistic_account.stat_date IS '统计日期';
COMMENT ON COLUMN statistic_account.use_money IS '可用余额';
COMMENT ON COLUMN statistic_account.relative_ratio IS '环比值';

-- ----------------------------
-- Records of statistic_account
-- ----------------------------

-- ----------------------------
-- Table structure for statistic_bad_debt
-- ----------------------------
DROP TABLE statistic_bad_debt;
...
amount NUMBER(20, 4) NULL ,
is_vouch CHAR(1) NULL ,
is_mortgage CHAR(1) NULL ,
is_realize CHAR(1) NULL 
)
LOGGING
NOCOMPRESS
NOCACHE
...
;
COMMENT ON TABLE statistic_bad_debt IS '坏账分析';
COMMENT ON COLUMN statistic_bad_debt.uuid IS '主键';
COMMENT ON COLUMN statistic_bad_debt.stat_date IS '代收日期';
COMMENT ON COLUMN statistic_bad_debt.project_id IS '代收订单ID';
COMMENT ON COLUMN statistic_bad_debt.amount IS '代收金额';
COMMENT ON COLUMN statistic_bad_debt.is_vouch IS '是否担保借款，1-是，0-否';
COMMENT ON COLUMN statistic_bad_debt.is_mortgage IS '是否抵押借款，1-是，0-否';
COMMENT ON COLUMN statistic_bad_debt.is_realize IS '是否变现借款，1-是，0-否';

-- ----------------------------
-- Records of statistic_bad_debt
-- ----------------------------

-- ----------------------------
-- Table structure for statistic_bond
-- ----------------------------
DROP TABLE statistic_bond;
CREATE TABLE statistic_bond (
uuid NVARCHAR2(32) NOT NULL ,
user_id NVARCHAR2(32) NULL ,
bond_date DATE NULL ,
bond_invest_id NVARCHAR2(32) NULL ,
bond_amount NUMBER(20, 4) NULL ,
bond_time_limit NUMBER(11) NULL ,
is_vouch CHAR(1) NULL ,
is_mortgage CHAR(1) NULL 
)
LOGGING
...
;
COMMENT ON TABLE statistic_bond IS '债权转让分析';
COMMENT ON COLUMN statistic_bond.uuid IS '主键';
COMMENT ON COLUMN statistic_bond.user_id IS '用户ID';
COMMENT ON COLUMN statistic_bond.bond_date IS '转让日期';
COMMENT ON COLUMN statistic_bond.bond_invest_id IS '转让投资订单ID';
COMMENT ON COLUMN statistic_bond.bond_amount IS '转让金额';
COMMENT ON COLUMN statistic_bond.bond_time_limit IS '债权期限，以天为单位，1个月30天，1年365天';
COMMENT ON COLUMN statistic_bond.is_vouch IS '是否担保，1-是，0-否';
COMMENT ON COLUMN statistic_bond.is_mortgage IS '是否抵押，1-是，0-否';

-- ----------------------------
-- Records of statistic_bond
-- ----------------------------

-- ----------------------------
-- Table structure for statistic_borrow
-- ----------------------------
DROP TABLE statistic_borrow;
...
;
COMMENT ON COLUMN statistic_borrow.uuid IS '主键';
COMMENT ON COLUMN statistic_borrow.project_id IS '项目ID';
COMMENT ON COLUMN statistic_borrow.borrow_date IS '借款日期';
COMMENT ON COLUMN statistic_borrow.user_id IS '用户ID';
COMMENT ON COLUMN statistic_borrow.is_mortgage IS '是否抵押';
COMMENT ON COLUMN statistic_borrow.is_vouch IS '是否担保';
COMMENT ON COLUMN statistic_borrow.account IS '借款金额';
COMMENT ON COLUMN statistic_borrow.time_limit IS '借款期限';
COMMENT ON COLUMN statistic_borrow.borrow_nature IS '借款性质';
COMMENT ON COLUMN statistic_borrow.area IS '地区';

-- ----------------------------
-- Records of statistic_borrow
-- ----------------------------

-- ----------------------------
-- Table structure for statistic_earn
-- ----------------------------
DROP TABLE statistic_earn;
...
;
COMMENT ON TABLE statistic_earn IS '投资收益分析';
COMMENT ON COLUMN statistic_earn.uuid IS '主键';
COMMENT ON COLUMN statistic_earn.user_id IS '用户ID';
COMMENT ON COLUMN statistic_earn.stat_date IS '统计日期';
COMMENT ON COLUMN statistic_earn.amount IS '金额';
COMMENT ON COLUMN statistic_earn.account_type IS '资金类型';

-- ----------------------------
-- Records of statistic_earn
-- ----------------------------

-- ----------------------------
-- Table structure for statistic_invest
-- ----------------------------
DROP TABLE statistic_invest;
CREATE TABLE statistic_invest (
uuid NVARCHAR2(32) NOT NULL ,
invest_date DATE NULL ,
invest_id NVARCHAR2(32) NULL ,
invest_amount NUMBER(20, 4) NULL ,
invest_area NVARCHAR2(15) NULL ,
invest_channel CHAR(1) NULL ,
project_type NVARCHAR2(32) NULL ,
project_apr NUMBER(8, 4) NULL ,
project_time_limit NUMBER(11) NULL ,
user_id NVARCHAR2(32) NULL ,
user_nature CHAR(1) NULL ,
real_amount NUMBER(20, 4) NULL ,
is_use_red CHAR(1) NULL ,
is_use_rate CHAR(1) NULL ,
is_add_apr CHAR(1) NULL 
)
LOGGING
NOCOMPRESS
NOCACHE
...
;
COMMENT ON TABLE statistic_invest IS '投资分析';
COMMENT ON COLUMN statistic_invest.uuid IS '主键';
COMMENT ON COLUMN statistic_invest.invest_date IS '投资日期';
COMMENT ON COLUMN statistic_invest.invest_id IS '投资ID';
COMMENT ON COLUMN statistic_invest.invest_amount IS '投标金额';
COMMENT ON COLUMN statistic_invest.invest_area IS '投资地址';
COMMENT ON COLUMN statistic_invest.invest_channel IS '投资渠道 1 PC  2 APP 3 微信 ';
COMMENT ON COLUMN statistic_invest.project_type IS '产品类型标识： BX-变现理财，ZQ-债权转让、其它理财类型以project_type表nid为准';
COMMENT ON COLUMN statistic_invest.project_apr IS '年利率';
COMMENT ON COLUMN statistic_invest.project_time_limit IS '借款期限，以天为单位，1个月30天，1年365天';
COMMENT ON COLUMN statistic_invest.user_id IS '用户ID';
COMMENT ON COLUMN statistic_invest.user_nature IS '用户类型:  1个人用户、2 企业用户';
COMMENT ON COLUMN statistic_invest.real_amount IS '实付金额=投资金额-红包金额';
COMMENT ON COLUMN statistic_invest.is_use_red IS '是否使用了红包，0-未使用，1-已使用';
COMMENT ON COLUMN statistic_invest.is_use_rate IS '是否使用了加息券，0-未使用，1-已使用';
COMMENT ON COLUMN statistic_invest.is_add_apr IS '产品是否加息，0-未加息，1-已加息';

-- ----------------------------
-- Records of statistic_invest
-- ----------------------------

-- ----------------------------
-- Table structure for statistic_overdue
-- ----------------------------
DROP TABLE statistic_overdue;
CREATE TABLE statistic_overdue (
uuid NVARCHAR2(32) NOT NULL ,
record_date DATE NULL ,
stat_type CHAR(1) NULL ,
total_count NUMBER(20, 4) NULL ,
first_series NUMBER(20, 4) NULL ,
second_series NUMBER(20, 4) NULL ,
third_series NUMBER(20, 4) NULL 
)
LOGGING
NOCOMPRESS
NOCACHE
...
;
COMMENT ON TABLE statistic_overdue IS '投资分析';
COMMENT ON COLUMN statistic_overdue.uuid IS '主键';
COMMENT ON COLUMN statistic_overdue.record_date IS '记录日期';
COMMENT ON COLUMN statistic_overdue.stat_type IS '统计类型：1-人数，2-金额，3-笔数';
COMMENT ON COLUMN statistic_overdue.total_count IS '总数';
COMMENT ON COLUMN statistic_overdue.first_series IS '第一级 90天以下';
COMMENT ON COLUMN statistic_overdue.second_series IS '第二级 90-180';
COMMENT ON COLUMN statistic_overdue.third_series IS '第三级 180天以上';

-- ----------------------------
-- Records of statistic_overdue
-- ----------------------------

-- ----------------------------
-- Table structure for statistic_repay
-- ----------------------------
DROP TABLE statistic_repay;
CREATE TABLE statistic_repay (
uuid NVARCHAR2(32) NOT NULL ,
record_date DATE NOT NULL ,
repay_status CHAR(1) NULL ,
borrow_type NVARCHAR2(8) NULL ,
borrow_nature CHAR(1) NULL ,
payment NUMBER(20, 4) NULL ,
capital NUMBER(20, 4) NULL ,
interest NUMBER(20, 4) NULL ,
repay_count NUMBER(20) NULL 
)
LOGGING
NOCOMPRESS
NOCACHE
...
;
COMMENT ON COLUMN statistic_repay.uuid IS '主键';
COMMENT ON COLUMN statistic_repay.record_date IS '记录日期';
COMMENT ON COLUMN statistic_repay.repay_status IS '还款状态 0 未还 1 已还';
COMMENT ON COLUMN statistic_repay.borrow_type IS '借款类型';
COMMENT ON COLUMN statistic_repay.borrow_nature IS '借款性质';
COMMENT ON COLUMN statistic_repay.payment IS '总额';
COMMENT ON COLUMN statistic_repay.capital IS '本金';
COMMENT ON COLUMN statistic_repay.interest IS '利息';
COMMENT ON COLUMN statistic_repay.repay_count IS '笔数';

-- ----------------------------
-- Records of statistic_repay
-- ----------------------------

-- ----------------------------
-- Table structure for statistic_repay_info
-- ----------------------------
DROP TABLE statistic_repay_info;
CREATE TABLE statistic_repay_info (
uuid NVARCHAR2(32) NOT NULL ,
record_date DATE NOT NULL ,
wait_total NUMBER(20, 4) NULL ,
biggest_one NUMBER(20, 4) NULL ,
biggest_one_ratio NUMBER(20, 4) NULL ,
biggest_ten NUMBER(20, 4) NULL ,
biggest_ten_ratio NUMBER(20, 4) NULL ,
overdue_num NUMBER(20, 4) NULL ,
overdue_ratio NUMBER(20, 4) NULL ,
overdue_account NUMBER(20, 4) NULL ,
overdue_account_ratio NUMBER(20, 4) NULL ,
old_overdue_account NUMBER(20, 4) NULL ,
old_overdue_ratio NUMBER(20, 4) NULL ,
commutation_num NUMBER(20, 4) NULL ,
commutation_account NUMBER(20, 4) NULL ,
overdue_borrower NUMBER(20, 4) NULL 
)
LOGGING
NOCOMPRESS
NOCACHE
...
;
COMMENT ON COLUMN statistic_repay_info.uuid IS '主键';
COMMENT ON COLUMN statistic_repay_info.record_date IS '记录日期';
COMMENT ON COLUMN statistic_repay_info.wait_total IS '待还总额';
COMMENT ON COLUMN statistic_repay_info.biggest_one IS '最大单户借款余额';
COMMENT ON COLUMN statistic_repay_info.biggest_one_ratio IS '最大单户余额占比';
COMMENT ON COLUMN statistic_repay_info.biggest_ten IS '最大十户借款余额';
COMMENT ON COLUMN statistic_repay_info.biggest_ten_ratio IS '最大十户余额占比';
COMMENT ON COLUMN statistic_repay_info.overdue_num IS '逾期项目数';
COMMENT ON COLUMN statistic_repay_info.overdue_ratio IS '逾期率';
COMMENT ON COLUMN statistic_repay_info.overdue_account IS '逾期金额';
COMMENT ON COLUMN statistic_repay_info.overdue_account_ratio IS '逾期金额比率';
COMMENT ON COLUMN statistic_repay_info.old_overdue_account IS '历史项目逾期金额';
COMMENT ON COLUMN statistic_repay_info.old_overdue_ratio IS '历史项目逾期金额比率';
COMMENT ON COLUMN statistic_repay_info.commutation_num IS '代偿笔数';
COMMENT ON COLUMN statistic_repay_info.commutation_account IS '代偿金额';
COMMENT ON COLUMN statistic_repay_info.overdue_borrower IS '逾期人数';

-- ----------------------------
-- Records of statistic_repay_info
-- ----------------------------

-- ----------------------------
-- Table structure for statistic_user
-- ----------------------------
DROP TABLE statistic_user;
CREATE TABLE statistic_user (
user_id NVARCHAR2(32) NOT NULL ,
regist_date DATE NOT NULL ,
real_name_date DATE NOT NULL ,
user_nature CHAR(1) NULL ,
regist_channel CHAR(1) NULL ,
sex CHAR(1) NULL ,
year NUMBER(11) NULL ,
real_name_status CHAR(1) NULL ,
area NVARCHAR2(10) NULL ,
is_investor CHAR(1) NULL ,
is_borrower CHAR(1) NULL ,
education NVARCHAR2(2) NULL ,
marital_status CHAR(1) NULL ,
month_income_range NVARCHAR2(20) NULL 
)
LOGGING
NOCOMPRESS
NOCACHE
...
;
COMMENT ON COLUMN statistic_user.user_id IS '用户ID';
COMMENT ON COLUMN statistic_user.regist_date IS '注册日期';
COMMENT ON COLUMN statistic_user.real_name_date IS '认证日期';
COMMENT ON COLUMN statistic_user.user_nature IS '用户类型';
COMMENT ON COLUMN statistic_user.regist_channel IS '注册渠道';
COMMENT ON COLUMN statistic_user.sex IS '性别';
COMMENT ON COLUMN statistic_user.year IS '生日年份';
COMMENT ON COLUMN statistic_user.is_investor IS '是否为投资人 0 普通用户 1 投资人 ';
COMMENT ON COLUMN statistic_user.is_borrower IS '是否为借款人 0 普通用户 1 借款人';
COMMENT ON COLUMN statistic_user.education IS '学历';
COMMENT ON COLUMN statistic_user.marital_status IS '婚姻状况 0:未婚；1：已婚；2：离异；3：丧偶';
COMMENT ON COLUMN statistic_user.month_income_range IS '收入范围';

-- ----------------------------
-- Records of statistic_user
-- ----------------------------
...
uuid NVARCHAR2(32) NOT NULL ,
area_code NVARCHAR2(6) NOT NULL ,
area_name NVARCHAR2(20) NOT NULL ,
area_level NUMBER(11) NULL ,
sort NUMBER(11) NULL ,
parent_code NVARCHAR2(6) NULL 
)
LOGGING
NOCOMPRESS
NOCACHE
...
;
COMMENT ON TABLE sys_area IS '省市区域';
COMMENT ON COLUMN sys_area.uuid IS '主键';
COMMENT ON COLUMN sys_area.area_code IS '区域编码';
COMMENT ON COLUMN sys_area.area_name IS '区域名称';
COMMENT ON COLUMN sys_area.area_level IS '层级（根节点 中国 0，省 1 市 2 区、县3）';
COMMENT ON COLUMN sys_area.sort IS '排序';
COMMENT ON COLUMN sys_area.parent_code IS '上一级';
...
config_value VARCHAR2(2048) NULL ,
config_type NVARCHAR2(2) NULL ,
create_time DATE NULL ,
status CHAR(1) NULL ,
remark NVARCHAR2(512) NULL ,
edit_enable CHAR(1) NULL 
)
LOGGING
NOCOMPRESS
NOCACHE
...
COMMENT ON COLUMN sys_config.uuid IS '主键';
COMMENT ON COLUMN sys_config.code IS '配置项标识';
COMMENT ON COLUMN sys_config.config_name IS '配置项名称';
COMMENT ON COLUMN sys_config.config_value IS '值';
COMMENT ON COLUMN sys_config.create_time IS '添加时间';
COMMENT ON COLUMN sys_config.status IS '启用状态：0 未启用 1 启用';
COMMENT ON COLUMN sys_config.remark IS '备注';
COMMENT ON COLUMN sys_config.edit_enable IS '是否可编辑';

-- ----------------------------
-- Records of sys_config
-- ----------------------------
INSERT INTO sys_config VALUES ('0a9f135dc1d6492f94000d72dfa52242', 'invest_unpay_max', '当日用户最大未支付投资订单数', '20', '2', TO_DATE('2016-08-14 14:27:53', 'YYYY-MM-DD HH24:MI:SS'), '1', '当日用户最大未支付投资订单数，包括支付超时、待支付订单', '1');
INSERT INTO sys_config VALUES ('0c56bcda11494b64a7361d2773a9c002', 'borrow_most_add_apr', '最高加息利率', '3', '2', TO_DATE('2016-08-10 16:59:01', 'YYYY-MM-DD HH24:MI:SS'), '1', '最高加息利率：2%', '1');
INSERT INTO sys_config VALUES ('1', 'manage_url', '管理平台地址', 'http://172.16.90.30:8081', '2', TO_DATE('2016-06-22 11:45:53', 'YYYY-MM-DD HH24:MI:SS'), '1', '网站后台页面访问地址，请不要在地址后面加/', '0');
INSERT INTO sys_config VALUES ('10', 'web_index_sina_microblog', '新浪微博', 'http://weibo.com/erongdu', '1', TO_DATE('2016-06-22 11:45:53', 'YYYY-MM-DD HH24:MI:SS'), '1', '平台新浪微博（关注我们）', '1');
INSERT INTO sys_config VALUES ('100', 'account_code', '账户编号', '001', '2', TO_DATE('2016-07-13 11:45:53', 'YYYY-MM-DD HH24:MI:SS'), '1', '子账户类型： 001-互金；002-众筹', '0');
INSERT INTO sys_config VALUES ('101', 'auth_service_type', '授权业务类型', '2', '2', TO_DATE('2016-07-22 13:38:33', 'YYYY-MM-DD HH24:MI:SS'), '1', '汇付2 双乾2,3,5 联动1 兴业2,3', '0');
INSERT INTO sys_config VALUES ('102', 'mobile_url', '移动端平台地址', 'http://172.16.90.30:8088', '1', TO_DATE('2016-12-20 18:28:28', 'YYYY-MM-DD HH24:MI:SS'), '1', '移动端平台地址', '1');
INSERT INTO sys_config VALUES ('12', 'address', '地址', '上海市嘉定区陈翔路88号6幢2楼B区2171', '1', TO_DATE('2016-06-22 11:45:53', 'YYYY-MM-DD HH24:MI:SS'), '1', '用于网站显示公司地址', '1');
INSERT INTO sys_config VALUES ('13', 'web_index_copyright', '网站CpoyRight', 'Copyright@2016 杭州融都科技股份有限公司 版权所有', '1', TO_DATE('2016-06-22 11:45:53', 'YYYY-MM-DD HH24:MI:SS'), '1', '用于网站显示网站版权', '1');
INSERT INTO sys_config VALUES ('14', 'web_record_number', '网站备案号', '沪ICP备15011786号', '1', TO_DATE('2016-06-22 11:45:53', 'YYYY-MM-DD HH24:MI:SS'), '1', '用于网站底部显示网站ICP备案号', '1');
INSERT INTO sys_config VALUES ('15', 'web_meta_keywords', '网站关键词', '互金3.0', '1', TO_DATE('2016-06-22 11:45:53', 'YYYY-MM-DD HH24:MI:SS'), '1', '网站关键词用于SEO，使网站更易被搜索引擎收录', '1');
INSERT INTO sys_config VALUES ('155', 'vip_growth_rate', 'vip成长系数', '1', '2', TO_DATE('2016-08-28 17:39:30', 'YYYY-MM-DD HH24:MI:SS'), '1', 'vip成长系数(投资金额*该值)', '1');
INSERT INTO sys_config VALUES ('16', 'web_meta_description', '网站描述', '互金3.0', '1', TO_DATE('2016-06-22 11:45:53', 'YYYY-MM-DD HH24:MI:SS'), '1', '网站描述用于SEO，使网站更易被搜索引擎收录', '1');
INSERT INTO sys_config VALUES ('17', 'ftl_dir', 'freemarker的模板地址', '/WEB-INF/html_default/', '1', TO_DATE('2016-06-22 11:45:53', 'YYYY-MM-DD HH24:MI:SS'), '1', '用于代码读取freemarker的模板目录', '0');
INSERT INTO sys_config VALUES ('18', 'theme_dir', '模板目录', '/themes/theme_default', '1', TO_DATE('2016-06-22 11:45:53', 'YYYY-MM-DD HH24:MI:SS'), '1', '用于代码读取js的模板目录', '0');
INSERT INTO sys_config VALUES ('19', 'admin_account', '系统管理员账户Id', '1', '2', TO_DATE('2016-06-22 11:45:53', 'YYYY-MM-DD HH24:MI:SS'), '1', '资金记录中，用于记录管理员账户Id', '0');
INSERT INTO sys_config VALUES ('19fa90231aa411e799bd408d5c073447', 'cbhb_customerId', '渤海银行商户号', '800057100010001', '1', TO_DATE('2017-03-01 11:13:11', 'YYYY-MM-DD HH24:MI:SS'), '1', '渤海银行商户号', '1');
INSERT INTO sys_config VALUES ('1a047fa91aa411e799bd408d5c073447', 'cbhb_submit_url', '渤海银行提交地址', 'http://221.239.93.145:8280/hipos/payTransaction', '1', TO_DATE('2017-03-01 11:13:11', 'YYYY-MM-DD HH24:MI:SS'), '1', '渤海银行提交地址(现在暂为测试地址)', '1');
INSERT INTO sys_config VALUES ('1a0dce8f1aa411e799bd408d5c073447', 'cbhb_private_key', '渤海银行证书私钥密码', '123456', '1', TO_DATE('2017-03-01 11:13:11', 'YYYY-MM-DD HH24:MI:SS'), '1', '渤海银行证书私钥密码', '1');
INSERT INTO sys_config VALUES ('1ac934dffb8b4846ab66958bc67d6f09', 'borrow_most_apr', '最高借款利率', '24', '2', TO_DATE('2016-06-29 11:01:15', 'YYYY-MM-DD HH24:MI:SS'), '1', '最高借款利率：24%', '1');
INSERT INTO sys_config VALUES ('2', 'web_url', '网站网址', 'http://172.16.90.30:8080', '1', TO_DATE('2016-06-22 11:45:53', 'YYYY-MM-DD HH24:MI:SS'), '1', 'http://172.16.88.13，请不要在地址后面加/', '0');
INSERT INTO sys_config VALUES ('200547df6a154a6984dbe0ffc4aa6831', 'ufx_public_key', '商户公钥', '', '2', TO_DATE('2016-07-11 10:21:47', 'YYYY-MM-DD HH24:MI:SS'), '1', 'UFX商户公钥', '0');
INSERT INTO sys_config VALUES ('200547df6a154a6984dbe0ffc4aa6832', 'ufx_private_key', '商户私钥', '', '2', TO_DATE('2016-07-11 10:21:47', 'YYYY-MM-DD HH24:MI:SS'), '1', 'UFX商户私钥', '0');
INSERT INTO sys_config VALUES ('200547df6a154a6984dbe0ffc4aa6833', 'ufx_customerId', 'UFX商户号', '01160708462', '2', TO_DATE('2016-06-14 10:21:47', 'YYYY-MM-DD HH24:MI:SS'), '1', 'UFX商户号', '0');
INSERT INTO sys_config VALUES ('200547df6a154a6984dbe0ffc4aa6834', 'ufx_url', 'UFX生产环境路径', 'http://ufx.web.rdtest.cn/ufx/main.html', '2', TO_DATE('2016-07-11 10:21:47', 'YYYY-MM-DD HH24:MI:SS'), '1', 'UFX生产环境路径，请不要在地址后面加/', '0');
INSERT INTO sys_config VALUES ('56ae97b61849465ab8bbdeda62ae3c97', 'isOnlineConfig', '是否是线上环境', '1', '2', TO_DATE('2016-11-02 15:41:27', 'YYYY-MM-DD HH24:MI:SS'), '1', '是否是线上环境1 ：是  ，0 ： 否', '1');
INSERT INTO sys_config VALUES ('6', 'web_name', '网站名称', '互联网金融资产交易系统', '1', TO_DATE('2016-06-22 11:45:53', 'YYYY-MM-DD HH24:MI:SS'), '1', '网站名称', '1');
INSERT INTO sys_config VALUES ('69', 'late_interest_rate', '逾期利息划给用户比例', '0.6', '2', TO_DATE('2016-06-22 11:45:53', 'YYYY-MM-DD HH24:MI:SS'), '1', '借款人逾期还款，逾期利息划给投资人比例，1代表全部给投资人，0代表全部给平台', '1');
INSERT INTO sys_config VALUES ('6a6b8498fbac4fb8bfbe03e54cf7414e', 'ufx_bond_fee_limit', '转让手续费限制', '10', '2', TO_DATE('2016-11-17 10:50:51', 'YYYY-MM-DD HH24:MI:SS'), '1', '转让手续费限制（单位：%） - -PS :由平台和第三方签订的协议可做配置变更', '1');
INSERT INTO sys_config VALUES ('7', 'customer_hotline', '客户服务热线', '400-183-3666', '1', TO_DATE('2016-06-22 11:45:53', 'YYYY-MM-DD HH24:MI:SS'), '1', '客户服务热线', '1');
INSERT INTO sys_config VALUES ('7565546a5523419880eb1eebbf2c7faa', 'borrow_lowest_apr', '最低借款利率', '1', '2', TO_DATE('2016-06-29 11:00:39', 'YYYY-MM-DD HH24:MI:SS'), '1', '最低借款利率：1%', '1');
INSERT INTO sys_config VALUES ('762494463c6c4407bf8ef6aa73a8b4a3', 'free_overdue_day', '逾期？天内不收逾期罚息', '0', '2', TO_DATE('2016-10-22 11:14:21', 'YYYY-MM-DD HH24:MI:SS'), '1', '配置逾期不收逾期罚息最大天数', '1');
INSERT INTO sys_config VALUES ('76e44686c5b511e6817dfa163e88e3b3', 'tpp_account_id', 'TPP商户账户号', '01160708462', '2', TO_DATE('2016-12-19 14:36:25', 'YYYY-MM-DD HH24:MI:SS'), '1', 'TPP商户账户号', '0');
INSERT INTO sys_config VALUES ('7e0ef9e96ca946e1b0fef036fe23a712', 'account_lock_time', '账户锁定时间', '86400', '6', TO_DATE('2016-11-23 11:39:29', 'YYYY-MM-DD HH24:MI:SS'), '1', '单位为秒，账户锁定时间是指用户登录失败次数超过限制而被锁定的时长，超过该设置时间后即系统自动解锁。', '1');
INSERT INTO sys_config VALUES ('8', 'fax', '传真', '0571-85132616', '1', TO_DATE('2016-06-22 11:45:53', 'YYYY-MM-DD HH24:MI:SS'), '1', '用于网站显示公司传真', '1');
INSERT INTO sys_config VALUES ('85', 'auto_invest', '自动投资开关', '1', '2', TO_DATE('2016-06-22 11:45:53', 'YYYY-MM-DD HH24:MI:SS'), '1', '自动投资功能是否开启：1 开启；0 关闭', '1');
INSERT INTO sys_config VALUES ('86', 'notify_url', '回调地址', 'http://172.16.90.30:8080', '2', TO_DATE('2016-06-22 11:45:53', 'YYYY-MM-DD HH24:MI:SS'), '1', '测试使用，请不要在地址后面加/', '0');
INSERT INTO sys_config VALUES ('8672c9bc1d4c4f51bb584a8f32560a43', 'borrow_lowest_invest_account', '最低起投金额', '1', '2', TO_DATE('2016-08-30 16:04:22', 'YYYY-MM-DD HH24:MI:SS'), '1', '最低起投金额：1元', '1');
INSERT INTO sys_config VALUES ('87', 'config_online', '是否是在线生产环境', '0', '2', TO_DATE('2016-06-22 11:45:53', 'YYYY-MM-DD HH24:MI:SS'), '1', '是否开通线上环境配置', '0');
INSERT INTO sys_config VALUES ('8f08063beb7343d0b818147378f2887b', 'account_warn_contacts', '资金预警联系人', '13516711996,15825541499,13856911394,18042465087', '1', TO_DATE('2016-09-29 20:48:19', 'YYYY-MM-DD HH24:MI:SS'), '1', '资金预警联系人手机号，多个手机号为用半角,分开，如13899999999,13688888888(最多4个)', '1');
INSERT INTO sys_config VALUES ('9', 'web_index_qq', 'QQ群', '277288852', '1', TO_DATE('2016-06-22 11:45:53', 'YYYY-MM-DD HH24:MI:SS'), '1', '平台交流QQ群', '1');
INSERT INTO sys_config VALUES ('918adf4d8e9311e699af000c296f8d8c', 'protocolStyle', '协议类型', '1', '1', TO_DATE('2016-10-10 10:45:13', 'YYYY-MM-DD HH24:MI:SS'), '1', '1', '0');
INSERT INTO sys_config VALUES ('941019ea8068425ab52d3b70745b0a94', 'bond_prefix', '债权转让标名称前缀', '转让', '2', TO_DATE('2016-11-05 15:35:44', 'YYYY-MM-DD HH24:MI:SS'), '1', '债权转让标名称前缀', '1');
INSERT INTO sys_config VALUES ('98cf78301aa411e799bd408d5c073447', 'ftp_host', 'ftp主机ip', '221.239.93.145', '2', TO_DATE('2017-04-06 16:39:50', 'YYYY-MM-DD HH24:MI:SS'), '1', 'ftp主机ip', '0');
INSERT INTO sys_config VALUES ('98d1e2851aa411e799bd408d5c073447', 'ftp_port', 'ftp port', '21', '2', TO_DATE('2017-04-06 16:39:50', 'YYYY-MM-DD HH24:MI:SS'), '1', 'ftp port', '0');
INSERT INTO sys_config VALUES ('98d1e2d21aa411e799bd408d5c073447', 'ftp_username', 'ftp用户名', 'rongdu', '2', TO_DATE('2017-04-06 16:39:50', 'YYYY-MM-DD HH24:MI:SS'), '1', 'ftp用户名', '0');
INSERT INTO sys_config VALUES ('98d1e2e91aa411e799bd408d5c073447', 'ftp_password', 'ftp密码', 'rongdu', '2', TO_DATE('2017-04-06 16:39:50', 'YYYY-MM-DD HH24:MI:SS'), '1', 'ftp密码', '0');
INSERT INTO sys_config VALUES ('99', 'cash_need_audit', '提现是否需要取现复核', '1', '2', TO_DATE('2016-06-22 11:45:53', 'YYYY-MM-DD HH24:MI:SS'), '1', '汇付、双乾需要提现复核', '1');
INSERT INTO sys_config VALUES ('99be7591ac2546b8aa086465420ebf00', 'interest_manage_rate', '利息管理费', '0.2', '2', TO_DATE('2016-06-29 19:24:32', 'YYYY-MM-DD HH24:MI:SS'), '1', '利息管理费：0.2%', '1');
INSERT INTO sys_config VALUES ('9c7dc1ae0f2e48eeb10eb953c60cbc8b', 'days_of_month', '每月?天', '30', '2', TO_DATE('2016-07-21 09:55:52', 'YYYY-MM-DD HH24:MI:SS'), '1', '表示每月月均天数为30天，用于还款时计息的计算', '1');
INSERT INTO sys_config VALUES ('a3adfcaf4d174768b77b04fe6d58b918', 'account_type', '账户类型', '01', '2', TO_DATE('2016-08-09 11:50:01', 'YYYY-MM-DD HH24:MI:SS'), '1', '账户类型', '0');
INSERT INTO sys_config VALUES ('b03687c9e84f48978781819ce1502f2c', 'borrow_most_account', '最高借款金额', '50000000', '2', TO_DATE('2016-06-29 10:50:25', 'YYYY-MM-DD HH24:MI:SS'), '1', '最高借款金额', '1');
INSERT INTO sys_config VALUES ('b855aadbc69447c9a723a1bfb5ebd6b6', 'project_no_init_value', '项目编号初始值', '3000', '2', TO_DATE('2016-09-09 14:55:28', 'YYYY-MM-DD HH24:MI:SS'), '1', '项目编号初始值', '0');
INSERT INTO sys_config VALUES ('bd6f6c4f8ba14bc3bc81595ef5d3da08', 'open_first_invest', '投资/成立审核之后发放首投奖励', '0', '2', TO_DATE('2017-01-18 11:47:03', 'YYYY-MM-DD HH24:MI:SS'), '1', '1 成立审核之后发放首投奖励，0 投资之后发放首投奖励，默认0', '1');
INSERT INTO sys_config VALUES ('bd874da06ea04924a606cad55ee6396d', 'open_rabbitmq', '开启RabbitMQ异步服务', '1', '2', TO_DATE('2016-06-23 10:16:23', 'YYYY-MM-DD HH24:MI:SS'), '1', '开启RabbitMQ异步服务', '1');
INSERT INTO sys_config VALUES ('c06d3dfaf3354a739a8c70599eb2d513', 'login_error_flash_time', '登录失败次数刷新时间', '3600', '6', TO_DATE('2016-08-09 21:44:11', 'YYYY-MM-DD HH24:MI:SS'), '1', '单位为秒，统计登录失败次数的清零时间，即超过该时长后重新登录则重新开始统计登录失败次数。', '1');
INSERT INTO sys_config VALUES ('c2cd38fd45d8412c9cd0a2071500b2f8', 'message_resource_default_language', '资源默认语言', 'zh_CN', '2', TO_DATE('2017-03-15 16:07:13', 'YYYY-MM-DD HH24:MI:SS'), '1', '资源默认语言', '1');
INSERT INTO sys_config VALUES ('d65ae86cda44432585fa2ad4645441fc', 'recharge_min_amount', '单笔充值最小金额', '1', '2', TO_DATE('2016-08-10 16:24:37', 'YYYY-MM-DD HH24:MI:SS'), '1', '最小充值金额：1元', '1');
INSERT INTO sys_config VALUES ('e50705d539ba412fb5c817d551c486e3', 'auto_invest_min_usemoney', '用户开启自动投资最低可用金额', '100', '2', TO_DATE('2016-07-26 16:07:18', 'YYYY-MM-DD HH24:MI:SS'), '1', '用户开启自动投资最低可用金额', '1');
INSERT INTO sys_config VALUES ('eb2fde7b706c48069d61357a45fb8484', 'auto_invest_max_apr', '产品最大自动投资比率', '0.3', '2', TO_DATE('2016-07-26 16:05:59', 'YYYY-MM-DD HH24:MI:SS'), '1', '产品最大自动投资比率', '1');
INSERT INTO sys_config VALUES ('f53c5be0008345f8adc03d68cd8a3017', 'company_max_tender', '企业用户最多可投数', '100', '2', TO_DATE('2016-06-04 16:32:05', 'YYYY-MM-DD HH24:MI:SS'), '1', '企业用户最多可投数', '1');
INSERT INTO sys_config VALUES ('f53c5be0008345f8adc03d68cd8a4444', 'sign_type', '签名类型', 'e_sign', '2', TO_DATE('2016-07-16 13:31:15', 'YYYY-MM-DD HH24:MI:SS'), '1', '协议有关的签名，e_sign  是e签宝配置，cfca_sign是安心签配置，不是这两种则就是没有第三方签署', '1');
INSERT INTO sys_config VALUES ('fa2fe59b3a244a4baedc188777745211', 'send_code_flash_time', '短信验证码刷新时间', '60', '5', TO_DATE('2016-08-08 18:04:47', 'YYYY-MM-DD HH24:MI:SS'), '1', '时间单位为秒', '1');
INSERT INTO sys_config VALUES ('fa2fe59b3a244a4baedc188777745231', 'borrow_manage_rate', '借款管理费', '0.7', '2', TO_DATE('2016-06-29 19:23:25', 'YYYY-MM-DD HH24:MI:SS'), '1', '借款管理费：0.7%', '1');
...
INSERT INTO sys_config VALUES ('fb9273270af946d5bd8a80cc3d279d22', 'redenvelope_max_avail_period', '红包最大有效期（固定期）', '365', '2', TO_DATE('2016-09-27 20:11:46', 'YYYY-MM-DD HH24:MI:SS'), '1', '固定期红包可设置的最大有效期天数', '1');
INSERT INTO sys_config VALUES ('fb9273270af946d5bd8a80cc3d279d54', 'send_code_space_time', '发送验证码间隔时间', '60', '5', TO_DATE('2016-08-16 20:17:45', 'YYYY-MM-DD HH24:MI:SS'), '1', '发送验证码间隔时间', '1');
INSERT INTO sys_config VALUES ('200547df6a154a6984dbe0ffc4aa6835', 'ufx_test_url', 'UFX测试环境路径', 'http://ufx.web.rdtest.cn/ufx/main.html', '2', TO_DATE('2016-07-11 10:21:47', 'YYYY-MM-DD HH24:MI:SS'), '1', 'UFX测试环境路径，请不要在地址后面加/', '0');
INSERT INTO sys_config VALUES ('22e7d6a4badc11e6b0fefa163e2d23ab', 'tpp_service_name', '第三方支付（银行存管）服务类型', 'ufx', '1', TO_DATE('2016-12-05 19:15:32', 'YYYY-MM-DD HH24:MI:SS'), '1', null, '0');
INSERT INTO sys_config VALUES ('230e42c900d249fcad4177a941cfb41c', 'project_time_limit_max_year', '项目最长年限', '4', '1', TO_DATE('2016-11-02 16:59:22', 'YYYY-MM-DD HH24:MI:SS'), '1', '项目最长年限', '0');
INSERT INTO sys_config VALUES ('2340af41644b4134a47ebc3b7bda1465', 'sign_id', '签名商户的id', '1111563517', '2', TO_DATE('2016-07-19 11:40:16', 'YYYY-MM-DD HH24:MI:SS'), '1', '协议有关的签名，1111563517e签宝id，38814918D6336888E05311016B0A0B19安心签id', '1');
INSERT INTO sys_config VALUES ('2340af41644b4134a47ebc3b7bda1577', 'sign_secret', '签名商户的秘钥', '95439b0863c241c63a861b87d1e647b7', '2', TO_DATE('2016-07-19 11:43:07', 'YYYY-MM-DD HH24:MI:SS'), '1', '协议有关的签名，e签宝需要，安心签不需要 
95439b0863c241c63a861b87d1e647b7--e签报', '1');
INSERT INTO sys_config VALUES ('26', 'cash_single_day_time_limit', '提现-单日提现次数限制', '3', '2', TO_DATE('2016-06-22 11:45:53', 'YYYY-MM-DD HH24:MI:SS'), '1', '提现-单日提现次数限制：5次', '1');
INSERT INTO sys_config VALUES ('27', 'cash_single_max_amount_limit', '提现-单笔提现额度限制', '5000000', '2', TO_DATE('2016-06-22 11:45:53', 'YYYY-MM-DD HH24:MI:SS'), '1', '单笔提现最大额度：5000000元', '1');
INSERT INTO sys_config VALUES ('28', 'cash_single_day_max_amount_limit', '提现-单日提现额度限制', '5000000', '2', TO_DATE('2016-06-22 11:45:53', 'YYYY-MM-DD HH24:MI:SS'), '1', '单日提现额度：5000000元', '1');
INSERT INTO sys_config VALUES ('2a0b7b78775d422d85633766ef5f33ca', 'cash_fee_platform_advance', '提现手续费是否平台垫付', '0', '2', TO_DATE('2016-10-20 09:59:29', 'YYYY-MM-DD HH24:MI:SS'), '1', '1：平台垫付
0：个人支付', '1');
INSERT INTO sys_config VALUES ('2c1f361a3587405bae46fa23a16e1fb8', 'borrow_lowest_account', '最低借款金额', '300', '2', TO_DATE('2016-06-29 10:49:46', 'YYYY-MM-DD HH24:MI:SS'), '1', '最低借款金额：300元', '1');
INSERT INTO sys_config VALUES ('2c388d35be3e41c081b96e830a4ef621', 'invest_timeout', '投资订单有效时间', '10', '2', TO_DATE('2016-08-17 11:26:40', 'YYYY-MM-DD HH24:MI:SS'), '1', '单位：分钟', '1');
INSERT INTO sys_config VALUES ('32', 'overdue_fee', '逾期罚息利率', '0.0004', '2', TO_DATE('2016-06-22 11:45:53', 'YYYY-MM-DD HH24:MI:SS'), '1', '用于计算逾期需要支付的手续费， 此处值为真实值,不加% 号', '1');
INSERT INTO sys_config VALUES ('34f4267f8cb642daa1a9dbf481a87b38', 'bond_no_init_value', '债权项目编号初始值', '2000', '2', TO_DATE('2016-11-07 16:21:30', 'YYYY-MM-DD HH24:MI:SS'), '1', '债权项目编号初始值', '1');
INSERT INTO sys_config VALUES ('37', 'email_port', '邮箱地址端口号', '25', '3', TO_DATE('2016-06-22 11:45:53', 'YYYY-MM-DD HH24:MI:SS'), '1', '邮箱地址端口号', '1');
INSERT INTO sys_config VALUES ('38', 'email_host', 'SMTP服务器', 'smtp.erongdu.com', '3', TO_DATE('2016-06-22 11:45:53', 'YYYY-MM-DD HH24:MI:SS'), '1', 'SMTP服务器', '1');
INSERT INTO sys_config VALUES ('3819577e6d0211e6b37f000c293c07d6', 'tppName', '第三方名称', 'chinapnr', '1', TO_DATE('2016-08-28 17:31:37', 'YYYY-MM-DD HH24:MI:SS'), '1', '平台使用的第三方名称，chinapnr表示汇付天下；请勿随意更改（PS:若此值为汇付天下，则将影响业务授权、债权转让只能全额转让和全额受让）', '1');
INSERT INTO sys_config VALUES ('4', 'image_server_url', '图片服务器地址', 'http://172.16.90.30:8083', '1', TO_DATE('2016-06-22 11:45:53', 'YYYY-MM-DD HH24:MI:SS'), '1', '图片服务器，请不要在地址后面加/', '1');
INSERT INTO sys_config VALUES ('40', 'email_email', '邮箱地址', 'hj3@erongdu.com', '3', TO_DATE('2016-06-22 11:45:53', 'YYYY-MM-DD HH24:MI:SS'), '1', '发送系统邮件的邮箱帐号', '1');
INSERT INTO sys_config VALUES ('41', 'email_pwd', '邮箱密码', 'Erongdu@1234', '3', TO_DATE('2016-06-22 11:45:53', 'YYYY-MM-DD HH24:MI:SS'), '1', '发送系统邮件的邮箱密码', '1');
INSERT INTO sys_config VALUES ('42', 'email_from', '发件人Email', 'test@erongdu.com', '3', TO_DATE('2016-06-22 11:45:53', 'YYYY-MM-DD HH24:MI:SS'), '1', '发送系统邮件的邮箱帐号', '1');
INSERT INTO sys_config VALUES ('43', 'email_from_name', '发件人昵称或姓名', '互金3.0--您信赖的投资平台', '3', TO_DATE('2016-06-22 11:45:53', 'YYYY-MM-DD HH24:MI:SS'), '1', '发送系统邮件的昵称或姓名', '1');
INSERT INTO sys_config VALUES ('431ebc8412e84a6ba4a9c6755f469947', 'recharge_max_amount', '单笔充值最大金额', '100000000', '2', TO_DATE('2016-09-22 20:41:53', 'YYYY-MM-DD HH24:MI:SS'), '1', '单笔充值最大金额', '1');
INSERT INTO sys_config VALUES ('43447301d95d4ef5bcd16c05199babdb', 'cash_min_amount', '最小提现金额', '10', '2', TO_DATE('2016-08-10 21:29:34', 'YYYY-MM-DD HH24:MI:SS'), '1', '最小提现金额：10元', '1');
INSERT INTO sys_config VALUES ('44', 'sms_username', '短信接口用户名', 'Erongdu3', '4', TO_DATE('2016-06-22 11:45:53', 'YYYY-MM-DD HH24:MI:SS'), '1', '短信运营商提供用户名用来发送短信', '1');
INSERT INTO sys_config VALUES ('45', 'sms_password', '短信接口密码', 'Erongdu888', '4', TO_DATE('2016-06-22 11:45:53', 'YYYY-MM-DD HH24:MI:SS'), '1', '短信运营商提供密码用来发送短信', '1');
INSERT INTO sys_config VALUES ('46', 'sms_notice', '短信调用地址', 'http://www.ztsms.cn/sendNSms.do', '4', TO_DATE('2016-06-22 11:45:53', 'YYYY-MM-DD HH24:MI:SS'), '1', '短信调用地址用来发送短信', '1');
INSERT INTO sys_config VALUES ('47', 'sms_use_url', '查询短信可用条数接口', 'http://sendsms.irdsms.com/sent.html', '1', TO_DATE('2016-06-22 11:45:53', 'YYYY-MM-DD HH24:MI:SS'), '1', '查询短信可用条数接口，请不要在地址后面加/', '1');
INSERT INTO sys_config VALUES ('477260768c7a4e478bf588a4e0a081ff', 'days_of_year', '每年?天', '365', '2', TO_DATE('2016-07-21 09:55:02', 'YYYY-MM-DD HH24:MI:SS'), '1', '表示一年360天，每月按照30天计算，用于还款时计息的计算', '1');
INSERT INTO sys_config VALUES ('48', 'sms_used_url', '查询短信已用条数接口', 'http://sendsms.irdsms.com/sent.html', '3', TO_DATE('2016-06-22 11:45:53', 'YYYY-MM-DD HH24:MI:SS'), '1', '查询短信已用条数接口，请不要在地址后面加/', '0');
INSERT INTO sys_config VALUES ('49', 'verify_code_time', '短信、语音验证码有效期', '5', '5', TO_DATE('2016-06-22 11:45:53', 'YYYY-MM-DD HH24:MI:SS'), '1', '验证码有效期，单位为分', '1');
INSERT INTO sys_config VALUES ('4a7676fc1d9e4ab29a3aea48c25ecc6e', 'web_company', '公司名称', '杭州融都科技股份有限公司', '1', TO_DATE('2016-09-29 10:46:03', 'YYYY-MM-DD HH24:MI:SS'), '1', '公司名称', '1');
INSERT INTO sys_config VALUES ('4baec0ca9afc4f44870e9798c76ed0a8', 'cash_serv_fee', '提现服务费', '0.0005', '2', TO_DATE('2016-08-11 17:36:47', 'YYYY-MM-DD HH24:MI:SS'), '1', '按照比例收费', '1');
INSERT INTO sys_config VALUES ('4bb851a4c4824436aa41f02d55f6dce5', 'support_interest_financing', '是否支持即息理财', '1', '2', TO_DATE('2016-11-30 10:17:37', 'YYYY-MM-DD HH24:MI:SS'), '1', '是否支持即息理财', '1');
INSERT INTO sys_config VALUES ('4d6cfb543a884f36907f172863eec829', 'merchant_account', '平台账户', '01160708462', '2', TO_DATE('2016-08-18 21:41:12', 'YYYY-MM-DD HH24:MI:SS'), '1', '平台支付活动奖励给投资用户的结算账户', '0');
INSERT INTO sys_config VALUES ('5', 'static_resource_url', '静态资源服务器', 'http://172.16.90.30:8083', '2', TO_DATE('2016-06-22 11:45:53', 'YYYY-MM-DD HH24:MI:SS'), '1', 'http://10.0.5.103:54611，请不要在地址后面加/', '0');
INSERT INTO sys_config VALUES ('50', 'bank_num', '绑定银行卡数量', '5', '2', TO_DATE('2016-06-22 11:45:53', 'YYYY-MM-DD HH24:MI:SS'), '1', '用户绑定银行卡数量最大个数', '1');
INSERT INTO sys_config VALUES ('54', 'vip_open', '是否开启vip功能', '1', '2', TO_DATE('2016-06-22 11:45:53', 'YYYY-MM-DD HH24:MI:SS'), '1', '0：不开启，1：开启', '0');
INSERT INTO sys_config VALUES ('54c84337b640461e922d2743c6e721b6', 'default_user_pwd', '默认用户密码', 'abc1234567', '2', TO_DATE('2016-07-30 15:02:19', 'YYYY-MM-DD HH24:MI:SS'), '1', '后台新建个人用户，默认登录密码', '1');
INSERT INTO sys_config VALUES ('56', 'user_invest_redEnvelope_rate', '每笔投资使用红包最大百分比', '99', '2', TO_DATE('2016-06-22 11:45:53', 'YYYY-MM-DD HH24:MI:SS'), '1', '每笔投资使用红包总额占投资总额最大百分比,小于100', '1');
INSERT INTO sys_config VALUES ('56787f7501a24f2ab7f88bf2afe67716', 'auto_invest_vip_flag', 'VIP等级优先自动投资', '1', '2', TO_DATE('2016-10-31 10:13:16', 'YYYY-MM-DD HH24:MI:SS'), '1', 'VIP等级优先自动投资0.未启用1启用', '1');
...
uuid NVARCHAR2(32) NOT NULL ,
dict_type NVARCHAR2(64) NOT NULL ,
item_name NVARCHAR2(64) NOT NULL ,
item_value NVARCHAR2(128) NULL ,
create_time DATE NULL ,
sort NUMBER(11) NULL ,
status CHAR(1) NULL ,
remark NVARCHAR2(512) NULL ,
expression NVARCHAR2(128) NULL 
)
LOGGING
NOCOMPRESS
NOCACHE
...
COMMENT ON COLUMN sys_dict_data.uuid IS '主键';
COMMENT ON COLUMN sys_dict_data.dict_type IS '字典类型';
COMMENT ON COLUMN sys_dict_data.item_name IS '字典项名称';
COMMENT ON COLUMN sys_dict_data.item_value IS '字典项值';
COMMENT ON COLUMN sys_dict_data.create_time IS '创建时间';
COMMENT ON COLUMN sys_dict_data.sort IS '排序';
COMMENT ON COLUMN sys_dict_data.status IS '启用状态(1 启用，0停用)';
COMMENT ON COLUMN sys_dict_data.remark IS '备注';
COMMENT ON COLUMN sys_dict_data.expression IS '表达式';

-- ----------------------------
-- Records of sys_dict_data
-- ----------------------------
INSERT INTO sys_dict_data VALUES ('00d0e09e32eb495bbee024219910ec12', 'sysLogContent', '角色权限', 'role_perms', null, '77', '1', null, null);
INSERT INTO sys_dict_data VALUES ('00fd0febff334b6fa2dd71b5407bdc5b', 'interestStyle', '成立计息', '1', null, '1', '1', '成立计息', null);
INSERT INTO sys_dict_data VALUES ('01418f8d1f12469aaad399a41860ef75', 'YesNo', '否', '0', null, '2', '1', null, null);
INSERT INTO sys_dict_data VALUES ('0141c7f236904c859752a728fd831eca', 'sysLogMethod', '查询', 'query', null, '1', '1', null, null);
INSERT INTO sys_dict_data VALUES ('0162d92ed9a94d14b6216c65c9bbf637', 'bondStatus', '转让完成', '3', null, '1', '1', '转让完成', null);
INSERT INTO sys_dict_data VALUES ('016a83e0c9af4328836eef5a6e66f277', 'menuIcon', '&lt;em class=&quot;iconfont&quot;&gt;&amp;#xe62b;&lt;/em&gt;', '&amp;#xe62b;', null, '19', '1', null, null);
INSERT INTO sys_dict_data VALUES ('02a65a5426a74cbd9deece7d591290eb', 'sysLogContent', '参数配置', 'config', null, '63', '1', null, null);
INSERT INTO sys_dict_data VALUES ('03284e056c6d4694a44d7d161ec3a3f1', 'sysLogContent', '邀请奖励', 'user_invite_award', null, '84', '1', null, null);
INSERT INTO sys_dict_data VALUES ('03a003fed8474a09bab1cad1d195c20c', 'sysLogContent', '账户日志', 'accountlog_list', null, '3', '1', null, null);
INSERT INTO sys_dict_data VALUES ('03e5d313b15543d7807b6aa198d4efb5', 'menuIcon', '&lt;em class=&quot;iconfont&quot;&gt;&amp;#xe618;&lt;/em&gt;', '&amp;#xe618;', null, '25', '1', null, null);
INSERT INTO sys_dict_data VALUES ('0441420041714d34890351ae441be246', 'userType', '担保机构', '3', null, '3', '1', null, null);
INSERT INTO sys_dict_data VALUES ('046eb4f27f504f8992ebdb1b15f18c92', 'sysLogContent', '借款下架', 'borrow_stop', null, '26', '1', null, null);
INSERT INTO sys_dict_data VALUES ('0506faa91167482493ad4789741fa8cf', 'bondInvestStatus', '受让失败', '2', null, '3', '1', '受让失败', null);
INSERT INTO sys_dict_data VALUES ('061dba46c3e442148a5ea48f48cb9cfd', 'sex', '男', '1', null, '1', '1', null, null);
INSERT INTO sys_dict_data VALUES ('07001c0c198c4049be37f8935ffc4737', 'workExperience', '25年以上', '7', null, '7', '0', null, null);
INSERT INTO sys_dict_data VALUES ('07fd2dbc60c54b26af11a887324fc2ef', 'productStatus', '成立待审', '5', null, '6', '1', null, null);
INSERT INTO sys_dict_data VALUES ('0818fae9c0ef4a74811d2886081514ae', 'productTimeLimit', '6个月以下', '1', null, '2', '1', null, null);
...
INSERT INTO sys_dict_data VALUES ('0b90e3336c7b4909bed88622d9f77022', 'investStatus', '投资成功', '1', null, '3', '1', null, null);
INSERT INTO sys_dict_data VALUES ('0c031f5038a04466b7993b75332d5832', 'sysLogContent', '红包', 'user_red', null, '51', '1', null, null);
INSERT INTO sys_dict_data VALUES ('0d52cbf52db948f3a1d1b1c41455e58c', 'sysLogContent', '组织机构', 'org', null, '74', '1', null, null);
INSERT INTO sys_dict_data VALUES ('0dc0f6004f97431a860af6880e7289c7', 'sysLogContent', '数据字典', 'dict', null, '64', '1', null, null);
INSERT INTO sys_dict_data VALUES ('0e7170b34c66491187d8efa47e7aa99b', 'sysLogContent', '投资列表', 'invest_record', null, '32', '1', null, null);
INSERT INTO sys_dict_data VALUES ('0e920fd35f234369ab1fcea54232cf19', 'investType', '手动投资', '0', null, '1', '1', null, null);
...
INSERT INTO sys_dict_data VALUES ('114eba1180aa48d291827ed5dfdca99f', 'sysLogContent', '后台用户', 'operator', null, '72', '1', null, null);
INSERT INTO sys_dict_data VALUES ('1179b9648b1545e19e57e4c66f7d4b6d', 'bondMoneyType', '小于10000元', '1', null, '1', '1', '小于10000元', 'n < 10000');
INSERT INTO sys_dict_data VALUES ('12393fd7cc2244698fb3e5095e2ea8f8', 'user_security_question', '您哥哥的姓名？', 'question_brother_name', null, '4', '1', null, null);
...
INSERT INTO sys_dict_data VALUES ('13909cb92fc842ec9004ba25c55f6ff9', 'menuIcon', '&lt;em class=&quot;iconfont&quot;&gt;&amp;#xe612;&lt;/em&gt;', '&amp;#xe612;', null, '13', '1', null, null);
...
INSERT INTO sys_dict_data VALUES ('148295ffbcae4e7182ea746e55d301d7', 'sysLogContent', '协议', 'protocol', null, '55', '1', null, null);
INSERT INTO sys_dict_data VALUES ('14d532773bc44b9db2c500b65c29a392', 'sysLogMethod', '冻结/解冻', 'freeze', null, '9', '1', null, null);
INSERT INTO sys_dict_data VALUES ('15600c3359a9483b8b4fd3dd5aa90c6c', 'bondStatus', '转让中', '0', null, '2', '1', '转让中', null);
INSERT INTO sys_dict_data VALUES ('15ed787af2f8486aa4878a3fa1efd2a3', 'sysLogContent', '资质认证', 'user_qualification', null, '87', '1', null, null);
INSERT INTO sys_dict_data VALUES ('16b01f693c2b41a49551144939cd2f70', 'menuIcon', '&lt;em class=&quot;iconfont&quot;&gt;&amp;#xe616;&lt;/em&gt;', '&amp;#xe616;', null, '29', '1', null, null);
INSERT INTO sys_dict_data VALUES ('1716a765052e4a08a1cc628357da64ea', 'test', '类型2', '2', null, '2', '1', null, null);
INSERT INTO sys_dict_data VALUES ('171d341d285645ed9dab1f68b82a35ca', 'productStatus', '待上架', '40', null, '3', '1', null, null);
INSERT INTO sys_dict_data VALUES ('173ba885f87d46a788c80e4c22b2c680', 'accountBank', '建设银行', 'CCB', null, '5', '1', null, null);
INSERT INTO sys_dict_data VALUES ('178fe6173f624cd09a37a7a3942afa42', 'repayStyle', '等额本金', '4', null, '4', '1', '等额本金', null);
INSERT INTO sys_dict_data VALUES ('17c73df783e04fd69be765b7b4e18b26', 'amountCondition', '1万元以下', '1', null, '1', '1', null, 'n<=10000');
INSERT INTO sys_dict_data VALUES ('17d2f83302974232bb13e1e096f29a25', 'menuIcon', '&lt;em class=&quot;iconfont&quot;&gt;&amp;#xe624;&lt;/em&gt;', '&amp;#xe624;', null, '38', '1', null, null);
INSERT INTO sys_dict_data VALUES ('17f5a753ce5340288ffa6f6d506d79f4', 'productStatus', '募集中', '4', null, '5', '1', null, null);
INSERT INTO sys_dict_data VALUES ('18dcc9f5c85140eabbbc0c57323d8c9b', 'userStatus', '冻结', '-1', null, '2', '1', null, null);
INSERT INTO sys_dict_data VALUES ('18df2887203c42ac84fee39742ea0ac5', 'amountCondition', '5~10万元', '3', null, '3', '1', null, '50000<n && n<=100000');
INSERT INTO sys_dict_data VALUES ('18fb69fc1ca449da8556fa3d85a2d349', 'menuIcon', '&lt;em class=&quot;iconfont&quot;&gt;&amp;#xe626;&lt;/em&gt;', '&amp;#xe626;', null, '37', '1', null, null);
INSERT INTO sys_dict_data VALUES ('19', 'accountType', '借款手续费', 'borrow_fee', null, '2', '1', null, null);
INSERT INTO sys_dict_data VALUES ('190f6a7849a444789801d1542b0a75eb', 'sysLogContent', '提现审核', '提现列表', null, '11', '1', null, null);
INSERT INTO sys_dict_data VALUES ('198aae9daf734ec9b42ead7efa1fc29c', 'tppType', '放款', 'loan', null, '2', '1', null, null);
INSERT INTO sys_dict_data VALUES ('1a089eb4351446e0b4263c70d886dcef', 'timeType', '月', '0', null, '0', '1', null, null);
...
INSERT INTO sys_dict_data VALUES ('1bb7234cb22d4a179b6dc7e7e28c13ae', 'configType', '网站管理', '1', TO_DATE('2016-09-26 13:41:37', 'YYYY-MM-DD HH24:MI:SS'), '1', '1', '网站管理', null);
...
INSERT INTO sys_dict_data VALUES ('1da47388c0434cba857c95d1ba2c67e2', 'configType', '短信', '4', TO_DATE('2016-09-26 13:41:37', 'YYYY-MM-DD HH24:MI:SS'), '4', '1', '短信', null);
...
INSERT INTO sys_dict_data VALUES ('1dde9bfc84d1488a98d0103a564a05cf', 'sysLogContent', '逾期记录', 'repayment_overdue', null, '41', '1', null, null);
INSERT INTO sys_dict_data VALUES ('1e7fd3afa8a7449dabeb96051a3edc68', 'bondInvestStatus', '超时取消', '3', null, '4', '1', '超时取消', null);
INSERT INTO sys_dict_data VALUES ('1eab8f654f2446078204fc7c0088881c', 'accountType', '提现待审核', 'cash_audit', null, '4', '1', null, null);
INSERT INTO sys_dict_data VALUES ('2e7159525d464f228efbaad1e8a12e1f', 'accountBank', '招商银行', 'CMB', null, '3', '1', null, null);
INSERT INTO sys_dict_data VALUES ('2fee84c1f8444b10ae1090b56d13a5e6', 'menuIcon', '&lt;em class=&quot;iconfont&quot;&gt;&amp;#xe61e;&lt;/em&gt;', '&amp;#xe61e;', null, '33', '1', null, null);
INSERT INTO sys_dict_data VALUES ('2ff0fa4531c446d6ab200a521fc21003', 'sysLogContent', '借款记录', 'borrow_record', null, '28', '1', null, null);
INSERT INTO sys_dict_data VALUES ('300', 'accountType', '逾期利息收回', 'collect_late_interest', null, '61', '1', null, null);
INSERT INTO sys_dict_data VALUES ('300916be14c14e6cb6de98115beff343', 'menuIcon', '&lt;em class=&quot;iconfont&quot;&gt;&amp;#xe621;&lt;/em&gt;', '&amp;#xe621;', null, '27', '1', null, null);
INSERT INTO sys_dict_data VALUES ('30912d3620d641ad8b21260e9622ae99', 'realizeStatus', '已还款', '9', null, '3', '1', null, null);
INSERT INTO sys_dict_data VALUES ('3194c4217cf3416b99c8bdc0934cb97c', 'projectStatus', '成立待审', '5', null, '10', '1', '成立待审', null);
INSERT INTO sys_dict_data VALUES ('3346582cfe9346fb9ba74a8aa3036f7c', 'activityLogStatus', '未使用', '0', null, '0', '1', null, null);
INSERT INTO sys_dict_data VALUES ('336f00e458994d6bbd9a53e6adf36dfe', 'companyQualificationType', '其它', 'other', null, '3', '1', null, null);
INSERT INTO sys_dict_data VALUES ('33b99df496ea424385c7de4d6a83b021', 'repayStatus', '已还款', '1', null, '2', '1', null, null);
...
INSERT INTO sys_dict_data VALUES ('35c93b513c294b2da8f117829a50151c', 'menuIcon', '&lt;em class=&quot;iconfont&quot;&gt;&amp;#xe601;&lt;/em&gt;', '&amp;#xe601;', null, '5', '1', null, null);
INSERT INTO sys_dict_data VALUES ('36', 'accountType', '解冻资金', 'unfreeze', null, '36', '1', null, null);
INSERT INTO sys_dict_data VALUES ('36f2edf493d24dc59d0e2ed4fd73ed81', 'sysLogContent', '债权列表', 'bond_list', null, '15', '1', null, null);
...
INSERT INTO sys_dict_data VALUES ('37a2e466ff364fa881d6f150fa74fbb1', 'sysLogContent', '平台提现', 'merchant_cash', null, '6', '1', null, null);
INSERT INTO sys_dict_data VALUES ('38', 'accountType', '提现成功', 'cash_success', null, '41', '1', null, null);
INSERT INTO sys_dict_data VALUES ('3835f2e89cd340f4932ec0fe3146e3aa', 'userFreeze', '充值', 'recharge', null, '1', '1', null, null);
INSERT INTO sys_dict_data VALUES ('38363f34cf97473bb074ef8478114247', 'realizeAmountCondition', '10万元以上', '4', null, '4', '1', null, 'n &gt; 100000');
INSERT INTO sys_dict_data VALUES ('39', 'accountType', '提现失败', 'cash_fail', null, '42', '1', null, null);
INSERT INTO sys_dict_data VALUES ('3915a45dc120494aa9616f43331667dc', 'bespeakStatus', '已回访', '1', null, '2', '1', null, null);
INSERT INTO sys_dict_data VALUES ('392760fd152440618778d62728b162e3', 'sysLogContent', '平台充值', 'merchant_recharge', null, '5', '1', null, null);
INSERT INTO sys_dict_data VALUES ('3a03dd071aa411e799bd408d5c073447', 'cbhb_bank_card', '平安银行', 'PAB', null, '12', '1', '平安银行', null);
INSERT INTO sys_dict_data VALUES ('3a0d94961aa411e799bd408d5c073447', 'cbhb_bank_card', '建设银行', 'CCB', null, '4', '1', '建设银行', null);
INSERT INTO sys_dict_data VALUES ('3a1be2a81aa411e799bd408d5c073447', 'cbhb_bank_card', '农行', 'ABC', null, '2', '1', '农行', null);
INSERT INTO sys_dict_data VALUES ('3a22e104a91441ce82e5d432a4368f8d', 'account_type', '代收本金', 'wait_capital', null, '1', '1', '12', null);
INSERT INTO sys_dict_data VALUES ('3a3f9b271aa411e799bd408d5c073447', 'cbhb_bank_card', '民生银行', 'CMBC', null, '7', '1', '民生银行', null);
INSERT INTO sys_dict_data VALUES ('3a4a3d181aa411e799bd408d5c073447', 'cbhb_bank_card', '渤海银行', 'CBHB', null, '9', '1', '渤海银行', null);
INSERT INTO sys_dict_data VALUES ('3a539e7b1aa411e799bd408d5c073447', 'cbhb_bank_card', '交通银行', 'BCOM', null, '6', '1', '交通银行', null);
INSERT INTO sys_dict_data VALUES ('3a60bd3e1aa411e799bd408d5c073447', 'cbhb_bank_card', '工商银行', 'ICBC', null, '1', '1', '工商银行', null);
INSERT INTO sys_dict_data VALUES ('3a6a64601aa411e799bd408d5c073447', 'cbhb_bank_card', '广发银行', 'GDB', null, '10', '1', '广发银行', null);
INSERT INTO sys_dict_data VALUES ('3a78e3221aa411e799bd408d5c073447', 'cbhb_bank_card', '招行', 'CMB', null, '3', '1', '招行', null);
INSERT INTO sys_dict_data VALUES ('3a81adf31aa411e799bd408d5c073447', 'cbhb_bank_card', '兴业银行', 'CIB', null, '8', '1', '兴业银行', null);
INSERT INTO sys_dict_data VALUES ('3a8aa1721aa411e799bd408d5c073447', 'cbhb_bank_card', '中国银行', 'BOC', null, '5', '1', '中国银行', null);
INSERT INTO sys_dict_data VALUES ('3a97618b1aa411e799bd408d5c073447', 'cbhb_bank_card', '上海浦东发展银行', 'SPDB', null, '14', '1', '上海浦东发展银行', null);
INSERT INTO sys_dict_data VALUES ('3aa034391aa411e799bd408d5c073447', 'cbhb_bank_card', '华夏银行', 'HXB', null, '11', '1', '华夏银行', null);
INSERT INTO sys_dict_data VALUES ('3aa08a9a773d45a7bbc4fb61adbb1048', 'papers_type', '答题', '2', null, '1', '1', '答题', null);
INSERT INTO sys_dict_data VALUES ('3aa901581aa411e799bd408d5c073447', 'cbhb_bank_card', '光大银行', 'CEB', null, '15', '1', '光大银行', null);
INSERT INTO sys_dict_data VALUES ('3ab25c721aa411e799bd408d5c073447', 'cbhb_bank_card', '邮储银行', 'PSBC', null, '13', '1', '邮储银行', null);
INSERT INTO sys_dict_data VALUES ('3abaf8161aa411e799bd408d5c073447', 'cbhb_transStat', 'S3', '放款解冻', null, '9', '1', '放款解冻', null);
INSERT INTO sys_dict_data VALUES ('3ac5575b1aa411e799bd408d5c073447', 'cbhb_transStat', 'F2', '撤标解冻失败', null, '7', '1', '撤标解冻失败', null);
INSERT INTO sys_dict_data VALUES ('3acde7e41aa411e799bd408d5c073447', 'cbhb_transStat', 'C1', '初始化', null, '2', '1', '初始化', null);
INSERT INTO sys_dict_data VALUES ('3ad6a7501aa411e799bd408d5c073447', 'cbhb_transStat', 'O1', '其他', null, '10', '1', '其他', null);
INSERT INTO sys_dict_data VALUES ('3aeefebb1aa411e799bd408d5c073447', 'cbhb_transStat', 'W4', '银行受理成功', null, '4', '1', '银行受理成功', null);
INSERT INTO sys_dict_data VALUES ('3af82ebc1aa411e799bd408d5c073447', 'cbhb_transStat', 'S1', '交易成功,已清分', null, '1', '1', '交易成功,已清分', null);
INSERT INTO sys_dict_data VALUES ('3b00f6331aa411e799bd408d5c073447', 'cbhb_transStat', 'B1', '部分成功,部分冻结', null, '8', '1', '部分成功,部分冻结', null);
INSERT INTO sys_dict_data VALUES ('3b0ce6321aa411e799bd408d5c073447', 'cbhb_transStat', 'F1', '交易失败,未清分', null, '5', '1', '交易失败,未清分', null);
INSERT INTO sys_dict_data VALUES ('3b1c03961aa411e799bd408d5c073447', 'cbhb_transStat', 'W3', '请求处理中', null, '3', '1', '请求处理中', null);
INSERT INTO sys_dict_data VALUES ('3b2cda6c1aa411e799bd408d5c073447', 'cbhb_transStat', 'S2', '撤标解冻成功', null, '6', '1', '撤标解冻成功', null);
INSERT INTO sys_dict_data VALUES ('3c4bdeff39b944df8842446a55114faa', 'projectStatus', '成立审核成功', '6', null, '11', '1', '成立审核成功', null);
INSERT INTO sys_dict_data VALUES ('3c9f1f57ebab40ae91e40a8519ef04f5', 'borrowStatus', '已作废', '30', null, '13', '1', null, null);
INSERT INTO sys_dict_data VALUES ('3d972579a5ee4a6a9dca38d4f1a015fa', 'sysLogContent', '平台给用户转账', 'merchant_transfer', null, '7', '1', null, null);
INSERT INTO sys_dict_data VALUES ('3e8f113ed6214d3bb09210ba089f1a8b', 'sysLogContent', '垫付记录', 'repayment_advance', null, '42', '1', null, null);
INSERT INTO sys_dict_data VALUES ('3ef2cc3406ef4f7cb56233d8290825a4', 'accountType', '冻结已变现本金', 'freeze_realize_capital', null, '90', '1', null, null);
...
INSERT INTO sys_dict_data VALUES ('4197e25c24b34cc7b9c479019079b2cf', 'sysLogContent', '风险问卷', 'risk_paper', null, '60', '1', null, null);
INSERT INTO sys_dict_data VALUES ('41d9ef1e085c405188d8c0991d21144d', 'qualificationApplyStatus', '审核不通过', '2', null, '3', '1', null, null);
INSERT INTO sys_dict_data VALUES ('42', 'accountType', '利息收回', 'collect_interest', null, '45', '1', null, null);
INSERT INTO sys_dict_data VALUES ('4331e125a9b9448fa46b577792adab2d', 'menuIcon', '&lt;em class=&quot;iconfont&quot;&gt;&amp;#xe61a;&lt;/em&gt;', '&amp;#xe61a;', null, '26', '1', null, null);
...
INSERT INTO sys_dict_data VALUES ('448d63792c1947dab3b2cdb6bca0cf6e', 'cardType', '身份证', '1', null, '1', '1', null, null);
INSERT INTO sys_dict_data VALUES ('449e9fc7b1734975bc5b391a5e3a7254', 'sysLogContent', '转让记录', 'bond_invest_list', null, '14', '1', null, null);
INSERT INTO sys_dict_data VALUES ('44cb3289ba9d4858af25ca6991807236', 'companyQualificationType', '企业证照', 'licence', null, '1', '1', null, null);
INSERT INTO sys_dict_data VALUES ('44eaa4a43c6c4a70bc6f006d8b995238', 'salaryRange', '80-100万', '10', null, '10', '1', null, null);
...
INSERT INTO sys_dict_data VALUES ('455b9b5d805c411ab92af87c3d603b12', 'sysLogContent', '用户vip', 'user_vip', null, '54', '1', null, null);
INSERT INTO sys_dict_data VALUES ('46676cedc35a4e4593cab2d39da50fa9', 'sysLogContent', '用户', 'user', null, '85', '1', null, null);
INSERT INTO sys_dict_data VALUES ('46d3c1f00373496489c545951f6efe9f', 'menuIcon', '&lt;em class=&quot;iconfont&quot;&gt;&amp;#xe622;&lt;/em&gt;', '&amp;#xe622;', null, '31', '1', null, null);
INSERT INTO sys_dict_data VALUES ('48b3653fa2dc4adf823ec4e375c9c4aa', 'sysLogContent', '借款上架', 'borrow_sale', null, '25', '1', null, null);
INSERT INTO sys_dict_data VALUES ('49a9f6785c0b4c388efe22a7923c7fe9', 'timeType', '天', '1', null, '1', '1', null, null);
INSERT INTO sys_dict_data VALUES ('4a5386a9c20c45fd86184ddd4bb3c163', 'sysLogMethod', '审核', 'audit', null, '11', '1', null, null);
INSERT INTO sys_dict_data VALUES ('4a99388fc4ef4ed98fc4bda8e396704f', 'sysLogMethod', '新增', 'add', null, '3', '1', null, null);
INSERT INTO sys_dict_data VALUES ('4baa5be31aa44d0fa103fe3495591f99', 'RealizeSellStyle', '全额变现', '1', null, '1', '1', null, null);
INSERT INTO sys_dict_data VALUES ('4bb2c8b785764ee4927f36b24b9efa71', 'salaryRange', '8-10万', '4', null, '4', '1', '8000-10000', null);
INSERT INTO sys_dict_data VALUES ('4cd78d98989540919f0a9917064ff040', 'sysLogContent', '风险问题', 'risk_question', null, '61', '1', null, null);
INSERT INTO sys_dict_data VALUES ('4f2373dbb55f4186a34c558b1d7b9ee0', 'userType', '个人用户', '1', null, '1', '1', null, null);
...
INSERT INTO sys_dict_data VALUES ('51ae37496e2248aa84fe75748ac980d4', 'timeCondition', '6~12个月', '4', null, '4', '1', null, null);
INSERT INTO sys_dict_data VALUES ('51e1c4d55843439089d64bb6096350f1', 'carStatus', '无', '0', null, '1', '1', null, null);
INSERT INTO sys_dict_data VALUES ('52331de3fecf460faa2b039d97e4d26d', 'platAccountType', '垫付红包', '8', null, '8', '1', null, null);
INSERT INTO sys_dict_data VALUES ('526ed01a84c148fb81b716e438c76ebb', 'menuIcon', '&lt;em class=&quot;iconfont&quot;&gt;&amp;#xe60e;&lt;/em&gt;', '&amp;#xe60e;', null, '17', '1', null, null);
INSERT INTO sys_dict_data VALUES ('52e84178205d4148b511dabecfe13c04', 'logTemplateType', '资金日志', '1', null, '1', '1', null, null);
INSERT INTO sys_dict_data VALUES ('5302d2fa8e884012aba115a574c9521d', 'user_security_question', '您父亲的姓名？', 'question_father_name', null, '2', '1', null, null);
INSERT INTO sys_dict_data VALUES ('533a7f6a9a2540f7b4005ae44e614c8c', 'tppType', '投资撤销', 'investFail', null, '1', '1', null, null);
INSERT INTO sys_dict_data VALUES ('537c6b3d73eb4f7da6d1a3762d995f60', 'sysLogContent', '用户积分', 'user_score', null, '48', '1', null, null);
INSERT INTO sys_dict_data VALUES ('53898c7b7d2f417f97735407b43001be', 'sendStatus', '新建', '0', TO_DATE('2016-06-22 16:32:37', 'YYYY-MM-DD HH24:MI:SS'), '1', '0', '新建状态', null);
INSERT INTO sys_dict_data VALUES ('53b5a40971bc4accaa62d32955dd1929', 'sysLogMethod', '下载', 'download', null, '8', '1', null, null);
INSERT INTO sys_dict_data VALUES ('53dbe1fdfa6d46ce8277d83674352b33', 'houseStatus', '无', '0', null, '1', '1', null, null);
INSERT INTO sys_dict_data VALUES ('53eb1e8cfc504117a5285d2cd551b5c7', 'bespeakLimitTime', '1-3个月', '1', null, '1', '1', null, null);
INSERT INTO sys_dict_data VALUES ('5458a3885bbc49fca2962c2bd280c76b', 'bespeakStatus', '不回访', '2', null, '3', '1', null, null);
INSERT INTO sys_dict_data VALUES ('54a3f9a0dfc142afa3f1f15b9f905e36', 'menuIcon', '&lt;em class=&quot;iconfont&quot;&gt;&amp;#xe613;&lt;/em&gt;', '&amp;#xe613;', null, '2', '1', null, null);
INSERT INTO sys_dict_data VALUES ('553c95b3a74a492190c27c5e4263eda7', 'projectStatus', '募集中', '4', null, '8', '1', '募集中', null);
INSERT INTO sys_dict_data VALUES ('5555e5555c9c4c249aea32489e931bbe', 'timeCondition', '1-3个月', '2', null, '2', '1', null, null);
INSERT INTO sys_dict_data VALUES ('562424d5cd33480c9320bdddc1788c5e', 'investStatus', '待支付', '0', null, '1', '1', null, null);
INSERT INTO sys_dict_data VALUES ('5716b2b402f7421abbb85def516c47e9', 'amountCondition', '1~5万元', '2', null, '2', '1', null, '10000<n && n<=50000');
INSERT INTO sys_dict_data VALUES ('5735958fa5e4467f84b8eb94820b9cca', 'accountType', '投资失败', 'invest_unfreeze', null, '6', '1', null, null);
INSERT INTO sys_dict_data VALUES ('579e8b34257b4d84b62e081b1caff489', 'accountType', '逾期利息给平台', 'repaid_merchant_late_interest', null, '0', '1', null, null);
INSERT INTO sys_dict_data VALUES ('588d1d46216c4b668faebea0e69ccc7a', 'maritalStatus', '丧偶', '3', null, '4', '1', null, null);
INSERT INTO sys_dict_data VALUES ('58cf95d8427a4fb08cf73d7c67f28c55', 'YesNo', '是', '1', null, '1', '1', null, null);
INSERT INTO sys_dict_data VALUES ('58e5609e76ac42138733a8e594f43e26', 'menuIcon', '&lt;em class=&quot;iconfont&quot;&gt;&amp;#xe625;&lt;/em&gt;', '&amp;#xe625;', null, '35', '1', null, null);
INSERT INTO sys_dict_data VALUES ('590ad24e368141409f8f234e41e7d343', 'accountBank', '广发银行', 'GDB', null, '12', '1', null, null);
...
INSERT INTO sys_dict_data VALUES ('5a3927e4ef2f4f289ad4dfd0cb13b9ce', 'vouchFreeze', '提现', 'cash', null, '2', '1', null, null);
...
INSERT INTO sys_dict_data VALUES ('5bef7235dc2c4df18a6bf543a3a9bf47', 'borrowNature', '个人借款', '1', null, '1', '1', null, null);
INSERT INTO sys_dict_data VALUES ('5c14740c805e45d99d7258492fe3da9c', 'productStatus', '未成立', '7', null, '7', '1', null, null);
INSERT INTO sys_dict_data VALUES ('5c451c939f3f44d9b0f10b828643be93', 'saleStyle', '按份额', '2', null, '2', '1', '按份额', null);
INSERT INTO sys_dict_data VALUES ('5c77c23c30164df3a0047117c86b1854', 'userFreeze', '提现', 'cash', null, '2', '1', null, null);
INSERT INTO sys_dict_data VALUES ('5c9e5c669ad74473a05adc3d571263ca', 'accountType', '变现金额入账', 'realize_income', null, '76', '1', null, null);
INSERT INTO sys_dict_data VALUES ('5da5fbb98191424ab0ab2fabdb5993d5', 'borrowStatus', '待售', '41', null, '6', '1', null, null);
INSERT INTO sys_dict_data VALUES ('5dc1d924875f414fa7f161b3c3701f18', 'borrowUse', '测试用途', '测试用途', null, '6', '1', '6', null);
INSERT INTO sys_dict_data VALUES ('5e2afdd223844a47a882a40c5198089a', 'rechargeStatus', '充值失败', '2', null, '2', '1', null, null);
...
INSERT INTO sys_dict_data VALUES ('6030da48f82e43468c4ebf96f95fc744', 'investStatus', '投资失败', '2', null, '4', '1', null, null);
...
INSERT INTO sys_dict_data VALUES ('627e7993b8714f9f9c5391401d443ec2', 'vipLevel', 'VIP4及以上', '4', null, '4', '1', null, null);
...
INSERT INTO sys_dict_data VALUES ('6426a7311c6543978bca5a03a8b6693f', 'sysLogContent', '用户积分记录', 'user_score_log', null, '49', '1', null, null);
INSERT INTO sys_dict_data VALUES ('6537e980098f4f84a165e1ec17d3c93f', 'rechargePayWay', '网银充值', '0', null, '1', '1', '网银充值', null);
INSERT INTO sys_dict_data VALUES ('657d5fc60a024ec8bd2481bb7f992f67', 'user_security_question', '您母亲的姓名？', 'question_mother_name', null, '1', '1', null, null);
INSERT INTO sys_dict_data VALUES ('65c6b686e91d472f967b1c95e426dba8', 'timeCondition', '1个月以下', '1', null, '1', '1', null, null);
INSERT INTO sys_dict_data VALUES ('66c254849bc54631a1122c0947c58361', 'orgLevel', '二级', '1', null, '2', '1', null, null);
INSERT INTO sys_dict_data VALUES ('6797e4ff774b40ad9c6acdc944ed35ec', 'productStatus', '发布待审', '1', null, '0', '1', null, null);
INSERT INTO sys_dict_data VALUES ('67a69d8d7bfd4f86a27bd502e73f1b2c', 'accountBank', '兴业银行', 'CIB', null, '9', '1', null, null);
INSERT INTO sys_dict_data VALUES ('67ef4715946f44458a0048f89e1506e1', 'sysLogContent', '提现列表', 'cash_list', null, '10', '1', null, null);
INSERT INTO sys_dict_data VALUES ('68feaaa4f9c447d28ab442a0ee41b90b', 'realNameStatus', '认证通过', '1', null, '2', '1', '认证通过', null);
INSERT INTO sys_dict_data VALUES ('69306d27cfbe4f39877ff6da56270822', 'investStatus', '超时取消', '5', null, '6', '1', null, null);
INSERT INTO sys_dict_data VALUES ('6959791438214b0284b75379834d55fb', 'menuIcon', '&lt;em class=&quot;iconfont&quot;&gt;&amp;#xe606;&lt;/em&gt;', '&amp;#xe606;', null, '8', '1', null, null);
INSERT INTO sys_dict_data VALUES ('69d89405b65740b5ae2081b0ab38d2c0', 'qualificationApplyStatus', '待审核', '0', null, '1', '1', null, null);
INSERT INTO sys_dict_data VALUES ('6a0819fb1a474f7db94c7f8a2e18f79f', 'remainDaysType', '90天~180天', '3', null, '3', '1', '90天~180天', 'n >= 90 &&  n < 180');
INSERT INTO sys_dict_data VALUES ('6a84955cf9a14211b7abfe376d814f64', 'activityLogStatus', '已使用', '1', null, '1', '1', null, null);
INSERT INTO sys_dict_data VALUES ('6aa67a973b4e409ca441ea58ff54e2d4', 'menuIcon', '&lt;em class=&quot;iconfont&quot;&gt;&amp;#xe605;&lt;/em&gt;', '&amp;#xe605;', null, '10', '1', null, null);
INSERT INTO sys_dict_data VALUES ('6aac2465e4fb48c989d6614b5e8be393', 'menuIcon', '&lt;em class=&quot;iconfont&quot;&gt;&amp;#xe611;&lt;/em&gt;', '&amp;#xe611;', null, '3', '1', null, null);
INSERT INTO sys_dict_data VALUES ('6b131942e43342aeb16cb26480bbb831', 'buyStyle', '部分投资', '0', null, '0', '1', null, null);
INSERT INTO sys_dict_data VALUES ('6ba8c29fdb3d4ca29193f0f63f381acf', 'rechargeStatus', '处理中', '0', null, '3', '1', null, null);
INSERT INTO sys_dict_data VALUES ('6bf5eca9de284c31a7d39e90eb49f7d4', 'specificSale', '不定向', '0', null, '0', '1', '定向销售默认值，不做定向限制', null);
INSERT INTO sys_dict_data VALUES ('6c5c9e13310a42168146655798bed704', 'investStatus', '已过期', '4', null, '5', '0', '已过期', null);
INSERT INTO sys_dict_data VALUES ('6c70091d21974d9798a9eb015810d80a', 'sysLogMethod', '登陆', 'login', null, '10', '1', null, null);
INSERT INTO sys_dict_data VALUES ('6cb987a196d5435b97e868dfd0a70276', 'sysLogContent', '产品分类', 'project_type', null, '39', '1', null, null);
INSERT INTO sys_dict_data VALUES ('6d424754cc5b497c92d9609069ee1be2', 'borrowStatus', '待担保', '11', null, '1', '1', null, null);
INSERT INTO sys_dict_data VALUES ('6d5717b6350a4e6e923401af056947f6', 'sysLogContent', '风险评估答案', 'risk_answer', null, '58', '1', null, null);
INSERT INTO sys_dict_data VALUES ('6d9dea033ba24399b051d5bfe5e1df05', 'amountCondition', '10万元以上', '4', null, '4', '1', null, 'n>100000');
INSERT INTO sys_dict_data VALUES ('6e40e3b326974546a315aa014d914535', 'sysLogContent', '调度任务', 'tpp_trade', null, '79', '1', null, null);
INSERT INTO sys_dict_data VALUES ('6fa45b81a5c44cdeadb7cac3b4fbbd01', 'menuIcon', '&lt;em class=&quot;iconfont&quot;&gt;&amp;#xe607;&lt;/em&gt;', '&amp;#xe607;', null, '11', '1', null, null);
INSERT INTO sys_dict_data VALUES ('6fdb3dbdd0554a50b56b9f9454cc73f1', 'educationLevel', '博士后', '10', null, '9', '1', null, null);
INSERT INTO sys_dict_data VALUES ('704e12ae92fe46c18015b2734f52efef', 'accountBank', '中国银行', 'BOC', null, '1', '1', null, null);
...
INSERT INTO sys_dict_data VALUES ('7113e658469c4863a88e97acb2b8a41d', 'salaryRange', '50-80万', '9', null, '9', '1', null, null);
INSERT INTO sys_dict_data VALUES ('720ce19f57874fa1b8294ac185e4372b', 'sysLogContent', '变现', 'realize', null, '56', '1', null, null);
INSERT INTO sys_dict_data VALUES ('7239001aba764c9d9748923297ef658c', 'productStatus', '已完成', '9', null, '9', '1', null, null);
INSERT INTO sys_dict_data VALUES ('7255cc7f56a74f9fa245af854eade243', 'sysLogContent', '债权规则', 'bond_rule', null, '17', '1', null, null);
...
INSERT INTO sys_dict_data VALUES ('7278c603daf5413791b83dcaef150260', 'accountBank', '光大银行', 'CEB', null, '8', '1', null, null);
INSERT INTO sys_dict_data VALUES ('73ffa518ce92427ea650de5a85fbba4f', 'enable', '禁用', '0', null, '2', '1', null, null);
INSERT INTO sys_dict_data VALUES ('741c3b9ffbb64408bc901b606423396e', 'cashStatus', '提现处理中', '1', null, '2', '1', null, null);
INSERT INTO sys_dict_data VALUES ('754948ababf24dfd893f436cce931bd6', 'sysLogMethod', '编辑', 'edit', null, '4', '1', null, null);
INSERT INTO sys_dict_data VALUES ('765214ace71845e993edc575e433b734', 'menuIcon', '&lt;em class=&quot;iconfont&quot;&gt;&amp;#xe60f;&lt;/em&gt;', '&amp;#xe60f;', null, '18', '1', null, null);
INSERT INTO sys_dict_data VALUES ('769940f1f0bd400b8133d931965d00a5', 'sysLogContent', '用户礼包', 'user_gift', null, '53', '1', null, null);
INSERT INTO sys_dict_data VALUES ('76bfc24179654f2fa34236f03335815a', 'accountBank', '深发银行', 'SDB', null, '16', '1', null, null);
...
INSERT INTO sys_dict_data VALUES ('76fb4ca220294b978f3fb63ba0342e77', 'menuIcon', '&lt;em class=&quot;iconfont&quot;&gt;&amp;#xe617;&lt;/em&gt;', '&amp;#xe617;', null, '30', '1', null, null);
INSERT INTO sys_dict_data VALUES ('77063198557d46af936f726fc1c35179', 'menuIcon', '&lt;em class=&quot;iconfont&quot;&gt;&amp;#xe615;&lt;/em&gt;', '&amp;#xe615;', null, '1', '1', null, null);
...
INSERT INTO sys_dict_data VALUES ('78eded0fafcd43318914ae529b6d0354', 'sysLogContent', '菜单', 'menu', null, '69', '1', null, null);
INSERT INTO sys_dict_data VALUES ('7967ed2cb87442799c36556c68fce246', 'bespeakLimitTime', '3-6个月', '2', null, '2', '1', null, null);
INSERT INTO sys_dict_data VALUES ('7a691ab51a1a4320a511346559792cca', 'menuIcon', '&lt;em class=&quot;iconfont&quot;&gt;&amp;#xe604;&lt;/em&gt;', '&amp;#xe604;', null, '9', '1', null, null);
INSERT INTO sys_dict_data VALUES ('7af563f9245d4730a98994ef5b2daaa4', 'sysLogContent', '借款成立审核', 'borrow_establish', null, '27', '1', null, null);
INSERT INTO sys_dict_data VALUES ('7c2c58c0e152499f9bcc4fc87df49e47', 'workExperience', '5-8年', '3', null, '3', '1', '工作年限', null);
INSERT INTO sys_dict_data VALUES ('7db368677d3b4dd6b843703279b600b6', 'sysLogContent', '借款', 'borrow', null, '21', '1', null, null);
INSERT INTO sys_dict_data VALUES ('7defd915ff6b4ffb98bec4f3c7e2ebbd', 'menuIcon', '&lt;em class=&quot;iconfont&quot;&gt;&amp;#xe609;&lt;/em&gt;', '&amp;#xe609;', null, '12', '1', null, null);
INSERT INTO sys_dict_data VALUES ('7e0ee6472733448482469f07cadeb07e', 'borrowNature', '公司借款', '2', null, '2', '1', null, null);
...
INSERT INTO sys_dict_data VALUES ('7ea2233a60324f36a46ebe1f9b2a3683', 'borrowStatus', '担保被拒', '12', null, '2', '1', null, null);
INSERT INTO sys_dict_data VALUES ('7f6f6451a7de48159387ee9ef9f5f97f', 'accountType', '垫付成功', 'pay_for_success', null, '4', '0', null, null);
INSERT INTO sys_dict_data VALUES ('80507bc3b0a44b2d8422e1773a40ac04', 'houseStatus', '有', '1', null, '2', '1', null, null);
INSERT INTO sys_dict_data VALUES ('80720cbabe2540b4999b5f2323a14b0b', 'cardType', '军官证', '2', null, '2', '1', null, null);
INSERT INTO sys_dict_data VALUES ('80758afe901149eb8e01879ba78ca3d2', 'realNameStatus', '未认证', '0', null, '1', '1', '未认证', null);
INSERT INTO sys_dict_data VALUES ('8206439655eb4794a004ce9b75982b90', 'sysLogContent', '业务统计', 'sale_statistics', null, '81', '1', null, null);
INSERT INTO sys_dict_data VALUES ('823662eaf718455d8a6dbd6b978ad81f', 'projectProcessNode', '审核', 'verify', null, '3', '1', null, null);
INSERT INTO sys_dict_data VALUES ('826226a077244d0b95a4003816a3dafd', 'saleChannel', 'PC', '1', null, '1', '1', 'PC端上架', null);
INSERT INTO sys_dict_data VALUES ('8342acfb9bc94c2d973e415d30341111', 'accountStatus', '处理中', '0', TO_DATE('2016-07-12 11:35:42', 'YYYY-MM-DD HH24:MI:SS'), '0', '1', null, null);
INSERT INTO sys_dict_data VALUES ('8342acfb9bc94c2d973e415d30342222', 'accountStatus', '成功', '1', TO_DATE('2016-07-12 11:36:22', 'YYYY-MM-DD HH24:MI:SS'), '1', '1', null, null);
INSERT INTO sys_dict_data VALUES ('8342acfb9bc94c2d973e415d30343333', 'accountStatus', '失败', '2', TO_DATE('2016-07-12 11:37:05', 'YYYY-MM-DD HH24:MI:SS'), '2', '1', null, null);
INSERT INTO sys_dict_data VALUES ('8342acfb9bc94c2d973e415d303448ba', 'sendStatus', '发送成功', '1', TO_DATE('2016-06-22 16:32:40', 'YYYY-MM-DD HH24:MI:SS'), '2', '1', '发送成功', null);
INSERT INTO sys_dict_data VALUES ('8351f5538bf242119c7a7130bf2c57df', 'user_security_question', '您姐姐的姓名？', 'question_sister_name', null, '3', '1', null, null);
INSERT INTO sys_dict_data VALUES ('83893edc1a63467d9006605816c8036a', 'tppType', '冻结', 'freeze', null, '3', '1', null, null);
INSERT INTO sys_dict_data VALUES ('8392a4bf0cca49d4ae5d84322dfd95d9', 'tppStatus', '失败', '2', null, '3', '1', null, null);
INSERT INTO sys_dict_data VALUES ('839e1c06ef0e4994aa4fe9cd87e191c1', 'platAccountType', '垫付加息利息', '7', null, '7', '1', null, null);
INSERT INTO sys_dict_data VALUES ('83e41f46e320409aa620837a2b82d03f', 'salaryRange', '2-4万', '2', null, '2', '1', '3000-5000元', null);
INSERT INTO sys_dict_data VALUES ('842f976f0ad04d4e920ef62384026dd2', 'accountType', '解冻已变现金额', 'unfreeze_realize_money', null, '73', '1', null, null);
INSERT INTO sys_dict_data VALUES ('84e0ac8abf164982bdd53706e66738e7', 'qualificationType', '驾驶证', 'driverLicense', null, '4', '1', '驾驶证', null);
INSERT INTO sys_dict_data VALUES ('8568b255ca374f32bb21ed395ef9fbbd', 'bondStatus', 'test', '1', null, '5', '0', null, null);
INSERT INTO sys_dict_data VALUES ('85f7d7e06ca643e7811cfced74cef370', 'saleChannel', '微信', '3', null, '3', '1', '微信端上架', null);
INSERT INTO sys_dict_data VALUES ('8625917f432f49fd8cef30232c00f6b4', 'sysLogMethod', '成立审核', 'establish', null, '14', '1', null, null);
INSERT INTO sys_dict_data VALUES ('867a1c269fdc409f9bc404d80756ba3a', 'productStatus', '待售', '41', null, '4', '1', null, null);
...
INSERT INTO sys_dict_data VALUES ('86d1d3cad4274a5991efb0eb7db3d719', 'sysLogContent', '账户列表', 'account_list', null, '1', '1', null, null);
INSERT INTO sys_dict_data VALUES ('86d3927a774f455d95912204abf45b49', 'borrowUse', '生活周转', '生活周转', null, '3', '1', null, null);
INSERT INTO sys_dict_data VALUES ('87bc6b462d59404eb29181a54a3e42f6', 'projectStatus', '未成立', '7', null, '12', '1', '未成立', null);
INSERT INTO sys_dict_data VALUES ('8836ec8ff40241c0a6736173e3654bb6', 'sysLogContent', '企业用户', 'user_company', null, '82', '1', null, null);
INSERT INTO sys_dict_data VALUES ('8880c1346fc449f09155ad2cd6b13cc9', 'menuIcon', '&lt;em class=&quot;iconfont&quot;&gt;&amp;#xe61d;&lt;/em&gt;', '&amp;#xe61d;', null, '22', '1', null, null);
INSERT INTO sys_dict_data VALUES ('88fd7264f70d432086d4406fc229b733', 'menuIcon', '&lt;em class=&quot;iconfont&quot;&gt;&amp;#xe60b;&lt;/em&gt;', '&amp;#xe60b;', null, '14', '1', null, null);
INSERT INTO sys_dict_data VALUES ('8914d73c3ab741dd90eaba8eed1b13d5', 'repayStatus', '未还款', '0', null, '1', '1', null, null);
INSERT INTO sys_dict_data VALUES ('895bb52b3be04b989f28aacd25d52bef', 'accountType', '冻结已变现利息', 'freeze_realize_interest', null, '91', '1', null, null);
...
INSERT INTO sys_dict_data VALUES ('8ba760d98dc34394ab2ab6012ea246b1', 'userFreeze', '变现', 'realize', null, '4', '1', null, null);
INSERT INTO sys_dict_data VALUES ('8be06dfc314c45158d6b82b4e9e8a1dd', 'accountType', '转让溢价收益', 'bond_sell_earn', null, '1', '1', '转让溢价收益', null);
INSERT INTO sys_dict_data VALUES ('8c1927162018404996f489201fa62c75', 'sysLogContent', '产品列表', 'product_list', null, '34', '1', null, null);
INSERT INTO sys_dict_data VALUES ('8c31e87e61c64c1a8b9be33416e431a9', 'sysLogContent', '加息规则', 'rate_rule', null, '46', '1', null, null);
INSERT INTO sys_dict_data VALUES ('8c9dbab9f8454e1da07a2d22345ba826', 'borrowStatus', '坏账', '88', null, '12', '1', null, null);
INSERT INTO sys_dict_data VALUES ('8d1edcc7e9294cf48c40de6886599bb2', 'sysLogContent', '经纪人客户', 'operator_customer', null, '80', '1', null, null);
INSERT INTO sys_dict_data VALUES ('8d589b7560244bcfa42a3b02e9ed7a37', 'account_type', '待收奖励', 'wait_award', null, '0', '1', null, null);
INSERT INTO sys_dict_data VALUES ('8e7c357cf56c4be28710610b9e539737', 'sysLogContent', '审核记录', 'verify_log', null, '30', '1', null, null);
INSERT INTO sys_dict_data VALUES ('8f8e4e1f0f61484980795a474fd11cd6', 'saleStyle', '按金额', '1', null, '1', '1', '按金额', null);
INSERT INTO sys_dict_data VALUES ('900ee0fd74414675bfd3dbcb1331be34', 'awardType', '加息券', '2', null, '2', '1', null, null);
INSERT INTO sys_dict_data VALUES ('904dbe01ee224253a79f381fa7fbdf0a', 'investStatus', '订单失效', '6', null, '7', '1', null, null);
INSERT INTO sys_dict_data VALUES ('92104836d23048649e7a6a1c6e4040e0', 'productStatus', '发布审核被拒', '3', null, '2', '1', null, null);
INSERT INTO sys_dict_data VALUES ('931b430e71c4416ab38d7e76ee9d6fb5', 'bondStatus', '前台手动撤回', '5', null, '4', '1', '前台手动撤回', null);
INSERT INTO sys_dict_data VALUES ('935a8890015845feba7753658db6a4bd', 'sysLogContent', 'vip等级', 'vip_level', null, '52', '1', null, null);
INSERT INTO sys_dict_data VALUES ('947311aa8a124e57be0049f52e55eb84', 'investType', '自动投资', '1', null, '2', '1', null, null);
INSERT INTO sys_dict_data VALUES ('94923051cac54396a928b9d10af9e6b9', 'sysLogContent', '预约跟进', 'borrow_bespeak', null, '19', '1', null, null);
INSERT INTO sys_dict_data VALUES ('949cbe42ea034271b3449b1f8ca413db', 'sysLogMethod', '下架', 'stop', null, '13', '1', null, null);
INSERT INTO sys_dict_data VALUES ('95900aa46b1a4228aebe038b10911c73', 'sysLogContent', '产品上架', 'product_sale', null, '36', '1', null, null);
INSERT INTO sys_dict_data VALUES ('95c8a28e043d463a8f56562c632a6b28', 'realizeAprCondition', '10~14%', '3', null, '3', '1', null, 'n &gt;= 10 &amp;&amp; n &lt;14');
...
INSERT INTO sys_dict_data VALUES ('96050540c307437892bbe4e98d025c07', 'menuIcon', '&lt;em class=&quot;iconfont&quot;&gt;&amp;#xe627;&lt;/em&gt;', '&amp;#xe627;', null, '36', '1', null, null);
INSERT INTO sys_dict_data VALUES ('9626b0d38f8d43f7b4fa3c719827f421', 'rechargeStatus', '充值成功', '1', null, '1', '1', null, null);
INSERT INTO sys_dict_data VALUES ('968965c94c9c4981a1ce0c66707f9400', 'projectStatus', '发布审核被拒', '3', null, '6', '1', '审核被拒', null);
INSERT INTO sys_dict_data VALUES ('971fae287de4472d9d80a751f02966d4', 'userType', '企业用户', '2', null, '2', '1', null, null);
INSERT INTO sys_dict_data VALUES ('9746d5a81b13483aab08ab9b6f4877fd', 'qualificationType', '信用报告', 'creditReport', null, '5', '1', '信用报告', null);
INSERT INTO sys_dict_data VALUES ('97497905f69049dc9f8d33fdfacf68dc', 'sysLogContent', '角色', 'role', null, '76', '1', null, null);
INSERT INTO sys_dict_data VALUES ('1eab8f654f2446078204fc7c008e2e1c', 'accountType', '提现处理中', 'cash_proccess', null, '8', '1', null, null);
INSERT INTO sys_dict_data VALUES ('1f41e4aae095457ca64fa6a4a46a2d62', 'tppType', '解冻', 'unFreeze', null, '4', '1', null, null);
INSERT INTO sys_dict_data VALUES ('20ab1879e1b2410b96e32f1111069528', 'sysLogContent', '充值列表', 'recharge_list', null, '13', '1', null, null);
INSERT INTO sys_dict_data VALUES ('20c690d7e9d349718f0b6f07f262e7a9', 'educationLevel', '中专', '4', null, '3', '1', '中专', null);
INSERT INTO sys_dict_data VALUES ('219834eaf935432eb487a6906d597ca8', 'menuIcon', '&lt;em class=&quot;iconfont&quot;&gt;&amp;#xe60d;&lt;/em&gt;', '&amp;#xe60d;', null, '16', '1', null, null);
...
INSERT INTO sys_dict_data VALUES ('233ba78c727540c8b2a0059cddd850cc', 'borrowUse', '购物消费', '购物消费', null, '4', '1', null, null);
INSERT INTO sys_dict_data VALUES ('23a6e01b2b6741d69a435c52a6e3b600', 'interLanguage', 'United States 美国(英文)', 'en_US', null, '2', '1', null, null);
INSERT INTO sys_dict_data VALUES ('243', 'messageType', '待还到期提醒', 'borrower_repay_notice', TO_DATE('2016-06-22 13:50:27', 'YYYY-MM-DD HH24:MI:SS'), '2', '1', '待还到期提醒', null);
INSERT INTO sys_dict_data VALUES ('243a2a0e2abc4732aae877c1d4dbd857', 'salaryRange', '30-50万', '8', null, '8', '1', '20000元以上', null);
INSERT INTO sys_dict_data VALUES ('244', 'messageType', '修改银行帐号验证码', 'bank_verify_code', TO_DATE('2016-06-22 13:50:27', 'YYYY-MM-DD HH24:MI:SS'), '3', '1', '修改银行帐号验证码', null);
INSERT INTO sys_dict_data VALUES ('245', 'messageType', '后台初审不通过', 'borrow_verify_fail', TO_DATE('2016-06-22 13:50:27', 'YYYY-MM-DD HH24:MI:SS'), '4', '1', '后台初审不通过', null);
INSERT INTO sys_dict_data VALUES ('246', 'messageType', '后台初审通过', 'borrow_verify_succ', TO_DATE('2016-06-22 13:50:27', 'YYYY-MM-DD HH24:MI:SS'), '5', '1', '后台初审通过', null);
INSERT INTO sys_dict_data VALUES ('247', 'messageType', '自动投资成功通知', 'auto_tender', TO_DATE('2016-06-22 13:50:27', 'YYYY-MM-DD HH24:MI:SS'), '6', '1', '自动投资成功通知', null);
INSERT INTO sys_dict_data VALUES ('248', 'messageType', '借款人还款', 'receive_repay', TO_DATE('2016-06-22 13:50:27', 'YYYY-MM-DD HH24:MI:SS'), '7', '1', '借款人还款', null);
INSERT INTO sys_dict_data VALUES ('249', 'messageType', '线上充值成功', 'recharge_succ', TO_DATE('2016-06-22 13:50:27', 'YYYY-MM-DD HH24:MI:SS'), '8', '1', '线上充值成功', null);
INSERT INTO sys_dict_data VALUES ('24b501bd2bb44851821b2d89b4511091', 'interLanguage', 'China 中国(中文简体)', 'zh_CN', null, '1', '1', null, null);
INSERT INTO sys_dict_data VALUES ('24ece2d25130447f89803205e81813a5', 'realizeDayCondition', '180天以上', '4', null, '4', '1', '180天以上', 'n &gt;= 180');
INSERT INTO sys_dict_data VALUES ('250', 'messageType', '提现审核失败', 'cash_verify_fail', TO_DATE('2016-06-22 13:50:27', 'YYYY-MM-DD HH24:MI:SS'), '9', '1', '提现审核失败', null);
INSERT INTO sys_dict_data VALUES ('251', 'messageType', '线下充值审核失败', 'down_recharge_verify_fail', TO_DATE('2016-06-22 13:50:27', 'YYYY-MM-DD HH24:MI:SS'), '10', '1', '线下充值审核失败', null);
INSERT INTO sys_dict_data VALUES ('252', 'messageType', '登录密码修改通知', 'password_update', TO_DATE('2016-06-22 13:50:27', 'YYYY-MM-DD HH24:MI:SS'), '11', '1', '登录密码修改通知', null);
INSERT INTO sys_dict_data VALUES ('253', 'messageType', '投资成功通知', 'invest_succ', TO_DATE('2016-06-22 13:50:27', 'YYYY-MM-DD HH24:MI:SS'), '12', '1', '投资成功通知', null);
INSERT INTO sys_dict_data VALUES ('254', 'messageType', '满标审核失败通知', 'borrow_full_fail', TO_DATE('2016-06-22 13:50:27', 'YYYY-MM-DD HH24:MI:SS'), '13', '1', '满标审核失败通知', null);
INSERT INTO sys_dict_data VALUES ('255', 'messageType', '借款项目取消通知', 'borrow_cancel', TO_DATE('2016-06-22 13:50:27', 'YYYY-MM-DD HH24:MI:SS'), '14', '1', '借款项目取消通知', null);
INSERT INTO sys_dict_data VALUES ('256', 'messageType', '流转标还款成功通知', 'flow_repay_succ', TO_DATE('2016-06-22 13:50:27', 'YYYY-MM-DD HH24:MI:SS'), '15', '1', '流转标还款成功通知', null);
INSERT INTO sys_dict_data VALUES ('256e4670de6d4ffbafa030a3a85be243', 'projectProcessNode', '下架', 'stop', null, '5', '1', '下架', null);
INSERT INTO sys_dict_data VALUES ('257', 'messageType', '后台批量充值审核成功', 'batch_recharge_verify_succ', TO_DATE('2016-06-22 13:50:27', 'YYYY-MM-DD HH24:MI:SS'), '16', '1', '后台批量充值审核成功', null);
INSERT INTO sys_dict_data VALUES ('258', 'messageType', '流转标重新流转', 'flow_restart', TO_DATE('2016-06-22 13:50:27', 'YYYY-MM-DD HH24:MI:SS'), '17', '1', '流转标重新流转', null);
INSERT INTO sys_dict_data VALUES ('259', 'messageType', '认证审核失败', 'certify_fail', TO_DATE('2016-06-22 13:50:27', 'YYYY-MM-DD HH24:MI:SS'), '18', '1', '认证审核失败', null);
INSERT INTO sys_dict_data VALUES ('25a96820fa7c4c699d925ec74d967358', 'sendType', '不限', null, TO_DATE('2016-11-04 11:30:14', 'YYYY-MM-DD HH24:MI:SS'), '0', '1', null, null);
INSERT INTO sys_dict_data VALUES ('25b8c9f8bb1e4fd3812aea62d43f61eb', 'menuIcon', '&lt;em class=&quot;iconfont&quot;&gt;&amp;#xe62a;&lt;/em&gt;', '&amp;#xe62a;', null, '20', '1', null, null);
INSERT INTO sys_dict_data VALUES ('260', 'messageType', '重新获取交易密码', 'get_paypwd', TO_DATE('2016-06-22 13:50:27', 'YYYY-MM-DD HH24:MI:SS'), '19', '1', '重新获取交易密码', null);
INSERT INTO sys_dict_data VALUES ('261', 'messageType', '获得投资奖励', 'receive_tender_award', TO_DATE('2016-06-22 13:50:27', 'YYYY-MM-DD HH24:MI:SS'), '20', '1', '获得投资奖励', null);
INSERT INTO sys_dict_data VALUES ('262', 'messageType', '后台扣费成功', 'houtai_deduct_succ', TO_DATE('2016-06-22 13:50:27', 'YYYY-MM-DD HH24:MI:SS'), '21', '1', '后台扣费成功', null);
INSERT INTO sys_dict_data VALUES ('263', 'messageType', '获得回款奖励', 'receive_huikuan_award', TO_DATE('2016-06-22 13:50:27', 'YYYY-MM-DD HH24:MI:SS'), '22', '1', '获得回款奖励', null);
INSERT INTO sys_dict_data VALUES ('264', 'messageType', '待收到期提醒', 'loaner_repay_notice', TO_DATE('2016-06-22 13:50:27', 'YYYY-MM-DD HH24:MI:SS'), '23', '1', '待收到期提醒', null);
INSERT INTO sys_dict_data VALUES ('265', 'messageType', '提现验证码', 'cash_verify_code', TO_DATE('2016-06-22 13:50:27', 'YYYY-MM-DD HH24:MI:SS'), '24', '1', '提现验证码', null);
INSERT INTO sys_dict_data VALUES ('266', 'messageType', '认证审核撤销', 'certify_cancel', TO_DATE('2016-06-22 13:50:27', 'YYYY-MM-DD HH24:MI:SS'), '25', '1', '认证审核撤销', null);
INSERT INTO sys_dict_data VALUES ('267', 'messageType', '新借款项目发布通知', 'new_borrow', TO_DATE('2016-06-22 13:50:27', 'YYYY-MM-DD HH24:MI:SS'), '26', '1', '新借款项目发布通知', null);
INSERT INTO sys_dict_data VALUES ('268', 'messageType', '投资失败', 'invest_fail', TO_DATE('2016-06-22 13:50:27', 'YYYY-MM-DD HH24:MI:SS'), '27', '1', '投资失败', null);
INSERT INTO sys_dict_data VALUES ('269', 'messageType', '提现审核成功', 'cash_verify_succ', TO_DATE('2016-06-22 13:50:27', 'YYYY-MM-DD HH24:MI:SS'), '28', '1', '提现审核成功', null);
INSERT INTO sys_dict_data VALUES ('270', 'messageType', '线下充值审核成功', 'down_recharge_verify_succ', TO_DATE('2016-06-22 13:50:27', 'YYYY-MM-DD HH24:MI:SS'), '29', '1', '线下充值审核成功', null);
INSERT INTO sys_dict_data VALUES ('2705c5cdb37942d48062dc29c3043011', 'sysLogContent', '借款资料', 'borrow_pic', null, '23', '1', null, null);
INSERT INTO sys_dict_data VALUES ('271', 'messageType', '短信验证码', 'phone_code', TO_DATE('2016-06-22 13:50:27', 'YYYY-MM-DD HH24:MI:SS'), '30', '1', '短信验证码', null);
INSERT INTO sys_dict_data VALUES ('272', 'messageType', '交易密码修改通知', 'paypwd_update', TO_DATE('2016-06-22 13:50:27', 'YYYY-MM-DD HH24:MI:SS'), '31', '1', '交易密码修改通知', null);
INSERT INTO sys_dict_data VALUES ('273', 'messageType', '满标审核通过通知', 'borrow_full_succ', TO_DATE('2016-06-22 13:50:27', 'YYYY-MM-DD HH24:MI:SS'), '32', '1', '满标审核通过通知', null);
INSERT INTO sys_dict_data VALUES ('273d5f5200f94511bc2f38bd07a3e545', 'sendStatus', '发送失败', '2', TO_DATE('2016-06-22 16:32:34', 'YYYY-MM-DD HH24:MI:SS'), '3', '1', '发送失败', null);
INSERT INTO sys_dict_data VALUES ('274', 'messageType', '还款成功通知', 'repay_succ', TO_DATE('2016-06-22 13:50:27', 'YYYY-MM-DD HH24:MI:SS'), '33', '1', '还款成功通知', null);
INSERT INTO sys_dict_data VALUES ('2741e88b19c948e8a746fc064298e88a', 'tppStatus', '未处理', '0', null, '1', '1', null, null);
INSERT INTO sys_dict_data VALUES ('275', 'messageType', '流转标认购成功通知', 'flow_buy_succ', TO_DATE('2016-06-22 13:50:27', 'YYYY-MM-DD HH24:MI:SS'), '34', '1', '流转标认购成功通知', null);
INSERT INTO sys_dict_data VALUES ('276', 'messageType', 'VIP到期通知', 'vip_expired', TO_DATE('2016-06-22 13:50:27', 'YYYY-MM-DD HH24:MI:SS'), '35', '1', 'VIP到期通知', null);
INSERT INTO sys_dict_data VALUES ('276a68273db543e0934bef2dbc30e6be', 'borrowUse', '生意周转', '生意周转', null, '2', '1', null, null);
INSERT INTO sys_dict_data VALUES ('277', 'messageType', 'VIP生日', 'vip_birth', TO_DATE('2016-06-22 13:50:27', 'YYYY-MM-DD HH24:MI:SS'), '36', '1', 'VIP生日', null);
INSERT INTO sys_dict_data VALUES ('278', 'messageType', '认证审核成功', 'certify_succ', TO_DATE('2016-06-22 13:50:27', 'YYYY-MM-DD HH24:MI:SS'), '37', '1', '认证审核成功', null);
INSERT INTO sys_dict_data VALUES ('279', 'messageType', '重新激活邮件', 'get_email', TO_DATE('2016-06-22 13:50:27', 'YYYY-MM-DD HH24:MI:SS'), '38', '1', '重新激活邮件', null);
INSERT INTO sys_dict_data VALUES ('27d16e5ab1404d768a3e44d90e575a53', 'menuIcon', '&lt;em class=&quot;iconfont&quot;&gt;&amp;#xe614;&lt;/em&gt;', '&amp;#xe614;', null, '7', '1', null, null);
INSERT INTO sys_dict_data VALUES ('280', 'messageType', '重新获取登录密码', 'get_pwd', TO_DATE('2016-06-22 13:50:27', 'YYYY-MM-DD HH24:MI:SS'), '39', '1', '重新获取登录密码', null);
INSERT INTO sys_dict_data VALUES ('281', 'messageType', '支付投资奖励', 'deduct_borrower_award', TO_DATE('2016-06-22 13:50:27', 'YYYY-MM-DD HH24:MI:SS'), '40', '1', '支付投资奖励', null);
INSERT INTO sys_dict_data VALUES ('281307ca83634caeb44d131337882d09', 'sysLogContent', '产品审核', 'product_audit', null, '35', '1', null, null);
INSERT INTO sys_dict_data VALUES ('282', 'sendType', '短信', '1', TO_DATE('2016-06-22 14:05:26', 'YYYY-MM-DD HH24:MI:SS'), '1', '1', null, null);
INSERT INTO sys_dict_data VALUES ('283', 'sendType', '邮件', '2', TO_DATE('2016-06-22 14:05:54', 'YYYY-MM-DD HH24:MI:SS'), '2', '1', null, null);
INSERT INTO sys_dict_data VALUES ('284', 'sendType', '站内信', '3', TO_DATE('2016-06-22 14:06:19', 'YYYY-MM-DD HH24:MI:SS'), '3', '1', null, null);
...
INSERT INTO sys_dict_data VALUES ('2b0b109e3dd641ffb6b95f5125675b0f', 'sysLogContent', '贷后跟踪', 'borrow_follow', null, '29', '1', null, null);
INSERT INTO sys_dict_data VALUES ('2b23eb14e4834e4cabb3f3b7dce0c380', 'accountType', '冻结逾期罚息', 'freeze_realize_lateinterest', null, '75', '1', null, null);
INSERT INTO sys_dict_data VALUES ('2b3f89746a4842589985ceb3a807622f', 'aprType', '14%以上', '4', null, '4', '1', '14%以上', 'n >= 14');
INSERT INTO sys_dict_data VALUES ('2b52855d52f1498aa43532408703064f', 'realizeStatus', '待还款', '8', null, '2', '1', null, null);
INSERT INTO sys_dict_data VALUES ('2b7fd89a7ea6421d8d27ce1a46526a9f', 'sysLogContent', '风险评测记录', 'risk_user_log', null, '62', '1', null, null);
INSERT INTO sys_dict_data VALUES ('2bb477e39df74039b995ff6054863763', 'sysLogContent', '用户列表', 'user_list', null, '86', '1', null, null);
INSERT INTO sys_dict_data VALUES ('2be89341af674ded834320c530a2b013', 'realizeStatus', '撤回', '7', null, '4', '1', null, null);
INSERT INTO sys_dict_data VALUES ('2c22c8d5ec5e45a9bee21e9003cf9502', 'sysLogMethod', '删除', 'del', null, '6', '1', null, null);
INSERT INTO sys_dict_data VALUES ('2c2efbb5ff314d0597cdf37079bde09c', 'sysLogContent', '操作日志', 'log', null, '65', '1', null, null);
INSERT INTO sys_dict_data VALUES ('2c54cf71724f45408a68976af0ff3535', 'repayType', '已还垫付', '3', null, '3', '1', '已还垫付', null);
INSERT INTO sys_dict_data VALUES ('2c856e916a8a4370a2fdff45582924d1', 'sysLogContent', '文章', 'article', null, '16', '1', null, null);
INSERT INTO sys_dict_data VALUES ('2ddd9e2e590b419cb1959a823823025d', 'borrowStatus', '待上架', '40', null, '5', '1', null, null);
...
INSERT INTO sys_dict_data VALUES ('97abaacf8207411490f213abbdc390c9', 'menuIcon', '&lt;em class=&quot;iconfont&quot;&gt;&amp;#xe620;&lt;/em&gt;', '&amp;#xe620;', null, '34', '1', null, null);
INSERT INTO sys_dict_data VALUES ('988fbe949dd546f887c779c6b3846346', 'borrowStatus', '已完成', '9', null, '11', '1', null, null);
INSERT INTO sys_dict_data VALUES ('99aedd7422f0490c8fad93809d8d2063', 'repayType', '垫付中', '2', null, '2', '1', '垫付中', null);
INSERT INTO sys_dict_data VALUES ('9a3d984f781946be80cca9baf1f204cb', 'activityLogStatus', '已作废', '3', null, '3', '1', null, null);
INSERT INTO sys_dict_data VALUES ('9c94449ee65b43f7a19e1b81f4d2c9ff', 'projectStatus', '担保被拒', '12', null, '3', '1', '担保被拒', null);
INSERT INTO sys_dict_data VALUES ('9dd054547a4e42668a93b3a68d426b3b', 'sysLogContent', '产品下架', 'product_stop', null, '37', '1', null, null);
INSERT INTO sys_dict_data VALUES ('9f2b1a9dee904402b62db0d8ec556a8d', 'productStatus', '还款中', '8', null, '8', '1', null, null);
INSERT INTO sys_dict_data VALUES ('9f32a2abd6314fb1be180cb7ab45b062', 'investStatus', '退款处理中', '3', null, '8', '1', null, null);
INSERT INTO sys_dict_data VALUES ('9feb92a560614ca4a4f3b918f20b69cd', 'accountBank', '平安银行', 'PAB', null, '15', '1', null, null);
...
INSERT INTO sys_dict_data VALUES ('a1bf3d02c25445009af253e2bfcf4ad6', 'cashStatus', '提现待审核', '2', null, '3', '1', null, null);
...
INSERT INTO sys_dict_data VALUES ('a38ed744128d491fa51539aadb4eb825', 'carStatus', '有', '1', null, '2', '1', null, null);
INSERT INTO sys_dict_data VALUES ('a52a61a6c37b441eab760332988f10e0', 'projectProcessNode', '修改', 'edit', null, '2', '1', '修改', null);
INSERT INTO sys_dict_data VALUES ('a5533dc35e3d40368066874e8794c50b', 'accountType', '还款利息', 'repaid_interest', null, '21', '1', null, null);
INSERT INTO sys_dict_data VALUES ('a6ca1526d86a4a55841e6116e7874f3c', 'configType', '业务规则', '2', TO_DATE('2016-09-26 13:41:37', 'YYYY-MM-DD HH24:MI:SS'), '2', '1', '业务规则', null);
INSERT INTO sys_dict_data VALUES ('a72d6bb5b052435f874b1e1152e50e83', 'platAccountType', '账户充值', '1', null, '1', '1', '账户充值', null);
INSERT INTO sys_dict_data VALUES ('a7dd5c05c1c011e6817dfa163e88e3b3', 'myLoanStatus', '待审核', '40', TO_DATE('2016-12-14 13:46:27', 'YYYY-MM-DD HH24:MI:SS'), '5', '1', '待上架', null);
INSERT INTO sys_dict_data VALUES ('a7dd6a97c1c011e6817dfa163e88e3b3', 'myLoanStatus', '已作废', '30', TO_DATE('2016-12-14 13:46:27', 'YYYY-MM-DD HH24:MI:SS'), '13', '0', null, null);
INSERT INTO sys_dict_data VALUES ('a7e01955c1c011e6817dfa163e88e3b3', 'myLoanStatus', '成立待审', '5', TO_DATE('2016-12-14 13:46:27', 'YYYY-MM-DD HH24:MI:SS'), '8', '1', '已下架的借款、募集金额已满的借款、募集时间结束的借款', null);
INSERT INTO sys_dict_data VALUES ('a7e01b7dc1c011e6817dfa163e88e3b3', 'myLoanStatus', '募集中', '41', TO_DATE('2016-12-14 13:46:27', 'YYYY-MM-DD HH24:MI:SS'), '6', '1', '待售', null);
INSERT INTO sys_dict_data VALUES ('a7e01d3ac1c011e6817dfa163e88e3b3', 'myLoanStatus', '待审核', '11', TO_DATE('2016-12-14 13:46:27', 'YYYY-MM-DD HH24:MI:SS'), '1', '1', '发布待审', null);
INSERT INTO sys_dict_data VALUES ('a7e02164c1c011e6817dfa163e88e3b3', 'myLoanStatus', '募集中', '4', TO_DATE('2016-12-14 13:46:27', 'YYYY-MM-DD HH24:MI:SS'), '7', '1', '募集中', null);
INSERT INTO sys_dict_data VALUES ('a7e02488c1c011e6817dfa163e88e3b3', 'myLoanStatus', '审核未通过', '12', TO_DATE('2016-12-14 13:46:27', 'YYYY-MM-DD HH24:MI:SS'), '2', '1', '担保被拒', null);
INSERT INTO sys_dict_data VALUES ('a7e0265ec1c011e6817dfa163e88e3b3', 'myLoanStatus', '还款中', '88', TO_DATE('2016-12-14 13:46:27', 'YYYY-MM-DD HH24:MI:SS'), '12', '1', null, null);
INSERT INTO sys_dict_data VALUES ('a7e02783c1c011e6817dfa163e88e3b3', 'myLoanStatus', '已还款', '9', TO_DATE('2016-12-14 13:46:27', 'YYYY-MM-DD HH24:MI:SS'), '11', '1', '已完成', null);
INSERT INTO sys_dict_data VALUES ('a7e02872c1c011e6817dfa163e88e3b3', 'myLoanStatus', '待审核', '0', TO_DATE('2016-12-14 13:46:27', 'YYYY-MM-DD HH24:MI:SS'), '0', '1', '新增', null);
INSERT INTO sys_dict_data VALUES ('a7e02964c1c011e6817dfa163e88e3b3', 'myLoanStatus', '还款中', '8', TO_DATE('2016-12-14 13:46:27', 'YYYY-MM-DD HH24:MI:SS'), '10', '1', null, null);
INSERT INTO sys_dict_data VALUES ('a7e0325cc1c011e6817dfa163e88e3b3', 'myLoanStatus', '待审核', '1', TO_DATE('2016-12-14 13:46:27', 'YYYY-MM-DD HH24:MI:SS'), '3', '1', '发布审核被拒', null);
INSERT INTO sys_dict_data VALUES ('a7e03398c1c011e6817dfa163e88e3b3', 'myLoanStatus', '审核未通过', '3', TO_DATE('2016-12-14 13:46:27', 'YYYY-MM-DD HH24:MI:SS'), '4', '1', '产品的发布审核不通过；借款审核不通过', null);
INSERT INTO sys_dict_data VALUES ('a7e03489c1c011e6817dfa163e88e3b3', 'myLoanStatus', '未成立', '7', TO_DATE('2016-12-14 13:46:27', 'YYYY-MM-DD HH24:MI:SS'), '9', '1', null, null);
INSERT INTO sys_dict_data VALUES ('a8091ed9183f428a93c343280509c6a8', 'realizeAprCondition', '14%以上', '4', null, '4', '1', null, 'n &gt;= 14');
INSERT INTO sys_dict_data VALUES ('a87b83ba4f264507b4d804708f6c2abe', 'sysLogContent', '用户登陆', 'user_login', null, '68', '1', null, null);
...
INSERT INTO sys_dict_data VALUES ('ac4b5d0f7022416583fd06bbe2b8e536', 'sysLogMethod', '执行', 'do', null, '8', '1', null, null);
INSERT INTO sys_dict_data VALUES ('acb91624afd141b5aa5a81d3529a62f1', 'RealizeSellStyle', '部分变现', '0', null, '0', '1', null, null);
INSERT INTO sys_dict_data VALUES ('adabb91a3f864eeeb518555853c07c21', 'menuIcon', '&lt;em class=&quot;iconfont&quot;&gt;&amp;#xe61c;&lt;/em&gt;', '&amp;#xe61c;', null, '28', '1', null, null);
INSERT INTO sys_dict_data VALUES ('ae4d7f20ff6242ca847b4c314bc77a2f', 'maritalStatus', '未婚', '0', null, '1', '1', null, null);
INSERT INTO sys_dict_data VALUES ('ae6a61052c27445d85d142c1a42a2eee', 'borrowStatus', '新增待维护', '0', null, '0', '1', null, null);
INSERT INTO sys_dict_data VALUES ('af243f6c6aaa45e392322718abe4406d', 'workExperience', '3-5年', '2', null, '2', '1', '工作年限', null);
INSERT INTO sys_dict_data VALUES ('af3175cc44084957b5abf99fa9b4f0cc', 'accountBank', '交通银行', 'BCM', null, '6', '1', null, null);
INSERT INTO sys_dict_data VALUES ('afcac0acbce341f5b7b23ce12374dc09', 'accountBank', '华夏银行', 'HXB', null, '10', '1', null, null);
INSERT INTO sys_dict_data VALUES ('b0f90785d14247889c876ff5b970d36c', 'accountType', '还款本金', 'repaid_capital', null, '22', '1', null, null);
INSERT INTO sys_dict_data VALUES ('b13b5e7202984da8b4beaf478b143648', 'productStatus', '已作废', '30', null, '10', '1', null, null);
INSERT INTO sys_dict_data VALUES ('b15e87a0a0e84b589d72bf945578a986', 'educationLevel', '博士', '8', null, '8', '1', '博士', null);
INSERT INTO sys_dict_data VALUES ('b19771966810443797ecd689e2d00854', 'platAccountType', '利息管理费', '5', null, '5', '1', null, null);
INSERT INTO sys_dict_data VALUES ('b19a2bdbbcea44dc85e3543202fd3cd4', 'userFreeze', '投资', 'invest', null, '3', '1', null, null);
INSERT INTO sys_dict_data VALUES ('b1e92adfddb54a9d8179eac173f0d1f2', 'sysLogContent', '变现规则', 'realize_rule', null, '57', '1', null, null);
INSERT INTO sys_dict_data VALUES ('b222306f7e6b4ff2af5d908f89572b97', 'accountType', '转让手续费', 'bond_buy_fee', null, '12', '1', '转让手续费', null);
INSERT INTO sys_dict_data VALUES ('b2544b145a6447b5bc06dfb56c4f191b', 'borrowStatus', '还款中', '8', null, '10', '1', null, null);
INSERT INTO sys_dict_data VALUES ('b2c626d7874345a2a51f7abe263f5af3', 'tppStatus', '成功', '1', null, '2', '1', null, null);
INSERT INTO sys_dict_data VALUES ('b31c0996c82144dcb49d1d29200ae87c', 'menuIcon', '&lt;em class=&quot;iconfont&quot;&gt;&amp;#xe60c;&lt;/em&gt;', '&amp;#xe60c;', null, '15', '1', null, null);
INSERT INTO sys_dict_data VALUES ('b3752f31085146ab848898508314124c', 'vipLevel', 'VIP5及以上', '5', null, '5', '1', null, null);
INSERT INTO sys_dict_data VALUES ('b3ad5a68d83f4d7fafd5cfa7694a7ce7', 'cashStatus', '提现申请', '0', null, '1', '1', null, null);
INSERT INTO sys_dict_data VALUES ('b3e0f89696a7435aa621ba797bee0e60', 'platAccountType', '账户取现', '2', null, '2', '1', '账户取现', null);
INSERT INTO sys_dict_data VALUES ('b3ffa6f160b340de83aef9dad18fe12c', 'sysLogMethod', '导出', 'export', null, '7', '1', null, null);
INSERT INTO sys_dict_data VALUES ('b43906e11eea4d44ae1aad4621d1bc07', 'realizeAmountCondition', '5~10万元', '3', null, '3', '1', null, 'n&gt; 50000 &amp;&amp; n&lt;= 100000');
INSERT INTO sys_dict_data VALUES ('b4ddb4ee10514414937385064f76852b', 'enable', '启用', '1', null, '1', '1', null, null);
INSERT INTO sys_dict_data VALUES ('b50550ff4740443db96c23fe9f9f5476', 'accountBank', '邮储银行', 'PSBC', null, '14', '1', null, null);
INSERT INTO sys_dict_data VALUES ('b51bf5345b4d4cfb97ee94959c6b7561', 'cashStatus', '提现成功', '3', null, '4', '1', null, null);
INSERT INTO sys_dict_data VALUES ('b58307348bcc4f57ba5ea39c1dc0c274', 'realizeStatus', '成立待审', '5', null, '7', '1', null, null);
INSERT INTO sys_dict_data VALUES ('b5896fe0615e495497f7f39900e00632', 'borrowUse', '其它借款', '其它借款', null, '5', '1', null, null);
...
INSERT INTO sys_dict_data VALUES ('b9b897faeb514ddc9e601cfd31738dd3', 'menuIcon', '&lt;em class=&quot;iconfont&quot;&gt;&amp;#xe623;&lt;/em&gt;', '&amp;#xe623;', null, '32', '1', null, null);
INSERT INTO sys_dict_data VALUES ('b9de9b8a19d74d4c842c17e38e249ce9', 'workExperience', '10年以下', '6', null, '6', '1', null, null);
INSERT INTO sys_dict_data VALUES ('ba187265a38d43f4bab8cbc1583a5b6f', 'projectStatus', '已还款', '9', null, '18', '1', '还款成功', null);
INSERT INTO sys_dict_data VALUES ('ba5e27380011442fb0a102e8e236a423', 'realizeStatus', '借款中', '4', null, '1', '1', null, null);
INSERT INTO sys_dict_data VALUES ('bb2938fd28204427abab814c80014da6', 'productTimeLimit', '12个月以上', '3', null, '4', '1', null, null);
...
INSERT INTO sys_dict_data VALUES ('bbfaf6825f40452785fb494ffef18835', 'sysLogContent', '平台账户日志', 'merchant_log', null, '4', '1', null, null);
INSERT INTO sys_dict_data VALUES ('bc32443d8a1944769d3235602d9905ad', 'accountBank', '农业银行', 'ABC', null, '4', '1', null, null);
INSERT INTO sys_dict_data VALUES ('bc72fcefc46842d0b6a5a5554de09965', 'remainDaysType', '30天~90天', '2', null, '2', '1', '30天~90天', 'n >= 30 && n < 90');
INSERT INTO sys_dict_data VALUES ('bc803db9552545c1a61f0587e9f9e3a5', 'sysLogContent', '担保机构', 'vouch_list', null, '89', '1', null, null);
INSERT INTO sys_dict_data VALUES ('bd713d36b60445869ea00f4703999394', 'accountBank', '浦发银行', 'SPDB', null, '11', '1', null, null);
INSERT INTO sys_dict_data VALUES ('be4b23c612f447318b15597acc804e94', 'salaryRange', '100万以上', '11', null, '11', '1', '11', null);
INSERT INTO sys_dict_data VALUES ('bf35062e1c234d5cbb969770e12bff99', 'menuIcon', '&lt;em class=&quot;iconfont&quot;&gt;&amp;#xe610;&lt;/em&gt;', '&amp;#xe610;', null, '6', '1', null, null);
INSERT INTO sys_dict_data VALUES ('c07a4e44dbab487b9fe53a15c9064c9f', 'protocolType', '投资协议', 'invest_protocol', null, '2', '1', null, null);
INSERT INTO sys_dict_data VALUES ('c07de1bbcaee46ffbef57f102145ad54', 'qualificationApplyStatus', '审核通过', '1', null, '2', '1', null, null);
INSERT INTO sys_dict_data VALUES ('c2769761bf6244ff92524a59fcdc22c1', 'realizeAprCondition', '6~10%', '2', null, '2', '1', null, 'n&gt;= 6 &amp;&amp; n&lt;10');
INSERT INTO sys_dict_data VALUES ('c5030964462b4e96ab185dde4791982e', 'maritalStatus', '已婚', '1', null, '2', '1', null, null);
...
INSERT INTO sys_dict_data VALUES ('c6d1f56a5656430db2d44987e31e9e12', 'sysLogContent', '资源', 'resource', null, '75', '1', null, null);
INSERT INTO sys_dict_data VALUES ('c71a91c21ea847009cdcfa1f1d79e91b', 'accountType', '转让折价损失', 'bond_sell_duct', null, '1', '1', '转让折价损失', null);
INSERT INTO sys_dict_data VALUES ('c71fabb3d8244858b513f454920ce209', 'sysLogContent', '还款记录', 'repayment_record', null, '40', '1', null, null);
INSERT INTO sys_dict_data VALUES ('c7a9ebd2fc01462fbe52ce02acfb9ae9', 'aprType', '10-14%', '3', null, '3', '1', '10-14%', 'n >= 10 && n <14');
INSERT INTO sys_dict_data VALUES ('c88ba01e570c461d9656b0dc34c56393', 'sysLogContent', '催收', 'repay_urge', null, '43', '1', null, null);
INSERT INTO sys_dict_data VALUES ('c91cbe86c24d4a3cb7625e3192e229a1', 'sysLogContent', '意见反馈', 'opinion', null, '78', '1', null, null);
...
INSERT INTO sys_dict_data VALUES ('c9ebd897ed164cf391aca09951f2d365', 'sysLogContent', '好友邀请', 'user_invite', null, '83', '1', null, null);
INSERT INTO sys_dict_data VALUES ('cb8c776c1ba442d18440fb47c4dec387', 'sysLogContent', '日志模板', 'log_template', null, '66', '1', null, null);
INSERT INTO sys_dict_data VALUES ('cbfb20bfed184b478f2158a726f63993', 'borrowStatus', '发布待审', '1', null, '3', '1', null, null);
INSERT INTO sys_dict_data VALUES ('cc41d7aaa11848fc8493f01084bb1fbe', 'buyStyle', '全额投资', '1', null, '1', '1', null, null);
INSERT INTO sys_dict_data VALUES ('cc9386513a2e4a859a4fe6f27e63356d', 'menuIcon', '&lt;em class=&quot;iconfont&quot;&gt;&amp;#xe600;&lt;/em&gt;', '&amp;#xe600;', null, '4', '1', null, null);
...
INSERT INTO sys_dict_data VALUES ('ce6952e2765a40399d8ff2bdcbc2243b', 'sysLogContent', '用户资金', 'user_account', null, '2', '1', null, null);
INSERT INTO sys_dict_data VALUES ('ce6f104e65974dd195dee0f7c8f8282d', 'realizeAmountCondition', '1~5万元', '2', null, '2', '1', null, '10000&lt;n &amp;&amp; n &lt;=50000');
INSERT INTO sys_dict_data VALUES ('cf3d3bb9656d4bc394b0b5f73cfa1008', 'sysLogContent', '消息记录', 'message', null, '70', '1', null, null);
...
INSERT INTO sys_dict_data VALUES ('d07764f18e594b26b6aa2698c8be5dfb', 'bespeakStatus', '未处理', '0', null, '1', '1', null, null);
INSERT INTO sys_dict_data VALUES ('d099151e67b342d2ab261cc0d6256e11', 'realizeAmountCondition', '1万元以下', '1', null, '1', '1', null, 'n&lt;= 10000');
INSERT INTO sys_dict_data VALUES ('d0c1b7d9dac942bc95410cc15d10be8a', 'timeCondition', '3-6个月', '3', null, '3', '1', null, null);
INSERT INTO sys_dict_data VALUES ('d1ed83a1a60a4502b502aa3e79b762b8', 'sysLogContent', '资金对账', 'account_check', null, '9', '0', null, null);
INSERT INTO sys_dict_data VALUES ('d28f1803c9d14f2791ea2222d6825432', 'realizeStatus', '逾期中', '87', null, '5', '1', null, null);
INSERT INTO sys_dict_data VALUES ('d291d500a98e497aa4e4cf815d3182ea', 'sysLogContent', '借款列表', 'borrow_list', null, '20', '1', null, null);
INSERT INTO sys_dict_data VALUES ('d38199b1cab442649d8038b10777ee18', 'sysLogMethod', '查看', 'view', null, '2', '1', null, null);
INSERT INTO sys_dict_data VALUES ('d38f231cdaaf44988d115a0a346ac6db', 'cashFeeType', '平台垫付', '1', null, '2', '1', '平台垫付', null);
INSERT INTO sys_dict_data VALUES ('d44919ced8ce4182848bb5170a0c5347', 'realizeStatus', '逾期已还款', '91', null, '6', '1', null, null);
INSERT INTO sys_dict_data VALUES ('d57960a450b14f87bc5bd376d75f8bfc', 'menuIcon', '&lt;em class=&quot;iconfont&quot;&gt;&amp;#xe619;&lt;/em&gt;', '&amp;#xe619;', null, '24', '1', null, null);
INSERT INTO sys_dict_data VALUES ('d5f2d5c92ad741d995f4050cada04f9c', 'activityLogStatus', '已过期', '2', null, '2', '1', null, null);
...
INSERT INTO sys_dict_data VALUES ('d7c71ab6960e41259b6374f577d16ee6', 'sysLogContent', '风险等级', 'risk_level', null, '59', '1', null, null);
INSERT INTO sys_dict_data VALUES ('d7f301f6a83a41ccb666088a9378c731', 'sysLogContent', '消息模板', 'message_type', null, '71', '1', null, null);
INSERT INTO sys_dict_data VALUES ('d8b377e538b2413c895219f55ed82085', 'sysLogContent', '产品成立审核', 'product_establish', null, '38', '1', null, null);
...
INSERT INTO sys_dict_data VALUES ('d977c93480cd42818f76c99207101d13', 'workExperience', '10年以上', '5', null, '5', '1', null, null);
INSERT INTO sys_dict_data VALUES ('d9bb42c9f897479084edbcee3b924f2a', 'bespeakLimitTime', '12个月以上', '4', null, '4', '1', null, null);
INSERT INTO sys_dict_data VALUES ('dadf452dd3ac4e1e80e45e1a74a303a0', 'configType', '邮箱', '3', TO_DATE('2016-09-26 13:41:37', 'YYYY-MM-DD HH24:MI:SS'), '3', '1', '邮箱', null);
INSERT INTO sys_dict_data VALUES ('db7fe3276df840dba31c66d0fde98dbd', 'rechargePayWay', '线下充值', '3', null, '3', '1', '线下充值', null);
INSERT INTO sys_dict_data VALUES ('dce0977d61374a5a884dbab82d508d6f', 'sysLogContent', '借款审核', 'borrow_audit', null, '24', '1', null, null);
INSERT INTO sys_dict_data VALUES ('dd0bb6abc11846f8a943e3f1ff2b7fb5', 'awardType', '红包', '1', null, '1', '1', null, null);
INSERT INTO sys_dict_data VALUES ('de3565a2caf74195aa42f8c0c3801255', 'sex', '女', 'F', null, '2', '1', null, null);
INSERT INTO sys_dict_data VALUES ('de3abfaac72b45f1a7da2046a32ea670', 'sysLogContent', '坏账', 'repay_bad_debt', null, '44', '1', null, null);
INSERT INTO sys_dict_data VALUES ('de97e76e8beb4a14b200c6ffad00c10e', 'sysLogContent', '栏目', 'section', null, '18', '1', null, null);
INSERT INTO sys_dict_data VALUES ('dfd584e80ba0455faae31e76ef242d01', 'projectStatus', '坏账', '88', null, '16', '1', '坏账', null);
INSERT INTO sys_dict_data VALUES ('e0b6dd753a0f492b9dea1ae53484fd51', 'repayStyle', '每季还息到期还本', '5', null, '5', '1', null, null);
INSERT INTO sys_dict_data VALUES ('e0e8076b28544ff59fb200e271df3e64', 'platAccountStatus', '待处理', '0', null, '1', '1', '待处理', null);
INSERT INTO sys_dict_data VALUES ('e11131922af0485aadc5ef3355e1f7a2', 'sysLogContent', '平台账户间转账', 'sub_merchant_transfer', null, '8', '1', null, null);
INSERT INTO sys_dict_data VALUES ('e17932bf1e074753afae0d8697f49f7e', 'sysLogContent', '产品', 'product', null, '33', '1', null, null);
INSERT INTO sys_dict_data VALUES ('e17b4241d51f46a596a7d6e6da028b29', 'maritalStatus', '离异', '2', null, '3', '1', null, null);
INSERT INTO sys_dict_data VALUES ('e3e958b398a047a6ba761312b8a3bfde', 'sysLogContent', '待收列表', 'collection_record', null, '31', '1', null, null);
...
INSERT INTO sys_dict_data VALUES ('e45e21cd83ab11e699af000c296f8d81', 'configType', '登录校验', '6', TO_DATE('2016-09-26 13:41:37', 'YYYY-MM-DD HH24:MI:SS'), '6', '1', '登录校验', null);
INSERT INTO sys_dict_data VALUES ('e45e21cd83ab11e699af000c296f8d8c', 'configType', '验证码', '5', TO_DATE('2016-09-26 13:41:37', 'YYYY-MM-DD HH24:MI:SS'), '5', '1', '验证码', null);
INSERT INTO sys_dict_data VALUES ('e4de5a02ac464e0caef7a8f167d78bea', 'realizeAprCondition', '6%以下', '1', null, '1', '1', null, 'n&lt;6');
INSERT INTO sys_dict_data VALUES ('e580a23cefbd4d1e963304c80da0dec8', 'vipLevel', 'VIP2及以上', '2', null, '2', '1', null, null);
INSERT INTO sys_dict_data VALUES ('e68204661a2c42089cda62051a276d18', 'rechargeFeeType', '平台垫付', '02', null, '2', '1', '平台垫付', null);
INSERT INTO sys_dict_data VALUES ('e77da6295c504261afaf0c2424546dc6', 'bespeakLimitTime', '6-12个月', '3', null, '3', '1', null, null);
INSERT INTO sys_dict_data VALUES ('e7e64c045f7146ab94f53199e84bfae5', 'sysLogMethod', '发放', 'grant', null, '5', '1', null, null);
INSERT INTO sys_dict_data VALUES ('e7eb723da54e41d4b7f9b4d4b4e0b429', 'projectStatus', '发布待审', '1', null, '4', '1', '发布待审', null);
INSERT INTO sys_dict_data VALUES ('e97462f35ba64d33a3b10dd8c3ec74b8', 'vipLevel', 'VIP3及以上', '3', null, '3', '1', null, null);
INSERT INTO sys_dict_data VALUES ('e97d1d1c895b420a80332ae29a29fe3f', 'vouchFreeze', '担保', 'vouch', null, '3', '1', null, null);
INSERT INTO sys_dict_data VALUES ('e9e19b9b4fbd45c587894b3a3256e6be', 'sysLogContent', '提现人工核查', 'cash_check', null, '12', '1', null, null);
INSERT INTO sys_dict_data VALUES ('ea06317743894fa2bcd21e32bf6b1505', 'projectStatus', '已作废', '30', null, '7', '1', '已作废', null);
INSERT INTO sys_dict_data VALUES ('ea2ebdbe35134133887ff21f7288df8d', 'platAccountType', '借款管理费', '6', null, '6', '1', null, null);
INSERT INTO sys_dict_data VALUES ('ea881c9b92fe4ddbaa892245cdae8021', 'educationLevel', '小学', '1', null, '1', '1', '小学', null);
INSERT INTO sys_dict_data VALUES ('eac1bab8baa6431781a6fd489a59aa16', 'menuIcon', '&lt;em class=&quot;iconfont&quot;&gt;&amp;#xe634;&lt;/em&gt;', '&amp;#xe634;', null, '21', '1', null, null);
INSERT INTO sys_dict_data VALUES ('ead3a993d92643c59e2081de6e7b6f73', 'borrowStatus', '发布审核被拒', '3', null, '4', '1', '产品的发布审核不通过；借款审核不通过', null);
INSERT INTO sys_dict_data VALUES ('eb1ee626d51b4bdcb2b0e444798db128', 'educationLevel', '幼稚园', '11', null, '0', '1', null, null);
INSERT INTO sys_dict_data VALUES ('eb32c278395146aaaec61cb1d09c8cf9', 'sysLogContent', '担保用户', 'vouch', null, '88', '1', null, null);
INSERT INTO sys_dict_data VALUES ('ed6f7f5877974d418492d374568ed69e', 'accountType', '受让投资', 'bond_buy', null, '1', '1', '受让投资', null);
INSERT INTO sys_dict_data VALUES ('edf40d0ba0ca489c883d5079143f6fdf', 'cashStatus', '提现失败', '4', null, '5', '1', null, null);
INSERT INTO sys_dict_data VALUES ('eee5f83c16654d28ae2b68cc180ebdbd', 'platAccountStatus', '失败', '2', null, '3', '1', '失败', null);
INSERT INTO sys_dict_data VALUES ('ef23ed9cb6e74393987e5710f310f4c3', 'accountBank', '民生银行', 'CMBC', null, '7', '1', null, null);
INSERT INTO sys_dict_data VALUES ('ef8458c77c014747bde0129cab4ca5d1', 'specificSale', '定向邮箱域名', '3', null, '3', '1', '只有指定邮箱域名的用户可以投资', null);
INSERT INTO sys_dict_data VALUES ('efa56c53cd444cb4acdf14846bd6e317', 'productTimeLimit', '6-12个月', '2', null, '3', '1', null, null);
INSERT INTO sys_dict_data VALUES ('efbcf9e89eb84984b368c33650ab663e', 'timeCondition', '12个月以上', '5', null, '5', '1', null, null);
INSERT INTO sys_dict_data VALUES ('efdb50233c97480f813d00ecf3bbd5a0', 'salaryRange', '10-15万', '5', null, '5', '1', '10000-13000元', null);
INSERT INTO sys_dict_data VALUES ('efddc6b176e649d88c72f322225e1ec7', 'vouchFreeze', '充值', 'recharge', null, '1', '1', null, null);
INSERT INTO sys_dict_data VALUES ('f0078190017d4b57bec8f08e9bf9829a', 'workExperience', '8年', '4', null, '4', '1', '工作年限', null);
INSERT INTO sys_dict_data VALUES ('f007cba5342c487d94db82ebb6821624', 'projectStatus', '待售', '41', null, '9', '1', null, null);
INSERT INTO sys_dict_data VALUES ('f07dcedc3e324aa0afe973f6e3ad1bda', 'sysLogContent', '首页信息', 'index', null, '67', '1', null, null);
INSERT INTO sys_dict_data VALUES ('f201657e22754749b89eb7e4df4cff2c', 'accountType', '变现管理费', 'realize_managefee', null, '77', '1', null, null);
INSERT INTO sys_dict_data VALUES ('f2d19b6059b740c38570d987851c4c2c', 'menuIcon', '&lt;em class=&quot;iconfont&quot;&gt;&amp;#xe628;&lt;/em&gt;', '&amp;#xe628;', null, '39', '1', null, null);
...
INSERT INTO sys_dict_data VALUES ('f48e2ba2a7594fef913a7dd8280bb8c1', 'tppType', '还款', 'repay', null, '5', '1', null, null);
INSERT INTO sys_dict_data VALUES ('f4c7eefeeaeb402eb17ca5717c84fba3', 'sysLogContent', '活动方案', 'activity', null, '45', '1', null, null);
INSERT INTO sys_dict_data VALUES ('f508fcfc3bef4f368e8fbffc280bafed', 'sysLogContent', '角色关联', 'operator_role', null, '73', '1', null, null);
INSERT INTO sys_dict_data VALUES ('f527ea4e8caf47bd920e50d7233db921', 'sendStatus', '全部', '99', null, '0', '1', null, null);
INSERT INTO sys_dict_data VALUES ('f5ca539f8e8943cc8fa5aa904f0539fc', 'menuIcon', '&lt;em class=&quot;iconfont&quot;&gt;&amp;#xe629;&lt;/em&gt;', '&amp;#xe629;', null, '40', '1', null, null);
INSERT INTO sys_dict_data VALUES ('f5fa088e7ca44566a84d93d843150725', 'companyQualificationType', '还款能力证明', 'repaymentAbility', null, '2', '1', null, null);
INSERT INTO sys_dict_data VALUES ('f662c60e770149528dfd2a8c567c95d6', 'accountType', '成立放款', 'loan', null, '20', '1', null, null);
INSERT INTO sys_dict_data VALUES ('f8d3ca5f621a4303b17099d5a916dff0', 'accountType', '投资成功', 'invest_success', null, '1', '1', null, null);
INSERT INTO sys_dict_data VALUES ('f9155dd559194080bb0a3200602e114f', 'realNameStatus', '认证未通过', '-1', null, '3', '1', '认证未通过', null);
INSERT INTO sys_dict_data VALUES ('f96a725e4cbf4f3086c1da16136c1413', 'sysLogContent', '红包规则', 'red_rule', null, '47', '1', null, null);
INSERT INTO sys_dict_data VALUES ('fa2f74f21a0544958065c6920fe8de80', 'sysLogContent', '借款人', 'borrower', null, '22', '1', null, null);
INSERT INTO sys_dict_data VALUES ('fb8c602198c948b0b569dd9359effb6e', 'sysLogContent', '加息券', 'user_rate', null, '50', '1', null, null);
INSERT INTO sys_dict_data VALUES ('fb92e8d8868b4ace9a824ece35f851f9', 'repayStyle', '一次性还款', '2', null, '2', '1', '一次性还款', null);
INSERT INTO sys_dict_data VALUES ('fbb74f24cd984e8489298d72a67f138d', 'borrowStatus', '未成立', '7', null, '9', '1', null, null);
INSERT INTO sys_dict_data VALUES ('fbe3043c03694c94b23dca0ec74d0772', 'vipLevel', 'VIP6', '6', null, '6', '1', null, null);
INSERT INTO sys_dict_data VALUES ('fdc7af6c2ab344518ce1dec010897fe0', 'sysLogMethod', '上架', 'sale', null, '12', '1', null, null);
...
INSERT INTO sys_dict_data VALUES ('fee085959bd642179b38de5f4a43d4f8', 'accountBank', '中信银行', 'CNCB', null, '13', '1', null, null);
...
;
COMMENT ON TABLE sys_dict_type IS '字典分类表';
COMMENT ON COLUMN sys_dict_type.uuid IS '主键';
...
-- ----------------------------
INSERT INTO sys_dict_type VALUES ('00923cfc6d71423db5863f4d4a874f83', 'accountType', '用户资金类别', TO_DATE('2016-06-04 18:09:57', 'YYYY-MM-DD HH24:MI:SS'), null);
INSERT INTO sys_dict_type VALUES ('00923cfc6d71423db5863f4d4a876456', 'accountStatus', '金额状态', TO_DATE('2016-07-12 11:34:45', 'YYYY-MM-DD HH24:MI:SS'), '充值提现使用');
INSERT INTO sys_dict_type VALUES ('033673e493ea45b4a14471cb671886b4', 'vouchFreeze', '担保机构可冻结功能', TO_DATE('2016-10-09 19:29:17', 'YYYY-MM-DD HH24:MI:SS'), null);
INSERT INTO sys_dict_type VALUES ('0e8ad58f0b1f43e6b52b7fc4338e0544', 'rechargePayWay', '充值类型', TO_DATE('2016-08-04 13:39:01', 'YYYY-MM-DD HH24:MI:SS'), '充值类型');
INSERT INTO sys_dict_type VALUES ('11121', 'messageType', '消息类型', TO_DATE('2016-06-22 13:46:55', 'YYYY-MM-DD HH24:MI:SS'), '消息类型');
INSERT INTO sys_dict_type VALUES ('11122', 'sendType', '通知类型', TO_DATE('2016-06-22 14:03:46', 'YYYY-MM-DD HH24:MI:SS'), '通知类型');
INSERT INTO sys_dict_type VALUES ('11123', 'borrowNature', '借款性质', TO_DATE('2016-06-27 13:30:26', 'YYYY-MM-DD HH24:MI:SS'), '借款性质根据用户性质来');
INSERT INTO sys_dict_type VALUES ('11d44438a6e048eeb3efa1d236f2f311', 'optType', '积分行为', null, null);
INSERT INTO sys_dict_type VALUES ('11d44438a6e048eeb3efa1d236f2f351', 'platAccountStatus', '平台资金状态', TO_DATE('2016-07-29 15:47:10', 'YYYY-MM-DD HH24:MI:SS'), null);
INSERT INTO sys_dict_type VALUES ('13276fae643641149b42419e53b0ed9c', 'buyStyle', '投资金额方式', TO_DATE('2016-07-25 14:07:41', 'YYYY-MM-DD HH24:MI:SS'), null);
INSERT INTO sys_dict_type VALUES ('1365056938784bcfae3bf992566b4533', 'investStatus', '投资状态', TO_DATE('2016-07-29 13:16:39', 'YYYY-MM-DD HH24:MI:SS'), '投资状态');
INSERT INTO sys_dict_type VALUES ('1b92cd0141124117ba8f691fb867fd36', 'interLanguage', '国际化语言', TO_DATE('2016-07-28 14:01:16', 'YYYY-MM-DD HH24:MI:SS'), '国际化语言');
INSERT INTO sys_dict_type VALUES ('1e9130605f084156b10e6840f9262c35', 'productTimeLimit', '产品期限', TO_DATE('2016-06-29 17:43:14', 'YYYY-MM-DD HH24:MI:SS'), '产品期限,产品管理条件查询枚举值');
INSERT INTO sys_dict_type VALUES ('2600e0429add4107878945c1bbce4a62', 'realizeStatus', '变现状态', TO_DATE('2016-09-12 16:52:20', 'YYYY-MM-DD HH24:MI:SS'), '变现项目的状态');
INSERT INTO sys_dict_type VALUES ('2727226a2e554458962260ff509ecf9d', 'configType', '参数类型', TO_DATE('2016-08-23 18:02:40', 'YYYY-MM-DD HH24:MI:SS'), null);
INSERT INTO sys_dict_type VALUES ('2a2779fe53124cd3bd71496d098e0db5', 'userNature', '用户性质', TO_DATE('2016-06-29 14:58:14', 'YYYY-MM-DD HH24:MI:SS'), '用户性质');
INSERT INTO sys_dict_type VALUES ('2b192879ef2d4152a53ca0328764f872', 'salaryRange', '年收入', TO_DATE('2016-07-27 13:46:41', 'YYYY-MM-DD HH24:MI:SS'), '年收入');
INSERT INTO sys_dict_type VALUES ('2c813424004a44a6a489ed7ef79c0fee', 'myLoanStatus', '我的借款状态', TO_DATE('2016-12-14 13:40:19', 'YYYY-MM-DD HH24:MI:SS'), '我的借款-项目状态');
INSERT INTO sys_dict_type VALUES ('2ca8cea8b30d4ee0a76a6db612135ab2', 'vipLevel', 'vip等级', TO_DATE('2016-07-04 17:46:04', 'YYYY-MM-DD HH24:MI:SS'), null);
INSERT INTO sys_dict_type VALUES ('318e15995d4547798ba53060ec856fb5', 'repayStatus', '还款状态', TO_DATE('2016-08-03 10:41:50', 'YYYY-MM-DD HH24:MI:SS'), '还款状态');
INSERT INTO sys_dict_type VALUES ('31f3749ecc114584b7b87c5cfafaad6e', 'sysLogMethod', '操作方式', TO_DATE('2016-10-24 11:19:46', 'YYYY-MM-DD HH24:MI:SS'), '系统日志操作方式');
INSERT INTO sys_dict_type VALUES ('3c8dd341b1d74a47a83c9a66955b0875', 'user_security_question', '用户密保问题', TO_DATE('2016-07-20 18:03:55', 'YYYY-MM-DD HH24:MI:SS'), '用户密保问题');
INSERT INTO sys_dict_type VALUES ('3f7549af7e5c4a38a6de00fc16ef3531', 'protocolType', '协议类型', TO_DATE('2016-07-21 15:50:18', 'YYYY-MM-DD HH24:MI:SS'), '协议模板类型标识（注册用户协议、借款协议、债权转让协议等）');
INSERT INTO sys_dict_type VALUES ('3f83b814545842fd9ae74316d9993a58', 'companyQualificationType', '企业资质认证资料类型', TO_DATE('2016-08-03 15:10:23', 'YYYY-MM-DD HH24:MI:SS'), '企业上传资质认证资料类型');
INSERT INTO sys_dict_type VALUES ('408829311aa411e799bd408d5c073447', 'cbhb_bank_card', '渤海银行--银行卡列表', TO_DATE('2017-03-01 13:48:02', 'YYYY-MM-DD HH24:MI:SS'), '渤海银行--银行卡列表');
INSERT INTO sys_dict_type VALUES ('409866b01aa411e799bd408d5c073447', 'cbhb_transStat', '渤海银行--交易状态枚举', TO_DATE('2017-03-02 20:00:09', 'YYYY-MM-DD HH24:MI:SS'), '渤海银行--交易状态枚举');
INSERT INTO sys_dict_type VALUES ('41969ae9689346d5959ff43f863acefc', 'bondMoneyType', '债权专区查询条件剩余债权', TO_DATE('2016-08-18 18:11:47', 'YYYY-MM-DD HH24:MI:SS'), '债权专区查询条件剩余债权');
INSERT INTO sys_dict_type VALUES ('44be6c29da4b4737bb9c27303742014c', 'borrowStatus', '借款状态', TO_DATE('2016-06-27 14:17:32', 'YYYY-MM-DD HH24:MI:SS'), '借贷项目状态');
INSERT INTO sys_dict_type VALUES ('460547f61b4c4712927928e16e8fc942', 'projectStatus', '借贷状态', TO_DATE('2016-08-02 11:29:33', 'YYYY-MM-DD HH24:MI:SS'), '我的借款-前台列表使用');
INSERT INTO sys_dict_type VALUES ('465d342f57d647f582ba4a5ff02f9057', 'sex', '性别', TO_DATE('2016-08-23 18:02:40', 'YYYY-MM-DD HH24:MI:SS'), null);
INSERT INTO sys_dict_type VALUES ('471674cc094b49e6bdf1d456c335d420', 'papersStatus', '问卷状态', TO_DATE('2016-07-13 11:23:40', 'YYYY-MM-DD HH24:MI:SS'), '问卷状态');
INSERT INTO sys_dict_type VALUES ('4c8eeac66af34a59bff610666c2c0a90', 'tppStatus', '第三方交易状态', TO_DATE('2016-09-27 15:43:47', 'YYYY-MM-DD HH24:MI:SS'), '第三方交易状态：0-未处理，1-成功，2-失败');
INSERT INTO sys_dict_type VALUES ('4e840a359a6d489aaf660327aca35712', 'bespeakStatus', '预约借款状态', TO_DATE('2016-08-19 13:33:45', 'YYYY-MM-DD HH24:MI:SS'), null);
INSERT INTO sys_dict_type VALUES ('520bbeee63024c328419bd64444932e4', 'specificSale', '定向销售', TO_DATE('2016-07-06 14:58:02', 'YYYY-MM-DD HH24:MI:SS'), '产品定向销售类型：不限制；定向VIP等级；定向密码；定向邮箱；');
INSERT INTO sys_dict_type VALUES ('54129d1bfe984d6bb81ff78463104dc0', 'borrowUse', '借款用途', TO_DATE('2016-06-27 16:01:29', 'YYYY-MM-DD HH24:MI:SS'), null);
INSERT INTO sys_dict_type VALUES ('567d54185c754e66ab92b007f682ee53', 'carStatus', '车产', TO_DATE('2016-08-03 21:52:02', 'YYYY-MM-DD HH24:MI:SS'), null);
INSERT INTO sys_dict_type VALUES ('56e904cf1c004786af5a4cfcdb2308cc', 'bondStatus', '债权状态', TO_DATE('2016-08-05 10:59:28', 'YYYY-MM-DD HH24:MI:SS'), '债权状态');
INSERT INTO sys_dict_type VALUES ('5e69c28e81054666a76fa13a5f406cb3', 'educationLevel', '学历', TO_DATE('2016-07-27 13:25:05', 'YYYY-MM-DD HH24:MI:SS'), '学历');
INSERT INTO sys_dict_type VALUES ('5fe55dc2b1374e9ab8019017455923b6', 'realizeAmountCondition', '变现金额查询条件', TO_DATE('2016-08-19 13:41:46', 'YYYY-MM-DD HH24:MI:SS'), '变现金额查询条件');
INSERT INTO sys_dict_type VALUES ('610c627792b04ccaaaa04ce70ec9e2a6', 'interestStyle', '计息方式', TO_DATE('2016-06-22 15:28:55', 'YYYY-MM-DD HH24:MI:SS'), '计息方式');
INSERT INTO sys_dict_type VALUES ('6a510934c8394dd3b4df6928b3f3e9ad', 'workExperience', '工作年限', TO_DATE('2016-07-27 13:43:50', 'YYYY-MM-DD HH24:MI:SS'), '工作年限');
INSERT INTO sys_dict_type VALUES ('6bdcfe862b5e4a24aacfe8ed1859bc1d', 'cardType', '证件类别', TO_DATE('2016-06-06 17:34:53', 'YYYY-MM-DD HH24:MI:SS'), null);
INSERT INTO sys_dict_type VALUES ('736837ab2b3a4e15bc23444ebf097093', 'userFreeze', '用户可冻结功能', TO_DATE('2016-07-27 10:36:06', 'YYYY-MM-DD HH24:MI:SS'), '用户可冻结功能');
INSERT INTO sys_dict_type VALUES ('738d5244a30b4c5f8b910dbf3072d269', 'accountBank', '银行列表', TO_DATE('2016-06-04 18:08:58', 'YYYY-MM-DD HH24:MI:SS'), null);
INSERT INTO sys_dict_type VALUES ('754914792f8f4d69a0ab63d817fffc90', 'realNameStatus', '实名认证状态', TO_DATE('2016-07-30 10:56:46', 'YYYY-MM-DD HH24:MI:SS'), '实名认证状态');
INSERT INTO sys_dict_type VALUES ('7565cfe44dd747289022a565e370b3ac', 'realizeDayCondition', '变现日期查询条件', TO_DATE('2016-08-19 13:43:34', 'YYYY-MM-DD HH24:MI:SS'), null);
INSERT INTO sys_dict_type VALUES ('7cef2e452fb44e0c9f89bf75bc0e75f4', 'saleStyle', '销售方式', TO_DATE('2016-06-22 17:27:41', 'YYYY-MM-DD HH24:MI:SS'), '销售方式');
INSERT INTO sys_dict_type VALUES ('81040a436946450b8d38778396aee877', 'rechargeFeeType', '充值垫付类型', TO_DATE('2016-08-04 13:37:28', 'YYYY-MM-DD HH24:MI:SS'), '充值垫付类型');
INSERT INTO sys_dict_type VALUES ('8977532c90984f6cbd3aa0d2cd345c68', 'investType', '投资方式', TO_DATE('2016-07-29 14:09:56', 'YYYY-MM-DD HH24:MI:SS'), null);
INSERT INTO sys_dict_type VALUES ('89cda4799171445c98f2b00b40242f58', 'rechargeStatus', '充值状态', TO_DATE('2016-07-23 10:16:23', 'YYYY-MM-DD HH24:MI:SS'), null);
INSERT INTO sys_dict_type VALUES ('8f7e2ba76275463bbdb6f956b9376e68', 'projectProcessNode', '项目环节', TO_DATE('2016-09-26 17:45:10', 'YYYY-MM-DD HH24:MI:SS'), '项目的流程环节，用于记录项目审核记录');
INSERT INTO sys_dict_type VALUES ('9058ffb6cb524e0ca0a0d4d596b91371', 'repayType', '还款类型', TO_DATE('2017-03-26 11:33:21', 'YYYY-MM-DD HH24:MI:SS'), '还款类型（1正常还款 2 垫付  3 已还垫付4 逾期还款）');
INSERT INTO sys_dict_type VALUES ('9637d8e82b4942c7b4b29c4a944d04a9', 'aprType', '债权专区查询条件利率', TO_DATE('2016-08-18 20:20:10', 'YYYY-MM-DD HH24:MI:SS'), '债权专区查询条件利率');
INSERT INTO sys_dict_type VALUES ('9645429e382845dab528f50bd5c22f49', 'maritalStatus', '婚姻状况', TO_DATE('2016-08-03 21:43:08', 'YYYY-MM-DD HH24:MI:SS'), null);
INSERT INTO sys_dict_type VALUES ('985268face2e42df8c8a4768edd880c0', 'cashFeeType', '提现垫付类型', TO_DATE('2016-08-04 14:28:26', 'YYYY-MM-DD HH24:MI:SS'), '提现垫付类型');
INSERT INTO sys_dict_type VALUES ('98e6548ddbd04cf38228fdcc8a148d26', 'timeType', '借款期限类型', TO_DATE('2016-06-27 15:32:43', 'YYYY-MM-DD HH24:MI:SS'), null);
INSERT INTO sys_dict_type VALUES ('9d1483a353374d89a75081f6423eca9b', 'orgLevel', '机构层级', TO_DATE('2016-08-23 18:02:40', 'YYYY-MM-DD HH24:MI:SS'), null);
INSERT INTO sys_dict_type VALUES ('a7413c1b19bf46fe924d10fa5bddbfde', 'papers_type', '问卷类型', TO_DATE('2016-07-13 11:25:43', 'YYYY-MM-DD HH24:MI:SS'), '问卷类型');
INSERT INTO sys_dict_type VALUES ('a784b78371c34d49ae9aea24ff7d63a9', 'houseStatus', '房产', TO_DATE('2016-08-03 21:53:40', 'YYYY-MM-DD HH24:MI:SS'), null);
INSERT INTO sys_dict_type VALUES ('ac60eb9209ec4801af7459aa0da1fadd', '答复', '是打发点', TO_DATE('2016-10-31 20:42:54', 'YYYY-MM-DD HH24:MI:SS'), '大师傅大');
INSERT INTO sys_dict_type VALUES ('b494deca668045bf8df4d4deba0859df', 'timeCondition', '产品期限查询条件', TO_DATE('2016-08-11 17:02:16', 'YYYY-MM-DD HH24:MI:SS'), null);
INSERT INTO sys_dict_type VALUES ('b88287c0b2044ac6a8ad155c71058910', 'saleChannel', '上架渠道', TO_DATE('2016-07-06 19:48:27', 'YYYY-MM-DD HH24:MI:SS'), '上架渠道:PC,APP,微信');
INSERT INTO sys_dict_type VALUES ('ba2b025b359346289f6daa7dbd51e8ac', 'logTemplateType', '日志模板类型', TO_DATE('2016-06-04 09:36:32', 'YYYY-MM-DD HH24:MI:SS'), null);
INSERT INTO sys_dict_type VALUES ('bb452a0602af4f95bc18321d6b6543da', 'userType', '用户类型', TO_DATE('2016-06-06 17:35:33', 'YYYY-MM-DD HH24:MI:SS'), null);
INSERT INTO sys_dict_type VALUES ('bed93f86c78d414db32ee5a41023ba86', 'productStatus', '产品状态', TO_DATE('2016-10-12 19:48:37', 'YYYY-MM-DD HH24:MI:SS'), '产品状态');
INSERT INTO sys_dict_type VALUES ('bf80442d72314a53a67bafebe4193a68', 'cashStatus', '提现状态', TO_DATE('2016-07-23 10:19:58', 'YYYY-MM-DD HH24:MI:SS'), null);
INSERT INTO sys_dict_type VALUES ('bf8cfe2337d1442da1d61d58fc3c4691', 'test', '测试类型', TO_DATE('2016-08-23 16:03:00', 'YYYY-MM-DD HH24:MI:SS'), '测试类型案例');
INSERT INTO sys_dict_type VALUES ('c62d18ad10e8407bb47f75e53fe65e3e', 'qualificationApplyStatus', '资质证明上传状态', TO_DATE('2016-08-03 19:03:39', 'YYYY-MM-DD HH24:MI:SS'), null);
INSERT INTO sys_dict_type VALUES ('c63bf86c33cf4c09baf79e0640057e81', 'cashStatusWeb', '提现前台状态', TO_DATE('2016-10-19 21:06:01', 'YYYY-MM-DD HH24:MI:SS'), '用户提现状态(前台展示)');
INSERT INTO sys_dict_type VALUES ('c7eb23df009546a092f38330598833fb', 'amountCondition', '产品金额查询条件', TO_DATE('2016-08-11 17:00:24', 'YYYY-MM-DD HH24:MI:SS'), '产品金额查询条件');
INSERT INTO sys_dict_type VALUES ('c9060803e2ce47fd99a4a42749e48554', 'qualificationType', '个人资质认证资料类型', TO_DATE('2016-07-26 16:07:41', 'YYYY-MM-DD HH24:MI:SS'), '个人上传资质认证资料类型');
INSERT INTO sys_dict_type VALUES ('ca1277ff48f94d728dfa45c9a0bcb7d4', 'realizeSellStyle', '变现金额方式', TO_DATE('2016-07-25 14:01:49', 'YYYY-MM-DD HH24:MI:SS'), '变现金额方式');
INSERT INTO sys_dict_type VALUES ('d1c1ce8c19054a649e6a4bd7e93b3d2f', 'realizeAprCondition', '变现利率查询条件', TO_DATE('2016-08-19 13:46:54', 'YYYY-MM-DD HH24:MI:SS'), '变现利率查询条件');
INSERT INTO sys_dict_type VALUES ('d326671f3cdd451986057a1694b0a3bd', 'awardType', '奖励类型', TO_DATE('2016-10-28 18:07:04', 'YYYY-MM-DD HH24:MI:SS'), null);
INSERT INTO sys_dict_type VALUES ('d8726e1c8b754350ad71bb6ab3f4fb9c', 'yesNo', '是否', TO_DATE('2016-08-10 14:14:12', 'YYYY-MM-DD HH24:MI:SS'), '是否标识');
INSERT INTO sys_dict_type VALUES ('dc4397c823db4788b6ab64487908d301', 'platAccountType', '商户资金类别', TO_DATE('2016-07-29 15:43:57', 'YYYY-MM-DD HH24:MI:SS'), '商户资金类别');
INSERT INTO sys_dict_type VALUES ('df728772cd2145ffaee1b1621f217b4f', 'menuIcon', '菜单图标', TO_DATE('2016-08-26 16:53:02', 'YYYY-MM-DD HH24:MI:SS'), null);
INSERT INTO sys_dict_type VALUES ('e020515e087d414c81171477b88eeae1', 'activityLogStatus', '邀请奖励状态', TO_DATE('2016-10-28 18:10:59', 'YYYY-MM-DD HH24:MI:SS'), null);
INSERT INTO sys_dict_type VALUES ('e15686c5bfe14b2cbbb1b69da1763d46', 'userStatus', '用户状态', TO_DATE('2016-08-12 15:44:35', 'YYYY-MM-DD HH24:MI:SS'), null);
INSERT INTO sys_dict_type VALUES ('e415925c59f346e6875d40ffec70dbfd', 'sysLogContent', '操作内容', TO_DATE('2016-10-24 11:18:15', 'YYYY-MM-DD HH24:MI:SS'), '系统日志操作内容');
INSERT INTO sys_dict_type VALUES ('e5c879a01151471da814a7966c2505e0', 'bespeakLimitTime', '预约借款期限', TO_DATE('2016-08-10 20:16:11', 'YYYY-MM-DD HH24:MI:SS'), null);
INSERT INTO sys_dict_type VALUES ('ed0d983af998494d96a8703140a50278', 'sendStatus', '发送状态', TO_DATE('2016-06-22 16:26:26', 'YYYY-MM-DD HH24:MI:SS'), '消息发送状态');
INSERT INTO sys_dict_type VALUES ('ed69d1f6e8cd422599919264d6b93b96', 'bondInvestStatus', '债权投资状态', TO_DATE('2016-08-05 11:30:48', 'YYYY-MM-DD HH24:MI:SS'), '债权投资状态');
INSERT INTO sys_dict_type VALUES ('ed7266c764f84529b338d4f37f7958df', 'tppType', '第三方服务类型', TO_DATE('2016-09-27 15:48:30', 'YYYY-MM-DD HH24:MI:SS'), '第三方服务类型');
INSERT INTO sys_dict_type VALUES ('f0c8f4e3a27c49298638e2bbfcb5d69b', 'authentication_type', '操作记录类型', TO_DATE('2016-06-06 15:25:51', 'YYYY-MM-DD HH24:MI:SS'), '操作记录类型');
INSERT INTO sys_dict_type VALUES ('f22a41de2f244cfd83b84339acd9a38c', 'remainDaysType', '债权专区查询条件剩余期限', TO_DATE('2016-08-18 18:18:09', 'YYYY-MM-DD HH24:MI:SS'), '债权专区查询条件剩余期限');
INSERT INTO sys_dict_type VALUES ('f614ecf27d9a458d8a1b2588945b2fdf', 'enable', '是否启用', TO_DATE('2016-08-23 18:02:40', 'YYYY-MM-DD HH24:MI:SS'), null);
INSERT INTO sys_dict_type VALUES ('fcd16b7389c14d66a38289a436cf490e', 'isSingle', '是否单选', TO_DATE('2016-07-13 11:48:01', 'YYYY-MM-DD HH24:MI:SS'), '是否单选');
INSERT INTO sys_dict_type VALUES ('ff6cd5a3abe240e7853cb0d76ff5ca4a', 'repayStyle', '还款方式', TO_DATE('2016-06-06 17:34:12', 'YYYY-MM-DD HH24:MI:SS'), null);

-- ----------------------------
-- Table structure for sys_letter
-- ----------------------------
DROP TABLE sys_letter;
CREATE TABLE sys_letter (
uuid NVARCHAR2(32) NOT NULL ,
send_user NVARCHAR2(32) NULL ,
receive_user NVARCHAR2(32) NULL ,
...
;
COMMENT ON TABLE sys_letter IS '站内信表（是message表的子集，提高前台用户查询效率）';
COMMENT ON COLUMN sys_letter.uuid IS '主键';
COMMENT ON COLUMN sys_letter.send_user IS '发送用户ID';
COMMENT ON COLUMN sys_letter.receive_user IS '接收用户ID';
COMMENT ON COLUMN sys_letter.title IS '消息标题';
COMMENT ON COLUMN sys_letter.content IS '内容';
COMMENT ON COLUMN sys_letter.status IS '状态（0 新建，1发送成功 2发送失败）';
COMMENT ON COLUMN sys_letter.read_flag IS '阅读标识(1已阅读，0未阅读，默认0)';
COMMENT ON COLUMN sys_letter.delete_flag IS '0 未删除，1 已删除';
COMMENT ON COLUMN sys_letter.create_time IS '添加时间';
COMMENT ON COLUMN sys_letter.remark IS '备注: 发送结果信息';
...
request_uri NVARCHAR2(512) NULL ,
request_method NVARCHAR2(128) NULL ,
params NCLOB NULL ,
exception NCLOB NULL ,
create_time DATE NULL ,
remark NVARCHAR2(300) NULL ,
user_id NVARCHAR2(32) NULL ,
TAKE_TIME NUMBER(10,4) NULL ,
operation_content NVARCHAR2(32) NULL 
)
LOGGING
NOCOMPRESS
NOCACHE
...
COMMENT ON COLUMN sys_log.uuid IS '主键';
...
COMMENT ON COLUMN sys_log.request_method IS '操作方式';
COMMENT ON COLUMN sys_log.params IS '操作提交的数据';
COMMENT ON COLUMN sys_log.exception IS '异常信息';
COMMENT ON COLUMN sys_log.create_time IS '添加时间';
COMMENT ON COLUMN sys_log.remark IS '备注';
COMMENT ON COLUMN sys_log.USER_ID IS '登录用户id';
COMMENT ON COLUMN sys_log.TAKE_TIME IS '耗时(s)';
COMMENT ON COLUMN sys_log.operation_content IS '操作内容';
...
;
COMMENT ON TABLE sys_log_template IS '日志模板';
COMMENT ON COLUMN sys_log_template.uuid IS '主键';
COMMENT ON COLUMN sys_log_template.log_type IS '日志类型:1资金日志，2积分日志';
COMMENT ON COLUMN sys_log_template.code IS '模板标识';
COMMENT ON COLUMN sys_log_template.template_name IS '模板名称';
COMMENT ON COLUMN sys_log_template.template_content IS '模板信息';
COMMENT ON COLUMN sys_log_template.delete_flag IS '0 未删除，1 已删除';
COMMENT ON COLUMN sys_log_template.create_time IS '添加时间';
COMMENT ON COLUMN sys_log_template.remark IS '备注';

-- ----------------------------
-- Records of sys_log_template
-- ----------------------------
INSERT INTO sys_log_template VALUES ('004679fc5cac410ca91b1e41abc8f56d', '1', 'realize_managefee', '扣除变现管理费', '扣除变现管理费${amount}元', '0', TO_DATE('2016-08-30 16:59:24', 'YYYY-MM-DD HH24:MI:SS'), '扣除变现管理费');
INSERT INTO sys_log_template VALUES ('0483f641a15e4deeaa30de80bf60ced7', '1', 'freeze_realize_lateinterest', '变现冻结逾期罚息', '冻结逾期罚息${amount!}元', '0', TO_DATE('2016-08-30 17:47:14', 'YYYY-MM-DD HH24:MI:SS'), '变现冻结逾期罚息');
INSERT INTO sys_log_template VALUES ('07113f8c4adf4bbca83fe598f36763be', '1', 'collect_interest', '收到利息', '${info!}还款，收到利息${amount}元', '0', TO_DATE('2016-08-29 14:19:50', 'YYYY-MM-DD HH24:MI:SS'), '收到利息');
INSERT INTO sys_log_template VALUES ('15dabf7ce88c4cd5a5209d1f36eb5bb5', '1', 'bond_sell_capital', '转让人转让本金入账', '【${bondInfo!}】转让成功，本金入账${capital!}元', '0', TO_DATE('2016-08-10 17:44:14', 'YYYY-MM-DD HH24:MI:SS'), '转让人转让本金入账');
INSERT INTO sys_log_template VALUES ('15ec4997946549348a9d005041164a6c', '1', 'collect_add_interest', '收到加息', '${info!}还款，收到加息${amount}元', '0', TO_DATE('2016-08-29 14:23:19', 'YYYY-MM-DD HH24:MI:SS'), '收到加息');
INSERT INTO sys_log_template VALUES ('1dff73dd846b40dc92dbf89bb6c03d28', '1', 'borrow_fee', '借款管理费', '支付借款管理费${fee!}元', '0', TO_DATE('2016-10-08 18:11:03', 'YYYY-MM-DD HH24:MI:SS'), '借款管理费');
INSERT INTO sys_log_template VALUES ('2748e39c2530439f89a57b399b288dcd', '1', 'first_tender_award', '第一次投资奖励', '收到第一次投资奖励${award}元。', '0', TO_DATE('2016-08-12 15:44:35', 'YYYY-MM-DD HH24:MI:SS'), '第一次投资奖励金额日志。');
INSERT INTO sys_log_template VALUES ('2ba421e612ad4e21b6e1e486732bc67c', '1', 'freeze_realize_interest', '冻结已变现利息', '变现原产品${projectName!}还款，冻结利息${amount!}元用于变现还款。', '0', TO_DATE('2016-12-12 18:07:21', 'YYYY-MM-DD HH24:MI:SS'), '冻结已变现利息');
INSERT INTO sys_log_template VALUES ('3dee7433ea19430b831d92ee7099a36d', '1', 'repay_late_interest_to_admin', '还款逾期利息给平台', '还款逾期利息，归还平台${amount!}元！', '0', TO_DATE('2016-10-26 15:38:21', 'YYYY-MM-DD HH24:MI:SS'), '还款逾期利息，归还平台xxx元！');
INSERT INTO sys_log_template VALUES ('4ea9e81b914611e699af000c296f8d8c', '1', 'bond_sell_duct', '转让人转让成功折让扣除', '【${bondInfo!}】转让成功,扣除折让金额${earnMoney!}元。', '0', TO_DATE('2016-10-13 21:09:43', 'YYYY-MM-DD HH24:MI:SS'), '转让人转让成功折让扣除');
INSERT INTO sys_log_template VALUES ('4f411f2e7daa4b60b2a0676e0ec31a25', '1', 'first_tender_award', '第一次投资奖励', '收到第一次投资奖励${award}元。', '0', TO_DATE('2016-08-23 18:02:40', 'YYYY-MM-DD HH24:MI:SS'), '第一次投资奖励金额日志。');
INSERT INTO sys_log_template VALUES ('51d4db463bcc4b2ea5ebdd257e5bf494', '1', 'collect_late_interest', '收到逾期利息', '${info!}还款，收到逾期利息${amount!}元', '0', TO_DATE('2016-08-29 14:20:25', 'YYYY-MM-DD HH24:MI:SS'), '收到逾期利息');
INSERT INTO sys_log_template VALUES ('56a7a52f7e104bafbd48e4413b3ff832', '1', 'invest_unfreeze', '投资失败', '投资失败，投资金额${amount!}，解冻实际支付金额${realAmount!}元。', '0', TO_DATE('2016-08-26 10:09:47', 'YYYY-MM-DD HH24:MI:SS'), '投资失败解冻资金');
INSERT INTO sys_log_template VALUES ('58420e1718a845a9ba47af9e96aff04a', '1', 'repaid_merchant_late_interest', '逾期给平台利息', '${info!}还款逾期,给平台利息${amount!}元', '0', TO_DATE('2016-11-05 18:57:01', 'YYYY-MM-DD HH24:MI:SS'), '逾期给平台利息');
INSERT INTO sys_log_template VALUES ('59d3495721d545ff9d2ae336d00c4c1a', '1', 'realize_income', '变现进账', '变现成功,收到变现金额${amount}元', '0', TO_DATE('2016-08-30 16:56:57', 'YYYY-MM-DD HH24:MI:SS'), '变现进账');
INSERT INTO sys_log_template VALUES ('5d4d5809914511e699af000c296f8d8c', '1', 'bond_sell_earn', '转让人转让成功收益收取', '【${bondInfo!}】转让成功,赚取收益${earnMoney!}元。', '0', TO_DATE('2016-10-13 21:02:58', 'YYYY-MM-DD HH24:MI:SS'), '转让人转让成功,收益处理');
INSERT INTO sys_log_template VALUES ('6030c83a60bc44e8a788e2b01eb1e349', '2', 'first_tender_award', '第一次投资奖励', '收到第一次投资奖励${award}元。', '0', TO_DATE('2016-11-28 14:56:16', 'YYYY-MM-DD HH24:MI:SS'), '第一次投资奖励金额日志。');
INSERT INTO sys_log_template VALUES ('70eef852ae4b4fd48c96cacdc8abf525', '1', 'freeze_realize_capital', '冻结已变现本金', '变现原产品${projectName!}还款，冻结本金${amount!}元用于变现还款。', '0', TO_DATE('2016-08-29 14:26:24', 'YYYY-MM-DD HH24:MI:SS'), '冻结已变现金额');
INSERT INTO sys_log_template VALUES ('802ee17049c342ca912ff2385ec4e28d', '1', 'interest_manage_fee', '利息管理费用', '${info!}还款利息，扣除利息管理费 ${amount}元。', '0', TO_DATE('2016-06-04 10:53:55', 'YYYY-MM-DD HH24:MI:SS'), '利息管理费日志。');
INSERT INTO sys_log_template VALUES ('8c009f63fde0436c86b128f9aea2f83e', '1', 'bond_buy_fee', '转让手续费收取', '【${bondInfo!}】转让成功，收取手续费${fee}元。', '0', TO_DATE('2016-08-17 17:52:40', 'YYYY-MM-DD HH24:MI:SS'), '转让手续费收取');
INSERT INTO sys_log_template VALUES ('9571007174c9446581e4fa09c5387133', '1', 'tender_award', '累计投资奖励', '用户名为${username}的用户累计投资奖励金额${award}元，已成功转入个人账户。', '0', TO_DATE('2016-06-04 09:49:05', 'YYYY-MM-DD HH24:MI:SS'), '用户累计投资奖励金额日志。');
INSERT INTO sys_log_template VALUES ('9bbeedd116f649e295e5c63169276d59', '1', 'borrow_success', '借款入账', '借款【${projectInfo!}】成立，收到借款${amount!} 元', '0', TO_DATE('2016-10-08 18:06:28', 'YYYY-MM-DD HH24:MI:SS'), '借款入账');
INSERT INTO sys_log_template VALUES ('9c019238db2b4c74b7bbe96c79df0d56', '1', 'collect_capital', '收到本金', '${info!}还款，收到本金${amount}元', '0', TO_DATE('2016-08-29 14:17:12', 'YYYY-MM-DD HH24:MI:SS'), '收到本金');
INSERT INTO sys_log_template VALUES ('a0c4789529b548959312b3172bc62876', '1', 'invest_success', '投资成功', '投资项目【${projectInfo!}】成功，投资金额${amount}元，实际支付${realAmount}元', '0', TO_DATE('2016-08-30 16:50:54', 'YYYY-MM-DD HH24:MI:SS'), '投资成功');
INSERT INTO sys_log_template VALUES ('b5101b3a4e3543079fd78f94cbbb5ba6', '1', 'first_tender_award', '第一次投资奖励', '收到第一次投资奖励${award}元。', '0', TO_DATE('2016-06-04 09:49:49', 'YYYY-MM-DD HH24:MI:SS'), '第一次投资奖励金额日志。');
INSERT INTO sys_log_template VALUES ('b8938ea45477417080919b67cd5a9076', '1', 'bond_buy', '受让人投资成功', '购买债权【${bondInfo!}】成功，实际支付${realPay!}元，得到债权${tenderMoney!}元，待收本息${bondCollectionMoney!}元', '0', TO_DATE('2016-08-10 17:39:02', 'YYYY-MM-DD HH24:MI:SS'), '债权转让受让人投资');
INSERT INTO sys_log_template VALUES ('bb58597e4c1d4690b9d5cc446dcba843', '2', 'score_email', '邮箱认证通过', '邮箱认证通过，获得${score}个积分。', '0', TO_DATE('2016-06-04 12:07:05', 'YYYY-MM-DD HH24:MI:SS'), '积分日志：邮箱认证通过积分日志。');
INSERT INTO sys_log_template VALUES ('bf0c47f7c7b94bcc8525c0e46b28544b', '1', 'repaid_late_interest', '还款逾期利息', '${info!}还款逾期利息${amount!}元', '0', TO_DATE('2016-08-29 14:04:26', 'YYYY-MM-DD HH24:MI:SS'), '还款逾期利息');
INSERT INTO sys_log_template VALUES ('d0f477addc9a4e679b5baa2418a4bbfa', '1', 'recharge_success_log', '充值成功', '用户账户充值成功，金额${money}元。', '0', TO_DATE('2016-06-03 14:29:01', 'YYYY-MM-DD HH24:MI:SS'), '充值手续费平台垫付');
INSERT INTO sys_log_template VALUES ('d0f477addc9a4e679b5baa2418a4bbfc', '2', 'back_manage_fee_level', '根据会员积分等级，退还利息管理费', '[<a href=''${web_url}/invest/${borrow.uuid!}/detail.html'' target=_blank>${borrow.name}</a>]，根据会员积分等级，退还利息管理费${money}元。', '0', TO_DATE('2016-06-03 14:29:01', 'YYYY-MM-DD HH24:MI:SS'), '根据会员积分等级，退还利息管理费日志。');
INSERT INTO sys_log_template VALUES ('e7ca28b241834692ba337a2b4298d326', '1', 'repaid_capital', '还款本金', '${info!}还款本金${amount!}元', '0', TO_DATE('2016-08-29 13:58:55', 'YYYY-MM-DD HH24:MI:SS'), '还款本金');
INSERT INTO sys_log_template VALUES ('f11e905d9d7449c58ee1c1fa58d07f81', '1', 'invest_freeze', '投资冻结', '用户投资项目【${info!}】金额${amount!}元，冻结金额${realAmount!}元<#if redEnvelope?? && redEnvelope gt 0>，使用红包${redEnvelope!}元</#if><#if upApr?? && upApr gt 0>，使用${upApr!}%加息券</#if>。', '0', TO_DATE('2016-07-16 16:51:05', 'YYYY-MM-DD HH24:MI:SS'), '投资冻结资金');
INSERT INTO sys_log_template VALUES ('f97a8c7c45a242bfbcb72d7401111111', '1', 'cash_proccess', '提现处理中', '提现处理中，冻结提现金额${money}元。', '0', TO_DATE('2016-07-06 10:24:51', 'YYYY-MM-DD HH24:MI:SS'), '申请提现日志。');
INSERT INTO sys_log_template VALUES ('f97a8c7c45a242bfbcb72d7401111112', '1', 'cash_audit', '提现待审核', '提现待审核，冻结提现金额${money}元。', '0', TO_DATE('2016-07-06 10:24:51', 'YYYY-MM-DD HH24:MI:SS'), '申请提现日志。');
INSERT INTO sys_log_template VALUES ('f97a8c7c45a242bfbcb72d740217b912', '1', 'cash_bank_fail', '提现对账', '提现银行对账失败，退回提现金额${money}元。', '0', TO_DATE('2016-07-06 10:24:51', 'YYYY-MM-DD HH24:MI:SS'), '提现异步对账日志。');
INSERT INTO sys_log_template VALUES ('f97a8c7c45a242bfbcb72d740217b9e4', '1', 'cash_success', '提现成功', '提现成功，提现${amount}元，到帐${realAmount}元，手续费${cashFee}元。', '0', TO_DATE('2016-07-06 10:24:51', 'YYYY-MM-DD HH24:MI:SS'), '提现成功日志。');
INSERT INTO sys_log_template VALUES ('f97a8c7c45a242bfbcb72d740217b9e5', '2', 'fee', '扣除充值手续费', '${payment}扣除充值手续费:${deduct}元。', '0', TO_DATE('2016-06-04 10:24:51', 'YYYY-MM-DD HH24:MI:SS'), '扣除充值手续费日志。');
INSERT INTO sys_log_template VALUES ('f97a8c7c45a242bfbcb72d740217b9e6', '1', 'cash_fail', '提现失败', '提现失败，退回冻结资金${money}元。', '0', TO_DATE('2016-07-06 10:24:51', 'YYYY-MM-DD HH24:MI:SS'), '提现审核不通过日志。');
INSERT INTO sys_log_template VALUES ('fa5353225439429590340cfe0eff39c5', '1', 'unfreeze_realize_money', '解冻已变现金额 ', '解冻已变现金额 ${amount}元', '0', TO_DATE('2016-11-23 19:06:31', 'YYYY-MM-DD HH24:MI:SS'), '解冻已变现金额 ');
INSERT INTO sys_log_template VALUES ('fc2fb482871e4a8c97c52da0044f0c81', '1', 'repaid_interest', '还款利息', '${info!}还款利息${amount!}元', '0', TO_DATE('2016-08-29 14:02:11', 'YYYY-MM-DD HH24:MI:SS'), '还款利息');
...
parent_id NVARCHAR2(32) NULL ,
parent_ids NVARCHAR2(512) NULL ,
icon_css NVARCHAR2(256) NULL ,
sort NUMBER(11) NULL ,
create_time DATE NULL ,
delete_flag CHAR(1) NULL ,
remark NVARCHAR2(512) NULL ,
...
COMMENT ON COLUMN sys_menu.uuid IS '主键';
...
COMMENT ON COLUMN sys_menu.parent_ids IS '链接地址';
COMMENT ON COLUMN sys_menu.icon_css IS '图标';
COMMENT ON COLUMN sys_menu.create_time IS '添加时间';
COMMENT ON COLUMN sys_menu.delete_flag IS '0 未删除，1 已删除';
COMMENT ON COLUMN sys_menu.remark IS '备注';
COMMENT ON COLUMN sys_menu.is_leaf IS '是否叶子节点，1是0否，默认0';

-- ----------------------------
-- Records of sys_menu
-- ----------------------------
INSERT INTO sys_menu VALUES ('034b7d6b6c104f89ab76c68b4a5e6343', 'set:operator', '个人设置', '#', 'a0f88f24408a42759589270385618808', 'a0f88f24408a42759589270385618808', '&amp;#xe636;', '16', TO_DATE('2016-10-10 09:56:09', 'YYYY-MM-DD HH24:MI:SS'), '0', null, '0');
INSERT INTO sys_menu VALUES ('07145b5a77aa4ffdbb41e96800ac0fbf', 'project:borrow:verify', '借款审核', '/loan/borrow/borrowVerifyManage.html', '6940d2925e36443f9630f229679fd945', '1f719034546143b783da0a82bbf5c4a1:6940d2925e36443f9630f229679fd945', null, '4', null, '0', null, '1');
INSERT INTO sys_menu VALUES ('0738842d7db04e49b16f2735e0c24cd0', 'stat:account', '资金分析', '#', '9b6b5489b9d947cdb73d209dde0ecf63', '9b6b5489b9d947cdb73d209dde0ecf63', null, '5', null, '1', null, '0');
INSERT INTO sys_menu VALUES ('086d419bcf8b4e12a29dc40ea7de0844', 'account:cashList', '提现记录', '/account/cash/cashList.html', 'd8d3e092a09e4c36abde2260f1660a49', 'd8d3e092a09e4c36abde2260f1660a49', '&amp;#xe603;', '1', null, '0', null, '1');
INSERT INTO sys_menu VALUES ('099e7b2858994d3ca59fedc491634f68', 'project:borrow:bespeak', '预约跟进', '/loan/borrowBespeak/borrowBespeakManage.html', '6940d2925e36443f9630f229679fd945', '1f719034546143b783da0a82bbf5c4a1:6940d2925e36443f9630f229679fd945', '&amp;#xe611;', '1', null, '0', null, '1');
INSERT INTO sys_menu VALUES ('0a1b98124c854381a403f767def3d124', 'project:borrow:stop', '下架管理', '/loan/borrow/borrowStopManage.html', '6940d2925e36443f9630f229679fd945', '1f719034546143b783da0a82bbf5c4a1:6940d2925e36443f9630f229679fd945', null, '6', null, '0', null, '1');
...
INSERT INTO sys_menu VALUES ('0ad428871db242999d4f7de1b700c01b', 'stat:borrow:borrowState', '借款情况分析', '#', '7431371acc1d40d98e45bbbcac350dd3', '9b6b5489b9d947cdb73d209dde0ecf63:7431371acc1d40d98e45bbbcac350dd3', null, '5', null, '1', null, '1');
INSERT INTO sys_menu VALUES ('0b3d8734926b4514b3e5a171de5107e3', 'project:borrow:sale', '上架管理', '/loan/borrow/borrowSaleManage.html', '6940d2925e36443f9630f229679fd945', '1f719034546143b783da0a82bbf5c4a1:6940d2925e36443f9630f229679fd945', null, '5', null, '0', null, '1');
INSERT INTO sys_menu VALUES ('0c6eede4546f4dadadd31dae718a7998', 'stat:invest:investArea', '投资地区分析', '#', '2efc0cf3524f449b964723d58397abab', '9b6b5489b9d947cdb73d209dde0ecf63:2efc0cf3524f449b964723d58397abab', null, '4', null, '1', null, '1');
INSERT INTO sys_menu VALUES ('0e9cbe92293944ddb6a2b83310eb31fd', 'vip:qualification', '资质认证', '/user/userQualification/manage.html', '7193b8e131824023abd1fe88ceb285dd', '7193b8e131824023abd1fe88ceb285dd', '&amp;#xe626;', '4', null, '0', null, '1');
INSERT INTO sys_menu VALUES ('0f934a2ed82b46cabd0e288161929eb0', 'consumer:consumerList', '客户列表', '/user/customer/customerManage.html', '70b917bfb77c49229f1b1c12e721690d', '70b917bfb77c49229f1b1c12e721690d', '&amp;#xe628;', '1', null, '0', null, '1');
...
INSERT INTO sys_menu VALUES ('1345de60f67945179c0b7812d77e2346', 'stat:borrow:borrowUser', '借款人数分析', '#', '7431371acc1d40d98e45bbbcac350dd3', '9b6b5489b9d947cdb73d209dde0ecf63:7431371acc1d40d98e45bbbcac350dd3', null, '1', null, '1', null, '1');
INSERT INTO sys_menu VALUES ('14d98400f07643b8b07071ae8951c15c', 'stat:invest:investState', '投资情况分析', '#', '2efc0cf3524f449b964723d58397abab', '9b6b5489b9d947cdb73d209dde0ecf63:2efc0cf3524f449b964723d58397abab', null, '5', null, '1', null, '1');
INSERT INTO sys_menu VALUES ('168c490a9eba4a5ebf4c1550652492b9', 'stat:account:recharge', '充值统计分析', '#', '0738842d7db04e49b16f2735e0c24cd0', '9b6b5489b9d947cdb73d209dde0ecf63:0738842d7db04e49b16f2735e0c24cd0', null, '1', null, '1', null, '1');
INSERT INTO sys_menu VALUES ('17199438e26e4ce5ab7dcd324868f0a0', 'stat:account:userBalance', '用户余额分析', '#', '0738842d7db04e49b16f2735e0c24cd0', '9b6b5489b9d947cdb73d209dde0ecf63:0738842d7db04e49b16f2735e0c24cd0', null, '3', null, '1', null, '1');
INSERT INTO sys_menu VALUES ('172c5c180bef49c98d9836108b34cee8', 'set:riskTpl:riskLevel', '风险等级管理', '/risk/riskConfigManage.html', 'd8d3e092a09e4c36abde2260f1111a49', 'a0f88f24408a42759589270385618808:d8d3e092a09e4c36abde2260f1111a49', '&amp;#xe62b;', '1', null, '0', null, '1');
INSERT INTO sys_menu VALUES ('191536e89e1c4fed89a57f41920dcb18', 'oper:score:scoreList', '积分记录', '/operate/score/userScoreLogManage.html', 'ce3536e101814111175dbc755a411145', '90c22e2f12b44f218d25c42b5bbd16a7:ce3536e101814111175dbc755a411145', null, '2', null, '0', null, '1');
INSERT INTO sys_menu VALUES ('1bab1129adec42e9ae38cd5fa10e16b9', 'stat:borrow:borrowArea', '借款地区分析', '#', '7431371acc1d40d98e45bbbcac350dd3', '9b6b5489b9d947cdb73d209dde0ecf63:7431371acc1d40d98e45bbbcac350dd3', null, '4', null, '1', null, '1');
INSERT INTO sys_menu VALUES ('1e102fbed8a448098bb64ce12ed36c30', 'project:product:ransom', '赎回审核', '#', 'ce3536e101814b7b975dbc755a434a45', '1f719034546143b783da0a82bbf5c4a1:ce3536e101814b7b975dbc755a434a45', null, '8', null, '1', null, '1');
INSERT INTO sys_menu VALUES ('1f719034546143b783da0a82bbf5c4a1', 'project', '产品', '#', null, null, null, '1', null, '0', null, '0');
INSERT INTO sys_menu VALUES ('22b308bd36744d3e8c94894a899c0394', 'set:resource', '资源管理', '/sys/resource/resourceManage.html', 'a0f88f24408a42759589270385618808', 'a0f88f24408a42759589270385618808', '&amp;#xe635;', '5', null, '0', null, '1');
INSERT INTO sys_menu VALUES ('2812eb5139054b00be156d3096cbd944', 'set:website:section', '栏目管理', '/column/section/sectionManage.html', '84f9a75ee24940ada9ea967d7825c8bc', 'a0f88f24408a42759589270385618808:84f9a75ee24940ada9ea967d7825c8bc', '&amp;#xe615;', '1', null, '0', null, '1');
INSERT INTO sys_menu VALUES ('2efc0cf3524f449b964723d58397abab', 'stat:invest', '投资分析', '#', '9b6b5489b9d947cdb73d209dde0ecf63', '9b6b5489b9d947cdb73d209dde0ecf63', null, '3', null, '1', null, '0');
INSERT INTO sys_menu VALUES ('2f700a22cf4349c891316352f719824d', 'product:bond', '转让管理', '#', '1f719034546143b783da0a82bbf5c4a1', '1f719034546143b783da0a82bbf5c4a1', '&#xe606;', '4', null, '0', null, '0');
INSERT INTO sys_menu VALUES ('31f91e34272e4eb4a7d1986de4ea150f', 'set:sys:role', '角色管理', '/sys/role/roleManage.html', '434db50f546d4b87b9f340eb3905b3ba', 'a0f88f24408a42759589270385618808:434db50f546d4b87b9f340eb3905b3ba', null, '3', null, '0', null, '1');
INSERT INTO sys_menu VALUES ('32b5c1c2e04342e09f696d257552f896', 'stat:oper:addApr', '加息券统计分析', '#', 'dab0444b0a974a3281abadf26a8aade9', '9b6b5489b9d947cdb73d209dde0ecf63:dab0444b0a974a3281abadf26a8aade9', null, '2', null, '1', null, '1');
INSERT INTO sys_menu VALUES ('356ab94e1cb94c9999ea11e3d9b15777', 'project:product:publish', '发布审核', '/product/manage/productPublishManage.html', 'ce3536e101814b7b975dbc755a434a45', '1f719034546143b783da0a82bbf5c4a1:ce3536e101814b7b975dbc755a434a45', null, '3', null, '0', null, '1');
INSERT INTO sys_menu VALUES ('358b374116284401aa4d510b0231fcdb', 'stat:borrow:borrowMoney', '借款金额分析', '#', '7431371acc1d40d98e45bbbcac350dd3', '9b6b5489b9d947cdb73d209dde0ecf63:7431371acc1d40d98e45bbbcac350dd3', null, '2', null, '1', null, '1');
INSERT INTO sys_menu VALUES ('3655012406c94acaacbe979d52e14900', 'set:riskTpl:question', '问卷管理', '/risk/riskPapersSingleManage.html', 'd8d3e092a09e4c36abde2260f1111a49', 'a0f88f24408a42759589270385618808:d8d3e092a09e4c36abde2260f1111a49', '&amp;#xe62a;', '2', null, '0', null, '1');
INSERT INTO sys_menu VALUES ('376c627aac1748a1aa7faffb50c18187', 'oper:addApr:addAprList', '加息券列表', '/operate/rateCoupon/userRateCouponManage.html', 'ce3536e101814b7b975dbc755a411145', '90c22e2f12b44f218d25c42b5bbd16a7:ce3536e101814b7b975dbc755a411145', null, '2', null, '0', null, '1');
INSERT INTO sys_menu VALUES ('3975def04c7942aebe871a4dcfa7124c', 'set:msg', '消息管理', '#', 'a0f88f24408a42759589270385618808', 'a0f88f24408a42759589270385618808', '&amp;#xe62d;', '5', null, '0', null, '0');
INSERT INTO sys_menu VALUES ('39af852544484d0b9dce4cb7c99564ec', 'project:product:ev', '成立审核', '/product/manage/productEstablishVerifyManage.html', 'ce3536e101814b7b975dbc755a434a45', '1f719034546143b783da0a82bbf5c4a1:ce3536e101814b7b975dbc755a434a45', null, '7', null, '0', null, '1');
INSERT INTO sys_menu VALUES ('3e4323cd2e924860865ede6d4f35e994', 'oper:actPlan', '活动方案', '/operate/activity/activityManage.html', '90c22e2f12b44f218d25c42b5bbd16a7', '90c22e2f12b44f218d25c42b5bbd16a7', '&amp;#xe61a;', '1', null, '0', null, '1');
INSERT INTO sys_menu VALUES ('434db50f546d4b87b9f340eb3905b3ba', 'set:sys', '后台管理', '#', 'a0f88f24408a42759589270385618808', 'a0f88f24408a42759589270385618808', '&#xe634;', '12', null, '0', null, '0');
INSERT INTO sys_menu VALUES ('4411f7211aa411e799bd408d5c073447', 'check', '对账', '#', null, null, null, '9', null, '0', null, '0');
INSERT INTO sys_menu VALUES ('453b4c7da24e42e098644a8839cb2bfe', 'set:msg:msgType', '消息模板', '/sys/messageType/messageTypeManage.html', '3975def04c7942aebe871a4dcfa7124c', 'a0f88f24408a42759589270385618808:3975def04c7942aebe871a4dcfa7124c', null, '1', null, '0', null, '1');
INSERT INTO sys_menu VALUES ('4e951fb9c90d4679b92998b6bb6fa483', 'project:product:stop', '下架管理', '/product/manage/productStopManage.html', 'ce3536e101814b7b975dbc755a434a45', '1f719034546143b783da0a82bbf5c4a1:ce3536e101814b7b975dbc755a434a45', null, '5', null, '0', null, '1');
INSERT INTO sys_menu VALUES ('99413546529348cda88f62d4d809c911', 'account:platAccount', '平台账户', '/account/merchant/tppMerchantLogList.html', 'd8d3e092a09e4c36abde2260f1660a49', 'd8d3e092a09e4c36abde2260f1660a49', '&amp;#xe617;', '5', null, '0', null, '1');
INSERT INTO sys_menu VALUES ('99830e3a22514f89af96d4c804649890', 'project:borrow:collList', '待收记录', '/loan/collection/collectionRecord.html?borrowFlag=1', '6940d2925e36443f9630f229679fd945', '1f719034546143b783da0a82bbf5c4a1:6940d2925e36443f9630f229679fd945', null, '10', null, '0', null, '1');
...
INSERT INTO sys_menu VALUES ('9ab14bce07864d12b3ce2843315abc5c', 'project:borrow:add', '新增借款', '/loan/borrow/borrowAddPage.html', '6940d2925e36443f9630f229679fd945', '1f719034546143b783da0a82bbf5c4a1:6940d2925e36443f9630f229679fd945', null, '2', null, '0', null, '1');
INSERT INTO sys_menu VALUES ('9ae631ce200d48a8a6e0b9b63b6ffaa0', 'stat:borrow:borrowCount', '借款笔数分析', '#', '7431371acc1d40d98e45bbbcac350dd3', '9b6b5489b9d947cdb73d209dde0ecf63:7431371acc1d40d98e45bbbcac350dd3', null, '3', null, '1', null, '1');
...
INSERT INTO sys_menu VALUES ('a26352064b324c839891e40e9046d5ea', 'oper:addApr:addAprRule', '加息券规则', '/operate/rateCoupon/rateRuleManage.html', 'ce3536e101814b7b975dbc755a411145', '90c22e2f12b44f218d25c42b5bbd16a7:ce3536e101814b7b975dbc755a411145', null, '1', null, '0', null, '1');
INSERT INTO sys_menu VALUES ('a39d0f69ccac4543a361bcf6e3392938', 'oper:score:userScore', '用户积分', '/operate/score/userScoreManage.html', 'ce3536e101814111175dbc755a411145', '90c22e2f12b44f218d25c42b5bbd16a7:ce3536e101814111175dbc755a411145', null, '1', null, '0', null, '1');
INSERT INTO sys_menu VALUES ('a467e89e50a146ada2f4cbae197d1e9d', 'project:realize:realizeRule', '变现规则', '/realize/rule/realizeRuleManage.html', 'ca0551e24d394eae8ea30085c9dcbc4d', '1f719034546143b783da0a82bbf5c4a1:ca0551e24d394eae8ea30085c9dcbc4d', null, '2', null, '0', null, '1');
INSERT INTO sys_menu VALUES ('abb04a408212494489f529aad408dda3', 'project:product:investList', '投资列表', '/loan/invest/investRecord.html', 'ce3536e101814b7b975dbc755a434a45', '1f719034546143b783da0a82bbf5c4a1:ce3536e101814b7b975dbc755a434a45', null, '9', null, '0', null, '1');
INSERT INTO sys_menu VALUES ('ac9942de9e4f4259a41952edcddc0a5f', 'stat:borrow:repay', '还款分析', '#', '7431371acc1d40d98e45bbbcac350dd3', '9b6b5489b9d947cdb73d209dde0ecf63:7431371acc1d40d98e45bbbcac350dd3', null, '6', null, '1', null, '1');
INSERT INTO sys_menu VALUES ('acb271cef985467696078186bfb3737a', 'stat:oper:redpacket', '红包统计分析', '#', 'dab0444b0a974a3281abadf26a8aade9', '9b6b5489b9d947cdb73d209dde0ecf63:dab0444b0a974a3281abadf26a8aade9', null, '1', null, '1', null, '1');
INSERT INTO sys_menu VALUES ('af599d39657e4c7dae33ca9ff8a82dcd', 'account:rechargeList', '充值记录', '/account/recharge/rechargeList.html', 'd8d3e092a09e4c36abde2260f1660a49', 'd8d3e092a09e4c36abde2260f1660a49', '&amp;#xe602;', '2', null, '0', null, '1');
INSERT INTO sys_menu VALUES ('b0e54a0b29eb4218b137a5de708dece2', 'consumer:performance', '业绩统计', '/user/customer/saleStatistics.html', '70b917bfb77c49229f1b1c12e721690d', '70b917bfb77c49229f1b1c12e721690d', '&amp;#xe629;', '2', null, '0', null, '1');
INSERT INTO sys_menu VALUES ('b22a29475cfc4b8db37838fe40857667', 'stat:oper:actAccount', '活动投资金额分析', '#', 'dab0444b0a974a3281abadf26a8aade9', '9b6b5489b9d947cdb73d209dde0ecf63:dab0444b0a974a3281abadf26a8aade9', null, '3', null, '1', null, '1');
INSERT INTO sys_menu VALUES ('b449d0ffc8334dcfa0cbd5057e0c3245', 'project:product:productMan', '产品维护', '/product/manage/newProductManage.html', 'ce3536e101814b7b975dbc755a434a45', '1f719034546143b783da0a82bbf5c4a1:ce3536e101814b7b975dbc755a434a45', null, '2', null, '0', null, '1');
INSERT INTO sys_menu VALUES ('b7415f6c0eee47f18ebab70cd5655ffe', 'project:borrow:overdue', '逾期管理', '/loan/repayment/repaymentOverdue.html', '6940d2925e36443f9630f229679fd945', '1f719034546143b783da0a82bbf5c4a1:6940d2925e36443f9630f229679fd945', null, '13', null, '0', null, '1');
INSERT INTO sys_menu VALUES ('b9cc5f669454439f8a28b81fc4a7cf8b', 'oper:userInvite:inviteReward', '邀请奖励', '/user/invite/userInviteAward.html', 'ce3511e10181411111212c755a411145', '90c22e2f12b44f218d25c42b5bbd16a7:ce3511e10181411111212c755a411145', null, '2', null, '0', null, '1');
INSERT INTO sys_menu VALUES ('ba1540b3cb32441cad6e14da6b4fa15b', 'project:borrow:follow', '贷后跟进', '/loan/borrow/borrowFollow.html', '6940d2925e36443f9630f229679fd945', '1f719034546143b783da0a82bbf5c4a1:6940d2925e36443f9630f229679fd945', null, '12', null, '0', null, '1');
INSERT INTO sys_menu VALUES ('be89d0803efe402a9697a40689ebda31', 'oper:vip:vipPack', 'VIP礼包管理', '/operate/vip/userGiftManage.html', 'ce3536e10181411111212c755a411145', '90c22e2f12b44f218d25c42b5bbd16a7', null, '3', null, '0', null, '1');
INSERT INTO sys_menu VALUES ('c1483b2033214964b2d763c305971180', 'set:config', '参数设置', '/sys/config/configManage.html', 'a0f88f24408a42759589270385618808', 'a0f88f24408a42759589270385618808', '&amp;#xe630;', '2', null, '0', null, '1');
INSERT INTO sys_menu VALUES ('c41abf5b7cac4a5989f9bf46e9d69afb', 'project:bond:bondRule', '转让规则', '/bond/rule/bondRuleAddEditQuery.html', '2f700a22cf4349c891316352f719824d', '1f719034546143b783da0a82bbf5c4a1:2f700a22cf4349c891316352f719824d', null, '2', null, '0', null, '1');
INSERT INTO sys_menu VALUES ('c5eab41d9d8d4de892ad4d7122f44112', 'set:operator:login', '个人信息', '/sys/operator/operatorLoginEditPage.html', '034b7d6b6c104f89ab76c68b4a5e6343', 'a0f88f24408a42759589270385618808:034b7d6b6c104f89ab76c68b4a5e6343', null, '2', TO_DATE('2016-10-31 19:19:39', 'YYYY-MM-DD HH24:MI:SS'), '0', null, '1');
INSERT INTO sys_menu VALUES ('ca0551e24d394eae8ea30085c9dcbc4d', 'project:realize', '变现管理', '#', '1f719034546143b783da0a82bbf5c4a1', '1f719034546143b783da0a82bbf5c4a1', '&#xe607;', '2', null, '0', null, '0');
INSERT INTO sys_menu VALUES ('ca10cbdd993e44f79385ee0fa1b8b62e', 'vip:company', '企业用户', '/user/userCompany/manage.html', '7193b8e131824023abd1fe88ceb285dd', '7193b8e131824023abd1fe88ceb285dd', '&amp;#xe624;', '2', null, '0', null, '1');
INSERT INTO sys_menu VALUES ('cb2cdcdf1f8f4b868a6f486322bd86fd', 'stat:user:portrait', '用户画像分析', '#', 'dda6aa8faede4bed9bb07cd28aef8925', '9b6b5489b9d947cdb73d209dde0ecf63:dda6aa8faede4bed9bb07cd28aef8925', null, '3', null, '1', null, '1');
INSERT INTO sys_menu VALUES ('cb4a9eb3d4d847b6ba3fc5f8ebfa54ec', 'vip:member', '个人用户', '/user/userPerson/manage.html', '7193b8e131824023abd1fe88ceb285dd', '7193b8e131824023abd1fe88ceb285dd', '&amp;#xe617;', '1', null, '0', null, '1');
INSERT INTO sys_menu VALUES ('cc81470463a44a35bacfcf9e9b10bd4a', 'vip:vouch', '担保机构', '/user/userVouch/manage.html', '7193b8e131824023abd1fe88ceb285dd', '7193b8e131824023abd1fe88ceb285dd', '&amp;#xe627;', '3', null, '0', null, '1');
INSERT INTO sys_menu VALUES ('cd4d2fb17ca149e7ab85cfcee2e8c1e5', '123122131', '1234', '123123123', '034b7d6b6c104f89ab76c68b4a5e6343', 'a0f88f24408a42759589270385618808', '', '100', null, '1', null, '0');
INSERT INTO sys_menu VALUES ('ce3511e10181411111212c755a411145', 'oper:userInvite', '好友邀请管理', '#', '90c22e2f12b44f218d25c42b5bbd16a7', '90c22e2f12b44f218d25c42b5bbd16a7', '&#xe619;', '5', null, '0', null, '0');
INSERT INTO sys_menu VALUES ('ce3536e10181411111212c755a411145', 'oper:vip', 'vip管理', '#', '90c22e2f12b44f218d25c42b5bbd16a7', '90c22e2f12b44f218d25c42b5bbd16a7', '&#xe618;', '4', null, '0', null, '0');
INSERT INTO sys_menu VALUES ('ce3536e101814111175dbc755a411145', 'oper:score', '积分管理', '#', '90c22e2f12b44f218d25c42b5bbd16a7', '90c22e2f12b44f218d25c42b5bbd16a7', '&#xe61d;', '3', null, '0', null, '0');
INSERT INTO sys_menu VALUES ('ce3536e101814b7b975dbc755a411145', 'oper:addApr', '加息券管理', '#', '90c22e2f12b44f218d25c42b5bbd16a7', '90c22e2f12b44f218d25c42b5bbd16a7', '&#xe61c;', '2', null, '0', null, '0');
INSERT INTO sys_menu VALUES ('ce3536e101814b7b975dbc755a411a45', 'oper:redpacket', '红包管理', '#', '90c22e2f12b44f218d25c42b5bbd16a7', '90c22e2f12b44f218d25c42b5bbd16a7', '&#xe61b;', '1', null, '0', null, '0');
INSERT INTO sys_menu VALUES ('ce3536e101814b7b975dbc755a434a45', 'project:product', '产品管理', '#', '1f719034546143b783da0a82bbf5c4a1', '1f719034546143b783da0a82bbf5c4a1', '&#xe600;', '1', null, '0', null, '0');
INSERT INTO sys_menu VALUES ('d0a1d4764e89473c989319f5a2fc33e3', 'set:website:article', '文章管理', '/column/article/articleManage.html', '84f9a75ee24940ada9ea967d7825c8bc', 'a0f88f24408a42759589270385618808:84f9a75ee24940ada9ea967d7825c8bc', null, '2', null, '0', null, '1');
INSERT INTO sys_menu VALUES ('d0ef25414a2f4f1fb8be2336bf630f2d', 'stat:invest:investUser', '投资人数分析', '#', '2efc0cf3524f449b964723d58397abab', '9b6b5489b9d947cdb73d209dde0ecf63:2efc0cf3524f449b964723d58397abab', null, '1', null, '1', null, '1');
INSERT INTO sys_menu VALUES ('d20738c990c4417ba2b49af085ac8a8c', 'oper:vip:vipUser', 'VIP用户', '/operate/vip/userVipManage.html', 'ce3536e10181411111212c755a411145', '90c22e2f12b44f218d25c42b5bbd16a7:ce3536e10181411111212c755a411145', null, '1', null, '0', null, '1');
...
INSERT INTO sys_menu VALUES ('d9aefea965d94f13a136956f9bfafe0a', 'oper:redpacket:redpacketRule', '红包规则', '/operate/redEnvelope/redRuleManage.html', 'ce3536e101814b7b975dbc755a411a45', '90c22e2f12b44f218d25c42b5bbd16a7,ce3536e101814b7b975dbc755a411a45', null, '1', null, '0', null, '1');
INSERT INTO sys_menu VALUES ('da10b946d2eb490bab155435f9d5a4c5', 'stat:account:cash', '提现统计分析', '#', '0738842d7db04e49b16f2735e0c24cd0', '9b6b5489b9d947cdb73d209dde0ecf63:0738842d7db04e49b16f2735e0c24cd0', null, '2', null, '1', null, '1');
INSERT INTO sys_menu VALUES ('dab0444b0a974a3281abadf26a8aade9', 'stat:oper', '活动运营分析', '#', '9b6b5489b9d947cdb73d209dde0ecf63', '9b6b5489b9d947cdb73d209dde0ecf63', null, '6', null, '1', null, '0');
...
INSERT INTO sys_menu VALUES ('dda6aa8faede4bed9bb07cd28aef8925', 'stat:user', '用户分析', '#', '9b6b5489b9d947cdb73d209dde0ecf63', '9b6b5489b9d947cdb73d209dde0ecf63', null, '1', null, '1', null, '0');
INSERT INTO sys_menu VALUES ('e3db465f991e421ea12342dd3b9b13b2', 'set:logtemplate', '日志模板', '/sys/logTemplate/logTemplateManage.html', 'a0f88f24408a42759589270385618808', 'a0f88f24408a42759589270385618808', '&amp;#xe637;', '4', null, '0', null, '1');
INSERT INTO sys_menu VALUES ('e3db465f991e421eadcd02dd3b9b13b2', 'set:dict', '数据字典', '/sys/dict/dictManage.html', 'a0f88f24408a42759589270385618808', 'a0f88f24408a42759589270385618808', '&amp;#xe631;', '3', null, '0', null, '1');
INSERT INTO sys_menu VALUES ('ef5b87ebc45e4537ac5e6d5328387218', 'stat:user:register', '注册用户分析', '#', 'dda6aa8faede4bed9bb07cd28aef8925', '9b6b5489b9d947cdb73d209dde0ecf63:dda6aa8faede4bed9bb07cd28aef8925', null, '1', null, '1', null, '1');
INSERT INTO sys_menu VALUES ('f03f8ab5839d4cdeaa783593168da4aa', 'stat:account:platBalance', '平台盈亏分析', '#', '0738842d7db04e49b16f2735e0c24cd0', '9b6b5489b9d947cdb73d209dde0ecf63:0738842d7db04e49b16f2735e0c24cd0', null, '5', null, '1', null, '1');
INSERT INTO sys_menu VALUES ('f495963d647b44e39dd426a3fdd8aa36', 'stat:user:active', '活跃用户分析', '#', 'dda6aa8faede4bed9bb07cd28aef8925', '9b6b5489b9d947cdb73d209dde0ecf63:dda6aa8faede4bed9bb07cd28aef8925', null, '2', null, '1', null, '1');
INSERT INTO sys_menu VALUES ('f67fc535ef7d4bb38180d22b0e908451', 'project:product:aprList', '派息列表', '#', 'ce3536e101814b7b975dbc755a434a45', '1f719034546143b783da0a82bbf5c4a1:ce3536e101814b7b975dbc755a434a45', null, '11', null, '1', null, '1');
INSERT INTO sys_menu VALUES ('fbb532930f11419eae657051c959dd2e', 'project:borrow:ev', '成立审核', '/loan/borrow/borrowEstablishVerifyManage.html', '6940d2925e36443f9630f229679fd945', '1f719034546143b783da0a82bbf5c4a1:6940d2925e36443f9630f229679fd945', null, '7', null, '0', null, '1');
INSERT INTO sys_menu VALUES ('54166c4a88e740fba422386ae21f3c05', 'stat:invest:investMoney', '投资金额分析', '#', '2efc0cf3524f449b964723d58397abab', '9b6b5489b9d947cdb73d209dde0ecf63:2efc0cf3524f449b964723d58397abab', null, '2', null, '1', null, '1');
...
INSERT INTO sys_menu VALUES ('54ccb1eda92f42728f4bfbcc5bd37d0c', 'stat:bond', '债权转让分析', '#', '9b6b5489b9d947cdb73d209dde0ecf63', '9b6b5489b9d947cdb73d209dde0ecf63', null, '4', null, '1', null, '1');
INSERT INTO sys_menu VALUES ('604873a8ae66493fb1ac6c429c8803d6', 'project:borrow:advance', '垫付记录', '/loan/repayment/repaymentAdvance.html', '6940d2925e36443f9630f229679fd945', '1f719034546143b783da0a82bbf5c4a1:6940d2925e36443f9630f229679fd945', null, '14', null, '0', null, '1');
INSERT INTO sys_menu VALUES ('610092f012f3442e96b1779f1fd30a67', 'project:borrow:borrowTest', '测试0001', 'www.baidu.com', '6940d2925e36443f9630f229679fd945', '1f719034546143b783da0a82bbf5c4a1:6940d2925e36443f9630f229679fd945', '', '100', null, '0', null, '1');
INSERT INTO sys_menu VALUES ('6282fd375d3948b9b511a577aa3715dc', 'account:userAccount', '用户账户列表', '/account/account/accountList.html', 'd8d3e092a09e4c36abde2260f1660a49', 'd8d3e092a09e4c36abde2260f1660a49', '&amp;#xe616;', '4', null, '0', null, '1');
INSERT INTO sys_menu VALUES ('66ebb7d8daac40bfa6e2ad4e8104f1c1', 'project:product:sale', '上架管理', '/product/manage/productSaleManage.html', 'ce3536e101814b7b975dbc755a434a45', '1f719034546143b783da0a82bbf5c4a1:ce3536e101814b7b975dbc755a434a45', null, '4', null, '0', null, '1');
INSERT INTO sys_menu VALUES ('6940d2925e36443f9630f229679fd945', 'project:borrow', '借贷管理', '#', '1f719034546143b783da0a82bbf5c4a1', '1f719034546143b783da0a82bbf5c4a1', '&#xe601;', '3', null, '0', null, '0');
INSERT INTO sys_menu VALUES ('697b4509ac2f4d14b8a8f5398dd488fd', 'project:product:aprMan', '利率维护', '#', 'ce3536e101814b7b975dbc755a434a45', '1f719034546143b783da0a82bbf5c4a1:ce3536e101814b7b975dbc755a434a45', null, '6', null, '1', null, '1');
INSERT INTO sys_menu VALUES ('6fc5976458c3415c894922d454be7293', 'set:msg:msgList', '消息记录', '/sys/message/messageManage.html', '3975def04c7942aebe871a4dcfa7124c', 'a0f88f24408a42759589270385618808:3975def04c7942aebe871a4dcfa7124c', null, '2', null, '0', null, '1');
INSERT INTO sys_menu VALUES ('70b917bfb77c49229f1b1c12e721690d', 'consumer', '客户', '#', null, null, null, '6', null, '0', null, '0');
INSERT INTO sys_menu VALUES ('70c49177b7664df9a3200074d18263bb', 'project:borrow:borrowMan', '借款维护', '/loan/borrow/borrowManage.html', '6940d2925e36443f9630f229679fd945', '1f719034546143b783da0a82bbf5c4a1:6940d2925e36443f9630f229679fd945', '&amp;#xe613;', '3', null, '0', null, '1');
INSERT INTO sys_menu VALUES ('7193b8e131824023abd1fe88ceb285dd', 'vip', '会员', '#', null, null, null, '5', null, '0', null, '0');
INSERT INTO sys_menu VALUES ('7431371acc1d40d98e45bbbcac350dd3', 'stat:borrow', '借款分析', '#', '9b6b5489b9d947cdb73d209dde0ecf63', '9b6b5489b9d947cdb73d209dde0ecf63', null, '2', null, '1', null, '0');
INSERT INTO sys_menu VALUES ('783a91f0e7474325b7076352f7881765', 'project:product:add', '新增产品', '/product/manage/productAddPage.html', 'ce3536e101814b7b975dbc755a434a45', '1f719034546143b783da0a82bbf5c4a1:ce3536e101814b7b975dbc755a434a45', null, '1', null, '0', null, '1');
INSERT INTO sys_menu VALUES ('7ab02fac290345d8993623b3c9fdb677', 'project:borrow:investList', '投资记录', '/loan/invest/investRecord.html?borrowFlag=1', '6940d2925e36443f9630f229679fd945', '1f719034546143b783da0a82bbf5c4a1:6940d2925e36443f9630f229679fd945', null, '9', null, '0', null, '1');
INSERT INTO sys_menu VALUES ('7f83cb85060b4499a665735723e9362d', 'set:opinion', '意见反馈记录', '/sys/opinion/opinionManage.html', 'a0f88f24408a42759589270385618808', 'a0f88f24408a42759589270385618808', '&amp;#xe632;', '8', null, '0', null, '1');
INSERT INTO sys_menu VALUES ('82da1ec38a83453f9bf835da0e6302f2', 'oper:vip:vipMan', 'VIP等级配置', '/operate/vip/vipLevelManage.html', 'ce3536e10181411111212c755a411145', '90c22e2f12b44f218d25c42b5bbd16a7:ce3536e10181411111212c755a411145', null, '2', null, '0', null, '1');
...
INSERT INTO sys_menu VALUES ('8460c24149d246a8a5e9200e3f12fce5', 'stat:account:investIncome', '投资收益分析', '#', '0738842d7db04e49b16f2735e0c24cd0', '9b6b5489b9d947cdb73d209dde0ecf63:0738842d7db04e49b16f2735e0c24cd0', null, '4', null, '1', null, '1');
INSERT INTO sys_menu VALUES ('84f9a75ee24940ada9ea967d7825c8bc', 'set:website', '网站管理', '#', 'a0f88f24408a42759589270385618808', 'a0f88f24408a42759589270385618808', '&amp;#xe62f;', '1', null, '0', null, '0');
INSERT INTO sys_menu VALUES ('867d3707f5f940079ed01f3ab459cd70', 'project:product:ransomList', '赎回列表', '#', 'ce3536e101814b7b975dbc755a434a45', '1f719034546143b783da0a82bbf5c4a1:ce3536e101814b7b975dbc755a434a45', null, '10', null, '1', null, '1');
...
INSERT INTO sys_menu VALUES ('879c53ceed324fd8a63f06f3876acd2b', 'oper:userInvite:inviteStat', '邀请统计', '/user/invite/statisticsManage.html', 'ce3511e10181411111212c755a411145', '90c22e2f12b44f218d25c42b5bbd16a7:ce3511e10181411111212c755a411145', null, '1', null, '0', null, '1');
INSERT INTO sys_menu VALUES ('898de066d9c74fcabc7c5347d0d24e20', 'project:realize:realizeList', '变现记录', '/realize/manage/realizeManage.html', 'ca0551e24d394eae8ea30085c9dcbc4d', '1f719034546143b783da0a82bbf5c4a1:ca0551e24d394eae8ea30085c9dcbc4d', null, '1', null, '0', null, '1');
INSERT INTO sys_menu VALUES ('89c357d88df342b88cc3c29f49e60a73', 'set:operator:pwd', '修改密码', '/sys/operator/operatorChangePwdPage.html', '034b7d6b6c104f89ab76c68b4a5e6343', 'a0f88f24408a42759589270385618808:034b7d6b6c104f89ab76c68b4a5e6343', '&amp;#xe613;', '1', TO_DATE('2016-10-10 09:53:21', 'YYYY-MM-DD HH24:MI:SS'), '0', null, '1');
INSERT INTO sys_menu VALUES ('8aea4bc2842f4f5ebe31342cf0c9ea4b', 'project:product:productList', '产品列表', '/product/manage/productQuery.html', 'ce3536e101814b7b975dbc755a434a45', '1f719034546143b783da0a82bbf5c4a1:ce3536e101814b7b975dbc755a434a45', null, '12', null, '0', null, '1');
INSERT INTO sys_menu VALUES ('8b0802e0208d493c853c6561d9e1f754', 'project:borrow:repayList', '还款记录', '/loan/repayment/repaymentRecord.html', '6940d2925e36443f9630f229679fd945', '1f719034546143b783da0a82bbf5c4a1:6940d2925e36443f9630f229679fd945', null, '11', null, '0', null, '1');
...
INSERT INTO sys_menu VALUES ('8ec02740ef6d4620b101589ff5942227', 'project:typeMan', '类别管理', '/project/type/typeManage.html', '1f719034546143b783da0a82bbf5c4a1', '1f719034546143b783da0a82bbf5c4a1', '&amp;#xe604;', '5', null, '0', null, '1');
INSERT INTO sys_menu VALUES ('8f64473b15a24a19a40df3c0a0ff074e', 'stat:invest:investCount', '投资笔数分析', '#', '2efc0cf3524f449b964723d58397abab', '9b6b5489b9d947cdb73d209dde0ecf63:2efc0cf3524f449b964723d58397abab', null, '3', null, '1', null, '1');
INSERT INTO sys_menu VALUES ('8febc2d0a04d4a42a3f8904970778b8c', 'set:riskTpl:answer', '评测记录', '/risk/riskUserLogManage.html', 'd8d3e092a09e4c36abde2260f1111a49', 'a0f88f24408a42759589270385618808:d8d3e092a09e4c36abde2260f1111a49', '&amp;#xe62c;', '3', null, '0', null, '1');
INSERT INTO sys_menu VALUES ('90c22e2f12b44f218d25c42b5bbd16a7', 'oper', '运营', '#', null, null, null, '3', null, '0', null, '0');
INSERT INTO sys_menu VALUES ('914d4ad12e724cbfbb59456997242959', 'project:borrow:borrowList', '借款记录', '/loan/borrow/borrowRecord.html', '6940d2925e36443f9630f229679fd945', '1f719034546143b783da0a82bbf5c4a1:6940d2925e36443f9630f229679fd945', null, '8', null, '0', null, '1');
INSERT INTO sys_menu VALUES ('91c57b3475a8433e82ff99a4b820c382', 'oper:redpacket:redpacketList', '红包列表', '/operate/redEnvelope/userRedenvelopeManage.html', 'ce3536e101814b7b975dbc755a411a45', '90c22e2f12b44f218d25c42b5bbd16a7:ce3536e101814b7b975dbc755a411a45', null, '2', null, '0', null, '1');
INSERT INTO sys_menu VALUES ('91c8e1ce152a4f24a315698ef6ea0b49', 'project:bond:bondList', '转让记录', '/bond/bond/bondManage.html', '2f700a22cf4349c891316352f719824d', '1f719034546143b783da0a82bbf5c4a1:2f700a22cf4349c891316352f719824d', null, '1', null, '0', null, '1');
INSERT INTO sys_menu VALUES ('948ccc45bfc04e56b7c6831ba7486bc7', 'account:accountList', '资金记录', '/account/account/accountLogList.html', 'd8d3e092a09e4c36abde2260f1660a49', 'd8d3e092a09e4c36abde2260f1660a49', '&amp;#xe607;', '3', null, '0', null, '1');
...
uuid NVARCHAR2(32) NOT NULL ,
message_type NVARCHAR2(30) NULL ,
send_user NVARCHAR2(32) NULL ,
receive_user NVARCHAR2(32) NULL ,
receive_addr NVARCHAR2(50) NULL ,
...
COMMENT ON COLUMN sys_message.uuid IS '主键';
COMMENT ON COLUMN sys_message.message_type IS '消息模板标识';
COMMENT ON COLUMN sys_message.send_user IS '发送用户ID';
COMMENT ON COLUMN sys_message.receive_user IS '接收用户ID';
COMMENT ON COLUMN sys_message.receive_addr IS '接收地址(1短信 ：填写接收人手机号；2邮件： 接收人邮箱 ；3站内信，填写用户名)';
COMMENT ON COLUMN sys_message.send_type IS '消息类型（1短信 2邮件 3站内信）';
COMMENT ON COLUMN sys_message.title IS '消息标题';
COMMENT ON COLUMN sys_message.content IS '内容';
COMMENT ON COLUMN sys_message.status IS '状态（0 新建，1发送成功 2发送失败）';
COMMENT ON COLUMN sys_message.create_time IS '添加时间';
COMMENT ON COLUMN sys_message.remark IS '备注: 发送结果信息';
...
-- ----------------------------
DROP TABLE sys_message_type;
CREATE TABLE sys_message_type (
uuid NVARCHAR2(32) NOT NULL ,
message_type NVARCHAR2(30) NULL ,
send_type CHAR(1) NULL ,
message_name NVARCHAR2(30) NULL ,
message_title NVARCHAR2(100) NULL ,
message_content NCLOB NULL ,
...
COMMENT ON COLUMN sys_message_type.uuid IS '主键';
COMMENT ON COLUMN sys_message_type.message_type IS '消息类型标识';
COMMENT ON COLUMN sys_message_type.send_type IS '消息类型（1短信 2邮件 3站内信）';
COMMENT ON COLUMN sys_message_type.message_name IS '消息类型名称';
COMMENT ON COLUMN sys_message_type.message_title IS '消息标题模板(freemark模板格式)';
COMMENT ON COLUMN sys_message_type.message_content IS '消息内容模板(freemark模板格式)';
COMMENT ON COLUMN sys_message_type.send IS '是否发送: 0 不发送，1 发送';
COMMENT ON COLUMN sys_message_type.create_time IS '添加时间';
COMMENT ON COLUMN sys_message_type.remark IS '备注';

-- ----------------------------
-- Records of sys_message_type
-- ----------------------------
INSERT INTO sys_message_type VALUES ('1001', 'user_repay_phoneCode', '1', '还款短信验证码', '还款短信验证码', '尊敬的用户[${user.userName}]，您于${noticeTime}所获取还款验证码为${code}，请您在${vtime}分钟内填写，完成验证。', '1', TO_DATE('2016-08-22 10:32:51', 'YYYY-MM-DD HH24:MI:SS'), '用户还款时，确认身份使用');
INSERT INTO sys_message_type VALUES ('102', 'get_email', '3', '重新激活邮件', '用户重新激活邮件', '尊敬的用户[${user.userName}]，您使用了激活邮件功能，请查收邮件并按邮件所述进行操作，如非本人操作，请联系客服。', '1', TO_DATE('2016-06-22 09:23:38', 'YYYY-MM-DD HH24:MI:SS'), '重新激活邮件');
INSERT INTO sys_message_type VALUES ('109', 'project_full_succ', '3', '成立审核通过', '成立审核通过', '尊敬的用户[${user.userName}]，您发布的项目[${projectName!}]已经通过成立审核，如有疑问，请联系客服。', '1', TO_DATE('2016-06-22 09:23:38', 'YYYY-MM-DD HH24:MI:SS'), '成立审核通过');
INSERT INTO sys_message_type VALUES ('110', 'project_full_fail', '3', '成立审核失败', '成立审核失败', '尊敬的用户[${user.userName}]，您发布的项目[${projectName!}]成立审核未通过，如有疑问，请联系客服。', '1', TO_DATE('2016-06-22 09:23:38', 'YYYY-MM-DD HH24:MI:SS'), '成立审核失败通知');
INSERT INTO sys_message_type VALUES ('111', 'invest', '3', '认购成功', '认购成功', '尊敬的用户[${user.userName}]，您于${investTime}投资的项目[${projectName!}]投资成功，冻结金额${investMoney}元，如有疑问，请联系客服。', '1', TO_DATE('2016-06-22 09:23:38', 'YYYY-MM-DD HH24:MI:SS'), '投资成功通知');
INSERT INTO sys_message_type VALUES ('112', 'invest_fail', '3', '投资失败', '用户投资失败', '尊敬的用户[${user.userName}]，您于${investTime!}投资的项目[${projectName}]满标复审没有通过，投资金额${amount!}，解冻实际支付金额${realAmount!}元。，请登录网站查看详情。', '1', TO_DATE('2016-06-22 09:23:38', 'YYYY-MM-DD HH24:MI:SS'), '撤标，复审失败后将资金退回投资人帐户。');
INSERT INTO sys_message_type VALUES ('115', 'receive_repay', '3', '借款人还款', '借款人还款', '尊敬的用户[${user.userName}]，您投资的项目[${projectName!}]第${period!1}期，于${repayTime!}回款，${repayStr}请查看资金明细详情。', '1', TO_DATE('2016-06-22 09:23:38', 'YYYY-MM-DD HH24:MI:SS'), '投资人收到还款时的短信通知');
INSERT INTO sys_message_type VALUES ('118', 'recharge_succ', '3', '线上充值成功', '用户线上充值成功', '尊敬的用户[${user.userName}]，您于${rechargeTime!}充值${amount!}元成功。', '1', TO_DATE('2016-06-22 09:23:38', 'YYYY-MM-DD HH24:MI:SS'), '线上充值成功提醒。');
INSERT INTO sys_message_type VALUES ('12', 'receive_repay', '1', '借款人还款', '借款人还款', '尊敬的用户[${user.userName}]，您投资的项目[${projectName!}]第${period!1}期，于${repayTime!}回款，${repayStr}请登录网站查看详情。', '1', TO_DATE('2016-06-22 09:23:38', 'YYYY-MM-DD HH24:MI:SS'), '借款人还款后向投资人发出的通知短信');
INSERT INTO sys_message_type VALUES ('123', 'phone_code', '3', '短信验证码', '短信验证码', '尊敬的用户[${user.userName}]，您于${dateformat(parseLong(noticeTime)?c)}所获取手机认证验证码为${code}，请您在${vtime}分钟内填写，如非本人操作，请联系客服。', '1', TO_DATE('2016-06-22 09:23:38', 'YYYY-MM-DD HH24:MI:SS'), '短信验证码');
INSERT INTO sys_message_type VALUES ('1231ad24f4f4y5yy5y435yy', 'cash_fail', '1', '提现失败', '提现失败', '尊敬的用户[${user.userName}]，您于${cashTime!}的提现审核失败，解冻金额${amount!}元，请登录网站查看详情！', '0', TO_DATE('2016-11-07 18:33:05', 'YYYY-MM-DD HH24:MI:SS'), '提现失败');
INSERT INTO sys_message_type VALUES ('134', 'vip_birth', '3', 'VIP生日', '祝您生日快乐', '尊敬的用户[${user.userName}]，今天是您的生日，感谢您一年来的支持，祝您生日快乐，万事如意，并请您继续支持我们。', '1', TO_DATE('2016-06-22 09:23:38', 'YYYY-MM-DD HH24:MI:SS'), 'VIP生日祝福');
INSERT INTO sys_message_type VALUES ('135', 'certify_succ', '3', '认证通过', '用户${type}审核通过', '尊敬的用户[${user.userName}]，您的${type}审核通过。', '1', TO_DATE('2016-06-22 09:23:38', 'YYYY-MM-DD HH24:MI:SS'), '认证通过提醒');
INSERT INTO sys_message_type VALUES ('136', 'certify_fail', '3', '认证未通过', '用户${type}审核未通过', '尊敬的用户[${user.userName}]，您的${type}审核不通过，如有疑问，请联系客服。', '1', TO_DATE('2016-06-22 09:23:38', 'YYYY-MM-DD HH24:MI:SS'), '认证不通过提醒');
INSERT INTO sys_message_type VALUES ('138', 'auto_invest', '3', '自动投资成功', '自动投资成功', '尊敬的用户[${user.userName}]，系统于${(noticeTime?string(''yyyy-MM-dd HH:mm''))!}为您进行自动投资[${project.projectName}],投资金额${parseDouble(money)?string(`#.##`)}元。', '1', TO_DATE('2016-06-22 09:23:38', 'YYYY-MM-DD HH24:MI:SS'), '自动投资成功通知');
INSERT INTO sys_message_type VALUES ('141', 'bond_sell_succ', '3', '债权转让成功', '债权转让成功', '尊敬的用户[${user.userName}]，您的债权[${bondName}]转让成功。', '1', TO_DATE('2016-06-22 09:23:38', 'YYYY-MM-DD HH24:MI:SS'), '债权转让成功');
INSERT INTO sys_message_type VALUES ('142', 'bond_buy_succ', '3', '债权转让投资成功', '债权转让投资成功', '尊敬的用户[${user.userName}]，您投资[${bondName}]债权成功，投资金额${investMoney}元，如有疑问，请联系客服。', '1', TO_DATE('2016-06-22 09:23:38', 'YYYY-MM-DD HH24:MI:SS'), '债权转让投资成功');
INSERT INTO sys_message_type VALUES ('148', 'user_register_phoneCode', '1', '注册验证码', '注册验证码', '手机号码为[${phone}]的用户,您在[${webname}]注册的验证码是${code}。', '1', TO_DATE('2016-06-22 09:23:38', 'YYYY-MM-DD HH24:MI:SS'), '注册验证码');
INSERT INTO sys_message_type VALUES ('149', 'invest_succ', '1', '投资成功', '投资成功', '尊敬的用户[${user.userName}]，您投资的项目[${projectName!}]已经成立，投资金额${amount!0}元，扣除冻结资金${realAmount!0}元，请登录网站查看详情。', '0', TO_DATE('2016-06-22 09:23:38', 'YYYY-MM-DD HH24:MI:SS'), '成立审核');
INSERT INTO sys_message_type VALUES ('15', 'recharge_succ', '1', '线上充值成功', '线上充值成功', '尊敬的用户[${user.userName}]，您于${rechargeTime!}充值${amount!}元成功，请登录网站查看详情！', '0', TO_DATE('2016-06-22 09:23:38', 'YYYY-MM-DD HH24:MI:SS'), '线上充值成功提醒。');
...
</div>', '0', TO_DATE('2016-06-22 09:23:38', 'YYYY-MM-DD HH24:MI:SS'), '成立审核');
...
</div>', '1', TO_DATE('2016-06-22 09:23:38', 'YYYY-MM-DD HH24:MI:SS'), '修改绑定邮箱-邮箱验证码');
...
</div>', '0', TO_DATE('2016-06-22 09:23:38', 'YYYY-MM-DD HH24:MI:SS'), '重置密保问题邮箱验证码');
INSERT INTO sys_message_type VALUES ('163', 'reset_question_phoneCode', '1', '重置密保问题', '重置密保问题短信验证码', '尊敬的用户[${user.userName}]，本次[重置密保问题]的验证码为：${code}，请在${vtime}分钟内输入。请勿将验证码告知他人，如非本人操作，请致电${customer_hotline}。', '1', TO_DATE('2016-06-22 09:23:38', 'YYYY-MM-DD HH24:MI:SS'), '重置密保问题短信验证码');
INSERT INTO sys_message_type VALUES ('20', 'phone_code', '1', '短信验证码', '短信验证码', '尊敬的用户[${user.userName}]，您于${dateformat(parseLong(noticeTime)?c)}所获取手机认证验证码为${code}，请您在${vtime}分钟内填写。如非本人操作，请致电${customer_hotline}。', '1', TO_DATE('2016-06-22 09:23:38', 'YYYY-MM-DD HH24:MI:SS'), '短信验证码');
INSERT INTO sys_message_type VALUES ('201', 'account_warn', '1', '自动预警', '订单资金异常预警', '${orderType}订单[${orderNo}]于${(createTime?string(''yyyy年MM月dd日 HH:mm''))!}出现资金不平衡，请尽快登录网站后台进行处理。', '1', TO_DATE('2016-06-22 09:23:38', 'YYYY-MM-DD HH24:MI:SS'), '订单出现资金异常时向联系人发出的通知短信');
INSERT INTO sys_message_type VALUES ('32', 'vip_birth', '1', 'VIP生日', 'VIP生日', '尊敬的用户[${user.userName}]，今天是您的生日，感谢您一年来的支持，祝您生日快乐，万事如意，并请您继续支持我们。', '0', TO_DATE('2016-06-22 09:23:38', 'YYYY-MM-DD HH24:MI:SS'), 'VIP生日祝福');
INSERT INTO sys_message_type VALUES ('34', 'certify_succ', '1', '认证通过', '${type}审核通过', '尊敬的用户[${user.userName}]，您的${type}审核通过，请登录网站查看详情。', '0', TO_DATE('2016-06-22 09:23:38', 'YYYY-MM-DD HH24:MI:SS'), '认证通过提醒');
INSERT INTO sys_message_type VALUES ('35', 'certify_fail', '1', '认证未通过', '${type}审核未通过', '尊敬的用户[${user.userName}]，您的${type}审核未通过，请登录网站查看详情。', '0', TO_DATE('2016-06-22 09:23:38', 'YYYY-MM-DD HH24:MI:SS'), '认证不通过提醒');
INSERT INTO sys_message_type VALUES ('37', 'get_email', '1', '激活邮件', '激活邮件', '尊敬的用户[${user.userName}]，您使用了激活邮件功能，请查收邮件并按邮件所述进行操作。', '0', TO_DATE('2016-06-22 09:23:38', 'YYYY-MM-DD HH24:MI:SS'), '重新激活邮件');
INSERT INTO sys_message_type VALUES ('382fb58d8f8311e699af000c296f8d8c', 'account_compare_warn', '1', '资金对比异常短信提醒', '资金异常', '尊敬的运维人员[${operUserName!''''}],您维护的平台${web_name!''''}上的用户${errorUserName!''''}资金有异常,请登录网站核查资金。', '1', TO_DATE('2016-10-11 15:20:42', 'YYYY-MM-DD HH24:MI:SS'), '资金对比异常短信提醒');
INSERT INTO sys_message_type VALUES ('39', 'get_pwd_phone', '1', '找回登录密码', '找回登录密码', '尊敬的用户[${user.userName}]，本次[找回登录密码]的验证码为：${code}。请在${vtime}分钟内输入。请勿将验证码告知他人，如非本人操作，请致电${customer_hotline}。', '1', TO_DATE('2016-06-22 09:23:38', 'YYYY-MM-DD HH24:MI:SS'), '通过手机验证码找回登录密码');
...
INSERT INTO sys_message_type VALUES ('151', 'invest_succ', '3', '投资成功', '投资成功', '尊敬的用户[${user.userName}]，您投资的项目[${projectName!}]已经成立，投资金额${amount!0}元，扣除冻结资金${realAmount!0}元，如有疑问，请联系客服。', '1', TO_DATE('2016-06-22 09:23:38', 'YYYY-MM-DD HH24:MI:SS'), '成立审核');
INSERT INTO sys_message_type VALUES ('152', 'notice_operator_password_reset', '1', '操作员密码重置', '操作员密码重置', '操作员${operator.name}重置密码成功！重置后密码是：${password}。为保证账户安全请尽快修改密码！', '1', TO_DATE('2016-06-22 09:23:38', 'YYYY-MM-DD HH24:MI:SS'), '操作员密码重置');
...
</div>', '1', TO_DATE('2016-06-22 09:23:38', 'YYYY-MM-DD HH24:MI:SS'), '修改绑定手机邮箱验证码');
...
</div>', '0', TO_DATE('2016-06-22 09:23:38', 'YYYY-MM-DD HH24:MI:SS'), '线上充值成功提醒。');
INSERT INTO sys_message_type VALUES ('7', 'project_full_fail', '1', '成立审核失败', '成立审核失败', '尊敬的用户[${user.userName}]，您发布的项目[${projectName!}]成立审核未通过，请登录网站查看详情。', '0', TO_DATE('2016-06-22 09:23:38', 'YYYY-MM-DD HH24:MI:SS'), '成立审核失败时向借款人发出的通知短信');
...
</div>', '1', TO_DATE('2016-06-22 09:23:38', 'YYYY-MM-DD HH24:MI:SS'), '短信验证码');
INSERT INTO sys_message_type VALUES ('8', 'invest', '1', '认购成功', '认购成功', '尊敬的用户[${user.userName}]，您于${investTime}成功投资项目[${projectName!}]，投资金额${investMoney!0}元，请登录网站查看详情。', '0', TO_DATE('2016-06-22 09:23:38', 'YYYY-MM-DD HH24:MI:SS'), '投资成功时向投资人发出的通知短信');
...
</div>', '1', TO_DATE('2016-06-22 09:23:38', 'YYYY-MM-DD HH24:MI:SS'), 'VIP生日祝福');
INSERT INTO sys_message_type VALUES ('40', 'auto_invest', '1', '自动投资成功', '自动投资成功', '尊敬的用户[${user.userName}]，系统于${(noticeTime?string(''yyyy年MM月dd日 HH:mm''))!}为您进行自动投资[${(project.projectName+`..........`)?substring(0,10)}],投资金额${parseDouble(money)?string(`#.##`)}元，请登录网站查看详情。', '0', TO_DATE('2016-06-22 09:23:38', 'YYYY-MM-DD HH24:MI:SS'), '自动投资成功通知');
INSERT INTO sys_message_type VALUES ('41', 'bind_phone', '1', '绑定手机验证码', '手机验证码', '尊敬的用户[${user.userName}]，您于${noticeTime}所获取手机认证验证码为${code}，请在${vtime}分钟内输入。请勿将验证码告知他人，如非本人操作，请致电${customer_hotline}。', '1', TO_DATE('2016-06-22 09:23:38', 'YYYY-MM-DD HH24:MI:SS'), '绑定手机验证码');
INSERT INTO sys_message_type VALUES ('42', 'modify_phone_phoneCode', '1', '修改绑定手机', '修改绑定手机短信验证码', '尊敬的用户[${user.userName}]，本次[修改绑定手机]的验证码为：${code}，请在${vtime}分钟内输入。请勿将验证码告知他人，如非本人操作，请致电${customer_hotline}。', '1', TO_DATE('2016-06-22 09:23:38', 'YYYY-MM-DD HH24:MI:SS'), '修改绑定手机短信验证码');
INSERT INTO sys_message_type VALUES ('45', 'bond_sell_succ', '1', '债权转让成功', '债权转让成功', '尊敬的用户[${user.userName}]，您已成功的转让[${bondName}]债权，请登录网站查看详情。', '0', TO_DATE('2016-06-22 09:23:38', 'YYYY-MM-DD HH24:MI:SS'), '债权转让成功');
INSERT INTO sys_message_type VALUES ('46', 'bond_buy_succ', '1', '债权转让投资成功', '债权转让投资成功', '尊敬的用户[${user.userName}]，您投资[${bondName}]债权成功，投资金额${investMoney}元，请登录网站查看详情。', '0', TO_DATE('2016-06-22 09:23:38', 'YYYY-MM-DD HH24:MI:SS'), '债权转让投资成功');
...
</div>', '0', TO_DATE('2016-06-22 09:23:38', 'YYYY-MM-DD HH24:MI:SS'), '成立审核通过时向借款人发出的通知邮件。');
...
</div>', '0', TO_DATE('2016-06-22 09:23:38', 'YYYY-MM-DD HH24:MI:SS'), '成立审核失败时向借款人发出的通知邮件');
...
</div>', '0', TO_DATE('2016-06-22 09:23:38', 'YYYY-MM-DD HH24:MI:SS'), '投资成功时向投资人发出的通知邮件');
...
</div>', '0', TO_DATE('2016-06-22 09:23:38', 'YYYY-MM-DD HH24:MI:SS'), '撤标、复审不通过后将自己退回投资人账户时发出的通知邮件');
INSERT INTO sys_message_type VALUES ('6', 'project_full_succ', '1', '成立审核通过', '成立审核通过', '尊敬的用户[${user.userName}]，您发布的项目[${projectName!}]已经通过成立审核，请登录网站查看详情。', '0', TO_DATE('2016-06-22 09:23:38', 'YYYY-MM-DD HH24:MI:SS'), '成立审核通过时向借款人发出的通知短信');
...
</div>', '0', TO_DATE('2016-06-22 09:23:38', 'YYYY-MM-DD HH24:MI:SS'), '借款人还款后向投资人发出的通知邮件');
...
</div>', '0', TO_DATE('2016-06-22 09:23:38', 'YYYY-MM-DD HH24:MI:SS'), '认证通过提醒');
...
</div>', '0', TO_DATE('2016-06-22 09:23:38', 'YYYY-MM-DD HH24:MI:SS'), '认证不通过提醒');
...
</div>', '1', TO_DATE('2016-06-22 09:23:38', 'YYYY-MM-DD HH24:MI:SS'), '绑定邮箱验证码');
INSERT INTO sys_message_type VALUES ('92', 'modify_email_phoneCode', '1', '修改绑定邮箱', '修改绑定邮箱-手机验证码', '尊敬的用户[${user.userName}]，您于${noticeTime}所获取邮箱认证验证码为${code}，请您在${vtime}分钟内填写，完成验证。', '1', TO_DATE('2016-06-22 09:23:38', 'YYYY-MM-DD HH24:MI:SS'), '修改绑定邮箱-手机验证码');
...
</div>', '0', TO_DATE('2016-06-22 09:23:38', 'YYYY-MM-DD HH24:MI:SS'), '债权转让成功');
...
</div>', '0', TO_DATE('2016-06-22 09:23:38', 'YYYY-MM-DD HH24:MI:SS'), '债权转让投资成功');
INSERT INTO sys_message_type VALUES ('9e48de15a28b11e6817dfa163e88e3b3', 'cash_succ', '1', '提现成功', '提现成功', '尊敬的用户[${user.userName}]，您于${cashTime!}提现操作成功，到账${amount!}元，手续费${fee!}元，请登录网站查看详情！', '0', TO_DATE('2016-11-04 20:38:04', 'YYYY-MM-DD HH24:MI:SS'), '提现成功通知');
...
</div>', '0', TO_DATE('2016-06-22 09:23:38', 'YYYY-MM-DD HH24:MI:SS'), '自动投资成功通知');
INSERT INTO sys_message_type VALUES ('88', 'get_email', '2', '激活邮件', '用户账户激活邮件', '1', '1', TO_DATE('2016-06-22 09:23:38', 'YYYY-MM-DD HH24:MI:SS'), '激活邮件');
INSERT INTO sys_message_type VALUES ('9', 'invest_fail', '1', '投资失败', '投资失败', '尊敬的用户[${user.userName}]，您于${investTime!}投资的项目[${projectName}]满标复审没有通过，投资金额${amount!}，解冻实际支付金额${realAmount!}元。，请登录网站查看详情。', '0', TO_DATE('2016-06-22 09:23:38', 'YYYY-MM-DD HH24:MI:SS'), '撤标、复审不通过后将自己退回投资人账户时发出的通知短信');
...
</div>', '1', TO_DATE('2016-06-22 09:23:38', 'YYYY-MM-DD HH24:MI:SS'), '找回登录密码');
...
</div>', '0', TO_DATE('2016-11-04 20:40:05', 'YYYY-MM-DD HH24:MI:SS'), '提现成功通知');
INSERT INTO sys_message_type VALUES ('bf9479dca28b11e6817dfa163e88e3b3', 'cash_succ', '3', '提现成功', '提现成功', '尊敬的用户[${user.userName}]，您于${cashTime!}提现操作成功，到账${amount!}元，手续费${fee!}元。', '1', TO_DATE('2016-11-04 20:40:07', 'YYYY-MM-DD HH24:MI:SS'), '提现成功通知');
...
</div>', '0', TO_DATE('2016-11-07 18:33:07', 'YYYY-MM-DD HH24:MI:SS'), '提现失败');
...
INSERT INTO sys_message_type VALUES ('d8347g4t24hg4t3g2413f', 'cash_fail', '3', '提现失败', '提现失败', '尊敬的用户[${user.userName}]，您于${cashTime!}的提现审核失败，解冻金额${amount!}元。', '1', TO_DATE('2016-11-07 18:33:09', 'YYYY-MM-DD HH24:MI:SS'), '提现失败');
...
INSERT INTO sys_message_type VALUES ('f8bf77d3902b11e699af000c296f8d8c', 'tpp_warn', '1', 'tppTask失败短信提醒', 'tppTask失败短信提醒', '尊敬的运维人员[${operUserName!''''}],您维护的平台${web_name!''''}上的用户${errorUserNameList!''''}于${createTime!}${operatorNameList!''''}失败,订单号为：${orderNoList!''''},请登录网站后台核查第三方调度任务。', '1', TO_DATE('2016-10-12 11:28:41', 'YYYY-MM-DD HH24:MI:SS'), 'tppTask失败短信提醒');
...
uuid NVARCHAR2(32) NOT NULL ,
code NVARCHAR2(64) NOT NULL ,
operation_name NVARCHAR2(50) NOT NULL ,
...
;
COMMENT ON TABLE sys_operation IS '功能操作表';
COMMENT ON COLUMN sys_operation.uuid IS '主键';
COMMENT ON COLUMN sys_operation.code IS '菜单英文标识,如:systemmange:user:page';
COMMENT ON COLUMN sys_operation.operation_type IS '操作类型：1操作  2 页面元素 （按钮、图表等）3文件 ';
COMMENT ON COLUMN sys_operation.create_time IS '添加时间';
COMMENT ON COLUMN sys_operation.delete_flag IS '0 未删除，1 已删除';
COMMENT ON COLUMN sys_operation.remark IS '备注';

-- ----------------------------
-- Records of sys_operation
-- ----------------------------
INSERT INTO sys_operation VALUES ('650237d88b5b4a2ea4fbb1a8c187aa22', 'query', '查询', '1', '1', TO_DATE('2016-06-04 15:10:50', 'YYYY-MM-DD HH24:MI:SS'), '0', null);
INSERT INTO sys_operation VALUES ('90b04389913b41008a69cead0cbf02b7', 'edit', '编辑', '1', '3', TO_DATE('2016-06-04 15:11:16', 'YYYY-MM-DD HH24:MI:SS'), '0', null);
INSERT INTO sys_operation VALUES ('94149ff5a0fa11e69638000c296f8d8c', 'resetPwd', '重置密码', '1', '31', TO_DATE('2016-11-02 20:48:49', 'YYYY-MM-DD HH24:MI:SS'), '0', null);
INSERT INTO sys_operation VALUES ('cc53ee6bba3947a392447e49b8f5e4f1', 'del', '删除', '1', '4', TO_DATE('2016-06-04 15:11:40', 'YYYY-MM-DD HH24:MI:SS'), '0', null);
INSERT INTO sys_operation VALUES ('ec401012c17444a29bb1247175452456', 'contentadd', '内容新增', '1', '20', TO_DATE('2017-01-18 18:12:26', 'YYYY-MM-DD HH24:MI:SS'), '0', null);
INSERT INTO sys_operation VALUES ('ec40101ca17444a29bb1247171234765', 'sale', '上架', '1', '17', TO_DATE('2017-01-18 18:12:26', 'YYYY-MM-DD HH24:MI:SS'), '0', null);
INSERT INTO sys_operation VALUES ('ec40101ca17444a29bb1247175111ccc', 'follow', '跟进', '1', '25', TO_DATE('2017-01-18 18:12:26', 'YYYY-MM-DD HH24:MI:SS'), '0', null);
INSERT INTO sys_operation VALUES ('ec40101ca17444a29bb1247175234ccc', 'answerdel', '答案删除', '1', '24', TO_DATE('2017-01-18 18:12:26', 'YYYY-MM-DD HH24:MI:SS'), '0', null);
INSERT INTO sys_operation VALUES ('ec40101ca17444a29bb1247175400001', 'check', '人工核查', '1', '26', TO_DATE('2017-01-18 18:12:26', 'YYYY-MM-DD HH24:MI:SS'), '0', null);
INSERT INTO sys_operation VALUES ('ec40101ca17444a29bb124717545009', 'assign', '子账户划拨', '1', '15', TO_DATE('2017-01-18 18:12:26', 'YYYY-MM-DD HH24:MI:SS'), '0', null);
INSERT INTO sys_operation VALUES ('ec40101ca17444a29bb124717545098', 'transfer', '用户转账', '1', '14', TO_DATE('2017-01-18 18:12:26', 'YYYY-MM-DD HH24:MI:SS'), '0', null);
INSERT INTO sys_operation VALUES ('ec40101ca17444a29bb1247175450987', 'stop', '下架', '1', '18', TO_DATE('2017-01-18 18:12:26', 'YYYY-MM-DD HH24:MI:SS'), '0', null);
INSERT INTO sys_operation VALUES ('ec40101ca17444a29bb1247175451212', 'download', '下载', '1', '16', TO_DATE('2017-01-18 18:12:26', 'YYYY-MM-DD HH24:MI:SS'), '0', null);
INSERT INTO sys_operation VALUES ('ec40101ca17444a29bb1247175451234', 'freeze', '冻结', '1', '9', TO_DATE('2017-01-18 18:12:26', 'YYYY-MM-DD HH24:MI:SS'), '0', null);
INSERT INTO sys_operation VALUES ('ec40101ca17444a29bb1247175452093', 'answeradd', '答案新增', '1', '22', TO_DATE('2017-01-18 18:12:26', 'YYYY-MM-DD HH24:MI:SS'), '0', null);
INSERT INTO sys_operation VALUES ('ec40101ca17444a29bb1247175452123', 'auditing', '审核', '1', '11', TO_DATE('2017-01-18 18:12:26', 'YYYY-MM-DD HH24:MI:SS'), '0', null);
INSERT INTO sys_operation VALUES ('ec40101ca17444a29bb1247175452124', 'export', '导出', '1', '8', TO_DATE('2017-01-18 18:12:26', 'YYYY-MM-DD HH24:MI:SS'), '0', null);
INSERT INTO sys_operation VALUES ('ec40101ca17444a29bb1247175452222', 'cash', '提现', '1', '13', TO_DATE('2017-01-18 18:12:26', 'YYYY-MM-DD HH24:MI:SS'), '0', null);
INSERT INTO sys_operation VALUES ('ec40101ca17444a29bb1247175452321', 'grant', '发放红包', '1', '35', TO_DATE('2016-11-05 15:45:31', 'YYYY-MM-DD HH24:MI:SS'), '0', null);
INSERT INTO sys_operation VALUES ('ec40101ca17444a29bb1247175452456', 'recharge', '充值', '1', '12', TO_DATE('2017-01-18 18:12:26', 'YYYY-MM-DD HH24:MI:SS'), '0', null);
INSERT INTO sys_operation VALUES ('ec40101ca17444a29bb1247175452992', 'answeredit', '答案编辑', '1', '23', TO_DATE('2017-01-18 18:12:26', 'YYYY-MM-DD HH24:MI:SS'), '0', null);
INSERT INTO sys_operation VALUES ('ec40101ca17444a29bb1247175452abc', 'cancel', '作废', '1', '10', TO_DATE('2017-01-18 18:12:26', 'YYYY-MM-DD HH24:MI:SS'), '0', null);
INSERT INTO sys_operation VALUES ('ec40101ca17444a29bb1247175452b11', 'mgr', '角色-用户管理', '1', '6', TO_DATE('2017-01-18 18:12:26', 'YYYY-MM-DD HH24:MI:SS'), '0', null);
INSERT INTO sys_operation VALUES ('ec40101ca17444a29bb1247175452bf0', 'add', '新增', '1', '2', TO_DATE('2016-06-04 15:10:15', 'YYYY-MM-DD HH24:MI:SS'), '0', null);
INSERT INTO sys_operation VALUES ('ec40101ca17444a29bb1247175452bf9', 'auth', '授权', '1', '5', TO_DATE('2017-01-18 18:12:26', 'YYYY-MM-DD HH24:MI:SS'), '0', null);
INSERT INTO sys_operation VALUES ('ec40101ca17444a29bb1247175452c99', 'contentedit', '内容编辑', '1', '21', TO_DATE('2017-01-18 18:12:26', 'YYYY-MM-DD HH24:MI:SS'), '0', null);
INSERT INTO sys_operation VALUES ('ec40101ca17444a29bb1247175452ccc', 'user:del', '角色-用户删除', '1', '7', TO_DATE('2017-01-18 18:12:26', 'YYYY-MM-DD HH24:MI:SS'), '0', null);
INSERT INTO sys_operation VALUES ('ec40101ca17444a29bb1247175452ddd', 'view', '经纪人-展示', '1', '30', TO_DATE('2016-10-26 17:53:27', 'YYYY-MM-DD HH24:MI:SS'), '0', null);
...
pwd NVARCHAR2(64) NOT NULL ,
real_name NVARCHAR2(20) NULL ,
emp_no NVARCHAR2(40) NULL ,
org_id NVARCHAR2(32) NULL ,
telephone NVARCHAR2(40) NULL ,
mobile NVARCHAR2(40) NULL ,
email NVARCHAR2(40) NULL ,
qq NVARCHAR2(20) NULL ,
create_time DATE NULL ,
status NVARCHAR2(2) NULL ,
delete_flag CHAR(1) NULL ,
remark NVARCHAR2(512) NULL 
...
;
COMMENT ON TABLE sys_operator IS '系统用户';
COMMENT ON COLUMN sys_operator.uuid IS '主键';
COMMENT ON COLUMN sys_operator.login_name IS '用户登陆名';
COMMENT ON COLUMN sys_operator.pwd IS '登陆密码';
COMMENT ON COLUMN sys_operator.real_name IS '姓名';
COMMENT ON COLUMN sys_operator.emp_no IS '工号';
COMMENT ON COLUMN sys_operator.org_id IS '所属部门';
COMMENT ON COLUMN sys_operator.telephone IS '电话';
COMMENT ON COLUMN sys_operator.mobile IS '手机';
COMMENT ON COLUMN sys_operator.email IS '邮箱';
COMMENT ON COLUMN sys_operator.qq IS 'QQ号码';
COMMENT ON COLUMN sys_operator.create_time IS '添加时间';
COMMENT ON COLUMN sys_operator.status IS '用户状态:(-1 锁定,0 正常)';
COMMENT ON COLUMN sys_operator.delete_flag IS '0 未删除，1 已删除';
COMMENT ON COLUMN sys_operator.remark IS '备注';
...
-- ----------------------------
DROP TABLE sys_operator_customer;
CREATE TABLE sys_operator_customer (
uuid NVARCHAR2(32) NOT NULL ,
user_id NVARCHAR2(32) NULL ,
operator_id NVARCHAR2(32) NULL ,
create_time DATE NULL ,
add_type CHAR(1) NULL ,
...
;
COMMENT ON TABLE sys_operator_customer IS '经理人客户表';
COMMENT ON COLUMN sys_operator_customer.user_id IS '客户id';
COMMENT ON COLUMN sys_operator_customer.operator_id IS '经纪人id';
COMMENT ON COLUMN sys_operator_customer.create_time IS '添加时间';
COMMENT ON COLUMN sys_operator_customer.add_type IS '添加类型 1 注册添加、2 后台添加';
COMMENT ON COLUMN sys_operator_customer.remark IS '备注';
...
;
COMMENT ON TABLE sys_operator_role IS '用户角色关联表';
COMMENT ON COLUMN sys_operator_role.uuid IS '主键';
COMMENT ON COLUMN sys_operator_role.operator_id IS '用户主键';
COMMENT ON COLUMN sys_operator_role.role_id IS '角色主键';
...
uuid NVARCHAR2(32) NOT NULL ,
org_no NVARCHAR2(32) NULL ,
org_name NVARCHAR2(40) NOT NULL ,
org_type CHAR(1) NULL ,
org_level NUMBER(11) NULL ,
parent_id NVARCHAR2(32) NULL ,
parent_ids NVARCHAR2(512) NULL ,
sort NUMBER(11) NULL ,
create_time DATE NULL ,
...
;
COMMENT ON TABLE sys_org IS '机构部门表';
COMMENT ON COLUMN sys_org.uuid IS '主键';
COMMENT ON COLUMN sys_org.org_no IS '机构(部门)编号';
COMMENT ON COLUMN sys_org.org_name IS '机构(部门)名称';
COMMENT ON COLUMN sys_org.org_type IS '类型(机构、部门)';
COMMENT ON COLUMN sys_org.org_level IS '层级，如： 根节点 0 一级部门 1  二级部门 2';
COMMENT ON COLUMN sys_org.parent_id IS '父级ID';
COMMENT ON COLUMN sys_org.parent_ids IS '父级ID集';
COMMENT ON COLUMN sys_org.create_time IS '添加时间';
COMMENT ON COLUMN sys_org.delete_flag IS '0 未删除，1 已删除';
...
uuid NVARCHAR2(32) NOT NULL ,
code NVARCHAR2(64) NOT NULL ,
permission_name NVARCHAR2(40) NULL ,
menu_id NVARCHAR2(32) NULL ,
operation_id NVARCHAR2(32) NULL 
)
LOGGING
NOCOMPRESS
NOCACHE
...
COMMENT ON COLUMN sys_permission.code IS '权限标识,如: systemmange:user:page';
COMMENT ON COLUMN sys_permission.permission_name IS '权限名称';
COMMENT ON COLUMN sys_permission.menu_id IS '菜单ID';
COMMENT ON COLUMN sys_permission.operation_id IS '功能操作ID';
...
INSERT INTO sys_permission VALUES ('5250312d1aa411e799bd408d5c073447', 'set:query:exp', '实时红包对账', 'f846f42e7030413496b18139efc130cf', '650237d88b5b4a2ea4fbb1a8c187aa22');
INSERT INTO sys_permission VALUES ('5259db171aa411e799bd408d5c073447', 'set:query:wdc', '提现对账', '7d3a8be5b46a43a7b1db032a4e5a8fa1', '650237d88b5b4a2ea4fbb1a8c187aa22');
INSERT INTO sys_permission VALUES ('527407401aa411e799bd408d5c073447', 'set:query:pdd', '充值对账', '33d8ce8fff0b4d03b9ddee5537cd323a', '650237d88b5b4a2ea4fbb1a8c187aa22');
INSERT INTO sys_permission VALUES ('527e65a61aa411e799bd408d5c073447', 'set:query:invest', '投标对账', 'a04ab66398b94c4ca1619f9a6cb0c3cc', '650237d88b5b4a2ea4fbb1a8c187aa22');
INSERT INTO sys_permission VALUES ('5b3cf4b11aa411e799bd408d5c073447', 'project:product:investList:export', '产品-投资列表-导出', 'abb04a408212494489f529aad408dda3', 'ec40101ca17444a29bb1247175452124');
INSERT INTO sys_permission VALUES ('5b45d6121aa411e799bd408d5c073447', 'project:product:productList:export', '产品-产品列表-导出', '8aea4bc2842f4f5ebe31342cf0c9ea4b', 'ec40101ca17444a29bb1247175452124');
INSERT INTO sys_permission VALUES ('5b5af8131aa411e799bd408d5c073447', 'project:borrow:investList:export', '借款-投资记录-导出', '7ab02fac290345d8993623b3c9fdb677', 'ec40101ca17444a29bb1247175452124');
INSERT INTO sys_permission VALUES ('5b6436941aa411e799bd408d5c073447', 'project:borrow:borrowList:export', '借款-借款记录-导出', '914d4ad12e724cbfbb59456997242959', 'ec40101ca17444a29bb1247175452124');
INSERT INTO sys_permission VALUES ('5b6cdd301aa411e799bd408d5c073447', 'project:borrow:collList:export', '借款-待收记录-导出', '99830e3a22514f89af96d4c804649890', 'ec40101ca17444a29bb1247175452124');
INSERT INTO sys_permission VALUES ('5b7933ae1aa411e799bd408d5c073447', 'project:borrow:repayList:export', '借款-还款记录-导出', '8b0802e0208d493c853c6561d9e1f754', 'ec40101ca17444a29bb1247175452124');
INSERT INTO sys_permission VALUES ('5b8aff941aa411e799bd408d5c073447', 'project:borrow:advance:export', '借款-垫付记录-导出', '604873a8ae66493fb1ac6c429c8803d6', 'ec40101ca17444a29bb1247175452124');
INSERT INTO sys_permission VALUES ('5b953d561aa411e799bd408d5c073447', 'account:userAccount:export', '用户账户列表-导出', '6282fd375d3948b9b511a577aa3715dc', 'ec40101ca17444a29bb1247175452124');
INSERT INTO sys_permission VALUES ('5b9f4c0a1aa411e799bd408d5c073447', 'account:platAccount:export', '平台账户-导出', '99413546529348cda88f62d4d809c911', 'ec40101ca17444a29bb1247175452124');
INSERT INTO sys_permission VALUES ('5ba92bcb1aa411e799bd408d5c073447', 'consumer:consumerList:add', '客户列表-新增', '0f934a2ed82b46cabd0e288161929eb0', 'ec40101ca17444a29bb1247175452bf0');
INSERT INTO sys_permission VALUES ('5bb18e361aa411e799bd408d5c073447', 'consumer:consumerList:edit', '客户列表-编辑', '0f934a2ed82b46cabd0e288161929eb0', '90b04389913b41008a69cead0cbf02b7');
INSERT INTO sys_permission VALUES ('5bbbee511aa411e799bd408d5c073447', 'set:website:section:edit', '栏目管理-编辑', '2812eb5139054b00be156d3096cbd944', '90b04389913b41008a69cead0cbf02b7');
INSERT INTO sys_permission VALUES ('5bc673421aa411e799bd408d5c073447', 'set:website:section:del', '栏目管理-删除', '2812eb5139054b00be156d3096cbd944', 'cc53ee6bba3947a392447e49b8f5e4f1');
INSERT INTO sys_permission VALUES ('5bceef641aa411e799bd408d5c073447', 'oper:addApr:addAprList:add', '加息券记录-发放', '376c627aac1748a1aa7faffb50c18187', 'ec40101ca17444a29bb1247175452bf0');
...
uuid NVARCHAR2(32) NOT NULL ,
res_name NVARCHAR2(100) NULL ,
res_text NVARCHAR2(200) NULL ,
res_language NVARCHAR2(10) NULL 
)
LOGGING
NOCOMPRESS
NOCACHE
...
COMMENT ON COLUMN sys_resource.uuid IS '主键';
COMMENT ON COLUMN sys_resource.res_name IS '资源标识';
COMMENT ON COLUMN sys_resource.res_text IS '资源信息内容';
COMMENT ON COLUMN sys_resource.res_language IS '语言';
...
COMMENT ON COLUMN sys_role.uuid IS '主键';
COMMENT ON COLUMN sys_role.code IS '角色标识，如admin/manager等';
COMMENT ON COLUMN sys_role.role_name IS '角色名';
COMMENT ON COLUMN sys_role.create_time IS '添加时间';
COMMENT ON COLUMN sys_role.delete_flag IS '0 未删除，1 已删除';
COMMENT ON COLUMN sys_role.remark IS '备注';

-- ----------------------------
-- Records of sys_role
-- ----------------------------
INSERT INTO sys_role VALUES ('22c0eef4a2c14515855d84f96eb991ae', 'admin', '超级管理员', TO_DATE('2016-09-29 16:34:34', 'YYYY-MM-DD HH24:MI:SS'), '0', null);
INSERT INTO sys_role VALUES ('839ab500da37478c84e9415c2283ee13', 'agent', '经纪人', TO_DATE('2016-10-26 10:44:18', 'YYYY-MM-DD HH24:MI:SS'), '0', null);
INSERT INTO sys_role VALUES ('e6c841039f7f459c9a68e540ef8462b0', 'onlineServer', '在线客服', TO_DATE('2016-10-13 15:48:19', 'YYYY-MM-DD HH24:MI:SS'), '0', null);
...
COMMENT ON COLUMN sys_role_permission.uuid IS '主键';
...
-- ----------------------------
DROP TABLE sys_user_message_config;
CREATE TABLE sys_user_message_config (
uuid NVARCHAR2(32) NOT NULL ,
user_id NVARCHAR2(32) NULL ,
message_type NVARCHAR2(32) NULL ,
sms CHAR(1) NULL ,
email CHAR(1) NULL ,
letter CHAR(1) NULL 
)
...
;
COMMENT ON TABLE sys_user_message_config IS '用户接收消息配置表';
COMMENT ON COLUMN sys_user_message_config.uuid IS '主键';
COMMENT ON COLUMN sys_user_message_config.user_id IS '用户';
COMMENT ON COLUMN sys_user_message_config.message_type IS '消息类型';
COMMENT ON COLUMN sys_user_message_config.sms IS '短信接收配置( 1 接收，0不接收)';
COMMENT ON COLUMN sys_user_message_config.email IS '邮件接收配置( 1 接收，0不接收)';
COMMENT ON COLUMN sys_user_message_config.letter IS '站内信接收配置( 1 接收，0不接收)';
...
uuid NVARCHAR2(32) NOT NULL ,
add_time DATE NULL ,
binding_id NVARCHAR2(256) NULL ,
client_id NVARCHAR2(256) NULL ,
expires_in NVARCHAR2(256) NULL ,
oauth_token NVARCHAR2(256) NULL ,
refresh_token NVARCHAR2(256) NULL 
)
LOGGING
NOCOMPRESS
NOCACHE
...
;
COMMENT ON TABLE token_store IS '移动端token表';
COMMENT ON COLUMN token_store.uuid IS '主键';
COMMENT ON COLUMN token_store.add_time IS '添加时间';
COMMENT ON COLUMN token_store.binding_id IS '对应用户';
COMMENT ON COLUMN token_store.client_id IS 'token来源';
COMMENT ON COLUMN token_store.expires_in IS '有效时间';
COMMENT ON COLUMN token_store.oauth_token IS 'token值';
COMMENT ON COLUMN token_store.refresh_token IS '刷新token值';
...
-- ----------------------------
-- Table structure for tpp_cbhb_request
-- ----------------------------
DROP TABLE tpp_cbhb_request;
CREATE TABLE tpp_cbhb_request (
uuid NVARCHAR2(32) NOT NULL ,
request_type NVARCHAR2(50) NOT NULL ,
request_merbillno NVARCHAR2(50) NOT NULL ,
request_map NCLOB NOT NULL ,
request_file_url NVARCHAR2(512) NOT NULL ,
...
;
COMMENT ON TABLE tpp_cbhb_request IS '渤海银行请求记录表';
COMMENT ON COLUMN tpp_cbhb_request.uuid IS '主键';
COMMENT ON COLUMN tpp_cbhb_request.request_type IS '请求类型';
COMMENT ON COLUMN tpp_cbhb_request.request_merbillno IS '请求流水号';
COMMENT ON COLUMN tpp_cbhb_request.request_map IS '请求数据包（包含明文、密文、证书信息）';
COMMENT ON COLUMN tpp_cbhb_request.request_file_url IS '请求文件的路径';
COMMENT ON COLUMN tpp_cbhb_request.request_time IS '请求时间';

-- ----------------------------
-- Records of tpp_cbhb_request
-- ----------------------------

-- ----------------------------
-- Table structure for tpp_cbhb_response
-- ----------------------------
DROP TABLE tpp_cbhb_response;
CREATE TABLE tpp_cbhb_response (
uuid NVARCHAR2(32) NOT NULL ,
resp_type NVARCHAR2(50) NOT NULL ,
request_merbillno NVARCHAR2(50) NOT NULL ,
resp_transid NVARCHAR2(50) NOT NULL ,
resp_map NCLOB NOT NULL ,
resp_file_url NVARCHAR2(512) NOT NULL ,
resp_code NVARCHAR2(50) NOT NULL ,
resp_desc NVARCHAR2(128) NOT NULL ,
resp_time DATE NOT NULL ,
return_resp_code NVARCHAR2(50) NOT NULL ,
return_resp_desc NVARCHAR2(128) NOT NULL ,
return_resp_time DATE NOT NULL ,
notify_resp_code NVARCHAR2(50) NOT NULL ,
notify_resp_desc NVARCHAR2(128) NOT NULL ,
notify_resp_time DATE NOT NULL 
)
LOGGING
NOCOMPRESS
NOCACHE
...
;
COMMENT ON TABLE tpp_cbhb_response IS '渤海银行响应记录表';
COMMENT ON COLUMN tpp_cbhb_response.resp_type IS '响应类型';
COMMENT ON COLUMN tpp_cbhb_response.request_merbillno IS '请求流水号';
COMMENT ON COLUMN tpp_cbhb_response.resp_transid IS '回调响应流水号';
COMMENT ON COLUMN tpp_cbhb_response.resp_map IS '回调响应数据包（包含明文、密文、证书）';
COMMENT ON COLUMN tpp_cbhb_response.resp_file_url IS '回调响应文件地址';
COMMENT ON COLUMN tpp_cbhb_response.resp_code IS '实时回调码';
COMMENT ON COLUMN tpp_cbhb_response.resp_desc IS '实时回调码解析';
COMMENT ON COLUMN tpp_cbhb_response.resp_time IS '实时响应时间';
COMMENT ON COLUMN tpp_cbhb_response.return_resp_code IS '同步回调码';
COMMENT ON COLUMN tpp_cbhb_response.return_resp_desc IS '同步回调码对应解析';
COMMENT ON COLUMN tpp_cbhb_response.return_resp_time IS '同步响应时间';
COMMENT ON COLUMN tpp_cbhb_response.notify_resp_code IS '异步回调码';
COMMENT ON COLUMN tpp_cbhb_response.notify_resp_desc IS '异步回调码解析';
COMMENT ON COLUMN tpp_cbhb_response.notify_resp_time IS '异步响应时间';

-- ----------------------------
-- Records of tpp_cbhb_response
-- ----------------------------

-- ----------------------------
-- Table structure for tpp_merchant_log
-- ----------------------------
DROP TABLE tpp_merchant_log;
CREATE TABLE tpp_merchant_log (
uuid NVARCHAR2(32) NOT NULL ,
operator_id NVARCHAR2(32) NULL ,
account NVARCHAR2(32) NULL ,
to_account NVARCHAR2(32) NULL ,
money NUMBER(20, 4) NULL ,
fee NUMBER(20, 4) NULL ,
status CHAR(1) NULL ,
operate_type NVARCHAR2(2) NULL ,
order_no NVARCHAR2(32) NULL ,
create_time DATE NULL ,
add_ip NVARCHAR2(32) NULL ,
remark NVARCHAR2(50) NULL 
...
;
COMMENT ON TABLE tpp_merchant_log IS '商户账户操作日志（充值、提现、转账）';
COMMENT ON COLUMN tpp_merchant_log.uuid IS '主键';
COMMENT ON COLUMN tpp_merchant_log.operator_id IS '操作员';
COMMENT ON COLUMN tpp_merchant_log.account IS '付款账户';
COMMENT ON COLUMN tpp_merchant_log.to_account IS '收款账户';
COMMENT ON COLUMN tpp_merchant_log.money IS '操作金额';
COMMENT ON COLUMN tpp_merchant_log.fee IS '操作手续费';
COMMENT ON COLUMN tpp_merchant_log.status IS '操作状态(0处理中1成功2失败，默认0)';
COMMENT ON COLUMN tpp_merchant_log.operate_type IS '操作类型(1充值2提现3转账)';
COMMENT ON COLUMN tpp_merchant_log.order_no IS '订单号';
COMMENT ON COLUMN tpp_merchant_log.create_time IS '操作时间';
COMMENT ON COLUMN tpp_merchant_log.add_ip IS '操作IP';
COMMENT ON COLUMN tpp_merchant_log.remark IS '备注';
...
-- ----------------------------
DROP TABLE tpp_trade;
CREATE TABLE tpp_trade (
uuid NVARCHAR2(32) NOT NULL ,
status NVARCHAR2(2) NULL ,
service_type NVARCHAR2(50) NULL ,
tpp_type NVARCHAR2(50) NULL ,
user_id NVARCHAR2(32) NULL ,
tpp_user_cust_id NVARCHAR2(50) NULL ,
to_user_id NVARCHAR2(32) NULL ,
to_tpp_user_cust_id NVARCHAR2(50) NULL ,
money NUMBER(20, 4) NULL ,
serv_fee NUMBER(20, 4) NULL ,
order_no NVARCHAR2(50) NULL ,
order_date DATE NULL ,
trade_no NVARCHAR2(50) NULL ,
trade_date DATE NULL ,
project_id NVARCHAR2(32) NULL ,
invest_id NVARCHAR2(32) NULL ,
params NVARCHAR2(512) NULL ,
return_url NVARCHAR2(255) NULL ,
notice_url NVARCHAR2(255) NULL ,
resp_desc NCLOB NULL ,
invest_project_id NVARCHAR2(32) NULL ,
create_time DATE NULL ,
redo_flag CHAR(1) NULL ,
pre_trade_id NVARCHAR2(32) NULL ,
...
;
COMMENT ON TABLE tpp_trade IS '接口交易记录';
COMMENT ON COLUMN tpp_trade.uuid IS '主键';
COMMENT ON COLUMN tpp_trade.status IS '状态：0-未处理，1-成功，2-失败';
COMMENT ON COLUMN tpp_trade.service_type IS '平台操作类型';
COMMENT ON COLUMN tpp_trade.tpp_type IS '第三方服务类型';
COMMENT ON COLUMN tpp_trade.user_id IS '付款用户';
COMMENT ON COLUMN tpp_trade.tpp_user_cust_id IS '付款用户第三方帐户';
COMMENT ON COLUMN tpp_trade.to_user_id IS '收款用户';
COMMENT ON COLUMN tpp_trade.to_tpp_user_cust_id IS '收款用户第三方账户';
COMMENT ON COLUMN tpp_trade.money IS '交易金额';
COMMENT ON COLUMN tpp_trade.serv_fee IS '服务费';
COMMENT ON COLUMN tpp_trade.order_no IS '平台订单号';
COMMENT ON COLUMN tpp_trade.order_date IS '平台订单日期';
COMMENT ON COLUMN tpp_trade.trade_no IS '三方流水号';
COMMENT ON COLUMN tpp_trade.trade_date IS '三方交易日期';
COMMENT ON COLUMN tpp_trade.project_id IS '本地 projectNo，对应第三方的projectId';
COMMENT ON COLUMN tpp_trade.invest_id IS '投资id';
COMMENT ON COLUMN tpp_trade.params IS '扩展参数';
COMMENT ON COLUMN tpp_trade.return_url IS '前台回调url';
COMMENT ON COLUMN tpp_trade.notice_url IS '后台回调url';
COMMENT ON COLUMN tpp_trade.resp_desc IS '回调信息';
COMMENT ON COLUMN tpp_trade.invest_project_id IS '本地项目id';
COMMENT ON COLUMN tpp_trade.create_time IS '添加时间';
COMMENT ON COLUMN tpp_trade.redo_flag IS '是否已重新发送';
COMMENT ON COLUMN tpp_trade.pre_trade_id IS '重发原记录ID';
COMMENT ON COLUMN tpp_trade.notify_time IS '回调时间';
COMMENT ON COLUMN tpp_trade.update_time IS '更新时间';
...
;
COMMENT ON TABLE urge_repay_log IS '催收记录日志';
COMMENT ON COLUMN urge_repay_log.uuid IS '主键';
COMMENT ON COLUMN urge_repay_log.repayment_id IS '代还id';
COMMENT ON COLUMN urge_repay_log.operator_id IS '操作员id';
COMMENT ON COLUMN urge_repay_log.create_time IS '催收时间';
COMMENT ON COLUMN urge_repay_log.remark IS '备注';
...
CREATE TABLE users (
uuid NVARCHAR2(32) NOT NULL ,
user_no NVARCHAR2(25) NULL ,
user_name NVARCHAR2(20) NOT NULL ,
pwd NVARCHAR2(64) NOT NULL ,
real_name NVARCHAR2(20) NULL ,
mobile NVARCHAR2(11) NULL ,
email NVARCHAR2(50) NULL ,
status NVARCHAR2(2) NULL ,
create_time DATE NULL ,
pay_pwd NVARCHAR2(64) NULL ,
tpp_status CHAR(1) NULL ,
tpp_user_acc_id NVARCHAR2(50) NULL ,
tpp_user_cust_id NVARCHAR2(50) NULL ,
user_nature CHAR(1) NULL 
)
LOGGING
...
COMMENT ON COLUMN users.uuid IS '主键';
COMMENT ON COLUMN users.user_no IS '用户唯一标识';
COMMENT ON COLUMN users.user_name IS '登录用户名';
COMMENT ON COLUMN users.pwd IS '登陆密码';
COMMENT ON COLUMN users.real_name IS '姓名';
COMMENT ON COLUMN users.mobile IS '手机号';
COMMENT ON COLUMN users.email IS '邮箱';
COMMENT ON COLUMN users.status IS '用户状态:(-1 锁定,0 正常,默认0)';
COMMENT ON COLUMN users.create_time IS '添加时间';
COMMENT ON COLUMN users.pay_pwd IS '交易密码';
COMMENT ON COLUMN users.tpp_status IS '第三方账号是否激活 1 激活， 0未激活';
COMMENT ON COLUMN users.tpp_user_acc_id IS '用户资金存管平台账户号(汇付天下账号如：xxx_2016051150021 )';
COMMENT ON COLUMN users.tpp_user_cust_id IS '用户资金存管平台账户(uid)';
COMMENT ON COLUMN users.user_nature IS '用户类型:  1个人用户、2 企业用户、3 担保机构，冗余user_cache.user_nature字段';

-- ----------------------------
-- Records of user
-- ----------------------------
INSERT INTO users VALUES ('d315ad95a4d211e6b8d6408d5c2885aa', '1', 'admin', 'admin', null, null, null, '0', null, null, '0', null, null, '2');

-- ----------------------------
-- Table structure for user_activity_award_log
-- ----------------------------
DROP TABLE user_activity_award_log;
CREATE TABLE user_activity_award_log (
uuid NVARCHAR2(32) NOT NULL ,
user_id NVARCHAR2(32) NULL ,
award NVARCHAR2(20) NULL ,
red_rule_id NVARCHAR2(32) NULL ,
rate_rule_id NVARCHAR2(32) NULL ,
user_red_id NVARCHAR2(32) NULL ,
user_rate_id NVARCHAR2(32) NULL ,
tender_id NVARCHAR2(32) NULL ,
invite_user_id NVARCHAR2(32) NULL ,
award_type CHAR(1) NULL ,
create_time DATE NULL ,
activity_name NVARCHAR2(30) NULL ,
rule_name NVARCHAR2(30) NULL ,
activity_code NVARCHAR2(30) NULL 
)
LOGGING
NOCOMPRESS
...
;
COMMENT ON TABLE user_activity_award_log IS '活动奖励记录';
COMMENT ON COLUMN user_activity_award_log.uuid IS '主键';
COMMENT ON COLUMN user_activity_award_log.user_id IS '用户id';
COMMENT ON COLUMN user_activity_award_log.award IS '发放的奖励(红包：金额，加息券：加息比例)';
COMMENT ON COLUMN user_activity_award_log.red_rule_id IS '红包规则id';
COMMENT ON COLUMN user_activity_award_log.rate_rule_id IS '加息券规则id';
COMMENT ON COLUMN user_activity_award_log.user_red_id IS '发放的红包id';
COMMENT ON COLUMN user_activity_award_log.user_rate_id IS '发放的加息券id';
COMMENT ON COLUMN user_activity_award_log.tender_id IS '投资记录id';
COMMENT ON COLUMN user_activity_award_log.invite_user_id IS '邀请人id';
COMMENT ON COLUMN user_activity_award_log.award_type IS '奖励类型 1 红包、2加息券';
COMMENT ON COLUMN user_activity_award_log.create_time IS '发放时间';
COMMENT ON COLUMN user_activity_award_log.activity_name IS '活动名称';
COMMENT ON COLUMN user_activity_award_log.rule_name IS '规则名称';
COMMENT ON COLUMN user_activity_award_log.activity_code IS '活动标志';
...
-- ----------------------------
DROP TABLE user_auth_sign_log;
CREATE TABLE user_auth_sign_log (
uuid NVARCHAR2(32) NOT NULL ,
user_id NVARCHAR2(32) NULL ,
auth_option CHAR(1) NULL ,
service_types NVARCHAR2(25) NULL ,
order_no NVARCHAR2(30) NULL ,
resp_desc CHAR(1) NULL ,
create_time DATE NULL ,
add_ip NVARCHAR2(32) NULL 
)
LOGGING
...
;
COMMENT ON TABLE user_auth_sign_log IS '用户业务授权(解约)记录';
COMMENT ON COLUMN user_auth_sign_log.uuid IS '主键';
COMMENT ON COLUMN user_auth_sign_log.user_id IS '用户';
COMMENT ON COLUMN user_auth_sign_log.auth_option IS '签约类型 0：授权解约 1：授权签约 ';
COMMENT ON COLUMN user_auth_sign_log.service_types IS '业务类型';
COMMENT ON COLUMN user_auth_sign_log.order_no IS '订单号';
COMMENT ON COLUMN user_auth_sign_log.resp_desc IS '0.未处理 1.成功 2.失败';
COMMENT ON COLUMN user_auth_sign_log.create_time IS '添加时间';
COMMENT ON COLUMN user_auth_sign_log.add_ip IS '操作ip';
...
-- ----------------------------
DROP TABLE user_auto_invest;
CREATE TABLE user_auto_invest (
uuid NVARCHAR2(32) NOT NULL ,
user_id NVARCHAR2(32) NOT NULL ,
rule_id NVARCHAR2(32) NULL ,
sort_time NUMBER(20) NULL 
)
LOGGING
NOCOMPRESS
NOCACHE
...
;
COMMENT ON TABLE user_auto_invest IS '用户自动投资设置表';
COMMENT ON COLUMN user_auto_invest.uuid IS '主键';
COMMENT ON COLUMN user_auto_invest.user_id IS '用户id';
COMMENT ON COLUMN user_auto_invest.rule_id IS '设置规则ID';
COMMENT ON COLUMN user_auto_invest.sort_time IS '排序时间';
...
education NVARCHAR2(2) NULL ,
marital_status CHAR(1) NULL ,
work_experience NVARCHAR2(2) NULL ,
month_income_range NVARCHAR2(20) NULL ,
car_status CHAR(1) NULL ,
house_status CHAR(1) NULL 
)
LOGGING
NOCOMPRESS
NOCACHE
...
COMMENT ON COLUMN user_base_info.uuid IS '主键';
COMMENT ON COLUMN user_base_info.user_id IS '用户ID';
COMMENT ON COLUMN user_base_info.birthday IS '出生年月日';
COMMENT ON COLUMN user_base_info.education IS '学历 1：小学；2：初中；3：高中；4：中专；5：大专；6：本科；7：硕士；8：博士；9其他';
COMMENT ON COLUMN user_base_info.marital_status IS '婚姻状况 0:未婚；1：已婚；2：离异；3：丧偶';
COMMENT ON COLUMN user_base_info.work_experience IS '工作年限 1：0-3年；2：3-5年；3:5-8年；4:8年以上；';
COMMENT ON COLUMN user_base_info.month_income_range IS '月收入范围';
COMMENT ON COLUMN user_base_info.car_status IS '车产有无';
COMMENT ON COLUMN user_base_info.house_status IS '房产有无';
...
user_id NVARCHAR2(32) NOT NULL ,
user_nature CHAR(1) NULL ,
cert_type NVARCHAR2(2) NULL ,
id_no NVARCHAR2(32) NULL ,
sex CHAR(1) NULL ,
post_code NVARCHAR2(6) NULL ,
province NVARCHAR2(50) NULL ,
city NVARCHAR2(50) NULL ,
area NVARCHAR2(50) NULL ,
address NVARCHAR2(128) NULL ,
risk_level NVARCHAR2(2) NULL ,
avatar_photo NVARCHAR2(256) NULL ,
login_fail_times NUMBER(11) NULL ,
lock_type CHAR(1) NULL ,
lock_time DATE NULL ,
lock_remark NVARCHAR2(255) NULL ,
rename_flag CHAR(1) NULL ,
sign_account NVARCHAR2(40) NULL ,
sign_seal_data NCLOB NULL ,
reg_mode CHAR(1) NULL ,
invest_num NUMBER(11) NULL ,
reset_pwd_flag CHAR(1) NULL ,
first_award_flag CHAR(1) NULL 
)
LOGGING
NOCOMPRESS
NOCACHE
...
;
COMMENT ON TABLE user_cache IS '用户附属信息表';
COMMENT ON COLUMN user_cache.uuid IS '主键';
COMMENT ON COLUMN user_cache.user_id IS '用户ID';
COMMENT ON COLUMN user_cache.user_nature IS '用户类型:  1个人用户、2 企业用户、3 担保机构';
COMMENT ON COLUMN user_cache.cert_type IS '证件类型，01 身份证18位，02 身份证15位；默认1';
COMMENT ON COLUMN user_cache.id_no IS '证件号码';
COMMENT ON COLUMN user_cache.sex IS '性别:M 男性，F女性';
COMMENT ON COLUMN user_cache.post_code IS '邮编';
COMMENT ON COLUMN user_cache.province IS '省';
COMMENT ON COLUMN user_cache.city IS '市';
COMMENT ON COLUMN user_cache.area IS '区';
COMMENT ON COLUMN user_cache.address IS '地址';
COMMENT ON COLUMN user_cache.risk_level IS '风险评估等级(数字等级)';
COMMENT ON COLUMN user_cache.avatar_photo IS '头像照片路径';
COMMENT ON COLUMN user_cache.login_fail_times IS '登录失败次数';
COMMENT ON COLUMN user_cache.lock_type IS '锁定类型  0-登录失败锁定 1-后台手动锁定';
COMMENT ON COLUMN user_cache.lock_time IS '锁定时间';
COMMENT ON COLUMN user_cache.lock_remark IS '锁定备注';
COMMENT ON COLUMN user_cache.rename_flag IS '用户名修改标识（默认0，修改过默认生成用户名置为1）';
COMMENT ON COLUMN user_cache.sign_account IS '签名认证账号';
COMMENT ON COLUMN user_cache.sign_seal_data IS '签名电子印章数据';
COMMENT ON COLUMN user_cache.reg_mode IS '用户注册方式 0 用户注册 1 后台录入';
COMMENT ON COLUMN user_cache.invest_num IS '用户投资记录数（在投、成功）';
COMMENT ON COLUMN user_cache.reset_pwd_flag IS '是否需要修改密码0.不需要1.需要';
COMMENT ON COLUMN user_cache.first_award_flag IS '首投奖励（0未发放，1已发放,默认0）';
...
-- ----------------------------
DROP TABLE user_company_info;
CREATE TABLE user_company_info (
uuid NVARCHAR2(32) NOT NULL ,
user_id NVARCHAR2(32) NOT NULL ,
company_name NVARCHAR2(50) NULL ,
simple_name NVARCHAR2(10) NULL ,
establish_date DATE NULL ,
registered_capital NVARCHAR2(16) NULL ,
address NVARCHAR2(50) NULL ,
bussiness_code NVARCHAR2(50) NULL ,
org_code NVARCHAR2(50) NULL ,
license_address NVARCHAR2(50) NULL ,
logo NVARCHAR2(100) NULL ,
license_expire_date DATE NULL ,
business_scope NVARCHAR2(256) NULL ,
telephone NVARCHAR2(13) NULL ,
contacts NVARCHAR2(10) NULL ,
email NVARCHAR2(50) NULL ,
summary NVARCHAR2(512) NULL ,
natural_person NVARCHAR2(50) NULL ,
legal_person NVARCHAR2(50) NULL ,
cert_no NVARCHAR2(30) NULL ,
cert_type NVARCHAR2(18) NULL ,
legal_person_phone NVARCHAR2(11) NULL ,
bank_code NVARCHAR2(10) NULL ,
bank_account_no NVARCHAR2(30) NULL ,
bank_province NVARCHAR2(10) NULL ,
bank_city NVARCHAR2(10) NULL ,
bank_branch NVARCHAR2(30) NULL ,
extend_param NVARCHAR2(200) NULL ,
audit_order_no NVARCHAR2(50) NULL ,
audit_status NVARCHAR2(2) NULL ,
audit_time DATE NULL ,
audit_message NVARCHAR2(200) NULL ,
legal_delegate NVARCHAR2(50) NULL ,
tax_reg_no NVARCHAR2(20) NULL ,
credit_code NVARCHAR2(32) NULL ,
office_province NVARCHAR2(16) NULL ,
office_city NVARCHAR2(16) NULL ,
office_area NVARCHAR2(16) NULL ,
office_address NVARCHAR2(50) NULL ,
three_certificate CHAR(1) NULL 
)
LOGGING
NOCOMPRESS
NOCACHE
...
;
COMMENT ON TABLE user_company_info IS '企业用户信息表';
COMMENT ON COLUMN user_company_info.uuid IS '主键';
COMMENT ON COLUMN user_company_info.user_id IS '用户ID';
COMMENT ON COLUMN user_company_info.company_name IS '公司名称';
COMMENT ON COLUMN user_company_info.simple_name IS '企业简称';
COMMENT ON COLUMN user_company_info.establish_date IS '成立时间';
COMMENT ON COLUMN user_company_info.registered_capital IS '注册本金';
COMMENT ON COLUMN user_company_info.address IS '企业地址';
COMMENT ON COLUMN user_company_info.bussiness_code IS '执照号';
COMMENT ON COLUMN user_company_info.org_code IS '组织机构代码';
COMMENT ON COLUMN user_company_info.license_address IS '营业执照所在地';
COMMENT ON COLUMN user_company_info.logo IS '企业LOGO';
COMMENT ON COLUMN user_company_info.license_expire_date IS '执照过期日（营业期限），格式为YYYYMMDD';
COMMENT ON COLUMN user_company_info.business_scope IS '营业范围';
COMMENT ON COLUMN user_company_info.telephone IS '联系电话';
COMMENT ON COLUMN user_company_info.contacts IS '联系人';
COMMENT ON COLUMN user_company_info.email IS '联系Email';
COMMENT ON COLUMN user_company_info.summary IS '企业简介';
COMMENT ON COLUMN user_company_info.natural_person IS '自然人';
COMMENT ON COLUMN user_company_info.legal_person IS '企业法人';
COMMENT ON COLUMN user_company_info.cert_no IS '法人证件号码';
COMMENT ON COLUMN user_company_info.cert_type IS '证件类型，默认身份证';
COMMENT ON COLUMN user_company_info.legal_person_phone IS '法人手机号码';
COMMENT ON COLUMN user_company_info.bank_code IS '银行编号';
COMMENT ON COLUMN user_company_info.bank_account_no IS '银行卡号';
COMMENT ON COLUMN user_company_info.bank_province IS '开户行省份';
COMMENT ON COLUMN user_company_info.bank_city IS '开户行城市';
COMMENT ON COLUMN user_company_info.bank_branch IS '支行名称';
COMMENT ON COLUMN user_company_info.extend_param IS '扩展信息';
COMMENT ON COLUMN user_company_info.audit_order_no IS '请求审核订单号';
COMMENT ON COLUMN user_company_info.audit_status IS '审核状态  0：待审核，1：审核成功，2：审核失败';
COMMENT ON COLUMN user_company_info.audit_time IS '审核时间';
COMMENT ON COLUMN user_company_info.audit_message IS '审核信息';
COMMENT ON COLUMN user_company_info.legal_delegate IS '法人代表';
COMMENT ON COLUMN user_company_info.tax_reg_no IS '税务登记号';
COMMENT ON COLUMN user_company_info.credit_code IS '统一社会信用代码';
COMMENT ON COLUMN user_company_info.office_province IS '工作地点省份';
COMMENT ON COLUMN user_company_info.office_city IS '工作地点成市';
COMMENT ON COLUMN user_company_info.office_area IS '工作地点地区';
COMMENT ON COLUMN user_company_info.office_address IS '工作地点';
COMMENT ON COLUMN user_company_info.three_certificate IS '是否三证合一用户（1是0否,默认0）';
...
;
COMMENT ON TABLE user_earn_log IS '用户收益记录';
COMMENT ON COLUMN user_earn_log.uuid IS '主键';
COMMENT ON COLUMN user_earn_log.user_id IS '用户ID';
COMMENT ON COLUMN user_earn_log.earn_date IS '收益日期';
COMMENT ON COLUMN user_earn_log.earn IS '收益金额';
COMMENT ON COLUMN user_earn_log.total IS '累计收益';
...
-- ----------------------------
DROP TABLE user_freeze;
CREATE TABLE user_freeze (
uuid NVARCHAR2(32) NOT NULL ,
user_id NVARCHAR2(32) NOT NULL ,
operation NVARCHAR2(20) NULL ,
create_time DATE NULL 
)
LOGGING
NOCOMPRESS
...
;
COMMENT ON TABLE user_freeze IS '用户冻结功能信息表';
COMMENT ON COLUMN user_freeze.uuid IS '主键';
COMMENT ON COLUMN user_freeze.user_id IS '用户ID';
COMMENT ON COLUMN user_freeze.operation IS '用户可冻结功能标识：充值recharge提现cash投资invest变现realize债权转让bond借款loan';
COMMENT ON COLUMN user_freeze.create_time IS '添加时间';
...
-- ----------------------------
DROP TABLE user_gift;
CREATE TABLE user_gift (
uuid NVARCHAR2(32) NOT NULL ,
gift_name NVARCHAR2(30) NULL ,
...
;
COMMENT ON TABLE user_gift IS '用户礼包表';
COMMENT ON COLUMN user_gift.uuid IS '主键';
COMMENT ON COLUMN user_gift.gift_name IS '礼包名称';
COMMENT ON COLUMN user_gift.gift_type IS '礼包类型 （0生日礼包 1专享礼包）';
COMMENT ON COLUMN user_gift.redenvelope_rule_id IS '红包发放规则id';
COMMENT ON COLUMN user_gift.rate_coupon_rule_id IS '加息券发放规则id';
COMMENT ON COLUMN user_gift.remark IS '礼包详情';
COMMENT ON COLUMN user_gift.create_time IS '添加日期';
COMMENT ON COLUMN user_gift.update_time IS '最后修改日期';
COMMENT ON COLUMN user_gift.delete_flag IS '逻辑删除标识 0正常  1删除';
...
-- ----------------------------
DROP TABLE user_identify;
CREATE TABLE user_identify (
uuid NVARCHAR2(32) NOT NULL ,
user_id NVARCHAR2(32) NOT NULL ,
real_name_status CHAR(1) NULL ,
real_name_verify_time DATE NULL ,
email_status CHAR(1) NULL ,
email_verify_time DATE NULL ,
mobile_phone_status CHAR(1) NULL ,
mobile_phone_verify_time DATE NULL ,
auth_sign_status CHAR(1) NULL ,
auth_sign_verify_time DATE NULL 
)
LOGGING
NOCOMPRESS
NOCACHE
...
;
COMMENT ON TABLE user_identify IS '用户认证信息';
COMMENT ON COLUMN user_identify.uuid IS '主键';
COMMENT ON COLUMN user_identify.user_id IS '用户ID';
COMMENT ON COLUMN user_identify.real_name_status IS '实名认证 0:未认证 1：实名认证通过 -1：实名认证未通过';
COMMENT ON COLUMN user_identify.real_name_verify_time IS '实名认证时间';
COMMENT ON COLUMN user_identify.email_status IS '邮箱认证 0:未认证 1：邮箱认证通过';
COMMENT ON COLUMN user_identify.email_verify_time IS '邮箱认证时间';
COMMENT ON COLUMN user_identify.mobile_phone_status IS '手机认证 -1:未通过,0:未认证,1:已认证';
COMMENT ON COLUMN user_identify.mobile_phone_verify_time IS '手机认证时间';
COMMENT ON COLUMN user_identify.auth_sign_status IS '业务授权状态（0.未授权 1.已授权，默认0）';
COMMENT ON COLUMN user_identify.auth_sign_verify_time IS '业务授权时间';
...
-- ----------------------------
DROP TABLE user_invest_auto_log;
CREATE TABLE user_invest_auto_log (
uuid NVARCHAR2(32) NOT NULL ,
user_id NVARCHAR2(32) NULL ,
project_id NVARCHAR2(32) NULL ,
invest_money NUMBER(20, 4) NULL ,
status CHAR(1) NULL ,
invest_time DATE NULL ,
remark NVARCHAR2(128) NULL 
)
LOGGING
NOCOMPRESS
...
;
COMMENT ON TABLE user_invest_auto_log IS '自动投资记录表';
COMMENT ON COLUMN user_invest_auto_log.uuid IS '主键';
COMMENT ON COLUMN user_invest_auto_log.user_id IS '用户id';
COMMENT ON COLUMN user_invest_auto_log.project_id IS '项目id';
COMMENT ON COLUMN user_invest_auto_log.invest_money IS '投资金额';
COMMENT ON COLUMN user_invest_auto_log.status IS '状态 0处理中. 1 成功 2 失败 ';
COMMENT ON COLUMN user_invest_auto_log.invest_time IS '投资时间';
COMMENT ON COLUMN user_invest_auto_log.remark IS '结果备注';
...
invite_user_id NVARCHAR2(32) NULL ,
invitee_user_id NVARCHAR2(32) NULL 
)
LOGGING
NOCOMPRESS
NOCACHE
...
;
COMMENT ON TABLE user_invite IS '邀请好友关联表';
COMMENT ON COLUMN user_invite.uuid IS '主键';
COMMENT ON COLUMN user_invite.invite_time IS '邀请时间';
COMMENT ON COLUMN user_invite.invite_user_id IS '邀请人';
COMMENT ON COLUMN user_invite.invitee_user_id IS '被邀请人';
...
;
COMMENT ON TABLE user_login_log IS '用户登录记录表';
COMMENT ON COLUMN user_login_log.uuid IS '主键';
...
-- ----------------------------
DROP TABLE user_opinion;
CREATE TABLE user_opinion (
uuid NVARCHAR2(32) NOT NULL ,
title NVARCHAR2(64) NULL ,
attachment_path NVARCHAR2(512) NULL ,
user_id NVARCHAR2(32) NULL ,
remark NVARCHAR2(512) NULL ,
create_time DATE NULL ,
add_ip NVARCHAR2(32) NULL 
...
;
COMMENT ON TABLE user_opinion IS '用户意见反馈表';
COMMENT ON COLUMN user_opinion.UUID IS '主键';
COMMENT ON COLUMN user_opinion.title IS '标题';
COMMENT ON COLUMN user_opinion.attachment_path IS '附件路径';
COMMENT ON COLUMN user_opinion.user_id IS '反馈人';
COMMENT ON COLUMN user_opinion.remark IS '反馈内容';
COMMENT ON COLUMN user_opinion.create_time IS '反馈时间';
COMMENT ON COLUMN user_opinion.add_ip IS 'IP地址';
...
-- ----------------------------
DROP TABLE user_qualification_apply;
CREATE TABLE user_qualification_apply (
uuid NVARCHAR2(32) NOT NULL ,
user_id NVARCHAR2(32) NOT NULL ,
qualification_type NVARCHAR2(32) NULL ,
create_time DATE NULL ,
verify_remark NVARCHAR2(200) NULL ,
verify_user NVARCHAR2(32) NULL ,
status CHAR(1) NULL ,
verify_time DATE NULL ,
add_ip NVARCHAR2(32) NULL 
...
;
COMMENT ON TABLE user_qualification_apply IS '借款资质审核申请';
COMMENT ON COLUMN user_qualification_apply.uuid IS '主键';
COMMENT ON COLUMN user_qualification_apply.user_id IS '用户ID';
COMMENT ON COLUMN user_qualification_apply.qualification_type IS '资质类型';
COMMENT ON COLUMN user_qualification_apply.create_time IS '添加时间';
COMMENT ON COLUMN user_qualification_apply.verify_remark IS '审核备注';
COMMENT ON COLUMN user_qualification_apply.verify_user IS '审核人';
COMMENT ON COLUMN user_qualification_apply.status IS '申请状态(待审核 0 ，审核成功 1 ，审核失败2 ，默认 0 )';
COMMENT ON COLUMN user_qualification_apply.verify_time IS '审核时间';
COMMENT ON COLUMN user_qualification_apply.add_ip IS '申请IP';
...
-- ----------------------------
DROP TABLE user_qualification_upload;
CREATE TABLE user_qualification_upload (
uuid NVARCHAR2(32) NOT NULL ,
user_id NVARCHAR2(32) NOT NULL ,
qualification_apply_id NVARCHAR2(32) NOT NULL ,
file_path NVARCHAR2(50) NULL ,
create_time DATE NULL ,
delete_flag CHAR(1) NULL 
)
LOGGING
...
;
COMMENT ON TABLE user_qualification_upload IS '借款资质文件';
COMMENT ON COLUMN user_qualification_upload.uuid IS '主键';
COMMENT ON COLUMN user_qualification_upload.user_id IS '用户ID';
COMMENT ON COLUMN user_qualification_upload.qualification_apply_id IS '审核申请ID';
COMMENT ON COLUMN user_qualification_upload.file_path IS '文件路径';
COMMENT ON COLUMN user_qualification_upload.create_time IS '添加时间';
COMMENT ON COLUMN user_qualification_upload.delete_flag IS '删除标识';
...
-- ----------------------------
DROP TABLE user_rate_coupon;
CREATE TABLE user_rate_coupon (
uuid NVARCHAR2(32) NOT NULL ,
user_id NVARCHAR2(32) NOT NULL ,
rule_id NVARCHAR2(32) NULL ,
rule_name NVARCHAR2(20) NOT NULL ,
activity_name NVARCHAR2(20) NULL ,
up_apr NUMBER(20, 4) NOT NULL ,
use_time DATE NULL ,
create_time DATE NULL ,
tender_id NVARCHAR2(32) NULL ,
status CHAR(1) NULL ,
...
;
COMMENT ON TABLE user_rate_coupon IS '用户加息券记录表';
COMMENT ON COLUMN user_rate_coupon.uuid IS '主键';
COMMENT ON COLUMN user_rate_coupon.user_id IS '用户id值';
COMMENT ON COLUMN user_rate_coupon.rule_id IS '加息券规则uuid';
COMMENT ON COLUMN user_rate_coupon.rule_name IS '加息券规则名称';
COMMENT ON COLUMN user_rate_coupon.activity_name IS '活动名称';
COMMENT ON COLUMN user_rate_coupon.up_apr IS '加息利率';
COMMENT ON COLUMN user_rate_coupon.use_time IS '使用时间';
COMMENT ON COLUMN user_rate_coupon.create_time IS '发放时间';
COMMENT ON COLUMN user_rate_coupon.tender_id IS '投资记录id值';
COMMENT ON COLUMN user_rate_coupon.status IS '加息券状态：0未使用,1已使用，2已过期 3已作废';
COMMENT ON COLUMN user_rate_coupon.use_valid_day IS '有效天数';
COMMENT ON COLUMN user_rate_coupon.use_tender_money IS '最低投资可用金额';
COMMENT ON COLUMN user_rate_coupon.use_project_type IS '可使用项目类型';
COMMENT ON COLUMN user_rate_coupon.use_expire_time IS '使用到期时间';
COMMENT ON COLUMN user_rate_coupon.grant_type IS '加息券发放方式：1 固定金额、2金额满返';
...
;
COMMENT ON TABLE user_redenvelope IS '用户获取红包实体表';
COMMENT ON COLUMN user_redenvelope.uuid IS '主键';
COMMENT ON COLUMN user_redenvelope.user_id IS '用户id值';
COMMENT ON COLUMN user_redenvelope.rule_id IS '红包规则uuid';
COMMENT ON COLUMN user_redenvelope.rule_name IS '红包规则名称';
COMMENT ON COLUMN user_redenvelope.activity_name IS '活动名称';
COMMENT ON COLUMN user_redenvelope.amount IS '红包金额';
COMMENT ON COLUMN user_redenvelope.use_time IS '使用时间';
COMMENT ON COLUMN user_redenvelope.create_time IS '发放时间';
COMMENT ON COLUMN user_redenvelope.tender_id IS '投资记录ID';
COMMENT ON COLUMN user_redenvelope.status IS '红包状态：0未使用,1已使用，2已过期 3已作废';
COMMENT ON COLUMN user_redenvelope.use_valid_day IS '有效天数';
COMMENT ON COLUMN user_redenvelope.use_tender_money IS '最低投资可用金额';
COMMENT ON COLUMN user_redenvelope.use_project_type IS '可使用项目类型';
COMMENT ON COLUMN user_redenvelope.use_expire_time IS '使用到期时间';
COMMENT ON COLUMN user_redenvelope.grant_type IS '红包发放方式：1 固定金额、2固定比例、3金额满返、4比例满返';
...
uuid NVARCHAR2(32) NOT NULL ,
user_id NVARCHAR2(32) NOT NULL ,
total_score NUMBER(11) NULL ,
use_score NUMBER(11) NULL ,
no_use_score NUMBER(11) NULL ,
expense_score NUMBER(11) NULL ,
create_time DATE NULL 
)
LOGGING
NOCOMPRESS
...
COMMENT ON COLUMN user_score.uuid IS '主键';
COMMENT ON COLUMN user_score.user_id IS '用户id';
COMMENT ON COLUMN user_score.total_score IS '总积分';
COMMENT ON COLUMN user_score.use_score IS '可用积分';
COMMENT ON COLUMN user_score.no_use_score IS '冻结积分';
COMMENT ON COLUMN user_score.expense_score IS '消费积分';
COMMENT ON COLUMN user_score.create_time IS '创建日期';
...
;
COMMENT ON TABLE user_score_log IS '用户积分记录';
COMMENT ON COLUMN user_score_log.uuid IS '主键';
COMMENT ON COLUMN user_score_log.user_id IS '用户id';
COMMENT ON COLUMN user_score_log.total_score IS '总积分';
COMMENT ON COLUMN user_score_log.use_score IS '可用积分';
COMMENT ON COLUMN user_score_log.opt_value IS '操作积分';
COMMENT ON COLUMN user_score_log.no_use_score IS '冻结积分';
COMMENT ON COLUMN user_score_log.opt_type IS '操作类型（0减少，1增加）';
COMMENT ON COLUMN user_score_log.type_name IS '积分类型名称';
COMMENT ON COLUMN user_score_log.create_time IS '创建日期';
...
-- ----------------------------
DROP TABLE user_security_answer;
CREATE TABLE user_security_answer (
uuid NVARCHAR2(32) NOT NULL ,
user_id NVARCHAR2(32) NOT NULL ,
question_flag NVARCHAR2(30) NULL ,
answer NVARCHAR2(64) NULL ,
sort NUMBER(11) NULL ,
create_time DATE NULL ,
add_ip NVARCHAR2(32) NULL ,
delete_flag CHAR(1) NULL 
...
;
COMMENT ON TABLE user_security_answer IS '用户密保答案';
COMMENT ON COLUMN user_security_answer.uuid IS '主键';
COMMENT ON COLUMN user_security_answer.user_id IS '用户ID';
COMMENT ON COLUMN user_security_answer.question_flag IS '问题标识（关联字典数据user_security_question）';
COMMENT ON COLUMN user_security_answer.answer IS '答案';
COMMENT ON COLUMN user_security_answer.sort IS '排序';
COMMENT ON COLUMN user_security_answer.create_time IS '添加时间';
COMMENT ON COLUMN user_security_answer.add_ip IS '添加IP';
COMMENT ON COLUMN user_security_answer.delete_flag IS '删除标识';
...
uuid NVARCHAR2(32) NOT NULL ,
user_id NVARCHAR2(32) NOT NULL ,
growth_value NUMBER(10, 2) NULL ,
vip_level NVARCHAR2(2) NULL ,
up_apr NUMBER(10, 2) NULL ,
birthday_gift_status CHAR(1) NULL ,
exclusive_gift_status CHAR(1) NULL ,
create_time DATE NULL ,
update_time DATE NULL ,
vip_level_rule NCLOB NULL 
)
LOGGING
NOCOMPRESS
NOCACHE
...
;
COMMENT ON TABLE user_vip IS '用户VIP等级';
COMMENT ON COLUMN user_vip.uuid IS '主键';
COMMENT ON COLUMN user_vip.user_id IS '用户的uuid';
COMMENT ON COLUMN user_vip.growth_value IS '成长值';
COMMENT ON COLUMN user_vip.vip_level IS 'Vip等级 1,2,3等';
COMMENT ON COLUMN user_vip.up_apr IS '额外收益率';
COMMENT ON COLUMN user_vip.birthday_gift_status IS '生日礼包状态（0未领取，1已经领取，3已经作废）';
COMMENT ON COLUMN user_vip.exclusive_gift_status IS '专享礼包状态（0未领取，1已经领取，3已经作废）';
COMMENT ON COLUMN user_vip.create_time IS '获取vip等级时间';
COMMENT ON COLUMN user_vip.update_time IS 'vip状态更新时间';
COMMENT ON COLUMN user_vip.vip_level_rule IS 'vip生成/更新时的vip等级json字符串';
...
-- ----------------------------
DROP TABLE user_vip_growth_log;
CREATE TABLE user_vip_growth_log (
uuid NVARCHAR2(32) NOT NULL ,
user_id NVARCHAR2(32) NULL ,
growth_value NUMBER(20, 2) NULL ,
opt_type CHAR(1) NULL ,
growth_value_new NUMBER(20, 2) NULL ,
opt_value NUMBER(20, 2) NULL ,
remark NVARCHAR2(512) NULL ,
create_time DATE NULL 
)
LOGGING
...
;
COMMENT ON TABLE user_vip_growth_log IS 'vip成长记录表';
COMMENT ON COLUMN user_vip_growth_log.user_id IS '用户id';
COMMENT ON COLUMN user_vip_growth_log.growth_value IS '原来成长值';
COMMENT ON COLUMN user_vip_growth_log.opt_type IS '操作类型（0减少，1增加）';
COMMENT ON COLUMN user_vip_growth_log.growth_value_new IS '操作后的成长值';
COMMENT ON COLUMN user_vip_growth_log.opt_value IS '本次操作成长值';
COMMENT ON COLUMN user_vip_growth_log.remark IS '操作备注';
COMMENT ON COLUMN user_vip_growth_log.create_time IS '操作时间';
...
-- ----------------------------
DROP TABLE user_vip_level;
CREATE TABLE user_vip_level (
uuid NVARCHAR2(32) NOT NULL ,
growth_value NUMBER(20, 2) NULL ,
growth_limit_value NUMBER(20, 2) NULL ,
vip_level NVARCHAR2(2) NULL ,
year_deduction NUMBER(20, 2) NULL ,
up_apr NUMBER(10, 2) NULL ,
redenvelope_rule_id NVARCHAR2(32) NULL ,
rate_coupon_rule_id NVARCHAR2(32) NULL ,
birthday_gift_id NVARCHAR2(32) NULL ,
exclusive_gift_id NVARCHAR2(32) NULL ,
create_time DATE NULL ,
update_time DATE NULL ,
delete_flag CHAR(1) NULL 
)
...
;
COMMENT ON TABLE user_vip_level IS 'vip等级配置表';
COMMENT ON COLUMN user_vip_level.uuid IS '主键';
COMMENT ON COLUMN user_vip_level.growth_value IS '所需成长值';
COMMENT ON COLUMN user_vip_level.growth_limit_value IS '成长封顶值';
COMMENT ON COLUMN user_vip_level.vip_level IS 'vip等级 每次新增+1 ';
COMMENT ON COLUMN user_vip_level.year_deduction IS '年扣除成长值';
COMMENT ON COLUMN user_vip_level.up_apr IS '额外收益率';
COMMENT ON COLUMN user_vip_level.redenvelope_rule_id IS '红包发放规则id';
COMMENT ON COLUMN user_vip_level.rate_coupon_rule_id IS '加息前发放规则id';
COMMENT ON COLUMN user_vip_level.birthday_gift_id IS '生日礼包id';
COMMENT ON COLUMN user_vip_level.exclusive_gift_id IS '专享礼包id';
COMMENT ON COLUMN user_vip_level.create_time IS '创建时间';
COMMENT ON COLUMN user_vip_level.update_time IS '更新日期';
COMMENT ON COLUMN user_vip_level.delete_flag IS '逻辑删除标识 0正常  1删除';
...
-- ----------------------------
CREATE UNIQUE INDEX uk_acc_userid_code
ON account (user_id ASC, account_code ASC)
LOGGING
VISIBLE;
...
-- ----------------------------
ALTER TABLE account ADD CHECK (uuid IS NOT NULL);
ALTER TABLE account ADD CHECK (user_id IS NOT NULL);
ALTER TABLE account ADD CHECK (account_code IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table account
-- ----------------------------
ALTER TABLE account ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table account_bank_card
-- ----------------------------

-- ----------------------------
-- Checks structure for table account_bank_card
-- ----------------------------
ALTER TABLE account_bank_card ADD CHECK (uuid IS NOT NULL);
ALTER TABLE account_bank_card ADD CHECK (user_id IS NOT NULL);
ALTER TABLE account_bank_card ADD CHECK (status IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table account_bank_card
-- ----------------------------
ALTER TABLE account_bank_card ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table account_check
-- ----------------------------

-- ----------------------------
-- Checks structure for table account_check
-- ----------------------------
ALTER TABLE account_check ADD CHECK (uuid IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table account_check
-- ----------------------------
ALTER TABLE account_check ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table account_log
-- ----------------------------
CREATE INDEX idx_acclog_userid_code
ON account_log (user_id ASC, account_code ASC)
LOGGING
VISIBLE;

-- ----------------------------
-- Checks structure for table account_log
-- ----------------------------
ALTER TABLE account_log ADD CHECK (uuid IS NOT NULL);
ALTER TABLE account_log ADD CHECK (account_code IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table account_log
-- ----------------------------
ALTER TABLE account_log ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table activity_plan
-- ----------------------------

-- ----------------------------
-- Checks structure for table activity_plan
-- ----------------------------
ALTER TABLE activity_plan ADD CHECK (uuid IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table activity_plan
-- ----------------------------
ALTER TABLE activity_plan ADD PRIMARY KEY (uuid);
...
-- ----------------------------
ALTER TABLE article ADD CHECK (uuid IS NOT NULL);
ALTER TABLE article ADD CHECK (section_code IS NOT NULL);
ALTER TABLE article ADD CHECK (title IS NOT NULL);
...
-- ----------------------------
-- Indexes structure for table auto_invest_rule_log
-- ----------------------------

-- ----------------------------
-- Checks structure for table auto_invest_rule_log
-- ----------------------------
ALTER TABLE auto_invest_rule_log ADD CHECK (uuid IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table auto_invest_rule_log
-- ----------------------------
ALTER TABLE auto_invest_rule_log ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table bond
-- ----------------------------
CREATE UNIQUE INDEX uq_bond_no
ON bond (bond_no ASC)
LOGGING
VISIBLE;

-- ----------------------------
-- Checks structure for table bond
-- ----------------------------
ALTER TABLE bond ADD CHECK (uuid IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table bond
-- ----------------------------
ALTER TABLE bond ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table bond_collection
-- ----------------------------
CREATE INDEX idx_bcoll_user_id
ON bond_collection (user_id ASC)
LOGGING
VISIBLE;

-- ----------------------------
-- Checks structure for table bond_collection
-- ----------------------------
ALTER TABLE bond_collection ADD CHECK (uuid IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table bond_collection
-- ----------------------------
ALTER TABLE bond_collection ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table bond_invest
-- ----------------------------
CREATE INDEX idx_binvest_bond_id
ON bond_invest (bond_id ASC)
LOGGING
VISIBLE;

-- ----------------------------
-- Checks structure for table bond_invest
-- ----------------------------
ALTER TABLE bond_invest ADD CHECK (uuid IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table bond_invest
-- ----------------------------
ALTER TABLE bond_invest ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table bond_rule
-- ----------------------------

-- ----------------------------
-- Checks structure for table bond_rule
-- ----------------------------
ALTER TABLE bond_rule ADD CHECK (uuid IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table bond_rule
-- ----------------------------
ALTER TABLE bond_rule ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table borrow
-- ----------------------------

-- ----------------------------
-- Checks structure for table borrow
-- ----------------------------
ALTER TABLE borrow ADD CHECK (project_id IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table borrow
-- ----------------------------
ALTER TABLE borrow ADD PRIMARY KEY (project_id);

-- ----------------------------
-- Indexes structure for table borrow_bespeak
-- ----------------------------

-- ----------------------------
-- Checks structure for table borrow_bespeak
-- ----------------------------
ALTER TABLE borrow_bespeak ADD CHECK (uuid IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table borrow_bespeak
-- ----------------------------
ALTER TABLE borrow_bespeak ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table borrow_follow
-- ----------------------------

-- ----------------------------
-- Checks structure for table borrow_follow
-- ----------------------------
ALTER TABLE borrow_follow ADD CHECK (uuid IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table borrow_follow
-- ----------------------------
ALTER TABLE borrow_follow ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table borrow_upload
-- ----------------------------
CREATE INDEX idx_borrow_upload_project_id
ON borrow_upload (project_id ASC)
LOGGING
VISIBLE;

-- ----------------------------
-- Checks structure for table borrow_upload
-- ----------------------------
ALTER TABLE borrow_upload ADD CHECK (uuid IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table borrow_upload
-- ----------------------------
ALTER TABLE borrow_upload ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table buyback
-- ----------------------------

-- ----------------------------
-- Checks structure for table buyback
-- ----------------------------
ALTER TABLE buyback ADD CHECK (uuid IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table buyback
-- ----------------------------
ALTER TABLE buyback ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table cash
-- ----------------------------

-- ----------------------------
-- Checks structure for table cash
-- ----------------------------
ALTER TABLE cash ADD CHECK (uuid IS NOT NULL);
ALTER TABLE cash ADD CHECK (user_id IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table cash
-- ----------------------------
ALTER TABLE cash ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table freeze_trade_log
-- ----------------------------

-- ----------------------------
-- Checks structure for table freeze_trade_log
-- ----------------------------
ALTER TABLE freeze_trade_log ADD CHECK (uuid IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table freeze_trade_log
-- ----------------------------
ALTER TABLE freeze_trade_log ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table message_resource
-- ----------------------------
-- ----------------------------
...
-- ----------------------------
ALTER TABLE product ADD CHECK (project_id IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table product
-- ----------------------------
ALTER TABLE product ADD PRIMARY KEY (project_id);

-- ----------------------------
-- Indexes structure for table project
-- ----------------------------
CREATE INDEX idx_project_status
ON project (status ASC)
LOGGING
VISIBLE;
CREATE INDEX idx_project_user_id
ON project (user_id ASC)
LOGGING
VISIBLE;
CREATE UNIQUE INDEX uq_project_no
ON project (project_no ASC)
LOGGING
VISIBLE;
...
-- ----------------------------
ALTER TABLE project ADD CHECK (uuid IS NOT NULL);
...
-- ----------------------------
-- Indexes structure for table project_collection
-- ----------------------------
CREATE INDEX idx_pcoll_project_id
ON project_collection (project_id ASC)
LOGGING
VISIBLE;
CREATE INDEX idx_pcoll_status
ON project_collection (status ASC)
LOGGING
VISIBLE;
CREATE INDEX idx_pcoll_user_id
ON project_collection (user_id ASC)
LOGGING
VISIBLE;

-- ----------------------------
-- Checks structure for table project_collection
-- ----------------------------
ALTER TABLE project_collection ADD CHECK (uuid IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table project_collection
-- ----------------------------
ALTER TABLE project_collection ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table project_invest
-- ----------------------------
CREATE INDEX idx_pinvest_order_no
ON project_invest (invest_order_no ASC)
LOGGING
VISIBLE;
CREATE INDEX idx_pinvest_project_id
ON project_invest (project_id ASC)
LOGGING
VISIBLE;
CREATE INDEX idx_pinvest_status
ON project_invest (status ASC)
LOGGING
VISIBLE;
CREATE INDEX idx_pinvest_user_id
ON project_invest (user_id ASC)
LOGGING
VISIBLE;

-- ----------------------------
-- Checks structure for table project_invest
-- ----------------------------
ALTER TABLE project_invest ADD CHECK (uuid IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table project_invest
-- ----------------------------
ALTER TABLE project_invest ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table project_invest_bespeak
-- ----------------------------
CREATE UNIQUE INDEX uk_pinvest_bespeak
ON project_invest_bespeak (user_id ASC, project_id ASC)
LOGGING
VISIBLE;

-- ----------------------------
-- Checks structure for table project_invest_bespeak
-- ----------------------------
ALTER TABLE project_invest_bespeak ADD CHECK (uuid IS NOT NULL);
ALTER TABLE project_invest_bespeak ADD CHECK (user_id IS NOT NULL);
ALTER TABLE project_invest_bespeak ADD CHECK (project_id IS NOT NULL);
ALTER TABLE project_invest_bespeak ADD CHECK (sale_time IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table project_invest_bespeak
-- ----------------------------
ALTER TABLE project_invest_bespeak ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table project_repayment
-- ----------------------------
CREATE INDEX idx_prepay_project_id
ON project_repayment (project_id ASC)
LOGGING
VISIBLE;
CREATE INDEX idx_prepay_user_id
ON project_repayment (user_id ASC)
LOGGING
VISIBLE;

-- ----------------------------
-- Checks structure for table project_repayment
-- ----------------------------
ALTER TABLE project_repayment ADD CHECK (uuid IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table project_repayment
-- ----------------------------
ALTER TABLE project_repayment ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table project_type
-- ----------------------------

-- ----------------------------
-- Checks structure for table project_type
-- ----------------------------
ALTER TABLE project_type ADD CHECK (uuid IS NOT NULL);
ALTER TABLE project_type ADD CHECK (delete_flag IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table project_type
-- ----------------------------
ALTER TABLE project_type ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table project_verify_log
-- ----------------------------
CREATE INDEX idx_pverlog_project_id
ON project_verify_log (project_id ASC)
LOGGING
VISIBLE;

-- ----------------------------
-- Checks structure for table project_verify_log
-- ----------------------------
ALTER TABLE project_verify_log ADD CHECK (uuid IS NOT NULL);
ALTER TABLE project_verify_log ADD CHECK (project_id IS NOT NULL);
ALTER TABLE project_verify_log ADD CHECK (verify_name IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table project_verify_log
-- ----------------------------
ALTER TABLE project_verify_log ADD PRIMARY KEY (uuid);
...
-- ----------------------------
-- Checks structure for table protocol
-- ----------------------------
ALTER TABLE protocol ADD CHECK (uuid IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table protocol
-- ----------------------------
ALTER TABLE protocol ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table protocol_log
-- ----------------------------

-- ----------------------------
-- Checks structure for table protocol_log
-- ----------------------------
ALTER TABLE protocol_log ADD CHECK (uuid IS NOT NULL);
ALTER TABLE protocol_log ADD CHECK (protocol_id IS NOT NULL);
ALTER TABLE protocol_log ADD CHECK (protocol_type IS NOT NULL);
ALTER TABLE protocol_log ADD CHECK (protocol_name IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table protocol_log
-- ----------------------------
ALTER TABLE protocol_log ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table rate_coupon_rule
-- ----------------------------

-- ----------------------------
-- Checks structure for table rate_coupon_rule
-- ----------------------------
ALTER TABLE rate_coupon_rule ADD CHECK (uuid IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table rate_coupon_rule
-- ----------------------------
ALTER TABLE rate_coupon_rule ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table rate_coupon_rule_detail
-- ----------------------------

-- ----------------------------
-- Checks structure for table rate_coupon_rule_detail
-- ----------------------------
ALTER TABLE rate_coupon_rule_detail ADD CHECK (uuid IS NOT NULL);
ALTER TABLE rate_coupon_rule_detail ADD CHECK (rule_id IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table rate_coupon_rule_detail
-- ----------------------------
ALTER TABLE rate_coupon_rule_detail ADD PRIMARY KEY (uuid);



-- ----------------------------
-- Indexes structure for table realize
-- ----------------------------
CREATE INDEX idx_realize_proid
ON realize (project_id ASC)
LOGGING
VISIBLE;
CREATE INDEX idx_realize_proid_investid
ON realize (project_id ASC, invest_id ASC)
LOGGING
VISIBLE;

-- ----------------------------
-- Checks structure for table realize
-- ----------------------------
ALTER TABLE realize ADD CHECK (project_id IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table realize
-- ----------------------------
ALTER TABLE realize ADD PRIMARY KEY (project_id);

-- ----------------------------
-- Indexes structure for table realize_freeze
-- ----------------------------
CREATE INDEX idx_rlfreeze_collid_status
ON realize_freeze (collection_id ASC, status ASC)
LOGGING
VISIBLE;
CREATE INDEX idx_rlfreeze_realizeid_status
ON realize_freeze (realize_id ASC, status ASC)
LOGGING
VISIBLE;

-- ----------------------------
-- Checks structure for table realize_freeze
-- ----------------------------
ALTER TABLE realize_freeze ADD CHECK (uuid IS NOT NULL);
ALTER TABLE realize_freeze ADD CHECK (user_id IS NOT NULL);
ALTER TABLE realize_freeze ADD CHECK (realize_id IS NOT NULL);
ALTER TABLE realize_freeze ADD CHECK (collection_id IS NOT NULL);
ALTER TABLE realize_freeze ADD CHECK (money IS NOT NULL);
ALTER TABLE realize_freeze ADD CHECK (freeze_type IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table realize_freeze
-- ----------------------------
ALTER TABLE realize_freeze ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table realize_rule
-- ----------------------------

-- ----------------------------
-- Checks structure for table realize_rule
-- ----------------------------
ALTER TABLE realize_rule ADD CHECK (uuid IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table realize_rule
-- ----------------------------
ALTER TABLE realize_rule ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Checks structure for table receiving_info
-- ----------------------------
ALTER TABLE receiving_info ADD CHECK (uuid IS NOT NULL);
ALTER TABLE receiving_info ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table recharge
-- ----------------------------

-- ----------------------------
-- Checks structure for table recharge
-- ----------------------------
ALTER TABLE recharge ADD CHECK (uuid IS NOT NULL);
ALTER TABLE recharge ADD CHECK (fee_type IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table recharge
-- ----------------------------
ALTER TABLE recharge ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table redenvelope_rule
-- ----------------------------

-- ----------------------------
-- Checks structure for table redenvelope_rule
-- ----------------------------
ALTER TABLE redenvelope_rule ADD CHECK (uuid IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table redenvelope_rule
-- ----------------------------
ALTER TABLE redenvelope_rule ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table redenvelope_rule_detail
-- ----------------------------

-- ----------------------------
-- Checks structure for table redenvelope_rule_detail
-- ----------------------------
ALTER TABLE redenvelope_rule_detail ADD CHECK (uuid IS NOT NULL);
ALTER TABLE redenvelope_rule_detail ADD CHECK (rule_id IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table redenvelope_rule_detail
-- ----------------------------
ALTER TABLE redenvelope_rule_detail ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table risk_answer
-- ----------------------------

-- ----------------------------
-- Checks structure for table risk_answer
-- ----------------------------
ALTER TABLE risk_answer ADD CHECK (uuid IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table risk_answer
-- ----------------------------
ALTER TABLE risk_answer ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table risk_level_config
-- ----------------------------

-- ----------------------------
-- Checks structure for table risk_level_config
-- ----------------------------
ALTER TABLE risk_level_config ADD CHECK (uuid IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table risk_level_config
-- ----------------------------
ALTER TABLE risk_level_config ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table risk_papers
-- ----------------------------

-- ----------------------------
-- Checks structure for table risk_papers
-- ----------------------------
ALTER TABLE risk_papers ADD CHECK (uuid IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table risk_papers
-- ----------------------------
ALTER TABLE risk_papers ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table risk_papers_score
-- ----------------------------

-- ----------------------------
-- Checks structure for table risk_papers_score
-- ----------------------------
ALTER TABLE risk_papers_score ADD CHECK (uuid IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table risk_papers_score
-- ----------------------------
ALTER TABLE risk_papers_score ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table risk_question
-- ----------------------------
CREATE INDEX fk_pattach_papersid
ON risk_question (papers_id ASC)
LOGGING
VISIBLE;

-- ----------------------------
-- Checks structure for table risk_question
-- ----------------------------
ALTER TABLE risk_question ADD CHECK (uuid IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table risk_question
-- ----------------------------
ALTER TABLE risk_question ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table risk_user_log
-- ----------------------------

-- ----------------------------
-- Checks structure for table risk_user_log
-- ----------------------------
ALTER TABLE risk_user_log ADD CHECK (uuid IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table risk_user_log
-- ----------------------------
ALTER TABLE risk_user_log ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table score_goods
-- ----------------------------

-- ----------------------------
-- Checks structure for table score_goods
-- ----------------------------
ALTER TABLE score_goods ADD CHECK (uuid IS NOT NULL);
ALTER TABLE score_goods ADD CHECK (goods_name IS NOT NULL);
ALTER TABLE score_goods ADD CHECK (status IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table score_goods
-- ----------------------------
ALTER TABLE score_goods ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table score_goods_category
-- ----------------------------

-- ----------------------------
-- Checks structure for table score_goods_category
-- ----------------------------
ALTER TABLE score_goods_category ADD CHECK (uuid IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table score_goods_category
-- ----------------------------
ALTER TABLE score_goods_category ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table score_goods_order
-- ----------------------------

-- ----------------------------
-- Checks structure for table score_goods_order
-- ----------------------------
ALTER TABLE score_goods_order ADD CHECK (uuid IS NOT NULL);
ALTER TABLE score_goods_order ADD CHECK (user_id IS NOT NULL);
ALTER TABLE score_goods_order ADD CHECK (goods_id IS NOT NULL);
ALTER TABLE score_goods_order ADD CHECK (num IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table score_goods_order
-- ----------------------------
ALTER TABLE score_goods_order ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table score_goods_pic
-- ----------------------------

-- ----------------------------
-- Checks structure for table score_goods_pic
-- ----------------------------
ALTER TABLE score_goods_pic ADD CHECK (uuid IS NOT NULL);
ALTER TABLE score_goods_pic ADD CHECK (goods_id IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table score_goods_pic
-- ----------------------------
ALTER TABLE score_goods_pic ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table score_goods_store
-- ----------------------------

-- ----------------------------
-- Checks structure for table score_goods_store
-- ----------------------------
ALTER TABLE score_goods_store ADD CHECK (uuid IS NOT NULL);
ALTER TABLE score_goods_store ADD CHECK (goods_id IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table score_goods_store
-- ----------------------------
ALTER TABLE score_goods_store ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table score_type
-- ----------------------------

-- ----------------------------
-- Checks structure for table score_type
-- ----------------------------
ALTER TABLE score_type ADD CHECK (uuid IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table score_type
-- ----------------------------
ALTER TABLE score_type ADD PRIMARY KEY (uuid);
...
-- ----------------------------
ALTER TABLE section ADD CHECK (uuid IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table section
-- ----------------------------
ALTER TABLE section ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table statistic_account
-- ----------------------------

-- ----------------------------
-- Checks structure for table statistic_account
-- ----------------------------
ALTER TABLE statistic_account ADD CHECK (uuid IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table statistic_account
-- ----------------------------
ALTER TABLE statistic_account ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table statistic_bad_debt
-- ----------------------------

-- ----------------------------
-- Checks structure for table statistic_bad_debt
-- ----------------------------
ALTER TABLE statistic_bad_debt ADD CHECK (uuid IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table statistic_bad_debt
-- ----------------------------
ALTER TABLE statistic_bad_debt ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table statistic_bond
-- ----------------------------

-- ----------------------------
-- Checks structure for table statistic_bond
-- ----------------------------
ALTER TABLE statistic_bond ADD CHECK (uuid IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table statistic_bond
-- ----------------------------
ALTER TABLE statistic_bond ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table statistic_borrow
-- ----------------------------

-- ----------------------------
-- Checks structure for table statistic_borrow
-- ----------------------------
ALTER TABLE statistic_borrow ADD CHECK (uuid IS NOT NULL);
ALTER TABLE statistic_borrow ADD CHECK (borrow_date IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table statistic_borrow
-- ----------------------------
ALTER TABLE statistic_borrow ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table statistic_earn
-- ----------------------------

-- ----------------------------
-- Checks structure for table statistic_earn
-- ----------------------------
ALTER TABLE statistic_earn ADD CHECK (uuid IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table statistic_earn
-- ----------------------------
ALTER TABLE statistic_earn ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table statistic_invest
-- ----------------------------

-- ----------------------------
-- Checks structure for table statistic_invest
-- ----------------------------
ALTER TABLE statistic_invest ADD CHECK (uuid IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table statistic_invest
-- ----------------------------
ALTER TABLE statistic_invest ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table statistic_overdue
-- ----------------------------

-- ----------------------------
-- Checks structure for table statistic_overdue
-- ----------------------------
ALTER TABLE statistic_overdue ADD CHECK (uuid IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table statistic_overdue
-- ----------------------------
ALTER TABLE statistic_overdue ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table statistic_repay
-- ----------------------------

-- ----------------------------
-- Checks structure for table statistic_repay
-- ----------------------------
ALTER TABLE statistic_repay ADD CHECK (uuid IS NOT NULL);
ALTER TABLE statistic_repay ADD CHECK (record_date IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table statistic_repay
-- ----------------------------
ALTER TABLE statistic_repay ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table statistic_repay_info
-- ----------------------------

-- ----------------------------
-- Checks structure for table statistic_repay_info
-- ----------------------------
ALTER TABLE statistic_repay_info ADD CHECK (uuid IS NOT NULL);
ALTER TABLE statistic_repay_info ADD CHECK (record_date IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table statistic_repay_info
-- ----------------------------
ALTER TABLE statistic_repay_info ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table statistic_user
-- ----------------------------

-- ----------------------------
-- Checks structure for table statistic_user
-- ----------------------------
ALTER TABLE statistic_user ADD CHECK (user_id IS NOT NULL);
ALTER TABLE statistic_user ADD CHECK (regist_date IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table statistic_user
-- ----------------------------
ALTER TABLE statistic_user ADD PRIMARY KEY (user_id);

-- ----------------------------
-- Indexes structure for table sys_area
-- ----------------------------
CREATE INDEX uk_sys_area
ON sys_area (area_code ASC)
LOGGING
VISIBLE;
...
-- ----------------------------
ALTER TABLE sys_area ADD CHECK (uuid IS NOT NULL);
ALTER TABLE sys_area ADD CHECK (area_code IS NOT NULL);
ALTER TABLE sys_area ADD CHECK (area_name IS NOT NULL);
...
-- ----------------------------
CREATE UNIQUE INDEX uk_config_code
ON sys_config (code ASC)
LOGGING
VISIBLE;
...
-- ----------------------------
ALTER TABLE sys_config ADD CHECK (uuid IS NOT NULL);
ALTER TABLE sys_config ADD CHECK (code IS NOT NULL);
ALTER TABLE sys_config ADD CHECK (config_name IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table sys_config
-- ----------------------------
ALTER TABLE sys_config ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table sys_dict_data
-- ----------------------------
CREATE UNIQUE INDEX uk_data_type_value
ON sys_dict_data (item_value ASC, dict_type ASC)
LOGGING
VISIBLE;
...
-- ----------------------------
ALTER TABLE sys_dict_data ADD CHECK (uuid IS NOT NULL);
ALTER TABLE sys_dict_data ADD CHECK (dict_type IS NOT NULL);
ALTER TABLE sys_dict_data ADD CHECK (item_name IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table sys_dict_data
-- ----------------------------
ALTER TABLE sys_dict_data ADD PRIMARY KEY (uuid);
...
-- ----------------------------
ALTER TABLE sys_dict_type ADD CHECK (uuid IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table sys_dict_type
-- ----------------------------
ALTER TABLE sys_dict_type ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table sys_letter
-- ----------------------------
CREATE INDEX idx_letter_rcuser_read_del
ON sys_letter (receive_user ASC, read_flag ASC, delete_flag ASC)
LOGGING
VISIBLE;

-- ----------------------------
-- Checks structure for table sys_letter
-- ----------------------------
ALTER TABLE sys_letter ADD CHECK (uuid IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table sys_letter
-- ----------------------------
ALTER TABLE sys_letter ADD PRIMARY KEY (uuid);
...
-- ----------------------------
ALTER TABLE sys_log ADD CHECK (uuid IS NOT NULL);
...
-- ----------------------------
-- Indexes structure for table sys_log_template
-- ----------------------------
CREATE INDEX idx_log_tpl_code
ON sys_log_template (code ASC)
LOGGING
VISIBLE;

-- ----------------------------
-- Checks structure for table sys_log_template
-- ----------------------------
ALTER TABLE sys_log_template ADD CHECK (uuid IS NOT NULL);
ALTER TABLE sys_log_template ADD CHECK (code IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table sys_log_template
-- ----------------------------
ALTER TABLE sys_log_template ADD PRIMARY KEY (uuid, code);

-- ----------------------------
-- Indexes structure for table sys_menu
-- ----------------------------
CREATE UNIQUE INDEX uk_menu_code
ON sys_menu (code ASC)
LOGGING
VISIBLE;
...
-- ----------------------------
ALTER TABLE sys_menu ADD CHECK (uuid IS NOT NULL);
ALTER TABLE sys_menu ADD CHECK (code IS NOT NULL);
ALTER TABLE sys_menu ADD CHECK (menu_name IS NOT NULL);
ALTER TABLE sys_menu ADD CHECK (url IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table sys_menu
-- ----------------------------
ALTER TABLE sys_menu ADD PRIMARY KEY (uuid);
...
-- ----------------------------
ALTER TABLE sys_message ADD CHECK (uuid IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table sys_message
-- ----------------------------
ALTER TABLE sys_message ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table sys_message_type
-- ----------------------------

-- ----------------------------
-- Checks structure for table sys_message_type
-- ----------------------------
ALTER TABLE sys_message_type ADD CHECK (uuid IS NOT NULL);
ALTER TABLE sys_message_type ADD CHECK (send IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table sys_message_type
-- ----------------------------
ALTER TABLE sys_message_type ADD PRIMARY KEY (uuid);
...
-- ----------------------------
ALTER TABLE sys_operation ADD CHECK (uuid IS NOT NULL);
ALTER TABLE sys_operation ADD CHECK (code IS NOT NULL);
ALTER TABLE sys_operation ADD CHECK (operation_name IS NOT NULL);
ALTER TABLE sys_operation ADD CHECK (operation_type IS NOT NULL);
ALTER TABLE sys_operation ADD CHECK (delete_flag IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table sys_operation
-- ----------------------------
ALTER TABLE sys_operation ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table sys_operator
-- ----------------------------
CREATE UNIQUE INDEX idx_user_login_name
ON sys_operator (login_name ASC)
LOGGING
VISIBLE;

-- ----------------------------
-- Checks structure for table sys_operator
-- ----------------------------
ALTER TABLE sys_operator ADD CHECK (uuid IS NOT NULL);
ALTER TABLE sys_operator ADD CHECK (login_name IS NOT NULL);
ALTER TABLE sys_operator ADD CHECK (pwd IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table sys_operator
-- ----------------------------
ALTER TABLE sys_operator ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table sys_operator_customer
-- ----------------------------

-- ----------------------------
-- Checks structure for table sys_operator_customer
-- ----------------------------
ALTER TABLE sys_operator_customer ADD CHECK (uuid IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table sys_operator_customer
-- ----------------------------
ALTER TABLE sys_operator_customer ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table sys_operator_role
-- ----------------------------

-- ----------------------------
-- Checks structure for table sys_operator_role
-- ----------------------------
ALTER TABLE sys_operator_role ADD CHECK (uuid IS NOT NULL);
ALTER TABLE sys_operator_role ADD CHECK (operator_id IS NOT NULL);
ALTER TABLE sys_operator_role ADD CHECK (role_id IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table sys_operator_role
-- ----------------------------
ALTER TABLE sys_operator_role ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table sys_org
-- ----------------------------
CREATE INDEX idx_org_name
ON sys_org (org_name ASC)
LOGGING
VISIBLE;
...
-- ----------------------------
ALTER TABLE sys_org ADD CHECK (uuid IS NOT NULL);
ALTER TABLE sys_org ADD CHECK (org_name IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table sys_org
-- ----------------------------
ALTER TABLE sys_org ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table sys_permission
-- ----------------------------
CREATE UNIQUE INDEX uk_perm_code
ON sys_permission (code ASC)
LOGGING
VISIBLE;
...
-- ----------------------------
ALTER TABLE sys_permission ADD CHECK (uuid IS NOT NULL);
ALTER TABLE sys_permission ADD CHECK (code IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table sys_permission
-- ----------------------------
ALTER TABLE sys_permission ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table sys_resource
-- ----------------------------
CREATE UNIQUE INDEX uk_sys_resource
ON sys_resource (res_name ASC, res_language ASC)
LOGGING
VISIBLE;
CREATE UNIQUE INDEX uk_sys_resource_res_name
ON sys_resource (res_name ASC)
LOGGING
VISIBLE;
...
-- ----------------------------
ALTER TABLE sys_resource ADD CHECK (uuid IS NOT NULL);
...
-- ----------------------------
ALTER TABLE sys_role ADD CHECK (uuid IS NOT NULL);
ALTER TABLE sys_role ADD CHECK (role_name IS NOT NULL);
...
-- ----------------------------
ALTER TABLE sys_role_permission ADD CHECK (uuid IS NOT NULL);
...
-- ----------------------------
ALTER TABLE sys_role_permission ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table sys_user_message_config
-- ----------------------------

-- ----------------------------
-- Checks structure for table sys_user_message_config
-- ----------------------------
ALTER TABLE sys_user_message_config ADD CHECK (uuid IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table sys_user_message_config
-- ----------------------------
ALTER TABLE sys_user_message_config ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table token_store
-- ----------------------------

-- ----------------------------
-- Checks structure for table token_store
-- ----------------------------
ALTER TABLE token_store ADD CHECK (uuid IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table token_store
-- ----------------------------
ALTER TABLE token_store ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table tpp_cbhb_request
-- ----------------------------

-- ----------------------------
-- Checks structure for table tpp_cbhb_request
-- ----------------------------
ALTER TABLE tpp_cbhb_request ADD CHECK (uuid IS NOT NULL);
ALTER TABLE tpp_cbhb_request ADD CHECK (request_type IS NOT NULL);
ALTER TABLE tpp_cbhb_request ADD CHECK (request_merbillno IS NOT NULL);
ALTER TABLE tpp_cbhb_request ADD CHECK (request_map IS NOT NULL);
ALTER TABLE tpp_cbhb_request ADD CHECK (request_file_url IS NOT NULL);
ALTER TABLE tpp_cbhb_request ADD CHECK (request_time IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table tpp_cbhb_request
-- ----------------------------
ALTER TABLE tpp_cbhb_request ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table tpp_cbhb_response
-- ----------------------------

-- ----------------------------
-- Checks structure for table tpp_cbhb_response
-- ----------------------------
ALTER TABLE tpp_cbhb_response ADD CHECK (uuid IS NOT NULL);
ALTER TABLE tpp_cbhb_response ADD CHECK (resp_type IS NOT NULL);
ALTER TABLE tpp_cbhb_response ADD CHECK (request_merbillno IS NOT NULL);
ALTER TABLE tpp_cbhb_response ADD CHECK (resp_transid IS NOT NULL);
ALTER TABLE tpp_cbhb_response ADD CHECK (resp_map IS NOT NULL);
ALTER TABLE tpp_cbhb_response ADD CHECK (resp_file_url IS NOT NULL);
ALTER TABLE tpp_cbhb_response ADD CHECK (resp_code IS NOT NULL);
ALTER TABLE tpp_cbhb_response ADD CHECK (resp_desc IS NOT NULL);
ALTER TABLE tpp_cbhb_response ADD CHECK (resp_time IS NOT NULL);
ALTER TABLE tpp_cbhb_response ADD CHECK (return_resp_code IS NOT NULL);
ALTER TABLE tpp_cbhb_response ADD CHECK (return_resp_desc IS NOT NULL);
ALTER TABLE tpp_cbhb_response ADD CHECK (return_resp_time IS NOT NULL);
ALTER TABLE tpp_cbhb_response ADD CHECK (notify_resp_code IS NOT NULL);
ALTER TABLE tpp_cbhb_response ADD CHECK (notify_resp_desc IS NOT NULL);
ALTER TABLE tpp_cbhb_response ADD CHECK (notify_resp_time IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table tpp_cbhb_response
-- ----------------------------
ALTER TABLE tpp_cbhb_response ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table tpp_merchant_log
-- ----------------------------

-- ----------------------------
-- Checks structure for table tpp_merchant_log
-- ----------------------------
ALTER TABLE tpp_merchant_log ADD CHECK (uuid IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table tpp_merchant_log
-- ----------------------------
ALTER TABLE tpp_merchant_log ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table tpp_trade
-- ----------------------------
CREATE INDEX idx_trade_to_user_id
ON tpp_trade (to_user_id ASC)
LOGGING
VISIBLE;
CREATE INDEX idx_trade_tpp_type
ON tpp_trade (tpp_type ASC)
LOGGING
VISIBLE;
CREATE INDEX idx_trade_user_id
ON tpp_trade (user_id ASC)
LOGGING
VISIBLE;

-- ----------------------------
-- Checks structure for table tpp_trade
-- ----------------------------
ALTER TABLE tpp_trade ADD CHECK (uuid IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table tpp_trade
-- ----------------------------
ALTER TABLE tpp_trade ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table urge_repay_log
-- ----------------------------

-- ----------------------------
-- Checks structure for table urge_repay_log
-- ----------------------------
ALTER TABLE urge_repay_log ADD CHECK (uuid IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table urge_repay_log
-- ----------------------------
ALTER TABLE urge_repay_log ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table user
-- ----------------------------
CREATE INDEX idx_user_create_time
ON users (create_time ASC)
LOGGING
VISIBLE;
CREATE INDEX idx_user_nature
ON users (user_nature ASC)
LOGGING
VISIBLE;
...
-- ----------------------------
ALTER TABLE users ADD CHECK (uuid IS NOT NULL);
ALTER TABLE users ADD CHECK (user_name IS NOT NULL);
ALTER TABLE users ADD CHECK (pwd IS NOT NULL);
...
-- ----------------------------
-- Indexes structure for table user_activity_award_log
-- ----------------------------

-- ----------------------------
-- Checks structure for table user_activity_award_log
-- ----------------------------
ALTER TABLE user_activity_award_log ADD CHECK (uuid IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table user_activity_award_log
-- ----------------------------
ALTER TABLE user_activity_award_log ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table user_auth_sign_log
-- ----------------------------

-- ----------------------------
-- Checks structure for table user_auth_sign_log
-- ----------------------------
ALTER TABLE user_auth_sign_log ADD CHECK (uuid IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table user_auth_sign_log
-- ----------------------------
ALTER TABLE user_auth_sign_log ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table user_auto_invest
-- ----------------------------
CREATE UNIQUE INDEX uq_auto_invest_userid
ON user_auto_invest (user_id ASC)
LOGGING
VISIBLE;

-- ----------------------------
-- Checks structure for table user_auto_invest
-- ----------------------------
ALTER TABLE user_auto_invest ADD CHECK (uuid IS NOT NULL);
ALTER TABLE user_auto_invest ADD CHECK (user_id IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table user_auto_invest
-- ----------------------------
ALTER TABLE user_auto_invest ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table user_base_info
-- ----------------------------
CREATE UNIQUE INDEX uq_baseinfo_userid
ON user_base_info (user_id ASC)
LOGGING
VISIBLE;

-- ----------------------------
-- Checks structure for table user_base_info
-- ----------------------------
ALTER TABLE user_base_info ADD CHECK (uuid IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table user_base_info
-- ----------------------------
ALTER TABLE user_base_info ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table user_cache
-- ----------------------------
CREATE INDEX idx_cache_id_no
ON user_cache (id_no ASC)
LOGGING
VISIBLE;
CREATE UNIQUE INDEX uq_cache_userid
ON user_cache (user_id ASC)
LOGGING
VISIBLE;

-- ----------------------------
-- Checks structure for table user_cache
-- ----------------------------
ALTER TABLE user_cache ADD CHECK (uuid IS NOT NULL);
ALTER TABLE user_cache ADD CHECK (user_id IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table user_cache
-- ----------------------------
ALTER TABLE user_cache ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table user_company_info
-- ----------------------------
CREATE UNIQUE INDEX uq_compinfo_userid
ON user_company_info (user_id ASC)
LOGGING
VISIBLE;

-- ----------------------------
-- Checks structure for table user_company_info
-- ----------------------------
ALTER TABLE user_company_info ADD CHECK (uuid IS NOT NULL);
ALTER TABLE user_company_info ADD CHECK (user_id IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table user_company_info
-- ----------------------------
ALTER TABLE user_company_info ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table user_earn_log
-- ----------------------------
CREATE INDEX idx_elog_userid
ON user_earn_log (user_id ASC)
LOGGING
VISIBLE;
CREATE INDEX idx_elog_userid_edate
ON user_earn_log (user_id ASC, earn_date ASC)
LOGGING
VISIBLE;

-- ----------------------------
-- Checks structure for table user_earn_log
-- ----------------------------
ALTER TABLE user_earn_log ADD CHECK (uuid IS NOT NULL);
ALTER TABLE user_earn_log ADD CHECK (user_id IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table user_earn_log
-- ----------------------------
ALTER TABLE user_earn_log ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table user_freeze
-- ----------------------------
CREATE INDEX idx_user_freeze_user_id
ON user_freeze (user_id ASC)
LOGGING
VISIBLE;

-- ----------------------------
-- Checks structure for table user_freeze
-- ----------------------------
ALTER TABLE user_freeze ADD CHECK (uuid IS NOT NULL);
ALTER TABLE user_freeze ADD CHECK (user_id IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table user_freeze
-- ----------------------------
ALTER TABLE user_freeze ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table user_gift
-- ----------------------------

-- ----------------------------
-- Checks structure for table user_gift
-- ----------------------------
ALTER TABLE user_gift ADD CHECK (uuid IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table user_gift
-- ----------------------------
ALTER TABLE user_gift ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table user_identify
-- ----------------------------
CREATE UNIQUE INDEX uq_identify_userid
ON user_identify (user_id ASC)
LOGGING
VISIBLE;

-- ----------------------------
-- Checks structure for table user_identify
-- ----------------------------
ALTER TABLE user_identify ADD CHECK (uuid IS NOT NULL);
ALTER TABLE user_identify ADD CHECK (user_id IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table user_identify
-- ----------------------------
ALTER TABLE user_identify ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table user_invest_auto_log
-- ----------------------------

-- ----------------------------
-- Checks structure for table user_invest_auto_log
-- ----------------------------
ALTER TABLE user_invest_auto_log ADD CHECK (uuid IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table user_invest_auto_log
-- ----------------------------
ALTER TABLE user_invest_auto_log ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table user_invite
-- ----------------------------

-- ----------------------------
-- Checks structure for table user_invite
-- ----------------------------
ALTER TABLE user_invite ADD CHECK (uuid IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table user_invite
-- ----------------------------
ALTER TABLE user_invite ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table user_login_log
-- ----------------------------
CREATE INDEX idx_login_log_userid
ON user_login_log (user_id ASC)
LOGGING
VISIBLE;
...
-- ----------------------------
ALTER TABLE user_login_log ADD CHECK (uuid IS NOT NULL);
ALTER TABLE user_login_log ADD CHECK (user_id IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table user_login_log
-- ----------------------------
ALTER TABLE user_login_log ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table user_opinion
-- ----------------------------

-- ----------------------------
-- Checks structure for table user_opinion
-- ----------------------------
ALTER TABLE user_opinion ADD CHECK (UUID IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table user_opinion
-- ----------------------------
ALTER TABLE user_opinion ADD PRIMARY KEY (UUID);

-- ----------------------------
-- Indexes structure for table user_qualification_apply
-- ----------------------------

-- ----------------------------
-- Checks structure for table user_qualification_apply
-- ----------------------------
ALTER TABLE user_qualification_apply ADD CHECK (uuid IS NOT NULL);
ALTER TABLE user_qualification_apply ADD CHECK (user_id IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table user_qualification_apply
-- ----------------------------
ALTER TABLE user_qualification_apply ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table user_qualification_upload
-- ----------------------------

-- ----------------------------
-- Checks structure for table user_qualification_upload
-- ----------------------------
ALTER TABLE user_qualification_upload ADD CHECK (uuid IS NOT NULL);
ALTER TABLE user_qualification_upload ADD CHECK (user_id IS NOT NULL);
ALTER TABLE user_qualification_upload ADD CHECK (qualification_apply_id IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table user_qualification_upload
-- ----------------------------
ALTER TABLE user_qualification_upload ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table user_rate_coupon
-- ----------------------------
CREATE INDEX idx_urc_expire_time_status
ON user_rate_coupon (use_expire_time ASC, status ASC)
LOGGING
VISIBLE;
CREATE INDEX idx_urc_tender_id
ON user_rate_coupon (tender_id ASC)
LOGGING
VISIBLE;
CREATE INDEX idx_urc_userid_status
ON user_rate_coupon (user_id ASC, status ASC)
LOGGING
VISIBLE;

-- ----------------------------
-- Checks structure for table user_rate_coupon
-- ----------------------------
ALTER TABLE user_rate_coupon ADD CHECK (uuid IS NOT NULL);
ALTER TABLE user_rate_coupon ADD CHECK (user_id IS NOT NULL);
ALTER TABLE user_rate_coupon ADD CHECK (rule_name IS NOT NULL);
ALTER TABLE user_rate_coupon ADD CHECK (up_apr IS NOT NULL);
ALTER TABLE user_rate_coupon ADD CHECK (grant_type IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table user_rate_coupon
-- ----------------------------
ALTER TABLE user_rate_coupon ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table user_redenvelope
-- ----------------------------
CREATE INDEX idx_urp_expire_time_status
ON user_redenvelope (use_expire_time ASC, status ASC)
LOGGING
VISIBLE;
CREATE INDEX idx_urp_tender_id
ON user_redenvelope (tender_id ASC)
LOGGING
VISIBLE;
CREATE INDEX idx_urp_user_id_status
ON user_redenvelope (user_id ASC, status ASC)
LOGGING
VISIBLE;

-- ----------------------------
-- Checks structure for table user_redenvelope
-- ----------------------------
ALTER TABLE user_redenvelope ADD CHECK (uuid IS NOT NULL);
ALTER TABLE user_redenvelope ADD CHECK (user_id IS NOT NULL);
ALTER TABLE user_redenvelope ADD CHECK (rule_name IS NOT NULL);
ALTER TABLE user_redenvelope ADD CHECK (amount IS NOT NULL);
ALTER TABLE user_redenvelope ADD CHECK (grant_type IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table user_redenvelope
-- ----------------------------
ALTER TABLE user_redenvelope ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table user_score
-- ----------------------------
CREATE UNIQUE INDEX uk_socre_userid
ON user_score (user_id ASC)
LOGGING
VISIBLE;

-- ----------------------------
-- Checks structure for table user_score
-- ----------------------------
ALTER TABLE user_score ADD CHECK (uuid IS NOT NULL);
ALTER TABLE user_score ADD CHECK (user_id IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table user_score
-- ----------------------------
ALTER TABLE user_score ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table user_score_log
-- ----------------------------
CREATE INDEX idx_sclog_userid_typecode
ON user_score_log (user_id ASC, type_code ASC)
LOGGING
VISIBLE;

-- ----------------------------
-- Checks structure for table user_score_log
-- ----------------------------
ALTER TABLE user_score_log ADD CHECK (uuid IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table user_score_log
-- ----------------------------
ALTER TABLE user_score_log ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table user_security_answer
-- ----------------------------

-- ----------------------------
-- Checks structure for table user_security_answer
-- ----------------------------
ALTER TABLE user_security_answer ADD CHECK (uuid IS NOT NULL);
ALTER TABLE user_security_answer ADD CHECK (user_id IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table user_security_answer
-- ----------------------------
ALTER TABLE user_security_answer ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table user_vip
-- ----------------------------
CREATE UNIQUE INDEX uq_vip_userid
ON user_vip (user_id ASC)
LOGGING
VISIBLE;

-- ----------------------------
-- Checks structure for table user_vip
-- ----------------------------
ALTER TABLE user_vip ADD CHECK (uuid IS NOT NULL);
ALTER TABLE user_vip ADD CHECK (user_id IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table user_vip
-- ----------------------------
ALTER TABLE user_vip ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table user_vip_growth_log
-- ----------------------------

-- ----------------------------
-- Checks structure for table user_vip_growth_log
-- ----------------------------
ALTER TABLE user_vip_growth_log ADD CHECK (uuid IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table user_vip_growth_log
-- ----------------------------
ALTER TABLE user_vip_growth_log ADD PRIMARY KEY (uuid);

-- ----------------------------
-- Indexes structure for table user_vip_level
-- ----------------------------

-- ----------------------------
-- Checks structure for table user_vip_level
-- ----------------------------
ALTER TABLE user_vip_level ADD CHECK (uuid IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table user_vip_level
-- ----------------------------
ALTER TABLE user_vip_level ADD PRIMARY KEY (uuid);
...
-- DROP TABLE USER_GIFT_GRANT;
CREATE TABLE USER_GIFT_GRANT (
UUID NVARCHAR2(32) NOT NULL ,
GIFT_NAME NVARCHAR2(32) NULL ,
GIFT_TYPE NCHAR(1) NULL ,
GIFT_LEVEL NCHAR(3) NULL ,
USER_ID NVARCHAR2(32) NOT NULL ,
REDENVELOPE_RULE_ID NVARCHAR2(32) NULL ,
RATE_COUPON_RULE_ID NVARCHAR2(32) NULL ,
...
;
COMMENT ON TABLE USER_GIFT_GRANT IS '用户礼包发放';
COMMENT ON COLUMN USER_GIFT_GRANT.UUID IS '主键';
COMMENT ON COLUMN USER_GIFT_GRANT.GIFT_NAME IS '礼包名称';
COMMENT ON COLUMN USER_GIFT_GRANT.GIFT_TYPE IS '礼包类型 （0生日礼包 1专享礼包）';
COMMENT ON COLUMN USER_GIFT_GRANT.GIFT_LEVEL IS '礼包等级';
COMMENT ON COLUMN USER_GIFT_GRANT.USER_ID IS '用户ID';
COMMENT ON COLUMN USER_GIFT_GRANT.REDENVELOPE_RULE_ID IS '红包发放规则id';
COMMENT ON COLUMN USER_GIFT_GRANT.RATE_COUPON_RULE_ID IS '加息券发放规则id';
COMMENT ON COLUMN USER_GIFT_GRANT.STATUS IS '状态';
COMMENT ON COLUMN USER_GIFT_GRANT.CREATE_TIME IS '添加时间';
