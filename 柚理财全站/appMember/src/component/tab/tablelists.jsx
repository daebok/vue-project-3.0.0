...
export default class Tabs extends React.Component{
  ...
  getlist(urls,stime,etime,selectvalue,page){
    ...
    let datas = {dateType:that.datatype,status:that.datastatus,startTime:stime,endTime:etime,"page.page":pages,"page.pageSize":that.props.pageSize ? that.props.pageSize : "10"};
  ...
  render() {
    ...
    let recordArr =<div className="Sselect"><em>兑换状态</em><ul className="clearfix" onClick={this.setstatus}>
                  <li><span className="on" data-status="">全部</span></li>
                  <li><span data-status="0">待审核</span></li>
                  <li><span data-status="1">审核通过</span></li>
                </ul></div>;
