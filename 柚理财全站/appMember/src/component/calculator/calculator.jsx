...
let ModalCal = React.createClass({
    ...
    componentDidMount(){
        ...
        this.refs.box.style.left=clientWidth/2-(this.props.width/2)+'px'
        $(document).on('mouseup',this.mouseUp)
        $(document).on('mousemove',this.MoveBox)
    },
    MoveBox(e){
    ...
    render() {
        return(
            <div className={this.props.visible==true?"ant-modal":"ant-modal hide"} ref="box" style={{'width':this.props.width, top: "100px",border:"1px solid #e9e9e9",position:'fixed', transformOrigin: "1235.5px 301px 0px"}} >
                <div className="ant-modal-content" style={{cursor:"move"}} onMouseDown={this.getMouseDown} onMouseMove={this.MoveBox} onMouseUp={this.mouseUp}>
                    <a className="ant-modal-close" >
                        <span className="ant-modal-close-x" onClick={this.props.onCancel}></span>
                    </a>
                    <div className="ant-modal-header" >
                        <div className="ant-modal-title">理财计算器</div>
                    </div>
                </div>
               <div className="ant-modal-body" style={{background:'#fff'}}>
                   {this.props.children}
               </div>
            </div>
        )
           ...
           <div className="clearfix">
               <ModalCal ref="modal"
                   ...
                   <div className="calculator clearfix">
                       <div className="site-col-7" style={{width:'350px'}}>
                            ...
                            <ul>
                                ...
                                <li className="clearfix"><label className="site-col-2">投资期限</label>
                                    <div className="site-col-5">
                                        ...
                                        <div className="site-col-3" style={{marginRight:'0'}}>
                                            <FormItem hasFeedback>
