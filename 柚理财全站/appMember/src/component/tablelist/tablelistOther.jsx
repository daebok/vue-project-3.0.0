...
export default class TablelistOther extends React.Component{
  constructor(props) {
    super(props);
    this.state={
      section:0,
  ...
  render() {
    ...
    let singleArr=""
    if(this.props.config.namestyle==true){
      singleArr =<ul className="clearfix" onClick={this.set}>
                  <li><span className="on" data-type="">全部</span></li>
                  <li><span data-type="01">未来7天</span></li>
                  <li><span data-type="02">未来1个月</span></li>
                  <li><span data-type="03">未来3个月</span></li>
                  <li><span data-type="04">未来1年</span></li>
                </ul>;
    }
    else{
      singleArr =<ul className="clearfix" onClick={this.set}>
