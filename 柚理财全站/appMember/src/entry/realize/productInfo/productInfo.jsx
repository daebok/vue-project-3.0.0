	...
	render() {
		...
		return (
			<table className="productInfo-list">
				<tbody>
				<tr>
					<td><div className="box"><strong>借款标题</strong><p>{data.project.projectName}</p></div></td>
				...
				<tr>
					...
					<td><div className="box"><strong>投资期限</strong><p>{data.project.timeLimit}天</p></div></td>
				</tr>
				<tr>
