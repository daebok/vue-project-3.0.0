      ...
      <Form horizontal className="form-themes" form={this.props.form} onSubmit={this.handleSubmit}>
        ...
        <div className="row" style={{width:800}}>
          ...
          <div className="col-18 pl20" style={{paddingTop:"13px",height:"150px"}}>
            ...
            <div style={{padding:"20px 0 0 0",height:"97px",width:"580px",overflow:"hidden"}}><Imgupload eq={0} data="" imgArray = {this.picPath} len ={5} /></div>
          </div>
        </div>
        <div className="row" style={{width:800}}>
...
ReactDOM.render(<Msgform tokenName={"commitAssistantToken"} tokenValue={$("input[name='commitAssistantToken']").val()} />,  document.getElementById("j-opinionAdd"));
