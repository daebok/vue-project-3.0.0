...
class Baseinfo extends React.Component{
  ...
  render(){
    ...
    let realNameDom = tppName=="cbhb" ?'':<Safeinfo status={realNameStatus} infoname='托管账户' link='/member/security/realNameIdentify.html' str1={str1[0]} str2={str2[0]} linkname={linkname[0]}/>;
    return(
