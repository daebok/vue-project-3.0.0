...
export default class Companyageinfoshow extends React.Component{
	...
	render() {
			...
			let region = <p className="txt fl">{data.userCache.provinceStr}-{data.userCache.cityStr}-{data.userCache.areaStr}</p>
	    ...
	    return (
	        <ul className="form-list">
				  ...
				  <li className="clearfix"><label className="label fl">注册地区</label>{region}</li>				  
				  ...
				  <li><label className="label">公司行业</label><p className="txt">{data.userCompanyInfo.companyIndustry}</p></li>
				  <li><label className="label">还款来源</label><p className="txt">{data.userCompanyInfo.repaySource}</p></li>
				  <li><label className="label">公司规模</label><p className="txt">{data.userCompanyInfo.companyScale}</p></li>
				  <li><label className="label">主营业务</label><p className="txt">{data.userCompanyInfo.businessScope}</p></li>
