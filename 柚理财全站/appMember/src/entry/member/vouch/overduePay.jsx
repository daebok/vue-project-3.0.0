...
class Detail extends React.Component{
  ...
  render() {
    ...
    let verifyTime = Publiclib.formatDate(data.borrow.verifyTime, 2);
        ...
        <div className="detail">
            <table>
              <tbody>
                ...
                <tr>
                  <th>借款方</th>
                  <th>{data.borrow.realName}{data.borrow.mobile}</th>
                  <th>预期年化收益率</th>
                  <th>{data.borrow.apr}</th>
                </tr>
                <tr>
                  <th>项目金额</th>
                  <th>{data.borrow.account}</th>
                  <th>项目期限</th>
