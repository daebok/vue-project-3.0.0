              ...
              html=<div>
                <div className="fund viewlist clearfix">
                    ...
                    <dl>
                        <dt>
                          资产总计
                          <Tooltip title="可用余额+担保中金额+冻结金额" placement="bottom">
                            <em className="iconfont">&#xe620;</em>
                          </Tooltip>
                        </dt>
                        <dd><s>{(Number(datas.account.useMoney) + Number(datas.vouchAccount)+Number(datas.account.noUseMoney)).toFixed(2)}</s><em>元</em></dd>
                    </dl>
                    <ul className="text">
                      ...
                      <li><strong>冻结金额</strong>{datas.account.noUseMoney ? (Number(datas.account.noUseMoney)).toFixed(2) : "0.00"}<em>元</em></li>
            ...
            return (<div className="account-main">
                      <div className="userinfo">
                          <dl className="clearfix">
                              <dt>
                                <span className="companyheaderimg"><a href="#"><img src={datas.logo ? datas.logo : $("#header").data("url") + "/data/img/avatar/default_company_portrait.png"} /></a></span>
                              </dt>
