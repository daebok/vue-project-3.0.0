 ...
 * @date 2016年10月11日
 */
public class AccountCheckWarnMsg implements MsgEvent, Serializable {
	/**
	 * 日志跟踪器
	 */
	private static final Logger LOGGER = LoggerFactory.getLogger(AccountCheckWarnMsg.class);
	 ...
	 * @param nid 模块ID
	 */
	public AccountCheckWarnMsg(final String messageType, final Map<String, Object> params) {
		this();
