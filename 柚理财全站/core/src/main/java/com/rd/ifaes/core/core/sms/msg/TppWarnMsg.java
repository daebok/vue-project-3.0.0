 ...
 * @date 2016年10月12日
 */
public class TppWarnMsg implements MsgEvent, Serializable{
	/**
	 * 日志跟踪器
	 */
	private static final Logger LOGGER = LoggerFactory.getLogger(TppWarnMsg.class);
	 ...
	 * @param nid 模块ID
	 */
	public TppWarnMsg(final String messageType, final Map<String, Object> params) {
		this();
	...
	public void sendMsg() {
		if (StringUtils.isNotBlank(messageType)) { 
			if(params!=null && params.size()>0){
				params.put("addTime", DateUtils.getNow());
				sendMessage();
			}
		}
	}
