  ...
  <div class="page">
    ...
    <ul class="project-detail-3 margin-t-10">
      <li class="border-b-e2 aui-border-b">
        <router-link :to="'/investDetail/'+$route.params.projectId+'/investInfo?borrowFlag='+resdata.borrowFlag+'&oldProjectId='+resdata.oldProjectId">了解项目
    ...
    <div v-else @click="investBid" class="invest-btn" :class="{disabled: resdata.isClick == 0}">{{ resdata.clickTitle }}</div>
  </div>
</template>
<script>
