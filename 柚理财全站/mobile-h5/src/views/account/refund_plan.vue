  ...
  export default {
    ...
    methods: {
      projectList( page = 1){
        ...
        let getParams = {
          projectId: this.$route.query.investId,
          userId: this.$store.state.user.userId,
          __sid: this.$store.state.user.__sid,
          'page.page': page
        }
        this.$http.get(ajaxUrl.myLoanPlanList, {params: getParams}).then((res) => {
