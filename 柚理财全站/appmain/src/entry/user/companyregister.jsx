...
let FirstStep = React.createClass({
  ...
  render() {
    ...
    const label = `${!this.state.checked ? '请阅读并同意《用户平台注册协议》' : ''}`;
    return (
      <Form horizontal className="form-themes" style={{marginLeft:100}} form={this.props.form} onSubmit={this.handleSubmit}>
          <div className="row" style={{width:400}}>
            <div className="col-6" style={{lineHeight:'42px',textAlign: 'right'}}>手机号</div>
          ...
          <div className="row" style={{width:400}}>
            <div className="col-6" style={{textAlign: 'right',lineHeight:'42px'}}>登录密码</div>
            <div className="col-18 pl20">
          ...
          <div className="row" style={{width:400}}>
            <div className="col-6" style={{textAlign: 'right',lineHeight:'42px'}}>确认密码</div>
            <div className="col-18 pl20">
          ...
          <div className="row" style={{width:400}}>
            <div className="col-6" style={{textAlign: 'right',lineHeight:'42px'}}>验证码</div>
          ...
          <div className="row" style={{width:400}}>
            ...
            <div className="col-18 pl20">
              <FormItem validateStatus="error" {...agreeProps} help = {label}><Checkbox checked={this.state.checked} onChange={this.onChange} ></Checkbox>我已阅读并同意<a href="#">《用户平台注册协议》</a></FormItem>
            </div>
          </div>  
      ...
      <Form horizontal className="form-themes" style={{marginLeft:100}} form={this.props.form} onSubmit={this.handleSubmit}>
          ...
          <div className="row" style={{width:400}}>
            ...
            <div className="col-9 pl20">
              <FormItem hasFeedback><Input {...smsProps} type="text" maxLength="6" autoComplete="off" placeholder="输入短信验证码"  />
              </FormItem>
            </div>
            <div className="col-9 pl20">
...
ReactDOM.render(<FirstStep />, document.getElementById("registerForm"));