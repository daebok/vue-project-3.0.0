		...
		return (
			<div className="borrowData-side">
				<div className="tabs-box" id="tabsBox">
					<div className="tab clearfix"><a href="javascript:;" className="first active">所有资料（{len}）</a><a href="javascript:;">基本信息（{fileTypeL1}）</a><a href="javascript:;" className="last">抵押资料（{fileTypeL2}）</a></div>
