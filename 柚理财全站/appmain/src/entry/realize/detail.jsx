...
class Detail extends React.Component{
  ...
  render() {
    ...
    let deadTimeHtml = '';
    if(project.stopTime){
      let deadTime = (project.stopTime - data.systemTime)/1000;
      ...
      <div>
          ...
          <div className="site-col-17 realize-header-info">
            <div className="info-title">
              <span className="title-name"><em className="iconfont">&#xe622;</em>{project.projectName}</span><span className="protocol" onClick={this.showAgreement}>协议预览</span>
            </div>
          ...
          <InvestFrame form = {this.props.form} id={this.props.id} data={data} infoData={this.state.infoData} msgdata={this.state.msgdata} />
        </div>
...
ReactDOM.render(<Detail id={$('#projectId').val()} />,  document.getElementById("j-realizeDetail"));