...
class Baseinfo extends React.Component{
  ...
  render(){
    ...
    let linkname = [],str1=[],str2=[],str3=[],riskLevel = 3;
    if( realNameStatus != 1 ){
      linkname[0] = 2;
          ...
          <Tabs defaultActiveKey="1" onChange={callback}>
            <TabPane tab="安全设置" key="1">
              <ul className="setinfo">
                ...
                <Safeinfo status={data.riskLevel ? true : false} infoname='风险承受能力' link='/member/risk/userRiskPapers.html' str1={str1[5]} str2={str2[5]} linkname={riskLevel} />
