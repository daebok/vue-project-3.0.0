...
class Baseinfo extends React.Component{
  ...
  render(){
    ...
    let pwdQuestLinkName = pwdQuestStatus==0 ? (pwdQuestStatus+4) : (pwdQuestStatus+1);
    //头像
          ...
          <Tabs defaultActiveKey="1" onChange={callback}>
            <TabPane tab="安全设置" key="1">
              <ul className="setinfo">
                ...
                <Safeinfo status={true} infoname='风险承受能力' link='/member/risk/userRiskPapers.html' str1='您的风险承受能力：' str2={str2[5]} linkname={3} />
                <Safeinfo status={authSignStatus} infoname='业务授权' link={authSignStatus == "1" ? 'javascript:void(0)' : '/member/security/authSign.html'} str1='业务授权是方便资金托管方在本平台进行相关资金操作，如投资、借款等' linkname={authSignStatus == "1" ? 6 : 5} />
              </ul>
            </TabPane>
