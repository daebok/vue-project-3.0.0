...
class Authentication extends React.Component{
    ...
    getData(){
        let self = this;
        $.ajax({
            url: '/member/usercertification/getCertificateInfoByUserId.html',
            type: 'POST',
            dataType: 'json',
...
class PersonageUserInfoComponent extends React.Component{
  render() {
    ...
    let birthday = Publiclib.getAge(baseInfo.birthday,this.props.topdata.currentTime);             //年龄
    let education = baseInfo.educationStr;            //学历
    let maritalStatus = Publiclib.getMaritalStatus(baseInfo.maritalStatus);     //婚姻状况
    let workExperience = baseInfo.workExperienceStr;    //工作年限
    let monthIncomeRange = baseInfo.monthIncomeRangeStr;//月收入范围
    ...
    return (
      <div className="personageUser-info">
        ...
        <ul className="list-info">
          ...
          <li><span>证件号码</span><strong>{data.idNo}</strong></li>          
