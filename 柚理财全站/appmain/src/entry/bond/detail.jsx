  ...
  render() {
    ...
    //if(hasLogin == "1"){
      productInfoHtml = <div className="bond-main-cont">
        <dl className="module ">
            <dt>借款详情<a href={'/invest/detail.html?id='+data.projectId} target="_blank" className="pull-right" style={{'fontSize':'14px'}}><i className="iconfont">&#xe619;</i>查看原项目</a> </dt>
             <div className="mt20 detail-info clearfix" style={{'fontSize':'14px'}}>
                            <label>借款标题</label>{project.projectName}
             </div>
            <dd className="detail-info"><BorrowDetail /></dd>
        </dl>
        <dl className="module">
            <dt>借款方信息</dt>
            <dd><BorrowersInfo  data = {data} /></dd>
        </dl>
        <dl className="module">
            <dt>借款资料</dt>
            <dd><BorrowData /></dd>
    ...
    return (
      <div>
        <div className="wrap site-row bond-detail-header">
          <div className="bond-header-info">
            <div className="info-title">
              <span className="title-name">{project.bondName}<i className="yellowIcon">转让</i></span><span className={hasLogin!=1?'protocol hide':'protocol'} onClick={this.getInfo}>协议预览</span>
                <Modal
