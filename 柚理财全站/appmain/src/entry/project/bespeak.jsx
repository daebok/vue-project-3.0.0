  ...
  render() {
    ...
    return (      
      <Form horizontal className="form-themes"  form={this.props.form} onSubmit={this.handleSubmit}>
        ...
        <div className="row" style={{"width":320,"margin":"0 0 2px"}}>
...
ReactDOM.render(<Loanform   tokenName={"borrowBespeakAddToken"} tokenValue={$("input[name='borrowBespeakAddToken']").val()} />, document.getElementById("j-bespeakForm"));