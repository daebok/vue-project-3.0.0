var Reg = {
	...
	//员工码校验
	regStaff: function(value){
		return !/^(?![^a-zA-Z]+$)(?!\D+$).{8}$/.test(value) || /\s/.test(value);
	},
	//手机号码
	...
	isNumber:function(value){
		...
		return ! value.match(/^[1-9]{1}\d*$/) || /\s/.test(value);
	},
	//只能是数字
	...
	moneyRrate:function(value){
		return value < 1 || value > 24  ||  ! /^([1-9]\d*|0)(?:\.\d{0,2})?$/.test(value);
	}
