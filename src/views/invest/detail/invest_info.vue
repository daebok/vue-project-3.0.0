<template>
  <div class="page">
    ...
    <ul class="describe-title" v-if="$route.query.borrowFlag == 1">
      <li @click="active = 'tab-container1'"><span :class="{current: active == 'tab-container1'}">借款描述</span></li>
        ...
        <mt-tab-container-item id="tab-container1">
          <div class="describe-info borrower-info margin-t-15">
            <div v-if="$route.query.borrowFlag == 1">
              <div class="borrow-title">借款标题</div>
              <div class="borrow-name">
                {{ borrowerDetail.projectName }}
              </div>
              <div class="borrow-title margin-t-20">借款用途</div>
              <div class="borrow-use">
                {{ borrowerDetail.borrowUse }}
                <!--<p>为了扩大经营，急需资金周转</p>-->
              </div>
              <div class="borrow-title margin-t-20">借款描述</div>
